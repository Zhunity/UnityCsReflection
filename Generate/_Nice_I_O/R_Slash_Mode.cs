...
namespace Hvak.Editor.Refleaction.RNiceIO
{
	...
	/// NiceIO.SlashMode
	/// </summary>
    public partial class RSlashMode : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RNiceIO.RSlashMode RFNative
		{
			get
			{
				if(r_FNative == null)
				{
					r_FNative = new( ReflectionUtils.GetType("NiceIO.SlashMode"), "Native");
		...
		public static Hvak.Editor.Refleaction.RNiceIO.RSlashMode RFForward
		{
			get
			{
				if(r_FForward == null)
				{
					r_FForward = new( ReflectionUtils.GetType("NiceIO.SlashMode"), "Forward");
		...
		public static Hvak.Editor.Refleaction.RNiceIO.RSlashMode RFBackward
		{
			get
			{
				if(r_FBackward == null)
				{
					r_FBackward = new( ReflectionUtils.GetType("NiceIO.SlashMode"), "Backward");
        ...
        public RSlashMode() : base("NiceIO.SlashMode")
        {
        }

        public RSlashMode(System.Object instance) : base("NiceIO.SlashMode")
		{
            SetInstance(instance);
		}

        public RSlashMode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSlashMode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
