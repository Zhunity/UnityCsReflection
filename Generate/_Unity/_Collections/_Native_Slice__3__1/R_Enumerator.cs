...
{public partial class RNativeSlice<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeSlice<SMFrame.Editor.Refleaction.RField> r_Fm_Array;
		public virtual SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeSlice<SMFrame.Editor.Refleaction.RField> RFm_Array
		{
			get
			{
				if(r_Fm_Array == null)
