	...
	public partial class RReadOnly
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeArray<SMFrame.Editor.Refleaction.RField>.RReadOnly r_Fm_Array;
		public virtual SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeArray<SMFrame.Editor.Refleaction.RField>.RReadOnly RFm_Array
		{
			get
			{
				if(r_Fm_Array == null)
