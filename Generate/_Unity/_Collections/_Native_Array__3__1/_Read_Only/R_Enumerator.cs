	...
	public partial class RReadOnly
{
    ...
    public partial class REnumerator : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("Unity.Collections.NativeArray`1+ReadOnly+Enumerator").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnity.RCollections.RNativeArray<Hvak.Editor.Refleaction.RField>.RReadOnly r_Fm_Array;
		public virtual Hvak.Editor.Refleaction.RUnity.RCollections.RNativeArray<Hvak.Editor.Refleaction.RField>.RReadOnly RFm_Array
		{
			get
			{
				if(r_Fm_Array == null)
