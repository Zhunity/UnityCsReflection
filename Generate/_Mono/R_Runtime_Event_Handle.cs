    ...
    public partial class RRuntimeEventHandle : RMember //
    {
		...
		public static RMethod RMop_Equality_RuntimeEventHandle_RuntimeEventHandle
		{
			get
			{
				...
				{
					r_Mop_Equality_RuntimeEventHandle_RuntimeEventHandle = new(Type, "op_Equality", 0,  ReflectionUtils.GetType("Mono.RuntimeEventHandle"),  ReflectionUtils.GetType("Mono.RuntimeEventHandle"));
				}
		...
		public static RMethod RMop_Inequality_RuntimeEventHandle_RuntimeEventHandle
		{
			get
			{
				...
				{
					r_Mop_Inequality_RuntimeEventHandle_RuntimeEventHandle = new(Type, "op_Inequality", 0,  ReflectionUtils.GetType("Mono.RuntimeEventHandle"),  ReflectionUtils.GetType("Mono.RuntimeEventHandle"));
				}
