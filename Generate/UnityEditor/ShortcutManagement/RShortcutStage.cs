...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RShortcutManagement
{
    ...
    public partial class RShortcutStage : RMember //
    {
		...
		/// </summary>
		protected static RUnityEditor.RShortcutManagement.RShortcutStage r_FBegin;
		public static RUnityEditor.RShortcutManagement.RShortcutStage RFBegin
		{
			get
			{
				if(r_FBegin == null)
				{
					r_FBegin = new(typeof(UnityEditor.ShortcutManagement.ShortcutStage), "Begin");
		...
		/// </summary>
		protected static RUnityEditor.RShortcutManagement.RShortcutStage r_FEnd;
		public static RUnityEditor.RShortcutManagement.RShortcutStage RFEnd
		{
			get
			{
				if(r_FEnd == null)
				{
					r_FEnd = new(typeof(UnityEditor.ShortcutManagement.ShortcutStage), "End");
