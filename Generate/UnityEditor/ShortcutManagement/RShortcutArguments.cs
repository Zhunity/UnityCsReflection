...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RShortcutManagement
{
    ...
    public partial class RShortcutArguments : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_Fcontext;
		public virtual RSystem.RObject RFcontext
		{
			get
			{
				if(r_Fcontext == null)
		...
		/// </summary>
		protected RUnityEditor.RShortcutManagement.RShortcutStage r_Fstage;
		public virtual RUnityEditor.RShortcutManagement.RShortcutStage RFstage
		{
			get
			{
				if(r_Fstage == null)
