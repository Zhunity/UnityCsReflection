...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RAudioFilterGUI : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEditor.REditorGUI.RVUMeter.RSmoothingData> r_FdataOut;
		public virtual RFieldArray<RUnityEditor.REditorGUI.RVUMeter.RSmoothingData> RFdataOut
		{
			get
			{
				if(r_FdataOut == null)
