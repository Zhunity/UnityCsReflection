...
{public partial class RAddComponentWindow
{
    ...
    public partial class RAnalyticsEventData : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_Ffilter;
		public virtual RSystem.RString RFfilter
		{
			get
			{
				if(r_Ffilter == null)
				{
					r_Ffilter = new(this, "filter");
					r_Ffilter.SetBelong(this.instance);
				}
				return r_Ffilter;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_FisNewScript;
		public virtual RSystem.RBoolean RFisNewScript
		{
			get
			{
				if(r_FisNewScript == null)
				{
					r_FisNewScript = new(this, "isNewScript");
					r_FisNewScript.SetBelong(this.instance);
				}
				return r_FisNewScript;
			}
		}
