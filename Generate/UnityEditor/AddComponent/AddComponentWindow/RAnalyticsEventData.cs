    ...
    public partial class RAnalyticsEventData : RMember //
    {
		...
		public virtual RField Rfilter
		{
			get
			{
				if(r_filter == null)
				{
					r_filter = new(this, "filter");
					r_filter.SetBelong(this.instance);
				}
				return r_filter;
			}
		}
		...
		public virtual RField RisNewScript
		{
			get
			{
				if(r_isNewScript == null)
				{
					r_isNewScript = new(this, "isNewScript");
					r_isNewScript.SetBelong(this.instance);
				}
				return r_isNewScript;
			}
		}
