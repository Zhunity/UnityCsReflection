...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RUndoRedoInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_FundoName;
		public virtual RSystem.RString RFundoName
		{
			get
			{
				if(r_FundoName == null)
				{
					...
					r_FundoName.SetBelong(this.instance);
				}
				return r_FundoName;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_FundoGroup;
		public virtual RSystem.RInt32 RFundoGroup
		{
			get
			{
				if(r_FundoGroup == null)
				{
					...
					r_FundoGroup.SetBelong(this.instance);
				}
				return r_FundoGroup;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_IsRedo;
		public virtual RSystem.RInt32 RFm_IsRedo
		{
			get
			{
				if(r_Fm_IsRedo == null)
				{
					...
					r_Fm_IsRedo.SetBelong(this.instance);
				}
				return r_Fm_IsRedo;
			}
		}
		...
		/// Boolean isRedo
		/// </summary>
		protected RSystem.RBoolean r_PisRedo;
		public virtual RSystem.RBoolean RPisRedo
		{
			get
			{
				if(r_PisRedo == null)
				{
					...
					r_PisRedo.SetBelong(this.instance);
				}
				return r_PisRedo;
			}
		}
