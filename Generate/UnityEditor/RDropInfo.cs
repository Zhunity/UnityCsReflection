...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RDropInfo : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.RIDropArea r_FdropArea;
		public virtual RUnityEditor.RIDropArea RFdropArea
		{
			get
			{
				if(r_FdropArea == null)
				{
					...
					r_FdropArea.SetBelong(this.instance);
				}
				return r_FdropArea;
			}
		}
		...
		/// </summary>
		protected RUnityEditor.RDropInfo.RType r_Ftype;
		public virtual RUnityEditor.RDropInfo.RType RFtype
		{
			get
			{
				if(r_Ftype == null)
