...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RDropInfo : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.RIDropArea r_dropArea;
		public virtual RUnityEditor.RIDropArea RdropArea
		{
			get
			{
				if(r_dropArea == null)
				{
					r_dropArea = new(this, "dropArea");
					r_dropArea.SetBelong(this.instance);
				}
				return r_dropArea;
			}
		}
