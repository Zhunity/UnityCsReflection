...
{public partial class ROverlayDropZone
{
	...
	/// <summary>
	/// UnityEditor.Overlays.OverlayDropZone+Placement
	/// </summary>
    public partial class RPlacement : RMember //
    {
		...
		/// </summary>
		protected static RUnityEditor.ROverlays.ROverlayDropZone.RPlacement r_FBefore;
		public static RUnityEditor.ROverlays.ROverlayDropZone.RPlacement RFBefore
		{
			get
			{
				if(r_FBefore == null)
				{
					r_FBefore = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayDropZone+Placement"), "Before");
		...
		/// </summary>
		protected static RUnityEditor.ROverlays.ROverlayDropZone.RPlacement r_FAfter;
		public static RUnityEditor.ROverlays.ROverlayDropZone.RPlacement RFAfter
		{
			get
			{
				if(r_FAfter == null)
				{
					r_FAfter = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayDropZone+Placement"), "After");
