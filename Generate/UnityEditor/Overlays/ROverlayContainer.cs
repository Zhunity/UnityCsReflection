...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayContainer : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RString r_FspacerClassName;
		public static RSystem.RString RFspacerClassName
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEditor.ROverlays.ROverlay r_FspacerMarker;
		public static RUnityEditor.ROverlays.ROverlay RFspacerMarker
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEditor.ROverlays.ROverlay> r_Fm_BeforeOverlays;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEditor.ROverlays.ROverlay> RFm_BeforeOverlays
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEditor.ROverlays.ROverlay> r_Fm_AfterOverlays;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEditor.ROverlays.ROverlay> RFm_AfterOverlays
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualElement r_Fm_Spacer;
		public virtual RUnityEngine.RUIElements.RVisualElement RFm_Spacer
		{
			get
			{
				if(r_Fm_Spacer == null)
		...
		/// </summary>
		protected RUnityEditor.ROverlays.RLayout r_Fm_SupportedOverlayLayouts;
		public virtual RUnityEditor.ROverlays.RLayout RFm_SupportedOverlayLayouts
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_IsHorizontal;
		public virtual RSystem.RBoolean RFm_IsHorizontal
		{
			get
			{
		...
		/// Int32 overlayCount
		/// </summary>
		protected RSystem.RInt32 r_PoverlayCount;
		public virtual RSystem.RInt32 RPoverlayCount
		{
			get
			{
		...
		/// </summary>
		protected RUnityEditor.ROverlays.RLayout r_PpreferredLayout;
		public virtual RUnityEditor.ROverlays.RLayout RPpreferredLayout
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PisHorizontal;
		public virtual RSystem.RBoolean RPisHorizontal
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualElement r_Pspacer;
		public virtual RUnityEngine.RUIElements.RVisualElement RPspacer
		{
			get
			{
				if(r_Pspacer == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_PisSpacerVisible;
		public virtual RSystem.RBoolean RPisSpacerVisible
		{
			get
			{
        ...
        public virtual System.Boolean ContainsOverlay(UnityEditor.Overlays.Overlay @overlay, RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
        ...
        public virtual void InsertOverlay(UnityEditor.Overlays.Overlay @overlay, RUnityEditor.ROverlays.ROverlayContainerSection @section, System.Int32 @index)
        {
        ...
        public virtual System.Boolean GetOverlayIndex(UnityEditor.Overlays.Overlay @overlay, out RUnityEditor.ROverlays.ROverlayContainerSection @section, out System.Int32 @index)
        {
			@section = default;
			@index = default;
			...
			@section = new RUnityEditor.ROverlays.ROverlayContainerSection(___parameters[1]);
        ...
        public virtual System.Int32 GetSectionCount(RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
        ...
        public virtual System.Collections.ObjectModel.ReadOnlyCollection<UnityEditor.Overlays.Overlay> GetSection(RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
        ...
        public virtual System.Collections.Generic.List<UnityEditor.Overlays.Overlay> GetSectionInternal(RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
        ...
        public virtual UnityEditor.Overlays.Overlay GetFirstVisible(RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
        ...
        public virtual UnityEditor.Overlays.Overlay GetLastVisible(RUnityEditor.ROverlays.ROverlayContainerSection @section)
        {
