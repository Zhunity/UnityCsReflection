...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class RSaveData : RMember //
    {
		...
		/// </summary>
		protected RMethod r_REquals_SaveData;
		public virtual RMethod REquals_SaveData
		{
			get
			{
				if(r_REquals_SaveData == null)
				{
					r_REquals_SaveData = new(this, "Equals", 0,  ReleactionUtils.GetType("UnityEditor.Overlays.SaveData"));
					r_REquals_SaveData.SetBelong(this.instance);
				}
				return r_REquals_SaveData;
			}
		}
