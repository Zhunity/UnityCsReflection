...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayContainerSection : RMember //
    {
		...
		/// </summary>
		protected static RUnityEditor.ROverlays.ROverlayContainerSection r_FBeforeSpacer;
		public static RUnityEditor.ROverlays.ROverlayContainerSection RFBeforeSpacer
		{
			get
			{
				if(r_FBeforeSpacer == null)
				{
					r_FBeforeSpacer = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayContainerSection"), "BeforeSpacer");
					r_FBeforeSpacer.SetBelong(null);
				}
				return r_FBeforeSpacer;
			}
		}
		...
		/// </summary>
		protected static RUnityEditor.ROverlays.ROverlayContainerSection r_FAfterSpacer;
		public static RUnityEditor.ROverlays.ROverlayContainerSection RFAfterSpacer
		{
			get
			{
				if(r_FAfterSpacer == null)
				{
					r_FAfterSpacer = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayContainerSection"), "AfterSpacer");
					r_FAfterSpacer.SetBelong(null);
				}
				return r_FAfterSpacer;
			}
		}
