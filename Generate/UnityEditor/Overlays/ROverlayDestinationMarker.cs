...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayDestinationMarker : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RString r_Fk_LineClassName;
		public static RSystem.RString RFk_LineClassName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RString> r_Fm_DropZoneClasses;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RString> RFm_DropZoneClasses
		{
			get
			{
		...
		/// </summary>
		protected RUnityEditor.ROverlays.ROverlayDropZoneBase r_Fm_Target;
		public virtual RUnityEditor.ROverlays.ROverlayDropZoneBase RFm_Target
		{
			get
			{
				if(r_Fm_Target == null)
        ...
        public virtual void SetTarget(RUnityEditor.ROverlays.ROverlayDropZoneBase @target)
        {
