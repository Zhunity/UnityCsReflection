...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayDestinationMarker : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RString r_k_LineClassName;
		public static RSystem.RString Rk_LineClassName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RString> r_m_DropZoneClasses;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RString> Rm_DropZoneClasses
		{
			get
			{
