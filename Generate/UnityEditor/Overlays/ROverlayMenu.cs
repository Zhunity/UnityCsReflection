...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayMenu : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RBoolean r_s_KeepAlive;
		public static RSystem.RBoolean Rs_KeepAlive
		{
			get
			{
				if(r_s_KeepAlive == null)
				{
					r_s_KeepAlive = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_KeepAlive");
		...
		public static RSystem.RAction Rs_DelayUntilCanHide
		{
			get
			{
				...
				{
					r_s_DelayUntilCanHide = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_DelayUntilCanHide");
		...
		public static RSystem.RString Rk_UxmlPath
		{
			get
			{
				...
				{
					r_k_UxmlPath = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "k_UxmlPath");
		...
		public static RSystem.RString RussClassName
		{
			get
			{
				...
				{
					r_ussClassName = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "ussClassName");
		...
		public static RUnityEngine.RUIElements.RVisualTreeAsset Rs_TreeAsset
		{
			get
			{
				...
				{
					r_s_TreeAsset = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_TreeAsset");
		...
		/// Boolean isShown
		/// </summary>
		protected RSystem.RBoolean r_isShown;
		public virtual RSystem.RBoolean RisShown
		{
			get
			{
				if(r_isShown == null)
		...
		/// </summary>
		protected RMethod r_OnCustomStyleResolved_CustomStyleResolvedEvent;
		public virtual RMethod ROnCustomStyleResolved_CustomStyleResolvedEvent
		{
			get
			{
				if(r_OnCustomStyleResolved_CustomStyleResolvedEvent == null)
				{
					r_OnCustomStyleResolved_CustomStyleResolvedEvent = new(this, "OnCustomStyleResolved", 0, typeof(UnityEngine.UIElements.CustomStyleResolvedEvent));
					r_OnCustomStyleResolved_CustomStyleResolvedEvent.SetBelong(this.instance);
				}
				return r_OnCustomStyleResolved_CustomStyleResolvedEvent;
			}
		}
		...
		/// </summary>
		protected RMethod r_OnOverlayEnabledChanged_Boolean;
		public virtual RMethod ROnOverlayEnabledChanged_Boolean
		{
			get
			{
				if(r_OnOverlayEnabledChanged_Boolean == null)
				{
					r_OnOverlayEnabledChanged_Boolean = new(this, "OnOverlayEnabledChanged", 0, typeof(System.Boolean));
					r_OnOverlayEnabledChanged_Boolean.SetBelong(this.instance);
				}
				return r_OnOverlayEnabledChanged_Boolean;
			}
		}
		...
		/// </summary>
		protected RMethod r_CheckIfShouldHide_VisualElement;
		public virtual RMethod RCheckIfShouldHide_VisualElement
		{
			get
			{
				if(r_CheckIfShouldHide_VisualElement == null)
				{
					r_CheckIfShouldHide_VisualElement = new(this, "CheckIfShouldHide", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_CheckIfShouldHide_VisualElement.SetBelong(this.instance);
				}
				return r_CheckIfShouldHide_VisualElement;
			}
		}
		...
		/// </summary>
		protected RMethod r_DropdownOnClicked;
		public virtual RMethod RDropdownOnClicked
		{
			get
			{
				if(r_DropdownOnClicked == null)
				{
					r_DropdownOnClicked = new(this, "DropdownOnClicked", 0);
					r_DropdownOnClicked.SetBelong(this.instance);
				}
				return r_DropdownOnClicked;
			}
		}
		...
		/// </summary>
		protected RMethod r_RebuildMenu_IEnumerable_d_Overlay_p_;
		public virtual RMethod RRebuildMenu_IEnumerable_d_Overlay_p_
		{
			get
			{
				if(r_RebuildMenu_IEnumerable_d_Overlay_p_ == null)
				{
					r_RebuildMenu_IEnumerable_d_Overlay_p_ = new(this, "RebuildMenu", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType(typeof(UnityEditor.Overlays.Overlay)));
					r_RebuildMenu_IEnumerable_d_Overlay_p_.SetBelong(this.instance);
				}
				return r_RebuildMenu_IEnumerable_d_Overlay_p_;
			}
		}
		...
		/// </summary>
		protected RMethod r_Show_IEnumerable_d_Overlay_p__Boolean;
		public virtual RMethod RShow_IEnumerable_d_Overlay_p__Boolean
		{
			get
			{
				if(r_Show_IEnumerable_d_Overlay_p__Boolean == null)
				{
					r_Show_IEnumerable_d_Overlay_p__Boolean = new(this, "Show", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType(typeof(UnityEditor.Overlays.Overlay)), typeof(System.Boolean));
					r_Show_IEnumerable_d_Overlay_p__Boolean.SetBelong(this.instance);
				}
				return r_Show_IEnumerable_d_Overlay_p__Boolean;
			}
		}
		...
		/// </summary>
		protected RMethod r_ResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single;
		public virtual RMethod RResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single
		{
			get
			{
				if(r_ResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single == null)
				{
					r_ResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single = new(this, "ResolveSizeLimits", 0, typeof(System.Single).MakeByRefType(), typeof(System.Single).MakeByRefType(), typeof(System.Single).MakeByRefType(), typeof(System.Single).MakeByRefType());
					r_ResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single.SetBelong(this.instance);
				}
				return r_ResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_AdjustToParentSize;
		public virtual RMethod RAdjustToParentSize
		{
			get
			{
				if(r_AdjustToParentSize == null)
				{
					r_AdjustToParentSize = new(this, "AdjustToParentSize", 0);
					r_AdjustToParentSize.SetBelong(this.instance);
				}
				return r_AdjustToParentSize;
			}
		}
		...
		public virtual RMethod RHide
		{
			get
			{
				if(r_Hide == null)
				{
					r_Hide = new(this, "Hide", 0);
					r_Hide.SetBelong(this.instance);
				}
				return r_Hide;
			}
		}
		...
		/// </summary>
		protected static RMethod r_SetKeepAlive_Boolean;
		public static RMethod RSetKeepAlive_Boolean
		{
			get
			{
				if(r_SetKeepAlive_Boolean == null)
				{
					r_SetKeepAlive_Boolean = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "SetKeepAlive", 0, typeof(System.Boolean));
					r_SetKeepAlive_Boolean.SetBelong(null);
				}
				return r_SetKeepAlive_Boolean;
			}
		}
