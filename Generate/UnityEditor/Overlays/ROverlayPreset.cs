...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayPreset : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RCanApplyToWindow_Type;
		public virtual RMethod RCanApplyToWindow_Type
		{
			get
			{
				if(r_RCanApplyToWindow_Type == null)
				{
					r_RCanApplyToWindow_Type = new(this, "CanApplyToWindow", 0, typeof(System.Type));
					r_RCanApplyToWindow_Type.SetBelong(this.instance);
				}
				return r_RCanApplyToWindow_Type;
			}
		}
