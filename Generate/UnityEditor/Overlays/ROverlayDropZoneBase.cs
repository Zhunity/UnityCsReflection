    ...
    public partial class ROverlayDropZoneBase : RMember //
    {
		...
		public virtual RMethod RSetVisualMode_VisualMode
		{
			get
			{
				...
				{
					r_SetVisualMode_VisualMode = new(this, "SetVisualMode", 0,  ReleactionUtils.GetType("UnityEditor.Overlays.OverlayDropZoneBase+VisualMode"));
		...
		public virtual RMethod RGetContainerStylingForDestMarker_OverlayContainer_Ref_IList_d_String_p_
		{
			get
			{
				...
				{
					r_GetContainerStylingForDestMarker_OverlayContainer_Ref_IList_d_String_p_ = new(this, "GetContainerStylingForDestMarker", 0,  ReleactionUtils.GetType("UnityEditor.Overlays.OverlayContainer"), typeof(System.Collections.Generic.IList<>).MakeGenericType(typeof(System.String)).MakeByRefType());
