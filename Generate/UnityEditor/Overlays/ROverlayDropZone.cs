...
namespace SMFrame.Editor.Refleaction.RUnityEditor.ROverlays
{
    ...
    public partial class ROverlayDropZone : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.ROverlays.ROverlay r_m_TargetOverlay;
		public virtual RUnityEditor.ROverlays.ROverlay Rm_TargetOverlay
		{
			get
			{
				if(r_m_TargetOverlay == null)
				{
					r_m_TargetOverlay = new(this, "m_TargetOverlay");
					r_m_TargetOverlay.SetBelong(this.instance);
				}
				return r_m_TargetOverlay;
			}
		}
		...
		/// </summary>
		protected RField r_m_Placement;
		public virtual RField Rm_Placement
		{
			get
			{
				if(r_m_Placement == null)
				{
					r_m_Placement = new(this, "m_Placement");
					r_m_Placement.SetBelong(this.instance);
				}
				return r_m_Placement;
			}
		}
