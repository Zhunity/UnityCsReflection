...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class REditorWindowTitleAttribute : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_F__0__title__1__k__BackingField;
		public virtual RSystem.RString RF__0__title__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_F__0__icon__1__k__BackingField;
		public virtual RSystem.RString RF__0__icon__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_F__0__useTypeNameAsIconName__1__k__BackingField;
		public virtual RSystem.RBoolean RF__0__useTypeNameAsIconName__1__k__BackingField
		{
			get
			{
		...
		/// System.String icon
		/// </summary>
		protected RSystem.RString r_Picon;
		public virtual RSystem.RString RPicon
		{
			get
			{
				if(r_Picon == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_PuseTypeNameAsIconName;
		public virtual RSystem.RBoolean RPuseTypeNameAsIconName
		{
			get
			{
