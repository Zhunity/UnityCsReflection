...
{public partial class RUnityType
{
    ...
    public partial class RUnityTypeTransport : RMember //
    {
		...
		/// </summary>
		protected RSystem.RUInt32 r_FbaseClassIndex;
		public virtual RSystem.RUInt32 RFbaseClassIndex
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_FclassName;
		public virtual RSystem.RString RFclassName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_FclassNamespace;
		public virtual RSystem.RString RFclassNamespace
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_Fmodule;
		public virtual RSystem.RString RFmodule
		{
			get
			{
				if(r_Fmodule == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_FpersistentTypeID;
		public virtual RSystem.RInt32 RFpersistentTypeID
		{
			get
			{
