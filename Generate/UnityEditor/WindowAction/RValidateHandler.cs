...
{public partial class RWindowAction
{
    ...
    public partial class RValidateHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_EditorWindow_WindowAction;
		public virtual RMethod RInvoke_EditorWindow_WindowAction
		{
			get
			{
				if(r_RInvoke_EditorWindow_WindowAction == null)
				{
					r_RInvoke_EditorWindow_WindowAction = new(this, "Invoke", 0, typeof(UnityEditor.EditorWindow),  ReleactionUtils.GetType("UnityEditor.WindowAction"));
					r_RInvoke_EditorWindow_WindowAction.SetBelong(this.instance);
				}
				return r_RInvoke_EditorWindow_WindowAction;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.EditorWindow),  ReleactionUtils.GetType("UnityEditor.WindowAction"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object;
			}
		}
