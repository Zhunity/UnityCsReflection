...
{public partial class RWindowAction
{
    ...
    public partial class RValidateHandler : RMember //
    {
		...
		public virtual RMethod RMInvoke_EditorWindow_WindowAction
		{
			get
			{
				if(r_MInvoke_EditorWindow_WindowAction == null)
				{
					...
					r_MInvoke_EditorWindow_WindowAction.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object.SetBelong(this.instance);
				}
        ...
        public virtual System.Boolean Invoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action, System.AsyncCallback @callback, System.Object @object)
        {
