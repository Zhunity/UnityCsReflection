...
{public partial class RWindowAction
{
    ...
    public partial class RDrawHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_EditorWindow_WindowAction_Rect;
		public virtual RMethod RInvoke_EditorWindow_WindowAction_Rect
		{
			get
			{
				if(r_Invoke_EditorWindow_WindowAction_Rect == null)
				{
					r_Invoke_EditorWindow_WindowAction_Rect = new(this, "Invoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect));
					r_Invoke_EditorWindow_WindowAction_Rect.SetBelong(this.instance);
				}
				return r_Invoke_EditorWindow_WindowAction_Rect;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object == null)
				{
					r_BeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
			}
		}
        ...
        public virtual System.Boolean Invoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action, UnityEngine.Rect @rect)
        {
            ...
            var ___result = RInvoke_EditorWindow_WindowAction_Rect.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action, UnityEngine.Rect @rect, System.AsyncCallback @callback, System.Object @object)
        {
            ...
            var ___result = RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
