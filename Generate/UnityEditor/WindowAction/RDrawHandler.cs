...
{public partial class RWindowAction
{
    ...
    public partial class RDrawHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_EditorWindow_WindowAction_Rect;
		public virtual RMethod RInvoke_EditorWindow_WindowAction_Rect
		{
			get
			{
				if(r_RInvoke_EditorWindow_WindowAction_Rect == null)
				{
					r_RInvoke_EditorWindow_WindowAction_Rect = new(this, "Invoke", 0, typeof(UnityEditor.EditorWindow),  ReleactionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect));
					r_RInvoke_EditorWindow_WindowAction_Rect.SetBelong(this.instance);
				}
				return r_RInvoke_EditorWindow_WindowAction_Rect;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.EditorWindow),  ReleactionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
			}
		}
