...
{public partial class RWindowAction
{
	...
	/// <summary>
	/// UnityEditor.WindowAction+DrawHandler
	/// </summary>
    public partial class RDrawHandler : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(UnityEditor.EditorWindow, UnityEditor.WindowAction, UnityEngine.Rect)
		/// </summary>
		protected RMethod r_MInvoke_EditorWindow_WindowAction_Rect;
		public virtual RMethod RMInvoke_EditorWindow_WindowAction_Rect
		{
			get
			{
				if(r_MInvoke_EditorWindow_WindowAction_Rect == null)
				{
					r_MInvoke_EditorWindow_WindowAction_Rect = new(this, "Invoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect));
					r_MInvoke_EditorWindow_WindowAction_Rect.SetBelong(this.instance);
				}
				return r_MInvoke_EditorWindow_WindowAction_Rect;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow, UnityEditor.WindowAction, UnityEngine.Rect, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object;
			}
		}
        ...
        public virtual System.Boolean Invoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action, UnityEngine.Rect @rect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@window, @action.Value, @rect};
            var ___result = RMInvoke_EditorWindow_WindowAction_Rect.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow @window, RUnityEditor.RWindowAction @action, UnityEngine.Rect @rect, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@window, @action.Value, @rect, @callback, @object};
            var ___result = RMBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
