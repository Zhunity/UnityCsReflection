    ...
    public partial class RSmoothingData : RMember //
    {
		...
		public virtual RField RlastValue
		{
			get
			{
				if(r_lastValue == null)
				{
					r_lastValue = new(this, "lastValue");
		...
		public virtual RField RpeakValue
		{
			get
			{
				if(r_peakValue == null)
				{
					r_peakValue = new(this, "peakValue");
					r_peakValue.SetBelong(this.instance);
				}
				return r_peakValue;
			}
		}
		...
		public virtual RField RpeakValueTime
		{
			get
			{
				if(r_peakValueTime == null)
				{
					r_peakValueTime = new(this, "peakValueTime");
					r_peakValueTime.SetBelong(this.instance);
				}
				return r_peakValueTime;
			}
		}
