...
{public partial class RAdvancedDropdownDataSource
{
    ...
    public partial class RSearchMatchItemHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean;
		public virtual RMethod RInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean
		{
			get
			{
				if(r_Invoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean == null)
				{
					r_Invoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean = new(this, "Invoke", 0, typeof(UnityEditor.IMGUI.Controls.AdvancedDropdownItem).MakeByRefType(), typeof(System.String).MakeArrayType().MakeByRefType(), typeof(System.Boolean).MakeByRefType());
					r_Invoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean.SetBelong(this.instance);
				}
				return r_Invoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object == null)
				{
					r_BeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.IMGUI.Controls.AdvancedDropdownItem).MakeByRefType(), typeof(System.String).MakeArrayType().MakeByRefType(), typeof(System.Boolean).MakeByRefType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_AsyncCallback_Object;
			}
		}
		...
		/// </summary>
		protected RMethod r_EndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult;
		public virtual RMethod REndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult
		{
			get
			{
				if(r_EndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult == null)
				{
					r_EndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult = new(this, "EndInvoke", 0, typeof(UnityEditor.IMGUI.Controls.AdvancedDropdownItem).MakeByRefType(), typeof(System.String).MakeArrayType().MakeByRefType(), typeof(System.Boolean).MakeByRefType(), typeof(System.IAsyncResult));
					r_EndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult.SetBelong(this.instance);
				}
				return r_EndInvoke_In_AdvancedDropdownItem_In_StringArray_Out_Boolean_IAsyncResult;
			}
		}
