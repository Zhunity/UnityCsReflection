...
{public partial class REditorWindow
{
    ...
    public partial class ROverlayShortcutContext : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.REditorWindow r_editorWindow;
		public virtual RUnityEditor.REditorWindow ReditorWindow
		{
			get
			{
				if(r_editorWindow == null)
				{
					r_editorWindow = new(this, "editorWindow");
					r_editorWindow.SetBelong(this.instance);
				}
				return r_editorWindow;
			}
		}
