...
{public partial class REditorWindow
{
	...
	/// <summary>
	/// UnityEditor.EditorWindow+OverlayShortcutContext
	/// </summary>
    public partial class ROverlayShortcutContext : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.REditorWindow r_FeditorWindow;
		public virtual RUnityEditor.REditorWindow RFeditorWindow
		{
			get
			{
				if(r_FeditorWindow == null)
				{
					r_FeditorWindow = new(this, "editorWindow");
					r_FeditorWindow.SetBelong(this.instance);
				}
				return r_FeditorWindow;
			}
		}
