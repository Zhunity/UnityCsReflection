...
{public partial class REditor
{
	
	/// <summary>
	/// UnityEditor.Editor+OnEditorGUIDelegate
	/// </summary>
    public partial class ROnEditorGUIDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEditor.Editor, UnityEngine.Rect)
		/// </summary>
		protected RMethod r_MInvoke_Editor_Rect;
		public virtual RMethod RMInvoke_Editor_Rect
		{
			get
			{
				if(r_MInvoke_Editor_Rect == null)
				{
					r_MInvoke_Editor_Rect = new(this, "Invoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect));
					r_MInvoke_Editor_Rect.SetBelong(this.instance);
				}
				return r_MInvoke_Editor_Rect;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditor.Editor, UnityEngine.Rect, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Editor_Rect_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Editor_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Editor_Rect_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Editor_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Editor_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Editor_Rect_AsyncCallback_Object;
			}
		}
        ...
        public ROnEditorGUIDelegate() : base("UnityEditor.Editor+OnEditorGUIDelegate")
        {
        }

        public ROnEditorGUIDelegate(System.Object instance) : base("UnityEditor.Editor+OnEditorGUIDelegate")
		{
            SetInstance(instance);
		}

        public ROnEditorGUIDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnEditorGUIDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEditor.Editor @editor, UnityEngine.Rect @drawRect)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@editor, @drawRect};
            var ___result = RMInvoke_Editor_Rect.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEditor.Editor @editor, UnityEngine.Rect @drawRect, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@editor, @drawRect, @callback, @object};
            var ___result = RMBeginInvoke_Editor_Rect_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
