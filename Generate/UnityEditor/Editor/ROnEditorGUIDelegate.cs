...
{public partial class REditor
{
    ...
    public partial class ROnEditorGUIDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Editor_Rect;
		public virtual RMethod RInvoke_Editor_Rect
		{
			get
			{
				if(r_RInvoke_Editor_Rect == null)
				{
					r_RInvoke_Editor_Rect = new(this, "Invoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect));
					r_RInvoke_Editor_Rect.SetBelong(this.instance);
				}
				return r_RInvoke_Editor_Rect;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Editor_Rect_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Editor_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Editor_Rect_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Editor_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Editor_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Editor_Rect_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(UnityEditor.Editor  @editor, UnityEngine.Rect  @drawRect)
        {
            ...
            var ___result = RInvoke_Editor_Rect.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEditor.Editor  @editor, UnityEngine.Rect  @drawRect, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_Editor_Rect_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
