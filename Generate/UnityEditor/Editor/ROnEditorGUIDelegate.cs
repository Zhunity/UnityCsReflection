...
{public partial class REditor
{
    ...
    public partial class ROnEditorGUIDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_Editor_Rect;
		public virtual RMethod RInvoke_Editor_Rect
		{
			get
			{
				if(r_Invoke_Editor_Rect == null)
				{
					r_Invoke_Editor_Rect = new(this, "Invoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect));
					r_Invoke_Editor_Rect.SetBelong(this.instance);
				}
				return r_Invoke_Editor_Rect;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_Editor_Rect_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Editor_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_Editor_Rect_AsyncCallback_Object == null)
				{
					r_BeginInvoke_Editor_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.Editor), typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_Editor_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_Editor_Rect_AsyncCallback_Object;
			}
		}
