...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RDataModeChangeEventArgs : RMember //
    {
		...
		/// </summary>
		protected RUnityEditor.RDataMode r_FnextDataMode;
		public virtual RUnityEditor.RDataMode RFnextDataMode
		{
			get
			{
				if(r_FnextDataMode == null)
				{
					r_FnextDataMode = new(this, "nextDataMode");
					r_FnextDataMode.SetBelong(this.instance);
				}
				return r_FnextDataMode;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_FchangedThroughUI;
		public virtual RSystem.RBoolean RFchangedThroughUI
		{
			get
			{
				if(r_FchangedThroughUI == null)
				{
					r_FchangedThroughUI = new(this, "changedThroughUI");
					r_FchangedThroughUI.SetBelong(this.instance);
				}
				return r_FchangedThroughUI;
			}
		}
