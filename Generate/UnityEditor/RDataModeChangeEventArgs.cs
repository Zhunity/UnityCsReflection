...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RDataModeChangeEventArgs : RMember //
    {
		...
		/// </summary>
		protected RField r_nextDataMode;
		public virtual RField RnextDataMode
		{
			get
			{
				if(r_nextDataMode == null)
				{
					r_nextDataMode = new(this, "nextDataMode");
					r_nextDataMode.SetBelong(this.instance);
				}
				return r_nextDataMode;
			}
		}
		...
		public virtual RSystem.RBoolean RchangedThroughUI
		{
			get
			{
				if(r_changedThroughUI == null)
				{
					r_changedThroughUI = new(this, "changedThroughUI");
					r_changedThroughUI.SetBelong(this.instance);
				}
				return r_changedThroughUI;
			}
		}
