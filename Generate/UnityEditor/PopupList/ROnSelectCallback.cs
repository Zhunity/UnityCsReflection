...
{public partial class RPopupList
{
    ...
    public partial class ROnSelectCallback : RMember //
    {
		...
		public virtual RMethod RMInvoke_ListElement
		{
			get
			{
				if(r_MInvoke_ListElement == null)
				{
					...
					r_MInvoke_ListElement.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMBeginInvoke_ListElement_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_ListElement_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_ListElement_AsyncCallback_Object.SetBelong(this.instance);
				}
        ...
        public virtual void Invoke(RUnityEditor.RPopupList.RListElement @element)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(RUnityEditor.RPopupList.RListElement @element, System.AsyncCallback @callback, System.Object @object)
        {
