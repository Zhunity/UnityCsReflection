...
{public partial class RPopupList
{
    ...
    public partial class ROnSelectCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_ListElement;
		public virtual RMethod RInvoke_ListElement
		{
			get
			{
				if(r_RInvoke_ListElement == null)
				{
					r_RInvoke_ListElement = new(this, "Invoke", 0,  ReleactionUtils.GetType("UnityEditor.PopupList+ListElement"));
					r_RInvoke_ListElement.SetBelong(this.instance);
				}
				return r_RInvoke_ListElement;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_ListElement_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ListElement_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_ListElement_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_ListElement_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("UnityEditor.PopupList+ListElement"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_ListElement_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_ListElement_AsyncCallback_Object;
			}
		}
