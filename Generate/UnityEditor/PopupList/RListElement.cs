...
{public partial class RPopupList
{
    ...
    public partial class RListElement : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RGUIContent r_Fm_Content;
		public virtual RUnityEngine.RGUIContent RFm_Content
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RSingle r_Fm_FilterScore;
		public virtual RSystem.RSingle RFm_FilterScore
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_Selected;
		public virtual RSystem.RBoolean RFm_Selected
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_WasSelected;
		public virtual RSystem.RBoolean RFm_WasSelected
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_PartiallySelected;
		public virtual RSystem.RBoolean RFm_PartiallySelected
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_Enabled;
		public virtual RSystem.RBoolean RFm_Enabled
		{
			get
			{
		...
		/// </summary>
		protected RFieldArray<RSystem.RString> r_Fm_Types;
		public virtual RFieldArray<RSystem.RString> RFm_Types
		{
			get
			{
				if(r_Fm_Types == null)
		...
		/// Single filterScore
		/// </summary>
		protected RSystem.RSingle r_PfilterScore;
		public virtual RSystem.RSingle RPfilterScore
		{
			get
			{
		...
		/// Boolean selected
		/// </summary>
		protected RSystem.RBoolean r_Pselected;
		public virtual RSystem.RBoolean RPselected
		{
			get
			{
				if(r_Pselected == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_PpartiallySelected;
		public virtual RSystem.RBoolean RPpartiallySelected
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIEnumerable<RSystem.RString> r_Ptypes;
		public virtual RSystem.RCollections.RGeneric.RIEnumerable<RSystem.RString> RPtypes
		{
			get
			{
				if(r_Ptypes == null)
