...
namespace SMFrame.Editor.Refleaction.RUnityEditor
{
    ...
    public partial class RAudioFilterGUI : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RUnityEditor.REditorGUI.RVUMeter.RSmoothingData> r_FdataOut;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RUnityEditor.REditorGUI.RVUMeter.RSmoothingData> RFdataOut
		{
			get
			{
				if(r_FdataOut == null)
				{
					...
					r_FdataOut.SetBelong(this.instance);
				}
				return r_FdataOut;
			}
		}
		...
		public virtual RMethod RMDrawAudioFilterGUI_MonoBehaviour
		{
			get
			{
				if(r_MDrawAudioFilterGUI_MonoBehaviour == null)
				{
					...
					r_MDrawAudioFilterGUI_MonoBehaviour.SetBelong(this.instance);
				}
