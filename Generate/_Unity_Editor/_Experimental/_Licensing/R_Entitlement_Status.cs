...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RExperimental.RLicensing
{
	...
	/// </summary>
    public partial class REntitlementStatus : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RExperimental.RLicensing.REntitlementStatus RFUnknown
		{
			get
			{
				if(r_FUnknown == null)
				{
					r_FUnknown = new( ReflectionUtils.GetType("UnityEditor.Experimental.Licensing.EntitlementStatus"), "Unknown");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RExperimental.RLicensing.REntitlementStatus RFGranted
		{
			get
			{
				if(r_FGranted == null)
				{
					r_FGranted = new( ReflectionUtils.GetType("UnityEditor.Experimental.Licensing.EntitlementStatus"), "Granted");
					r_FGranted.SetBelong(null);
				}
				return r_FGranted;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RExperimental.RLicensing.REntitlementStatus RFNotGranted
		{
			get
			{
				if(r_FNotGranted == null)
				{
					r_FNotGranted = new( ReflectionUtils.GetType("UnityEditor.Experimental.Licensing.EntitlementStatus"), "NotGranted");
					r_FNotGranted.SetBelong(null);
				}
				return r_FNotGranted;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RExperimental.RLicensing.REntitlementStatus RFFree
		{
			get
			{
				if(r_FFree == null)
				{
					r_FFree = new( ReflectionUtils.GetType("UnityEditor.Experimental.Licensing.EntitlementStatus"), "Free");
        ...
        public REntitlementStatus() : base("UnityEditor.Experimental.Licensing.EntitlementStatus")
        {
        }

        public REntitlementStatus(System.Object instance) : base("UnityEditor.Experimental.Licensing.EntitlementStatus")
		{
            SetInstance(instance);
		}

        public REntitlementStatus(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REntitlementStatus(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
