...
{public partial class RWindowAction
{
	
	/// <summary>
	/// UnityEditor.WindowAction+ValidateHandler
	/// </summary>
    public partial class RValidateHandler : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(UnityEditor.EditorWindow, UnityEditor.WindowAction)
		/// </summary>
		protected RMethod r_MInvoke_EditorWindow_WindowAction;
		public virtual RMethod RMInvoke_EditorWindow_WindowAction
		{
			get
			{
				if(r_MInvoke_EditorWindow_WindowAction == null)
				{
					r_MInvoke_EditorWindow_WindowAction = new(this, "Invoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"));
					r_MInvoke_EditorWindow_WindowAction.SetBelong(this.GetValue());
				}
				return r_MInvoke_EditorWindow_WindowAction;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow, UnityEditor.WindowAction, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditor.EditorWindow),  ReflectionUtils.GetType("UnityEditor.WindowAction"), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object;
			}
		}
        ...
        public RValidateHandler() : base("UnityEditor.WindowAction+ValidateHandler")
        {
        }

        public RValidateHandler(System.Object instance) : base("UnityEditor.WindowAction+ValidateHandler")
		{
            SetInstance(instance);
		}

        public RValidateHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RValidateHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Boolean Invoke(UnityEditor.EditorWindow @window, Hvak.Editor.Refleaction.RUnityEditor.RWindowAction @action)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@window, @action.Value};
            var ___result = RMInvoke_EditorWindow_WindowAction.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow @window, Hvak.Editor.Refleaction.RUnityEditor.RWindowAction @action, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@window, @action.Value, @callback, @object};
            var ___result = RMBeginInvoke_EditorWindow_WindowAction_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
