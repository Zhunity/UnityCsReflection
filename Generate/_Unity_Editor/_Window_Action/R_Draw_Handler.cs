...
{public partial class RWindowAction
{
    ...
    public partial class RDrawHandler : RMember //
    {
		...
		public virtual RMethod RMInvoke_EditorWindow_WindowAction_Rect
		{
			get
			{
				if(r_MInvoke_EditorWindow_WindowAction_Rect == null)
				{
					...
					r_MInvoke_EditorWindow_WindowAction_Rect.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_EditorWindow_WindowAction_Rect_AsyncCallback_Object.SetBelong(this.GetValue());
				}
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEditor.EditorWindow @window, Hvak.Editor.Refleaction.RUnityEditor.RWindowAction @action, UnityEngine.Rect @rect, System.AsyncCallback @callback, System.Object @object)
        {
