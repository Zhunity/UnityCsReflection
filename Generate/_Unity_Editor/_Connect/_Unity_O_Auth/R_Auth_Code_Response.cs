		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RF__0__AuthCode__1__k__BackingField
		{
			get
			{
				if(r_F__0__AuthCode__1__k__BackingField == null)
				{
					...
					r_F__0__AuthCode__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RException RF__0__Exception__1__k__BackingField
		{
			get
			{
				if(r_F__0__Exception__1__k__BackingField == null)
				{
					...
					r_F__0__Exception__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPAuthCode
		{
			get
			{
				if(r_PAuthCode == null)
				{
					...
					r_PAuthCode.SetBelong(this.instance);
				}
				return r_PAuthCode;
			}
		}
