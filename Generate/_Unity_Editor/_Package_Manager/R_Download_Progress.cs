...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
    ...
    public partial class RDownloadProgress : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RUInt64 RFcurrentBytes
		{
			get
			{
				if(r_FcurrentBytes == null)
				{
					r_FcurrentBytes = new(this, "currentBytes");
					r_FcurrentBytes.SetBelong(this.GetValue());
				}
				return r_FcurrentBytes;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RUInt64 RFtotalBytes
		{
			get
			{
				if(r_FtotalBytes == null)
				{
					r_FtotalBytes = new(this, "totalBytes");
					r_FtotalBytes.SetBelong(this.GetValue());
				}
				return r_FtotalBytes;
			}
		}
