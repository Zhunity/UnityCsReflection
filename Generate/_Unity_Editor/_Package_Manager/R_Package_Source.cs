    ...
    public partial class RPackageSource : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFUnknown
		{
			get
			{
				if(r_FUnknown == null)
				{
					r_FUnknown = new(typeof(UnityEditor.PackageManager.PackageSource), "Unknown");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFRegistry
		{
			get
			{
				if(r_FRegistry == null)
				{
					r_FRegistry = new(typeof(UnityEditor.PackageManager.PackageSource), "Registry");
					r_FRegistry.SetBelong(null);
				}
				return r_FRegistry;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFBuiltIn
		{
			get
			{
				if(r_FBuiltIn == null)
				{
					r_FBuiltIn = new(typeof(UnityEditor.PackageManager.PackageSource), "BuiltIn");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFEmbedded
		{
			get
			{
				if(r_FEmbedded == null)
				{
					r_FEmbedded = new(typeof(UnityEditor.PackageManager.PackageSource), "Embedded");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFLocal
		{
			get
			{
				if(r_FLocal == null)
				{
					r_FLocal = new(typeof(UnityEditor.PackageManager.PackageSource), "Local");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFGit
		{
			get
			{
				if(r_FGit == null)
				{
					r_FGit = new(typeof(UnityEditor.PackageManager.PackageSource), "Git");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageSource RFLocalTarball
		{
			get
			{
				if(r_FLocalTarball == null)
				{
					r_FLocalTarball = new(typeof(UnityEditor.PackageManager.PackageSource), "LocalTarball");
					r_FLocalTarball.SetBelong(null);
				}
				return r_FLocalTarball;
			}
		}
