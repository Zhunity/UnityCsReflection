...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RSearchCapabilities : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSearchCapabilities RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SearchCapabilities"), "None");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSearchCapabilities RFClassification
		{
			get
			{
				if(r_FClassification == null)
				{
					r_FClassification = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SearchCapabilities"), "Classification");
					r_FClassification.SetBelong(null);
				}
				return r_FClassification;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSearchCapabilities RFOrdering
		{
			get
			{
				if(r_FOrdering == null)
				{
					r_FOrdering = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SearchCapabilities"), "Ordering");
					r_FOrdering.SetBelong(null);
				}
				return r_FOrdering;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSearchCapabilities RFPagination
		{
			get
			{
				if(r_FPagination == null)
				{
					r_FPagination = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SearchCapabilities"), "Pagination");
					r_FPagination.SetBelong(null);
				}
				return r_FPagination;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSearchCapabilities RFAll
		{
			get
			{
				if(r_FAll == null)
				{
					r_FAll = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SearchCapabilities"), "All");
        ...
        public RSearchCapabilities() : base("UnityEditor.PackageManager.SearchCapabilities")
        {
        }

        public RSearchCapabilities(System.Object instance) : base("UnityEditor.PackageManager.SearchCapabilities")
		{
            SetInstance(instance);
		}

        public RSearchCapabilities(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSearchCapabilities(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
