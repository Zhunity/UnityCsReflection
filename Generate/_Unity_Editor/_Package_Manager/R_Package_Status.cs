...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RPackageStatus : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageStatus RFUnknown
		{
			get
			{
				if(r_FUnknown == null)
				{
					r_FUnknown = new(typeof(UnityEditor.PackageManager.PackageStatus), "Unknown");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageStatus RFUnavailable
		{
			get
			{
				if(r_FUnavailable == null)
				{
					r_FUnavailable = new(typeof(UnityEditor.PackageManager.PackageStatus), "Unavailable");
					r_FUnavailable.SetBelong(null);
				}
				return r_FUnavailable;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageStatus RFInProgress
		{
			get
			{
				...
				{
					r_FInProgress = new(typeof(UnityEditor.PackageManager.PackageStatus), "InProgress");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageStatus RFError
		{
			get
			{
				if(r_FError == null)
				{
					r_FError = new(typeof(UnityEditor.PackageManager.PackageStatus), "Error");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageStatus RFAvailable
		{
			get
			{
				if(r_FAvailable == null)
				{
					r_FAvailable = new(typeof(UnityEditor.PackageManager.PackageStatus), "Available");
					r_FAvailable.SetBelong(null);
				}
				return r_FAvailable;
			}
		}
        ...
        public RPackageStatus() : base("UnityEditor.PackageManager.PackageStatus")
        {
        }

        public RPackageStatus(System.Object instance) : base("UnityEditor.PackageManager.PackageStatus")
		{
            SetInstance(instance);
		}

        public RPackageStatus(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageStatus(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
