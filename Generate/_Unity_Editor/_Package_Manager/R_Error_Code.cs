...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RErrorCode : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFUnknown
		{
			get
			{
				if(r_FUnknown == null)
				{
					r_FUnknown = new(typeof(UnityEditor.PackageManager.ErrorCode), "Unknown");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFNotFound
		{
			get
			{
				if(r_FNotFound == null)
				{
					r_FNotFound = new(typeof(UnityEditor.PackageManager.ErrorCode), "NotFound");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFForbidden
		{
			get
			{
				...
				{
					r_FForbidden = new(typeof(UnityEditor.PackageManager.ErrorCode), "Forbidden");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFInvalidParameter
		{
			get
			{
				...
				{
					r_FInvalidParameter = new(typeof(UnityEditor.PackageManager.ErrorCode), "InvalidParameter");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFConflict
		{
			get
			{
				if(r_FConflict == null)
				{
					r_FConflict = new(typeof(UnityEditor.PackageManager.ErrorCode), "Conflict");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RErrorCode RFAggregateError
		{
			get
			{
				...
				{
					r_FAggregateError = new(typeof(UnityEditor.PackageManager.ErrorCode), "AggregateError");
        ...
        public RErrorCode() : base("UnityEditor.PackageManager.ErrorCode")
        {
        }

        public RErrorCode(System.Object instance) : base("UnityEditor.PackageManager.ErrorCode")
		{
            SetInstance(instance);
		}

        public RErrorCode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RErrorCode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
