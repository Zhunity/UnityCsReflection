...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RProgressState : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFPending
		{
			get
			{
				if(r_FPending == null)
				{
					r_FPending = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Pending");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFDownloading
		{
			get
			{
				...
				{
					r_FDownloading = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Downloading");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFCaching
		{
			get
			{
				if(r_FCaching == null)
				{
					r_FCaching = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Caching");
					r_FCaching.SetBelong(null);
				}
				return r_FCaching;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFInstalling
		{
			get
			{
				...
				{
					r_FInstalling = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Installing");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFReady
		{
			get
			{
				if(r_FReady == null)
				{
					r_FReady = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Ready");
					r_FReady.SetBelong(null);
				}
				return r_FReady;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RProgressState RFError
		{
			get
			{
				if(r_FError == null)
				{
					r_FError = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ProgressState"), "Error");
        ...
        public RProgressState() : base("UnityEditor.PackageManager.ProgressState")
        {
        }

        public RProgressState(System.Object instance) : base("UnityEditor.PackageManager.ProgressState")
		{
            SetInstance(instance);
		}

        public RProgressState(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RProgressState(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
