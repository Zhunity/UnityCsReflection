...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RConfigSource : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFUnknown
		{
			get
			{
				if(r_FUnknown == null)
				{
					r_FUnknown = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "Unknown");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFDefault
		{
			get
			{
				if(r_FDefault == null)
				{
					r_FDefault = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "Default");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFGlobal
		{
			get
			{
				if(r_FGlobal == null)
				{
					r_FGlobal = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "Global");
					r_FGlobal.SetBelong(null);
				}
				return r_FGlobal;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFUser
		{
			get
			{
				if(r_FUser == null)
				{
					r_FUser = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "User");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFProject
		{
			get
			{
				if(r_FProject == null)
				{
					r_FProject = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "Project");
					r_FProject.SetBelong(null);
				}
				return r_FProject;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RConfigSource RFEnvironment
		{
			get
			{
				if(r_FEnvironment == null)
				{
					r_FEnvironment = new( ReflectionUtils.GetType("UnityEditor.PackageManager.ConfigSource"), "Environment");
					r_FEnvironment.SetBelong(null);
				}
				return r_FEnvironment;
			}
		}
        ...
        public RConfigSource() : base("UnityEditor.PackageManager.ConfigSource")
        {
        }

        public RConfigSource(System.Object instance) : base("UnityEditor.PackageManager.ConfigSource")
		{
            SetInstance(instance);
		}

        public RConfigSource(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RConfigSource(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
