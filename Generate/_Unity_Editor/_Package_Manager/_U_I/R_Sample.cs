		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RF__0__description__1__k__BackingField
		{
			get
			{
				if(r_F__0__description__1__k__BackingField == null)
				{
					...
					r_F__0__description__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RF__0__resolvedPath__1__k__BackingField
		{
			get
			{
				if(r_F__0__resolvedPath__1__k__BackingField == null)
				{
					...
					r_F__0__resolvedPath__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RF__0__importPath__1__k__BackingField
		{
			get
			{
				if(r_F__0__importPath__1__k__BackingField == null)
				{
					...
					r_F__0__importPath__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RF__0__interactiveImport__1__k__BackingField
		{
			get
			{
				if(r_F__0__interactiveImport__1__k__BackingField == null)
				{
					...
					r_F__0__interactiveImport__1__k__BackingField.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<SMFrame.Editor.Refleaction.RSystem.RString> RFm_PreviousImports
		{
			get
			{
				if(r_Fm_PreviousImports == null)
				{
					...
					r_Fm_PreviousImports.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RPimportPath
		{
			get
			{
				if(r_PimportPath == null)
				{
					...
					r_PimportPath.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RPinteractiveImport
		{
			get
			{
				if(r_PinteractiveImport == null)
				{
					...
					r_PinteractiveImport.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RPisImported
		{
			get
			{
				if(r_PisImported == null)
				{
					...
					r_PisImported.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<SMFrame.Editor.Refleaction.RSystem.RString> RPpreviousImports
		{
			get
			{
				if(r_PpreviousImports == null)
				{
					...
					r_PpreviousImports.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMImport_ImportOptions
		{
			get
			{
				if(r_MImport_ImportOptions == null)
				{
					...
					r_MImport_ImportOptions.SetBelong(this.instance);
				}
