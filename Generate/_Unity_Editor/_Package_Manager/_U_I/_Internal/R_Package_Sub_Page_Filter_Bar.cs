...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageSubPageFilterBar
	/// </summary>
    public partial class RPackageSubPageFilterBar : RMember //
    {
		...
		public virtual RMethod RMOnSubPageChanged_IPage
		{
			get
			{
				if(r_MOnSubPageChanged_IPage == null)
				{
					...
					r_MOnSubPageChanged_IPage.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefresh_IPage
		{
			get
			{
				if(r_MRefresh_IPage == null)
				{
					r_MRefresh_IPage = new(this, "Refresh", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPage"));
					r_MRefresh_IPage.SetBelong(this.GetValue());
				}
				return r_MRefresh_IPage;
			}
		}
        ...
        public virtual void Refresh(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPage @page)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@page.Value};
            var ___result = RMRefresh_IPage.Invoke(___genericsType, ___parameters);
