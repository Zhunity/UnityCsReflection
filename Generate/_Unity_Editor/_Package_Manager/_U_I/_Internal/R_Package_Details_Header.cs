...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RPackageDetailsHeader : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag> r_Fk_VisibleTags;
		public static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag> RFk_VisibleTags
		{
			get
			{
				if(r_Fk_VisibleTags == null)
				{
					r_Fk_VisibleTags = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDetailsHeader"), "k_VisibleTags");
					r_Fk_VisibleTags.SetBelong(null);
				}
				return r_Fk_VisibleTags;
			}
		}

		/// <summary>
		/// System.String[] k_InfoBoxReadMoreUrl
		/// </summary>
		protected static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> r_Fk_InfoBoxReadMoreUrl;
		public static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> RFk_InfoBoxReadMoreUrl
		{
			get
			{
				if(r_Fk_InfoBoxReadMoreUrl == null)
				{
					r_Fk_InfoBoxReadMoreUrl = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDetailsHeader"), "k_InfoBoxReadMoreUrl");
					r_Fk_InfoBoxReadMoreUrl.SetBelong(null);
				}
				return r_Fk_InfoBoxReadMoreUrl;
			}
		}

		/// <summary>
		/// System.String[] k_InfoBoxReadMoreText
		/// </summary>
		protected static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> r_Fk_InfoBoxReadMoreText;
		public static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> RFk_InfoBoxReadMoreText
		{
			get
			{
				if(r_Fk_InfoBoxReadMoreText == null)
				{
					r_Fk_InfoBoxReadMoreText = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDetailsHeader"), "k_InfoBoxReadMoreText");
					r_Fk_InfoBoxReadMoreText.SetBelong(null);
				}
				return r_Fk_InfoBoxReadMoreText;
			}
		}
		...
		/// <summary>
		/// System.String infoBoxUrl
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_PinfoBoxUrl;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPinfoBoxUrl
		{
			get
			{
				if(r_PinfoBoxUrl == null)
				{
					r_PinfoBoxUrl = new(this, "infoBoxUrl", -1);
					r_PinfoBoxUrl.SetBelong(this.GetValue());
				}
				return r_PinfoBoxUrl;
			}
		}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.SelectableLabel detailTitle
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel r_PdetailTitle;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel RPdetailTitle
		{
			get
			{
				if(r_PdetailTitle == null)
				{
					r_PdetailTitle = new(this, "detailTitle", -1);
					r_PdetailTitle.SetBelong(this.GetValue());
				}
				return r_PdetailTitle;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label detailEntitlement
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_PdetailEntitlement;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RPdetailEntitlement
		{
			get
			{
				if(r_PdetailEntitlement == null)
				{
					r_PdetailEntitlement = new(this, "detailEntitlement", -1);
					r_PdetailEntitlement.SetBelong(this.GetValue());
				}
				return r_PdetailEntitlement;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.SelectableLabel detailVersion
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel r_PdetailVersion;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel RPdetailVersion
		{
			get
			{
				if(r_PdetailVersion == null)
				{
					r_PdetailVersion = new(this, "detailVersion", -1);
					r_PdetailVersion.SetBelong(this.GetValue());
				}
				return r_PdetailVersion;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement versionInfoIcon
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PversionInfoIcon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPversionInfoIcon
		{
			get
			{
				if(r_PversionInfoIcon == null)
				{
					r_PversionInfoIcon = new(this, "versionInfoIcon", -1);
					r_PversionInfoIcon.SetBelong(this.GetValue());
				}
				return r_PversionInfoIcon;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.SelectableLabel detailName
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel r_PdetailName;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RSelectableLabel RPdetailName
		{
			get
			{
				if(r_PdetailName == null)
				{
					r_PdetailName = new(this, "detailName", -1);
					r_PdetailName.SetBelong(this.GetValue());
				}
				return r_PdetailName;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RPdetailAuthorLink
		{
			get
			{
				if(r_PdetailAuthorLink == null)
				{
					r_PdetailAuthorLink = new(this, "detailAuthorLink", -1);
					r_PdetailAuthorLink.SetBelong(this.GetValue());
				}
				return r_PdetailAuthorLink;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageDetailsLinks detailsLinks
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageDetailsLinks r_PdetailsLinks;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageDetailsLinks RPdetailsLinks
		{
			get
			{
				if(r_PdetailsLinks == null)
				{
					r_PdetailsLinks = new(this, "detailsLinks", -1);
					r_PdetailsLinks.SetBelong(this.GetValue());
				}
				return r_PdetailsLinks;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RPdetailRegistry
		{
			get
			{
				if(r_PdetailRegistry == null)
				{
					...
					r_PdetailRegistry.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.HelpBox scopedRegistryInfoBox
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox r_PscopedRegistryInfoBox;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox RPscopedRegistryInfoBox
		{
			get
			{
				if(r_PscopedRegistryInfoBox == null)
				{
					r_PscopedRegistryInfoBox = new(this, "scopedRegistryInfoBox", -1);
					r_PscopedRegistryInfoBox.SetBelong(this.GetValue());
				}
				return r_PscopedRegistryInfoBox;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RPquickStart
		{
			get
			{
				if(r_PquickStart == null)
				{
					...
					r_PquickStart.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement usedInFeatureSetMessageContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PusedInFeatureSetMessageContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPusedInFeatureSetMessageContainer
		{
			get
			{
				if(r_PusedInFeatureSetMessageContainer == null)
				{
					r_PusedInFeatureSetMessageContainer = new(this, "usedInFeatureSetMessageContainer", -1);
					r_PusedInFeatureSetMessageContainer.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPdependencyContainer
		{
			get
			{
				if(r_PdependencyContainer == null)
				{
					...
					r_PdependencyContainer.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.HelpBox featureSetDependentVersionDifferentInfoBox
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox r_PfeatureSetDependentVersionDifferentInfoBox;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox RPfeatureSetDependentVersionDifferentInfoBox
		{
			get
			{
				if(r_PfeatureSetDependentVersionDifferentInfoBox == null)
				{
					r_PfeatureSetDependentVersionDifferentInfoBox = new(this, "featureSetDependentVersionDifferentInfoBox", -1);
					r_PfeatureSetDependentVersionDifferentInfoBox.SetBelong(this.GetValue());
				}
				return r_PfeatureSetDependentVersionDifferentInfoBox;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement lockedIcon
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PlockedIcon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPlockedIcon
		{
			get
			{
				if(r_PlockedIcon == null)
				{
					r_PlockedIcon = new(this, "lockedIcon", -1);
					r_PlockedIcon.SetBelong(this.GetValue());
				}
				return r_PlockedIcon;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.HelpBox embeddedFeatureSetWarningBox
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox r_PembeddedFeatureSetWarningBox;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox RPembeddedFeatureSetWarningBox
		{
			get
			{
				if(r_PembeddedFeatureSetWarningBox == null)
				{
					r_PembeddedFeatureSetWarningBox = new(this, "embeddedFeatureSetWarningBox", -1);
					r_PembeddedFeatureSetWarningBox.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPhiddenAssetInfoBoxContainer
		{
			get
			{
				if(r_PhiddenAssetInfoBoxContainer == null)
				{
					...
					r_PhiddenAssetInfoBoxContainer.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox RPdisabledWarningBox
		{
			get
			{
				if(r_PdisabledWarningBox == null)
				{
					...
					r_PdisabledWarningBox.SetBelong(this.GetValue());
				}
		...
		/// Void RefreshName()
		/// </summary>
		protected RMethod r_MRefreshName;
		public virtual RMethod RMRefreshName
		{
			get
			{
				if(r_MRefreshName == null)
				{
					r_MRefreshName = new(this, "RefreshName", 0);
					r_MRefreshName.SetBelong(this.GetValue());
				}
				return r_MRefreshName;
			}
		}
		...
		public virtual RMethod RMRefreshHiddenAssetInfo
		{
			get
			{
				if(r_MRefreshHiddenAssetInfo == null)
				{
					...
					r_MRefreshHiddenAssetInfo.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshFeatureSetElements_VisualState
		{
			get
			{
				if(r_MRefreshFeatureSetElements_VisualState == null)
				{
					...
					r_MRefreshFeatureSetElements_VisualState.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshQuickStart
		{
			get
			{
				if(r_MRefreshQuickStart == null)
				{
					...
					r_MRefreshQuickStart.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMViewQuickStartClick
		{
			get
			{
				if(r_MViewQuickStartClick == null)
				{
					...
					r_MViewQuickStartClick.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshDependency
		{
			get
			{
				if(r_MRefreshDependency == null)
				{
					...
					r_MRefreshDependency.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshLockIcons_IEnumerable_d_IPackageVersion_p__VisualState
		{
			get
			{
				...
				{
					r_MRefreshLockIcons_IEnumerable_d_IPackageVersion_p__VisualState = new(this, "RefreshLockIcons", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"));
					r_MRefreshLockIcons_IEnumerable_d_IPackageVersion_p__VisualState.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.Button CreateLink(UnityEditor.PackageManager.UI.Internal.IPackageVersion)
		/// </summary>
		protected static RMethod r_MCreateLink_IPackageVersion;
		public static RMethod RMCreateLink_IPackageVersion
		{
			get
			{
				if(r_MCreateLink_IPackageVersion == null)
				{
					r_MCreateLink_IPackageVersion = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDetailsHeader"), "CreateLink", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
					r_MCreateLink_IPackageVersion.SetBelong(null);
				}
				return r_MCreateLink_IPackageVersion;
			}
		}

		/// <summary>
		/// Void RefreshUsedInFeatureSetMessage(System.Collections.Generic.IEnumerable`1[UnityEditor.PackageManager.UI.Internal.IPackageVersion])
		/// </summary>
		protected RMethod r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_;
		public virtual RMethod RMRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_
		{
			get
			{
				if(r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_ == null)
				{
					r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_ = new(this, "RefreshUsedInFeatureSetMessage", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
					r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_.SetBelong(this.GetValue());
				}
				return r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_;
			}
		}

		/// <summary>
		/// Void RefreshFeatureSetDependentVersionDifferentInfoBox(System.Collections.Generic.IEnumerable`1[UnityEditor.PackageManager.UI.Internal.IPackageVersion])
		/// </summary>
		protected RMethod r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_;
		public virtual RMethod RMRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_
		{
			get
			{
				if(r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_ == null)
				{
					r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_ = new(this, "RefreshFeatureSetDependentVersionDifferentInfoBox", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
					r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_.SetBelong(this.GetValue());
				}
				return r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_;
			}
		}
		...
		/// Void RefreshAuthor()
		/// </summary>
		protected RMethod r_MRefreshAuthor;
		public virtual RMethod RMRefreshAuthor
		{
			get
			{
				if(r_MRefreshAuthor == null)
				{
					r_MRefreshAuthor = new(this, "RefreshAuthor", 0);
					r_MRefreshAuthor.SetBelong(this.GetValue());
				}
				return r_MRefreshAuthor;
			}
		}
		...
		/// Void AuthorClick()
		/// </summary>
		protected RMethod r_MAuthorClick;
		public virtual RMethod RMAuthorClick
		{
			get
			{
				if(r_MAuthorClick == null)
				{
					r_MAuthorClick = new(this, "AuthorClick", 0);
					r_MAuthorClick.SetBelong(this.GetValue());
				}
				return r_MAuthorClick;
			}
		}
		...
		/// </summary>
		protected RMethod r_MRefreshVersionLabel;
		public virtual RMethod RMRefreshVersionLabel
		{
			get
			{
				if(r_MRefreshVersionLabel == null)
				{
					r_MRefreshVersionLabel = new(this, "RefreshVersionLabel", 0);
					r_MRefreshVersionLabel.SetBelong(this.GetValue());
				}
				return r_MRefreshVersionLabel;
			}
		}

		/// <summary>
		/// Void RefreshVersionInfoIcon()
		/// </summary>
		protected RMethod r_MRefreshVersionInfoIcon;
		public virtual RMethod RMRefreshVersionInfoIcon
		{
			get
			{
				if(r_MRefreshVersionInfoIcon == null)
				{
					r_MRefreshVersionInfoIcon = new(this, "RefreshVersionInfoIcon", 0);
					r_MRefreshVersionInfoIcon.SetBelong(this.GetValue());
				}
				return r_MRefreshVersionInfoIcon;
			}
		}
		...
		public virtual RMethod RMRefreshRegistry
		{
			get
			{
				if(r_MRefreshRegistry == null)
				{
					...
					r_MRefreshRegistry.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void RefreshEmbeddedFeatureSetWarningBox()
		/// </summary>
		protected RMethod r_MRefreshEmbeddedFeatureSetWarningBox;
		public virtual RMethod RMRefreshEmbeddedFeatureSetWarningBox
		{
			get
			{
				if(r_MRefreshEmbeddedFeatureSetWarningBox == null)
				{
					r_MRefreshEmbeddedFeatureSetWarningBox = new(this, "RefreshEmbeddedFeatureSetWarningBox", 0);
					r_MRefreshEmbeddedFeatureSetWarningBox.SetBelong(this.GetValue());
				}
				return r_MRefreshEmbeddedFeatureSetWarningBox;
			}
		}

		/// <summary>
		/// Void OnInfoBoxClickMore()
		/// </summary>
		protected RMethod r_MOnInfoBoxClickMore;
		public virtual RMethod RMOnInfoBoxClickMore
		{
			get
			{
				if(r_MOnInfoBoxClickMore == null)
				{
					r_MOnInfoBoxClickMore = new(this, "OnInfoBoxClickMore", 0);
					r_MOnInfoBoxClickMore.SetBelong(this.GetValue());
				}
				return r_MOnInfoBoxClickMore;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageTagLabel GetTagLabel(System.String)
		/// </summary>
		protected RMethod r_MGetTagLabel_String;
		public virtual RMethod RMGetTagLabel_String
		{
			get
			{
				if(r_MGetTagLabel_String == null)
				{
					r_MGetTagLabel_String = new(this, "GetTagLabel", 0, typeof(System.String));
					r_MGetTagLabel_String.SetBelong(this.GetValue());
				}
				return r_MGetTagLabel_String;
			}
		}
		...
		public virtual RMethod RM__0__OnVisualStateChange__1__b__24_0_VisualState
		{
			get
			{
				if(r_M__0__OnVisualStateChange__1__b__24_0_VisualState == null)
				{
					...
					r_M__0__OnVisualStateChange__1__b__24_0_VisualState.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RM__0__RefreshTags__1__b__29_0_DependencyInfo
		{
			get
			{
				if(r_M__0__RefreshTags__1__b__29_0_DependencyInfo == null)
				{
					...
					r_M__0__RefreshTags__1__b__29_0_DependencyInfo.SetBelong(this.GetValue());
				}
        ...
        public virtual void RefreshName()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshName.Invoke(___genericsType, ___parameters);
        ...
        public static UnityEngine.UIElements.Button CreateLink(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@version.Value};
            var ___result = RMCreateLink_IPackageVersion.Invoke(___genericsType, ___parameters);

            return (UnityEngine.UIElements.Button)___result;
        }


        public virtual void RefreshUsedInFeatureSetMessage(Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion> @featureSets)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@featureSets.Value};
            var ___result = RMRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RefreshFeatureSetDependentVersionDifferentInfoBox(Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion> @featureSets)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@featureSets.Value};
            var ___result = RMRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RefreshAuthor()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshAuthor.Invoke(___genericsType, ___parameters);
        ...
        public virtual void AuthorClick()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMAuthorClick.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RefreshVersionLabel()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshVersionLabel.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RefreshVersionInfoIcon()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshVersionInfoIcon.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RefreshEmbeddedFeatureSetWarningBox()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshEmbeddedFeatureSetWarningBox.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnInfoBoxClickMore()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMOnInfoBoxClickMore.Invoke(___genericsType, ___parameters);

            
        }


        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTagLabel GetTagLabel(System.String @tag)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@tag};
            var ___result = RMGetTagLabel_String.Invoke(___genericsType, ___parameters);

            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTagLabel(___result);
        }
