    ...
    public partial class RPackageDetailsHeader : RMember //
    {
		...
		public virtual RMethod RMRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_
		{
			get
			{
				...
				{
					r_MRefreshUsedInFeatureSetMessage_IEnumerable_d_IPackageVersion_p_ = new(this, "RefreshUsedInFeatureSetMessage", 0,  ReflectionUtils.GetType("System.Collections.Generic.IEnumerable`1").MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
				}
		...
		public virtual RMethod RMRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_
		{
			get
			{
				...
				{
					r_MRefreshFeatureSetDependentVersionDifferentInfoBox_IEnumerable_d_IPackageVersion_p_ = new(this, "RefreshFeatureSetDependentVersionDifferentInfoBox", 0,  ReflectionUtils.GetType("System.Collections.Generic.IEnumerable`1").MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
				}
