...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageRemoveCustomButton
	/// </summary>
    public partial class RPackageRemoveCustomButton : RMember //
    {
		...
		/// <summary>
		/// Void DeselectVersions(System.Collections.Generic.IList`1[UnityEditor.PackageManager.UI.Internal.IPackageVersion])
		/// </summary>
		protected RMethod r_MDeselectVersions_IList_d_IPackageVersion_p_;
		public virtual RMethod RMDeselectVersions_IList_d_IPackageVersion_p_
		{
			get
			{
				if(r_MDeselectVersions_IList_d_IPackageVersion_p_ == null)
				{
					r_MDeselectVersions_IList_d_IPackageVersion_p_ = new(this, "DeselectVersions", 0, typeof(System.Collections.Generic.IList<>).MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
					r_MDeselectVersions_IList_d_IPackageVersion_p_.SetBelong(this.instance);
				}
				return r_MDeselectVersions_IList_d_IPackageVersion_p_;
			}
		}
        ...
        public RPackageRemoveCustomButton() : base("UnityEditor.PackageManager.UI.Internal.PackageRemoveCustomButton")
        {
        }

        public RPackageRemoveCustomButton(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageRemoveCustomButton")
		{
            SetInstance(instance);
		}

        public RPackageRemoveCustomButton(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageRemoveCustomButton(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void DeselectVersions(SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RIList<SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion> @versions)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@versions.Value};
            var ___result = RMDeselectVersions_IList_d_IPackageVersion_p_.Invoke(___genericsType, ___parameters);
