...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RPackageRemoveCustomButton : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageRemoveCustomButton");
            }
        }
		...
		public virtual RMethod RMDeselectVersions_IList_d_IPackageVersion_p_
		{
			get
			{
				...
				{
					r_MDeselectVersions_IList_d_IPackageVersion_p_ = new(this, "DeselectVersions", 0,  ReflectionUtils.GetType("System.Collections.Generic.IList`1").MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion")));
				}
