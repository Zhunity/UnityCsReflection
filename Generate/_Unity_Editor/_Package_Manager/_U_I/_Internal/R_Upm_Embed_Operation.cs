...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.UpmEmbedOperation
	/// </summary>
    public partial class RUpmEmbedOperation : RMember //
    {
		...
		/// <summary>
		/// System.Action`1[UnityEditor.PackageManager.Requests.EmbedRequest] onProcessResult
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.EmbedRequest m_Request
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.REmbedRequest r_Fm_Request;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.REmbedRequest RFm_Request
		{
			get
			{
		...
		/// <summary>
		/// Void Embed(System.String, System.String)
		/// </summary>
		protected RMethod r_MEmbed_String_String;
		public virtual RMethod RMEmbed_String_String
		{
			get
			{
				if(r_MEmbed_String_String == null)
				{
					r_MEmbed_String_String = new(this, "Embed", 0, typeof(System.String), typeof(System.String));
					r_MEmbed_String_String.SetBelong(this.instance);
				}
				return r_MEmbed_String_String;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.Requests.EmbedRequest CreateRequest()
		/// </summary>
        ...
        public RUpmEmbedOperation() : base("UnityEditor.PackageManager.UI.Internal.UpmEmbedOperation")
        {
        }

        public RUpmEmbedOperation(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.UpmEmbedOperation")
		{
            SetInstance(instance);
		}

        public RUpmEmbedOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUpmEmbedOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Embed(System.String @packageName, System.String @packageUniqueId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@packageName, @packageUniqueId};
            var ___result = RMEmbed_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEditor.PackageManager.Requests.EmbedRequest CreateRequest()
        {
