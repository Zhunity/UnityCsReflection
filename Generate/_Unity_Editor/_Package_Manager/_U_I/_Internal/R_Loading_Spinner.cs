...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.LoadingSpinner
	/// </summary>
    public partial class RLoadingSpinner : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_F__0__started__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RF__0__started__1__k__BackingField
		{
			get
			{
				if(r_F__0__started__1__k__BackingField == null)
				{
					r_F__0__started__1__k__BackingField = new(this, "<started>k__BackingField");
					r_F__0__started__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__started__1__k__BackingField;
			}
		}

		/// <summary>
		/// System.Int32 k_RotationSpeed
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RInt32 r_Fk_RotationSpeed;
		public static Hvak.Editor.Refleaction.RSystem.RInt32 RFk_RotationSpeed
		{
			get
			{
				if(r_Fk_RotationSpeed == null)
				{
					r_Fk_RotationSpeed = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "k_RotationSpeed");
					r_Fk_RotationSpeed.SetBelong(null);
				}
				return r_Fk_RotationSpeed;
			}
		}

		/// <summary>
		/// System.Double k_PaintInterval
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RDouble r_Fk_PaintInterval;
		public static Hvak.Editor.Refleaction.RSystem.RDouble RFk_PaintInterval
		{
			get
			{
				if(r_Fk_PaintInterval == null)
				{
					r_Fk_PaintInterval = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "k_PaintInterval");
					r_Fk_PaintInterval.SetBelong(null);
				}
				return r_Fk_PaintInterval;
			}
		}

		/// <summary>
		/// System.Int32 s_Rotation
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RInt32 r_Fs_Rotation;
		public static Hvak.Editor.Refleaction.RSystem.RInt32 RFs_Rotation
		{
			get
			{
				if(r_Fs_Rotation == null)
				{
					r_Fs_Rotation = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "s_Rotation");
					r_Fs_Rotation.SetBelong(null);
				}
				return r_Fs_Rotation;
			}
		}

		/// <summary>
		/// System.Double s_LastRotationTime
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RDouble r_Fs_LastRotationTime;
		public static Hvak.Editor.Refleaction.RSystem.RDouble RFs_LastRotationTime
		{
			get
			{
				if(r_Fs_LastRotationTime == null)
				{
					r_Fs_LastRotationTime = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "s_LastRotationTime");
					r_Fs_LastRotationTime.SetBelong(null);
				}
				return r_Fs_LastRotationTime;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEditor.PackageManager.UI.Internal.LoadingSpinner] s_CurrentSpinners
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RLoadingSpinner> r_Fs_CurrentSpinners;
		public static Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RLoadingSpinner> RFs_CurrentSpinners
		{
			get
			{
				if(r_Fs_CurrentSpinners == null)
				{
					r_Fs_CurrentSpinners = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "s_CurrentSpinners");
					r_Fs_CurrentSpinners.SetBelong(null);
				}
				return r_Fs_CurrentSpinners;
			}
		}
		...
		/// Boolean started
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_Pstarted;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPstarted
		{
			get
			{
				if(r_Pstarted == null)
				{
					r_Pstarted = new(this, "started", -1);
					r_Pstarted.SetBelong(this.GetValue());
				}
				return r_Pstarted;
			}
		}
		...
		/// Void UpdateProgress()
		/// </summary>
		protected static RMethod r_MUpdateProgress;
		public static RMethod RMUpdateProgress
		{
			get
			{
				if(r_MUpdateProgress == null)
				{
					r_MUpdateProgress = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "UpdateProgress", 0);
					r_MUpdateProgress.SetBelong(null);
				}
				return r_MUpdateProgress;
			}
		}
		...
		public virtual RMethod RMStop
		{
			get
			{
				if(r_MStop == null)
				{
					...
					r_MStop.SetBelong(this.GetValue());
				}
				return r_MStop;
			}
		}
		...
		/// </summary>
		protected static RMethod r_MClearAllSpinners;
		public static RMethod RMClearAllSpinners
		{
			get
			{
				if(r_MClearAllSpinners == null)
				{
					r_MClearAllSpinners = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.LoadingSpinner"), "ClearAllSpinners", 0);
					r_MClearAllSpinners.SetBelong(null);
				}
				return r_MClearAllSpinners;
			}
		}
        ...
        public static void UpdateProgress()
        {
            ...
            var ___result = RMUpdateProgress.Invoke(___genericsType, ___parameters);
        ...
        public static void ClearAllSpinners()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMClearAllSpinners.Invoke(___genericsType, ___parameters);
