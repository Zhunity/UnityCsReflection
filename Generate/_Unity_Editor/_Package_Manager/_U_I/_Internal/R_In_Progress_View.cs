...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.InProgressView
	/// </summary>
    public partial class RInProgressView : RMember //
    {

		/// <summary>
		/// UnityEngine.UIElements.Label m_Title
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_Title;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_Title
		{
			get
			{
				if(r_Fm_Title == null)
				{
					...
					r_Fm_Title.SetBelong(this.GetValue());
				}
				return r_Fm_Title;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.Label m_Description
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_Description;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_Description
		{
			get
			{
		...
		/// <summary>
		/// Boolean Refresh(UnityEditor.PackageManager.UI.Internal.IPackage)
		/// </summary>
		protected RMethod r_MRefresh_IPackage;
		public virtual RMethod RMRefresh_IPackage
		{
			get
			{
				if(r_MRefresh_IPackage == null)
				{
					r_MRefresh_IPackage = new(this, "Refresh", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackage"));
					r_MRefresh_IPackage.SetBelong(this.GetValue());
				}
				return r_MRefresh_IPackage;
			}
		}
        ...
        public RInProgressView() : base("UnityEditor.PackageManager.UI.Internal.InProgressView")
        {
        }

        public RInProgressView(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.InProgressView")
		{
            SetInstance(instance);
		}

        public RInProgressView(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RInProgressView(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Boolean Refresh(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackage @package)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@package.Value};
            var ___result = RMRefresh_IPackage.Invoke(___genericsType, ___parameters);
