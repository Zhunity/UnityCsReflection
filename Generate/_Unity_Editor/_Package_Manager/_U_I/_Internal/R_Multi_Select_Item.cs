...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.MultiSelectItem
	/// </summary>
    public partial class RMultiSelectItem : RMember //
    {
		...
		/// <summary>
		/// System.String m_RightInfoText
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_Fm_RightInfoText;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_RightInfoText
		{
			get
			{
				if(r_Fm_RightInfoText == null)
				{
					r_Fm_RightInfoText = new(this, "m_RightInfoText");
					r_Fm_RightInfoText.SetBelong(this.GetValue());
				}
				return r_Fm_RightInfoText;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_TypeIcon
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_TypeIcon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_TypeIcon
		{
			get
			{
				if(r_Fm_TypeIcon == null)
				{
					r_Fm_TypeIcon = new(this, "m_TypeIcon");
					r_Fm_TypeIcon.SetBelong(this.GetValue());
				}
				return r_Fm_TypeIcon;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.Label m_RightInfoLabel
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_RightInfoLabel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_RightInfoLabel
		{
			get
			{
				if(r_Fm_RightInfoLabel == null)
				{
					r_Fm_RightInfoLabel = new(this, "m_RightInfoLabel");
					r_Fm_RightInfoLabel.SetBelong(this.GetValue());
				}
				return r_Fm_RightInfoLabel;
			}
		}
        ...
        public RMultiSelectItem() : base("UnityEditor.PackageManager.UI.Internal.MultiSelectItem")
        {
        }

        public RMultiSelectItem(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.MultiSelectItem")
		{
            SetInstance(instance);
		}

        public RMultiSelectItem(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMultiSelectItem(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
