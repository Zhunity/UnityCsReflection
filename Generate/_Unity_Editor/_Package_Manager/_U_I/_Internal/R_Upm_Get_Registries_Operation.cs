...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.UpmGetRegistriesOperation
	/// </summary>
    public partial class RUpmGetRegistriesOperation : RMember //
    {
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.GetRegistriesRequest m_Request
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RGetRegistriesRequest r_Fm_Request;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RGetRegistriesRequest RFm_Request
		{
			get
			{
		...
		public virtual RMethod RMGetRegistries
		{
			get
			{
				if(r_MGetRegistries == null)
				{
					...
					r_MGetRegistries.SetBelong(this.instance);
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.GetRegistriesRequest CreateRequest()
		/// </summary>
        ...
        public RUpmGetRegistriesOperation() : base("UnityEditor.PackageManager.UI.Internal.UpmGetRegistriesOperation")
        {
        }

        public RUpmGetRegistriesOperation(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.UpmGetRegistriesOperation")
		{
            SetInstance(instance);
		}

        public RUpmGetRegistriesOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUpmGetRegistriesOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void GetRegistries()
        {
        ...
        public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RGetRegistriesRequest CreateRequest()
        {
