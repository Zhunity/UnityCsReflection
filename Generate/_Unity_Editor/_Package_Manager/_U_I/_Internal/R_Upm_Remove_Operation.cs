...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.UpmRemoveOperation
	/// </summary>
    public partial class RUpmRemoveOperation : RMember //
    {
		...
		/// <summary>
		/// System.Action`1[UnityEditor.PackageManager.Requests.RemoveRequest] onProcessResult
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.RemoveRequest m_Request
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RRemoveRequest r_Fm_Request;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RRemoveRequest RFm_Request
		{
			get
			{
		...
		/// </summary>
		protected RMethod r_MRemove_String_String;
		public virtual RMethod RMRemove_String_String
		{
			get
			{
				if(r_MRemove_String_String == null)
				{
					r_MRemove_String_String = new(this, "Remove", 0, typeof(System.String), typeof(System.String));
					r_MRemove_String_String.SetBelong(this.instance);
				}
				return r_MRemove_String_String;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.Requests.RemoveRequest CreateRequest()
		/// </summary>
        ...
        public RUpmRemoveOperation() : base("UnityEditor.PackageManager.UI.Internal.UpmRemoveOperation")
        {
        }

        public RUpmRemoveOperation(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.UpmRemoveOperation")
		{
            SetInstance(instance);
		}

        public RUpmRemoveOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUpmRemoveOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Remove(System.String @packageName, System.String @packageUniqueId)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@packageName, @packageUniqueId};
            var ___result = RMRemove_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual UnityEditor.PackageManager.Requests.RemoveRequest CreateRequest()
        {
