    ...
    public partial class RRefreshOptions : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "None");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFUpmListOffline
		{
			get
			{
				...
				{
					r_FUpmListOffline = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "UpmListOffline");
					r_FUpmListOffline.SetBelong(null);
				}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFUpmList
		{
			get
			{
				if(r_FUpmList == null)
				{
					r_FUpmList = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "UpmList");
					r_FUpmList.SetBelong(null);
				}
				return r_FUpmList;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFUpmSearchOffline
		{
			get
			{
				...
				{
					r_FUpmSearchOffline = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "UpmSearchOffline");
					r_FUpmSearchOffline.SetBelong(null);
				}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFUpmSearch
		{
			get
			{
				...
				{
					r_FUpmSearch = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "UpmSearch");
					r_FUpmSearch.SetBelong(null);
				}
				return r_FUpmSearch;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFPurchased
		{
			get
			{
				...
				{
					r_FPurchased = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "Purchased");
					r_FPurchased.SetBelong(null);
				}
				return r_FPurchased;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFPurchasedOffline
		{
			get
			{
				...
				{
					r_FPurchasedOffline = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "PurchasedOffline");
					r_FPurchasedOffline.SetBelong(null);
				}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRefreshOptions RFUpmAny
		{
			get
			{
				if(r_FUpmAny == null)
				{
					r_FUpmAny = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.RefreshOptions"), "UpmAny");
					r_FUpmAny.SetBelong(null);
				}
				return r_FUpmAny;
			}
		}
