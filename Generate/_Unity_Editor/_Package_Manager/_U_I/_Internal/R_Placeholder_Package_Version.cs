...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PlaceholderPackageVersion
	/// </summary>
    public partial class RPlaceholderPackageVersion : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_UniqueId
		{
			get
			{
				if(r_Fm_UniqueId == null)
				{
					...
					r_Fm_UniqueId.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.UIError[] m_Errors
		/// </summary>
		protected Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUIError> r_Fm_Errors;
		public virtual Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUIError> RFm_Errors
		{
			get
			{
				if(r_Fm_Errors == null)
