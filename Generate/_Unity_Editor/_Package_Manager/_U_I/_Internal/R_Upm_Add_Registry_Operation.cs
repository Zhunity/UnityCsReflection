...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.UpmAddRegistryOperation
	/// </summary>
    public partial class RUpmAddRegistryOperation : RMember //
    {
		...
		/// <summary>
		/// System.Action`1[UnityEditor.PackageManager.Requests.AddScopedRegistryRequest] onProcessResult
		/// </summary>
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RString r_Fm_RegistryUrl;
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RFm_RegistryUrl
		{
			get
			{
				if(r_Fm_RegistryUrl == null)
				{
					...
					r_Fm_RegistryUrl.SetBelong(this.instance);
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.AddScopedRegistryRequest m_Request
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RAddScopedRegistryRequest r_Fm_Request;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RAddScopedRegistryRequest RFm_Request
		{
			get
			{
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RString r_PregistryName;
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RPregistryName
		{
			get
			{
				if(r_PregistryName == null)
				{
					...
					r_PregistryName.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RString r_PregistryUrl;
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RPregistryUrl
		{
			get
			{
				if(r_PregistryUrl == null)
				{
					...
					r_PregistryUrl.SetBelong(this.instance);
				}
		...
		/// <summary>
		/// Void Add(System.String, System.String, System.String[])
		/// </summary>
		protected RMethod r_MAdd_String_String_StringArray;
		public virtual RMethod RMAdd_String_String_StringArray
		{
			get
			{
				if(r_MAdd_String_String_StringArray == null)
				{
					r_MAdd_String_String_StringArray = new(this, "Add", 0, typeof(System.String), typeof(System.String), typeof(System.String).MakeArrayType());
					r_MAdd_String_String_StringArray.SetBelong(this.instance);
				}
				return r_MAdd_String_String_StringArray;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.Requests.AddScopedRegistryRequest CreateRequest()
		/// </summary>
        ...
        public RUpmAddRegistryOperation() : base("UnityEditor.PackageManager.UI.Internal.UpmAddRegistryOperation")
        {
        }

        public RUpmAddRegistryOperation(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.UpmAddRegistryOperation")
		{
            SetInstance(instance);
		}

        public RUpmAddRegistryOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUpmAddRegistryOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Add(System.String @name, System.String @url, System.String[] @scopes)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@name, @url, @scopes};
            var ___result = RMAdd_String_String_StringArray.Invoke(___genericsType, ___parameters);

            
        }


        public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RAddScopedRegistryRequest CreateRequest()
        {
