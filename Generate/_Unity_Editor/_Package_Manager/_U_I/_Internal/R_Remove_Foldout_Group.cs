...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.RemoveFoldoutGroup
	/// </summary>
    public partial class RRemoveFoldoutGroup : RMember //
    {
        ...
        public RRemoveFoldoutGroup() : base("UnityEditor.PackageManager.UI.Internal.RemoveFoldoutGroup")
        {
        }

        public RRemoveFoldoutGroup(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.RemoveFoldoutGroup")
		{
            SetInstance(instance);
		}

        public RRemoveFoldoutGroup(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRemoveFoldoutGroup(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
