		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RFm_Modified
		{
			get
			{
				if(r_Fm_Modified == null)
				{
					...
					r_Fm_Modified.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RFm_UserModificationsInstanceId
		{
			get
			{
				if(r_Fm_UserModificationsInstanceId == null)
				{
					...
					r_Fm_UserModificationsInstanceId.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRegistryInfoDraftData RFm_UserModifications
		{
			get
			{
				if(r_Fm_UserModifications == null)
				{
					...
					r_Fm_UserModifications.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RFm_OriginalInstanceId
		{
			get
			{
				if(r_Fm_OriginalInstanceId == null)
				{
					...
					r_Fm_OriginalInstanceId.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRegistryInfoOriginalData RFm_Original
		{
			get
			{
				if(r_Fm_Original == null)
				{
					...
					r_Fm_Original.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RRegistryInfoOriginalData RPoriginal
		{
			get
			{
				if(r_Poriginal == null)
				{
					...
					r_Poriginal.SetBelong(this.instance);
				}
				return r_Poriginal;
			}
		}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RPisUrlOrScopesUpdated
		{
			get
			{
				if(r_PisUrlOrScopesUpdated == null)
				{
					...
					r_PisUrlOrScopesUpdated.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMIsReady
		{
			get
			{
				if(r_MIsReady == null)
				{
					...
					r_MIsReady.SetBelong(this.instance);
				}
				return r_MIsReady;
			}
		}
		...
		public virtual RMethod RMSetModifiedAfterUndo
		{
			get
			{
				if(r_MSetModifiedAfterUndo == null)
				{
					...
					r_MSetModifiedAfterUndo.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMRegisterWithOriginalOnUndo_String
		{
			get
			{
				if(r_MRegisterWithOriginalOnUndo_String == null)
				{
					...
					r_MRegisterWithOriginalOnUndo_String.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMRegisterOnUndo_String
		{
			get
			{
				if(r_MRegisterOnUndo_String == null)
				{
					...
					r_MRegisterOnUndo_String.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSetOriginalRegistryInfo_RegistryInfo_Boolean
		{
			get
			{
				if(r_MSetOriginalRegistryInfo_RegistryInfo_Boolean == null)
				{
					...
					r_MSetOriginalRegistryInfo_RegistryInfo_Boolean.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMRevertChanges
		{
			get
			{
				if(r_MRevertChanges == null)
				{
					...
					r_MRevertChanges.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMAddErrorMessage_String
		{
			get
			{
				if(r_MAddErrorMessage_String == null)
				{
					...
					r_MAddErrorMessage_String.SetBelong(this.instance);
				}
