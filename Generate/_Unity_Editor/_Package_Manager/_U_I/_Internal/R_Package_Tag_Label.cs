    ...
    public partial class RPackageTagLabel : RMember //
    {
		...
		public static RMethod RMCreateTagLabel_IPackageVersion_Boolean
		{
			get
			{
				...
				{
					r_MCreateTagLabel_IPackageVersion_Boolean = new(Type, "CreateTagLabel", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"), typeof(System.Boolean));
				}
