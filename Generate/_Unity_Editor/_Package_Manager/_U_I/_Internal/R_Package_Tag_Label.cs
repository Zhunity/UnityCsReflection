...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RPackageTagLabel : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag RFm_Tag
		{
			get
			{
				if(r_Fm_Tag == null)
				{
					...
					r_Fm_Tag.SetBelong(this.GetValue());
				}
				return r_Fm_Tag;
			}
		}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageTag tag
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag r_Ptag;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag RPtag
		{
			get
			{
				if(r_Ptag == null)
		...
		/// <summary>
		/// Void Refresh(UnityEditor.PackageManager.UI.Internal.IPackageVersion, Boolean)
		/// </summary>
		protected RMethod r_MRefresh_IPackageVersion_Boolean;
		public virtual RMethod RMRefresh_IPackageVersion_Boolean
		{
			get
			{
				if(r_MRefresh_IPackageVersion_Boolean == null)
				{
					r_MRefresh_IPackageVersion_Boolean = new(this, "Refresh", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"), typeof(System.Boolean));
					r_MRefresh_IPackageVersion_Boolean.SetBelong(this.GetValue());
				}
				return r_MRefresh_IPackageVersion_Boolean;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageTagLabel CreateTagLabel(UnityEditor.PackageManager.UI.Internal.IPackageVersion, Boolean)
		/// </summary>
		protected static RMethod r_MCreateTagLabel_IPackageVersion_Boolean;
		public static RMethod RMCreateTagLabel_IPackageVersion_Boolean
		{
			get
			{
				if(r_MCreateTagLabel_IPackageVersion_Boolean == null)
				{
					r_MCreateTagLabel_IPackageVersion_Boolean = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageTagLabel"), "CreateTagLabel", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"), typeof(System.Boolean));
					r_MCreateTagLabel_IPackageVersion_Boolean.SetBelong(null);
				}
				return r_MCreateTagLabel_IPackageVersion_Boolean;
			}
		}
        ...
        public virtual void Refresh(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version, System.Boolean @isVersionItem)
        {
            ...
            var ___parameters = new object[]{@version.Value, @isVersionItem};
            var ___result = RMRefresh_IPackageVersion_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTagLabel CreateTagLabel(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version, System.Boolean @isVersionItem)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@version.Value, @isVersionItem};
            var ___result = RMCreateTagLabel_IPackageVersion_Boolean.Invoke(___genericsType, ___parameters);
