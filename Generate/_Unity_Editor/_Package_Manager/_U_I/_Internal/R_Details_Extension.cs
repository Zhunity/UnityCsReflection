...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.DetailsExtension
	/// </summary>
    public partial class RDetailsExtension : RMember //
    {
		...
		public virtual REvent REonPriorityChanged
		{
			get
			{
				if(r_EonPriorityChanged == null)
				{
					...
					r_EonPriorityChanged.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.Toggle m_HeaderToggle
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle r_Fm_HeaderToggle;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle RFm_HeaderToggle
		{
			get
			{
				if(r_Fm_HeaderToggle == null)
				{
					r_Fm_HeaderToggle = new(this, "m_HeaderToggle");
					r_Fm_HeaderToggle.SetBelong(this.GetValue());
				}
				return r_Fm_HeaderToggle;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt32 RFm_Priority
		{
			get
			{
				if(r_Fm_Priority == null)
				{
					...
					r_Fm_Priority.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RAction RFonPriorityChanged
		{
			get
			{
				if(r_FonPriorityChanged == null)
				{
					...
					r_FonPriorityChanged.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void UnityEditor.PackageManager.UI.IDetailsExtension.Add(UnityEngine.UIElements.VisualElement)
		/// </summary>
		protected RMethod r_MUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement;
		public virtual RMethod RMUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement
		{
			get
			{
				if(r_MUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement == null)
				{
					r_MUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement = new(this, "UnityEditor.PackageManager.UI.IDetailsExtension.Add", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_MUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement.SetBelong(this.GetValue());
				}
				return r_MUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement;
			}
		}

		/// <summary>
		/// Void <.ctor>b__24_0(UnityEngine.UIElements.ChangeEvent`1[System.Boolean])
		/// </summary>
		protected RMethod r_M__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_;
		public virtual RMethod RM__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_
		{
			get
			{
				if(r_M__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_ == null)
				{
					r_M__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_ = new(this, "<.ctor>b__24_0", 0, typeof(UnityEngine.UIElements.ChangeEvent<>).MakeGenericType(typeof(System.Boolean)));
					r_M__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_.SetBelong(this.GetValue());
				}
				return r_M__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_;
			}
		}
		...
		/// Boolean get_visible()
		/// </summary>
		protected RMethod r_Mget_visible;
		public virtual RMethod RMget_visible
		{
			get
			{
				if(r_Mget_visible == null)
				{
					r_Mget_visible = new(this, "get_visible", 0);
					r_Mget_visible.SetBelong(this.GetValue());
				}
				return r_Mget_visible;
			}
		}
		...
		/// </summary>
		protected RMethod r_Mset_visible_Boolean;
		public virtual RMethod RMset_visible_Boolean
		{
			get
			{
				if(r_Mset_visible_Boolean == null)
				{
					r_Mset_visible_Boolean = new(this, "set_visible", 0, typeof(System.Boolean));
					r_Mset_visible_Boolean.SetBelong(this.GetValue());
				}
				return r_Mset_visible_Boolean;
			}
		}
        ...
        public virtual void UnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add(UnityEngine.UIElements.VisualElement @element)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@element};
            var ___result = RMUnityEditor__2__PackageManager__2__UI__2__IDetailsExtension__2__Add_VisualElement.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0____2__ctor__1__b__24_0(UnityEngine.UIElements.ChangeEvent<System.Boolean> @evt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evt};
            var ___result = RM__0____2__ctor__1__b__24_0_ChangeEvent_d_Boolean_p_.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean get_visible()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMget_visible.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void set_visible(System.Boolean @value)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RMset_visible_Boolean.Invoke(___genericsType, ___parameters);
