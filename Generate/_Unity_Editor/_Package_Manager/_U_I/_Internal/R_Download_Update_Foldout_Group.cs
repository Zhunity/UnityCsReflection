...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.DownloadUpdateFoldoutGroup
	/// </summary>
    public partial class RDownloadUpdateFoldoutGroup : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMultiSelectFoldout RPmainFoldout
		{
			get
			{
				if(r_PmainFoldout == null)
				{
					...
					r_PmainFoldout.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMultiSelectFoldout RPinProgressFoldout
		{
			get
			{
				if(r_PinProgressFoldout == null)
				{
					...
					r_PinProgressFoldout.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton RPmainButton
		{
			get
			{
				if(r_PmainButton == null)
				{
					...
					r_PmainButton.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton RPcancelButton
		{
			get
			{
				if(r_PcancelButton == null)
				{
					...
					r_PcancelButton.SetBelong(this.GetValue());
				}
        ...
        public RDownloadUpdateFoldoutGroup() : base("UnityEditor.PackageManager.UI.Internal.DownloadUpdateFoldoutGroup")
        {
        }

        public RDownloadUpdateFoldoutGroup(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.DownloadUpdateFoldoutGroup")
		{
            SetInstance(instance);
		}

        public RDownloadUpdateFoldoutGroup(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDownloadUpdateFoldoutGroup(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
