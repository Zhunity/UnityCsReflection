...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RUnityOAuthProxy : RMember //
    {
		...
		public virtual RMethod RMGetAuthorizationCodeAsync_String_Action_d_AuthCodeResponse_p_
		{
			get
			{
				if(r_MGetAuthorizationCodeAsync_String_Action_d_AuthCodeResponse_p_ == null)
				{
					...
					r_MGetAuthorizationCodeAsync_String_Action_d_AuthCodeResponse_p_.SetBelong(this.instance);
				}
        ...
        public virtual void GetAuthorizationCodeAsync(System.String @clientId, SMFrame.Editor.Refleaction.RSystem.RAction<SMFrame.Editor.Refleaction.RUnityEditor.RConnect.RUnityOAuth.RAuthCodeResponse> @callback)
        {
