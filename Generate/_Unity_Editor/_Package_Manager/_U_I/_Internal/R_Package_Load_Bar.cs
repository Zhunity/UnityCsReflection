...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RPackageLoadBar : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageLoadBar");
            }
        }
		...
		public virtual RMethod RMUpdateVisibility_Nullable_d_PackageFilterTab_p_
		{
			get
			{
				...
				{
					r_MUpdateVisibility_Nullable_d_PackageFilterTab_p_ = new(this, "UpdateVisibility", 0,  ReflectionUtils.GetType("System.Nullable`1").MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageFilterTab")));
				}
