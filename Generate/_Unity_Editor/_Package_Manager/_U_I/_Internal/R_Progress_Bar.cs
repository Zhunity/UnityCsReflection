...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.ProgressBar
	/// </summary>
    public partial class RProgressBar : RMember //
    {
		...
		/// <summary>
		/// System.Double s_LastWidthTime
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RDouble r_Fs_LastWidthTime;
		public static Hvak.Editor.Refleaction.RSystem.RDouble RFs_LastWidthTime
		{
			get
			{
				if(r_Fs_LastWidthTime == null)
				{
					r_Fs_LastWidthTime = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ProgressBar"), "s_LastWidthTime");
					r_Fs_LastWidthTime.SetBelong(null);
				}
				return r_Fs_LastWidthTime;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RSystem.RDouble RFk_PaintInterval
		{
			get
			{
				...
				{
					r_Fk_PaintInterval = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ProgressBar"), "k_PaintInterval");
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement currentProgressBar
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PcurrentProgressBar;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPcurrentProgressBar
		{
			get
			{
				if(r_PcurrentProgressBar == null)
				{
					r_PcurrentProgressBar = new(this, "currentProgressBar", -1);
					r_PcurrentProgressBar.SetBelong(this.GetValue());
				}
				return r_PcurrentProgressBar;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label currentProgressState
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_PcurrentProgressState;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RPcurrentProgressState
		{
			get
			{
				if(r_PcurrentProgressState == null)
				{
					r_PcurrentProgressState = new(this, "currentProgressState", -1);
					r_PcurrentProgressState.SetBelong(this.GetValue());
				}
				return r_PcurrentProgressState;
			}
		}
		...
		/// <summary>
		/// Boolean UpdateProgress(UnityEditor.PackageManager.UI.Internal.IOperation)
		/// </summary>
		protected RMethod r_MUpdateProgress_IOperation;
		public virtual RMethod RMUpdateProgress_IOperation
		{
			get
			{
				if(r_MUpdateProgress_IOperation == null)
				{
					r_MUpdateProgress_IOperation = new(this, "UpdateProgress", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IOperation"));
					r_MUpdateProgress_IOperation.SetBelong(this.GetValue());
				}
				return r_MUpdateProgress_IOperation;
			}
		}
        ...
        public RProgressBar() : base("UnityEditor.PackageManager.UI.Internal.ProgressBar")
        {
        }

        public RProgressBar(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.ProgressBar")
		{
            SetInstance(instance);
		}

        public RProgressBar(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RProgressBar(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Boolean UpdateProgress(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIOperation @operation)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@operation.Value};
            var ___result = RMUpdateProgress_IOperation.Invoke(___genericsType, ___parameters);
