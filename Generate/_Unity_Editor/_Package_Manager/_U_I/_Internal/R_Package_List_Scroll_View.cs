...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageListScrollView
	/// </summary>
    public partial class RPackageListScrollView : RMember //
    {

		/// <summary>
		/// System.String k_UnityPackageGroupDisplayName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_Fk_UnityPackageGroupDisplayName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_UnityPackageGroupDisplayName
		{
			get
			{
				if(r_Fk_UnityPackageGroupDisplayName == null)
				{
					r_Fk_UnityPackageGroupDisplayName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageListScrollView"), "k_UnityPackageGroupDisplayName");
					r_Fk_UnityPackageGroupDisplayName.SetBelong(null);
				}
				return r_Fk_UnityPackageGroupDisplayName;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RDictionary<Hvak.Editor.Refleaction.RSystem.RString, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem> RFm_PackageItemsLookup
		{
			get
			{
				if(r_Fm_PackageItemsLookup == null)
				{
					...
					r_Fm_PackageItemsLookup.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_ItemsList
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_ItemsList;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_ItemsList
		{
			get
			{
				if(r_Fm_ItemsList == null)
				{
					r_Fm_ItemsList = new(this, "m_ItemsList");
					r_Fm_ItemsList.SetBelong(this.GetValue());
				}
				return r_Fm_ItemsList;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_ScrollToTarget
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_ScrollToTarget;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_ScrollToTarget
		{
			get
			{
				if(r_Fm_ScrollToTarget == null)
				{
					r_Fm_ScrollToTarget = new(this, "m_ScrollToTarget");
					r_Fm_ScrollToTarget.SetBelong(this.GetValue());
				}
				return r_Fm_ScrollToTarget;
			}
		}
		...
		/// <summary>
		/// System.Collections.Generic.IEnumerable`1[UnityEditor.PackageManager.UI.Internal.PackageItem] packageItems
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem> r_PpackageItems;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem> RPpackageItems
		{
			get
			{
				if(r_PpackageItems == null)
				{
					r_PpackageItems = new(this, "packageItems", -1);
					r_PpackageItems.SetBelong(this.GetValue());
				}
				return r_PpackageItems;
			}
		}

		/// <summary>
		/// System.Collections.Generic.IEnumerable`1[UnityEditor.PackageManager.UI.Internal.PackageGroup] packageGroups
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup> r_PpackageGroups;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup> RPpackageGroups
		{
			get
			{
				if(r_PpackageGroups == null)
				{
					r_PpackageGroups = new(this, "packageGroups", -1);
					r_PpackageGroups.SetBelong(this.GetValue());
				}
				return r_PpackageGroups;
			}
		}
		...
		public virtual RMethod RMGetFirstSelectedItem
		{
			get
			{
				if(r_MGetFirstSelectedItem == null)
				{
					...
					r_MGetFirstSelectedItem.SetBelong(this.GetValue());
				}
		...
		/// Void ScrollIfNeeded()
		/// </summary>
		protected RMethod r_MScrollIfNeeded;
		public virtual RMethod RMScrollIfNeeded
		{
			get
			{
				if(r_MScrollIfNeeded == null)
				{
					r_MScrollIfNeeded = new(this, "ScrollIfNeeded", 0);
					r_MScrollIfNeeded.SetBelong(this.GetValue());
				}
				return r_MScrollIfNeeded;
			}
		}

		/// <summary>
		/// Void ScrollIfNeeded(UnityEngine.UIElements.VisualElement)
		/// </summary>
		protected RMethod r_MScrollIfNeeded_VisualElement;
		public virtual RMethod RMScrollIfNeeded_VisualElement
		{
			get
			{
				if(r_MScrollIfNeeded_VisualElement == null)
				{
					r_MScrollIfNeeded_VisualElement = new(this, "ScrollIfNeeded", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_MScrollIfNeeded_VisualElement.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void AddOrUpdatePackageItem(UnityEditor.PackageManager.UI.Internal.VisualState, UnityEditor.PackageManager.UI.Internal.IPackage)
		/// </summary>
		protected RMethod r_MAddOrUpdatePackageItem_VisualState_IPackage;
		public virtual RMethod RMAddOrUpdatePackageItem_VisualState_IPackage
		{
			get
			{
				if(r_MAddOrUpdatePackageItem_VisualState_IPackage == null)
				{
					r_MAddOrUpdatePackageItem_VisualState_IPackage = new(this, "AddOrUpdatePackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackage"));
					r_MAddOrUpdatePackageItem_VisualState_IPackage.SetBelong(this.GetValue());
				}
				return r_MAddOrUpdatePackageItem_VisualState_IPackage;
			}
		}

		/// <summary>
		/// System.String GetGroupDisplayName(System.String)
		/// </summary>
		protected static RMethod r_MGetGroupDisplayName_String;
		public static RMethod RMGetGroupDisplayName_String
		{
			get
			{
				if(r_MGetGroupDisplayName_String == null)
				{
					r_MGetGroupDisplayName_String = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageListScrollView"), "GetGroupDisplayName", 0, typeof(System.String));
					r_MGetGroupDisplayName_String.SetBelong(null);
				}
				return r_MGetGroupDisplayName_String;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageGroup GetOrCreateGroup(System.String)
		/// </summary>
		protected RMethod r_MGetOrCreateGroup_String;
		public virtual RMethod RMGetOrCreateGroup_String
		{
			get
			{
				if(r_MGetOrCreateGroup_String == null)
				{
					r_MGetOrCreateGroup_String = new(this, "GetOrCreateGroup", 0, typeof(System.String));
					r_MGetOrCreateGroup_String.SetBelong(this.GetValue());
				}
				return r_MGetOrCreateGroup_String;
			}
		}

		/// <summary>
		/// Void RemovePackageItem(System.String)
		/// </summary>
		protected RMethod r_MRemovePackageItem_String;
		public virtual RMethod RMRemovePackageItem_String
		{
			get
			{
				if(r_MRemovePackageItem_String == null)
				{
					r_MRemovePackageItem_String = new(this, "RemovePackageItem", 0, typeof(System.String));
					r_MRemovePackageItem_String.SetBelong(this.GetValue());
				}
				return r_MRemovePackageItem_String;
			}
		}
		...
		/// Void ReorderGroups()
		/// </summary>
		protected RMethod r_MReorderGroups;
		public virtual RMethod RMReorderGroups
		{
			get
			{
				if(r_MReorderGroups == null)
				{
					r_MReorderGroups = new(this, "ReorderGroups", 0);
					r_MReorderGroups.SetBelong(this.GetValue());
				}
				return r_MReorderGroups;
			}
		}
		...
		public virtual RMethod RMGetPackageItemFromMouseEvent_MouseDownEvent
		{
			get
			{
				if(r_MGetPackageItemFromMouseEvent_MouseDownEvent == null)
				{
					...
					r_MGetPackageItemFromMouseEvent_MouseDownEvent.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSelectAllBetween_String_String
		{
			get
			{
				if(r_MSelectAllBetween_String_String == null)
				{
					...
					r_MSelectAllBetween_String_String.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSelectAllVisible
		{
			get
			{
				if(r_MSelectAllVisible == null)
				{
					...
					r_MSelectAllVisible.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMOnMouseDown_MouseDownEvent
		{
			get
			{
				if(r_MOnMouseDown_MouseDownEvent == null)
				{
					...
					r_MOnMouseDown_MouseDownEvent.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMHandleShiftSelection_NavigationMoveEvent
		{
			get
			{
				if(r_MHandleShiftSelection_NavigationMoveEvent == null)
				{
					...
					r_MHandleShiftSelection_NavigationMoveEvent.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSelectNext_Boolean
		{
			get
			{
				if(r_MSelectNext_Boolean == null)
				{
					...
					r_MSelectNext_Boolean.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.ISelectableItem FindNextVisibleSelectableItem(Boolean)
		/// </summary>
		protected RMethod r_MFindNextVisibleSelectableItem_Boolean;
		public virtual RMethod RMFindNextVisibleSelectableItem_Boolean
		{
			get
			{
				if(r_MFindNextVisibleSelectableItem_Boolean == null)
				{
					r_MFindNextVisibleSelectableItem_Boolean = new(this, "FindNextVisibleSelectableItem", 0, typeof(System.Boolean));
					r_MFindNextVisibleSelectableItem_Boolean.SetBelong(this.GetValue());
				}
				return r_MFindNextVisibleSelectableItem_Boolean;
			}
		}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageItem FindNextVisiblePackageItem(UnityEditor.PackageManager.UI.Internal.PackageItem, Boolean)
		/// </summary>
		protected static RMethod r_MFindNextVisiblePackageItem_PackageItem_Boolean;
		public static RMethod RMFindNextVisiblePackageItem_PackageItem_Boolean
		{
			get
			{
				if(r_MFindNextVisiblePackageItem_PackageItem_Boolean == null)
				{
					r_MFindNextVisiblePackageItem_PackageItem_Boolean = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageListScrollView"), "FindNextVisiblePackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), typeof(System.Boolean));
					r_MFindNextVisiblePackageItem_PackageItem_Boolean.SetBelong(null);
				}
				return r_MFindNextVisiblePackageItem_PackageItem_Boolean;
			}
		}
        ...
        public RPackageListScrollView() : base("UnityEditor.PackageManager.UI.Internal.PackageListScrollView")
        {
        }

        public RPackageListScrollView(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageListScrollView")
		{
            SetInstance(instance);
		}

        public RPackageListScrollView(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageListScrollView(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RISelectableItem GetFirstSelectedItem()
        {
            ...
            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RISelectableItem(___result);
        }
        ...
        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup GetOrCreateGroup(System.String @groupName)
        {
            ...
            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup(___result);
        }
