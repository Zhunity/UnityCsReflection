    ...
    public partial class RPackageListScrollView : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_UnityPackageGroupDisplayName
		{
			get
			{
				...
				{
					r_Fk_UnityPackageGroupDisplayName = new(Type, "k_UnityPackageGroupDisplayName");
				}
		...
		public static RMethod RMGetGroupDisplayName_String
		{
			get
			{
				...
				{
					r_MGetGroupDisplayName_String = new(Type, "GetGroupDisplayName", 0, typeof(System.String));
				}
		...
		public static RMethod RMFindNextVisiblePackageItem_PackageItem_Boolean
		{
			get
			{
				...
				{
					r_MFindNextVisiblePackageItem_PackageItem_Boolean = new(Type, "FindNextVisiblePackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), typeof(System.Boolean));
				}
