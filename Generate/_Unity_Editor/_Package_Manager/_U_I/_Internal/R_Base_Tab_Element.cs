...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.BaseTabElement
	/// </summary>
    public partial class RBaseTabElement : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_DisplayName
		{
			get
			{
				if(r_Fm_DisplayName == null)
				{
					...
					r_Fm_DisplayName.SetBelong(this.GetValue());
				}
        ...
        public RBaseTabElement() : base("UnityEditor.PackageManager.UI.Internal.BaseTabElement")
        {
        }

        public RBaseTabElement(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.BaseTabElement")
		{
            SetInstance(instance);
		}

        public RBaseTabElement(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBaseTabElement(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
