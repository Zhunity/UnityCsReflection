...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageCancelDownloadButton
	/// </summary>
    public partial class RPackageCancelDownloadButton : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RBoolean r_Fm_IsIconButton;
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RFm_IsIconButton
		{
			get
			{
				if(r_Fm_IsIconButton == null)
				{
					...
					r_Fm_IsIconButton.SetBelong(this.instance);
				}
        ...
        public RPackageCancelDownloadButton() : base("UnityEditor.PackageManager.UI.Internal.PackageCancelDownloadButton")
        {
        }

        public RPackageCancelDownloadButton(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageCancelDownloadButton")
		{
            SetInstance(instance);
		}

        public RPackageCancelDownloadButton(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageCancelDownloadButton(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
