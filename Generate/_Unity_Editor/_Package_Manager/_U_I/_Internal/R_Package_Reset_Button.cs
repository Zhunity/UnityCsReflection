...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageResetButton
	/// </summary>
    public partial class RPackageResetButton : RMember //
    {
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.DropdownButton m_Element
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RDropdownButton r_Fm_Element;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RDropdownButton RFm_Element
		{
			get
			{
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.DropdownButton element
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RDropdownButton r_Pelement;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RDropdownButton RPelement
		{
			get
			{
				if(r_Pelement == null)
        ...
        public RPackageResetButton() : base("UnityEditor.PackageManager.UI.Internal.PackageResetButton")
        {
        }

        public RPackageResetButton(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageResetButton")
		{
            SetInstance(instance);
		}

        public RPackageResetButton(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageResetButton(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
