...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageGroup
	/// </summary>
    public partial class RPackageGroup : RMember //
    {
		...
		/// </summary>
		protected REvent r_EonGroupToggle;
		public virtual REvent REonGroupToggle
		{
			get
			{
				if(r_EonGroupToggle == null)
				{
					r_EonGroupToggle = new(this, "onGroupToggle");
					r_EonGroupToggle.SetBelong(this.GetValue());
				}
				return r_EonGroupToggle;
			}
		}
		...
		/// System.Action`1[System.Boolean] onGroupToggle
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RAction<Hvak.Editor.Refleaction.RSystem.RBoolean> r_FonGroupToggle;
		public virtual Hvak.Editor.Refleaction.RSystem.RAction<Hvak.Editor.Refleaction.RSystem.RBoolean> RFonGroupToggle
		{
			get
			{
				if(r_FonGroupToggle == null)
				{
					r_FonGroupToggle = new(this, "onGroupToggle");
					r_FonGroupToggle.SetBelong(this.GetValue());
				}
				return r_FonGroupToggle;
			}
		}

		/// <summary>
		/// System.Boolean <isHidden>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_F__0__isHidden__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RF__0__isHidden__1__k__BackingField
		{
			get
			{
				if(r_F__0__isHidden__1__k__BackingField == null)
				{
					r_F__0__isHidden__1__k__BackingField = new(this, "<isHidden>k__BackingField");
					r_F__0__isHidden__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__isHidden__1__k__BackingField;
			}
		}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.VisualElementCache m_Cache
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualElementCache r_Fm_Cache;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualElementCache RFm_Cache
		{
			get
			{
				if(r_Fm_Cache == null)
		...
		/// Boolean isHidden
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_PisHidden;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPisHidden
		{
			get
			{
				if(r_PisHidden == null)
				{
					r_PisHidden = new(this, "isHidden", -1);
					r_PisHidden.SetBelong(this.GetValue());
				}
				return r_PisHidden;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement groupContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PgroupContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPgroupContainer
		{
			get
			{
				if(r_PgroupContainer == null)
				{
					r_PgroupContainer = new(this, "groupContainer", -1);
					r_PgroupContainer.SetBelong(this.GetValue());
				}
				return r_PgroupContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement headerContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PheaderContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPheaderContainer
		{
			get
			{
				if(r_PheaderContainer == null)
				{
					r_PheaderContainer = new(this, "headerContainer", -1);
					r_PheaderContainer.SetBelong(this.GetValue());
				}
				return r_PheaderContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Toggle headerCaret
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle r_PheaderCaret;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle RPheaderCaret
		{
			get
			{
				if(r_PheaderCaret == null)
				{
					r_PheaderCaret = new(this, "headerCaret", -1);
					r_PheaderCaret.SetBelong(this.GetValue());
				}
				return r_PheaderCaret;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label headerTag
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_PheaderTag;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RPheaderTag
		{
			get
			{
				if(r_PheaderTag == null)
				{
					r_PheaderTag = new(this, "headerTag", -1);
					r_PheaderTag.SetBelong(this.GetValue());
				}
				return r_PheaderTag;
			}
		}
		...
		/// <summary>
		/// Boolean Contains(UnityEditor.PackageManager.UI.Internal.ISelectableItem)
		/// </summary>
		protected RMethod r_MContains_ISelectableItem;
		public virtual RMethod RMContains_ISelectableItem
		{
			get
			{
				if(r_MContains_ISelectableItem == null)
				{
					r_MContains_ISelectableItem = new(this, "Contains", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ISelectableItem"));
					r_MContains_ISelectableItem.SetBelong(this.GetValue());
				}
				return r_MContains_ISelectableItem;
			}
		}
		...
		/// </summary>
		protected RMethod r_MRefreshHeaderVisibility;
		public virtual RMethod RMRefreshHeaderVisibility
		{
			get
			{
				if(r_MRefreshHeaderVisibility == null)
				{
					r_MRefreshHeaderVisibility = new(this, "RefreshHeaderVisibility", 0);
					r_MRefreshHeaderVisibility.SetBelong(this.GetValue());
				}
				return r_MRefreshHeaderVisibility;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageItem AddPackageItem(UnityEditor.PackageManager.UI.Internal.IPackage, UnityEditor.PackageManager.UI.Internal.VisualState)
		/// </summary>
		protected RMethod r_MAddPackageItem_IPackage_VisualState;
		public virtual RMethod RMAddPackageItem_IPackage_VisualState
		{
			get
			{
				if(r_MAddPackageItem_IPackage_VisualState == null)
				{
					r_MAddPackageItem_IPackage_VisualState = new(this, "AddPackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackage"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"));
					r_MAddPackageItem_IPackage_VisualState.SetBelong(this.GetValue());
				}
				return r_MAddPackageItem_IPackage_VisualState;
			}
		}

		/// <summary>
		/// Void AddPackageItem(UnityEditor.PackageManager.UI.Internal.PackageItem)
		/// </summary>
		protected RMethod r_MAddPackageItem_PackageItem;
		public virtual RMethod RMAddPackageItem_PackageItem
		{
			get
			{
				if(r_MAddPackageItem_PackageItem == null)
				{
					r_MAddPackageItem_PackageItem = new(this, "AddPackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"));
					r_MAddPackageItem_PackageItem.SetBelong(this.GetValue());
				}
				return r_MAddPackageItem_PackageItem;
			}
		}

		/// <summary>
		/// Void ClearPackageItems()
		/// </summary>
		protected RMethod r_MClearPackageItems;
		public virtual RMethod RMClearPackageItems
		{
			get
			{
				if(r_MClearPackageItems == null)
				{
					r_MClearPackageItems = new(this, "ClearPackageItems", 0);
					r_MClearPackageItems.SetBelong(this.GetValue());
				}
				return r_MClearPackageItems;
			}
		}

		/// <summary>
		/// Void RemovePackageItem(UnityEditor.PackageManager.UI.Internal.PackageItem)
		/// </summary>
		protected RMethod r_MRemovePackageItem_PackageItem;
		public virtual RMethod RMRemovePackageItem_PackageItem
		{
			get
			{
				if(r_MRemovePackageItem_PackageItem == null)
				{
					r_MRemovePackageItem_PackageItem = new(this, "RemovePackageItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"));
					r_MRemovePackageItem_PackageItem.SetBelong(this.GetValue());
				}
				return r_MRemovePackageItem_PackageItem;
			}
		}
        ...
        public virtual System.Boolean Contains(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RISelectableItem @item)
        {
            ...
            var ___result = RMContains_ISelectableItem.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void RefreshHeaderVisibility()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshHeaderVisibility.Invoke(___genericsType, ___parameters);

            
        }


        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem AddPackageItem(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackage @package, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState @state)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@package.Value, @state.Value};
            var ___result = RMAddPackageItem_IPackage_VisualState.Invoke(___genericsType, ___parameters);

            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem(___result);
        }


        public virtual void AddPackageItem(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem @item)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@item.Value};
            var ___result = RMAddPackageItem_PackageItem.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void ClearPackageItems()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMClearPackageItems.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RemovePackageItem(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageItem @item)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@item.Value};
            var ___result = RMRemovePackageItem_PackageItem.Invoke(___genericsType, ___parameters);
