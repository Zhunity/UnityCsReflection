...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageDetailsTabElement
	/// </summary>
    public partial class RPackageDetailsTabElement : RMember //
    {
		...
		/// <summary>
		/// Boolean IsValid(UnityEditor.PackageManager.UI.Internal.IPackageVersion)
		/// </summary>
		protected RMethod r_MIsValid_IPackageVersion;
		public virtual RMethod RMIsValid_IPackageVersion
		{
			get
			{
				if(r_MIsValid_IPackageVersion == null)
				{
					r_MIsValid_IPackageVersion = new(this, "IsValid", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
					r_MIsValid_IPackageVersion.SetBelong(this.GetValue());
				}
				return r_MIsValid_IPackageVersion;
			}
		}
        ...
        public virtual System.Boolean IsValid(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version)
        {
            ...
            var ___result = RMIsValid_IPackageVersion.Invoke(___genericsType, ___parameters);
