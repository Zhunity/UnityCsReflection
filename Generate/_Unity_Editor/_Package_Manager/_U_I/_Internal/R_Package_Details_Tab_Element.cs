...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RPackageDetailsTabElement : RMember //
    {
		...
		public virtual RMethod RMIsValid_IPackageVersion
		{
			get
			{
				if(r_MIsValid_IPackageVersion == null)
				{
					...
					r_MIsValid_IPackageVersion.SetBelong(this.instance);
				}
        ...
        public virtual System.Boolean IsValid(SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version)
        {
