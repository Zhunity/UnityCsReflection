...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.UpmListOperation
	/// </summary>
    public partial class RUpmListOperation : RMember //
    {
		...
		/// <summary>
		/// System.Action`1[UnityEditor.PackageManager.Requests.ListRequest] onProcessResult
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.Requests.ListRequest m_Request
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RListRequest r_Fm_Request;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests.RListRequest RFm_Request
		{
			get
			{
		...
		/// Void List()
		/// </summary>
		protected RMethod r_MList;
		public virtual RMethod RMList
		{
			get
			{
				if(r_MList == null)
				{
					r_MList = new(this, "List", 0);
					r_MList.SetBelong(this.instance);
				}
				return r_MList;
			}
		}
		...
		/// <summary>
		/// Void ListOffline(Int64)
		/// </summary>
		protected RMethod r_MListOffline_Int64;
		public virtual RMethod RMListOffline_Int64
		{
			get
			{
				if(r_MListOffline_Int64 == null)
				{
					r_MListOffline_Int64 = new(this, "ListOffline", 0, typeof(System.Int64));
					r_MListOffline_Int64.SetBelong(this.instance);
				}
				return r_MListOffline_Int64;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.Requests.ListRequest CreateRequest()
		/// </summary>
        ...
        public RUpmListOperation() : base("UnityEditor.PackageManager.UI.Internal.UpmListOperation")
        {
        }

        public RUpmListOperation(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.UpmListOperation")
		{
            SetInstance(instance);
		}

        public RUpmListOperation(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUpmListOperation(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
