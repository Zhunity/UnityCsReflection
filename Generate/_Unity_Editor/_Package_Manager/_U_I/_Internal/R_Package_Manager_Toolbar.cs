    ...
    public partial class RPackageManagerToolbar : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_ResetPackagesMenuName
		{
			get
			{
				...
				{
					r_Fk_ResetPackagesMenuName = new(Type, "k_ResetPackagesMenuName");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_ResetPackagesMenuPath
		{
			get
			{
				...
				{
					r_Fk_ResetPackagesMenuPath = new(Type, "k_ResetPackagesMenuPath");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RInt64 RFk_SearchEventDelayTicks
		{
			get
			{
				...
				{
					r_Fk_SearchEventDelayTicks = new(Type, "k_SearchEventDelayTicks");
				}
		...
		public static RMethod RMGetFilterDisplayName_PackageFilterTab
		{
			get
			{
				...
				{
					r_MGetFilterDisplayName_PackageFilterTab = new(Type, "GetFilterDisplayName", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageFilterTab"));
				}
