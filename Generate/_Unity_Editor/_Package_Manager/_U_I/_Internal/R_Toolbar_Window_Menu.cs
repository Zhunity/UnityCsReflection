...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu
	/// </summary>
    public partial class RToolbarWindowMenu : RMember //
    {
		...
		/// <summary>
		/// System.String oldUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FoldUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFoldUssClassName
		{
			get
			{
				if(r_FoldUssClassName == null)
				{
					r_FoldUssClassName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu"), "oldUssClassName");
					r_FoldUssClassName.SetBelong(null);
				}
				return r_FoldUssClassName;
			}
		}

		/// <summary>
		/// System.String newUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FnewUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFnewUssClassName
		{
			get
			{
				if(r_FnewUssClassName == null)
				{
					r_FnewUssClassName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu"), "newUssClassName");
					r_FnewUssClassName.SetBelong(null);
				}
				return r_FnewUssClassName;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFtextUssClassName
		{
			get
			{
				...
				{
					r_FtextUssClassName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu"), "textUssClassName");
		...
		/// <summary>
		/// System.String arrowUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FarrowUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFarrowUssClassName
		{
			get
			{
				if(r_FarrowUssClassName == null)
				{
					r_FarrowUssClassName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu"), "arrowUssClassName");
					r_FarrowUssClassName.SetBelong(null);
				}
				return r_FarrowUssClassName;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_ArrowElement;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_ArrowElement
		{
			get
			{
				if(r_Fm_ArrowElement == null)
				{
					r_Fm_ArrowElement = new(this, "m_ArrowElement");
					r_Fm_ArrowElement.SetBelong(this.GetValue());
				}
				return r_Fm_ArrowElement;
			}
		}
        ...
        public RToolbarWindowMenu() : base("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu")
        {
        }

        public RToolbarWindowMenu(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.ToolbarWindowMenu")
		{
            SetInstance(instance);
		}

        public RToolbarWindowMenu(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RToolbarWindowMenu(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
