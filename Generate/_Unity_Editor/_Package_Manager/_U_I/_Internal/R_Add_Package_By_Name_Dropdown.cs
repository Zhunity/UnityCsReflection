    ...
    public partial class RAddPackageByNameDropdown : RMember //
    {
		...
		public virtual RMethod RMOnTextFieldChange_ChangeEvent_d_String_p_
		{
			get
			{
				...
				{
					r_MOnTextFieldChange_ChangeEvent_d_String_p_ = new(this, "OnTextFieldChange", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.ChangeEvent`1").MakeGenericType(typeof(System.String)));
				}
