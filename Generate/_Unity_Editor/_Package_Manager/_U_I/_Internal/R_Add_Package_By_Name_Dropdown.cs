...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.AddPackageByNameDropdown
	/// </summary>
    public partial class RAddPackageByNameDropdown : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RVector2 r_Fk_DefaultWindowSize;
		public static Hvak.Editor.Refleaction.RUnityEngine.RVector2 RFk_DefaultWindowSize
		{
			get
			{
				if(r_Fk_DefaultWindowSize == null)
				{
					r_Fk_DefaultWindowSize = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.AddPackageByNameDropdown"), "k_DefaultWindowSize");
					r_Fk_DefaultWindowSize.SetBelong(null);
				}
				return r_Fk_DefaultWindowSize;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 k_WindowSizeWithError
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RVector2 r_Fk_WindowSizeWithError;
		public static Hvak.Editor.Refleaction.RUnityEngine.RVector2 RFk_WindowSizeWithError
		{
			get
			{
				if(r_Fk_WindowSizeWithError == null)
				{
					r_Fk_WindowSizeWithError = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.AddPackageByNameDropdown"), "k_WindowSizeWithError");
					r_Fk_WindowSizeWithError.SetBelong(null);
				}
				return r_Fk_WindowSizeWithError;
			}
		}

		/// <summary>
		/// UnityEditor.EditorWindow m_AnchorWindow
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.REditorWindow r_Fm_AnchorWindow;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.REditorWindow RFm_AnchorWindow
		{
			get
			{
				if(r_Fm_AnchorWindow == null)
				{
					r_Fm_AnchorWindow = new(this, "m_AnchorWindow");
					r_Fm_AnchorWindow.SetBelong(this.GetValue());
				}
				return r_Fm_AnchorWindow;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.UpmSearchOperation m_ExtraFetchOperation
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUpmSearchOperation r_Fm_ExtraFetchOperation;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUpmSearchOperation RFm_ExtraFetchOperation
		{
			get
			{
				if(r_Fm_ExtraFetchOperation == null)
				{
					r_Fm_ExtraFetchOperation = new(this, "m_ExtraFetchOperation");
					r_Fm_ExtraFetchOperation.SetBelong(this.GetValue());
				}
				return r_Fm_ExtraFetchOperation;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.TextFieldPlaceholder m_PackageNamePlaceholder
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RTextFieldPlaceholder r_Fm_PackageNamePlaceholder;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RTextFieldPlaceholder RFm_PackageNamePlaceholder
		{
			get
			{
				if(r_Fm_PackageNamePlaceholder == null)
				{
					r_Fm_PackageNamePlaceholder = new(this, "m_PackageNamePlaceholder");
					r_Fm_PackageNamePlaceholder.SetBelong(this.GetValue());
				}
				return r_Fm_PackageNamePlaceholder;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.TextFieldPlaceholder m_PackageVersionPlaceholder
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RTextFieldPlaceholder r_Fm_PackageVersionPlaceholder;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RTextFieldPlaceholder RFm_PackageVersionPlaceholder
		{
			get
			{
				if(r_Fm_PackageVersionPlaceholder == null)
				{
					r_Fm_PackageVersionPlaceholder = new(this, "m_PackageVersionPlaceholder");
					r_Fm_PackageVersionPlaceholder.SetBelong(this.GetValue());
				}
				return r_Fm_PackageVersionPlaceholder;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RVector2 r_PwindowSize;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RVector2 RPwindowSize
		{
			get
			{
				if(r_PwindowSize == null)
				{
					r_PwindowSize = new(this, "windowSize", -1);
					r_PwindowSize.SetBelong(this.GetValue());
				}
				return r_PwindowSize;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement inputForm
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PinputForm;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPinputForm
		{
			get
			{
				if(r_PinputForm == null)
				{
					r_PinputForm = new(this, "inputForm", -1);
					r_PinputForm.SetBelong(this.GetValue());
				}
				return r_PinputForm;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.TextField packageNameField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_PpackageNameField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RPpackageNameField
		{
			get
			{
				if(r_PpackageNameField == null)
				{
					r_PpackageNameField = new(this, "packageNameField", -1);
					r_PpackageNameField.SetBelong(this.GetValue());
				}
				return r_PpackageNameField;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.TextField packageVersionField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_PpackageVersionField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RPpackageVersionField
		{
			get
			{
				if(r_PpackageVersionField == null)
				{
					r_PpackageVersionField = new(this, "packageVersionField", -1);
					r_PpackageVersionField.SetBelong(this.GetValue());
				}
				return r_PpackageVersionField;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.HelpBox errorInfoBox
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox r_PerrorInfoBox;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBox RPerrorInfoBox
		{
			get
			{
				if(r_PerrorInfoBox == null)
				{
					r_PerrorInfoBox = new(this, "errorInfoBox", -1);
					r_PerrorInfoBox.SetBelong(this.GetValue());
				}
				return r_PerrorInfoBox;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Button submitButton
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton r_PsubmitButton;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RPsubmitButton
		{
			get
			{
				if(r_PsubmitButton == null)
				{
					r_PsubmitButton = new(this, "submitButton", -1);
					r_PsubmitButton.SetBelong(this.GetValue());
				}
				return r_PsubmitButton;
			}
		}

		/// <summary>
		/// UnityEditor.EditorWindow container
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.REditorWindow r_Pcontainer;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.REditorWindow RPcontainer
		{
			get
			{
				if(r_Pcontainer == null)
				{
					...
					r_Pcontainer.SetBelong(this.GetValue());
				}
				return r_Pcontainer;
			}
		}
		...
		/// <summary>
		/// Void ResolveDependencies(UnityEditor.PackageManager.UI.Internal.ResourceLoader, UnityEditor.PackageManager.UI.Internal.PackageFiltering, UnityEditor.PackageManager.UI.Internal.UpmClient, UnityEditor.PackageManager.UI.Internal.PackageDatabase, UnityEditor.PackageManager.UI.Internal.PageManager)
		/// </summary>
		protected RMethod r_MResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager;
		public virtual RMethod RMResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager
		{
			get
			{
				if(r_MResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager == null)
				{
					r_MResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager = new(this, "ResolveDependencies", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.ResourceLoader"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageFiltering"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.UpmClient"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDatabase"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PageManager"));
					r_MResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager.SetBelong(this.GetValue());
				}
				return r_MResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager;
			}
		}

		/// <summary>
		/// Void Init(UnityEditor.EditorWindow)
		/// </summary>
		protected RMethod r_MInit_EditorWindow;
		public virtual RMethod RMInit_EditorWindow
		{
			get
			{
				if(r_MInit_EditorWindow == null)
				{
					r_MInit_EditorWindow = new(this, "Init", 0, typeof(UnityEditor.EditorWindow));
					r_MInit_EditorWindow.SetBelong(this.GetValue());
				}
				return r_MInit_EditorWindow;
			}
		}
		...
		/// </summary>
		protected RMethod r_MOnDropdownShown;
		public virtual RMethod RMOnDropdownShown
		{
			get
			{
				if(r_MOnDropdownShown == null)
				{
					r_MOnDropdownShown = new(this, "OnDropdownShown", 0);
					r_MOnDropdownShown.SetBelong(this.GetValue());
				}
				return r_MOnDropdownShown;
			}
		}
		...
		/// </summary>
		protected RMethod r_MOnDropdownClosed;
		public virtual RMethod RMOnDropdownClosed
		{
			get
			{
				if(r_MOnDropdownClosed == null)
				{
					r_MOnDropdownClosed = new(this, "OnDropdownClosed", 0);
					r_MOnDropdownClosed.SetBelong(this.GetValue());
				}
				return r_MOnDropdownClosed;
			}
		}
		...
		public virtual RMethod RMSetError_String_Boolean_Boolean
		{
			get
			{
				if(r_MSetError_String_Boolean_Boolean == null)
				{
					...
					r_MSetError_String_Boolean_Boolean.SetBelong(this.GetValue());
				}
		...
		/// Void SubmitClicked()
		/// </summary>
		protected RMethod r_MSubmitClicked;
		public virtual RMethod RMSubmitClicked
		{
			get
			{
				if(r_MSubmitClicked == null)
				{
					r_MSubmitClicked = new(this, "SubmitClicked", 0);
					r_MSubmitClicked.SetBelong(this.GetValue());
				}
				return r_MSubmitClicked;
			}
		}

		/// <summary>
		/// Void InstallByNameAndVersion(System.String, System.String)
		/// </summary>
		protected RMethod r_MInstallByNameAndVersion_String_String;
		public virtual RMethod RMInstallByNameAndVersion_String_String
		{
			get
			{
				if(r_MInstallByNameAndVersion_String_String == null)
				{
					r_MInstallByNameAndVersion_String_String = new(this, "InstallByNameAndVersion", 0, typeof(System.String), typeof(System.String));
					r_MInstallByNameAndVersion_String_String.SetBelong(this.GetValue());
				}
				return r_MInstallByNameAndVersion_String_String;
			}
		}

		/// <summary>
		/// Void OnExtraFetchOperation(UnityEditor.PackageManager.UI.Internal.IOperation)
		/// </summary>
		protected RMethod r_MOnExtraFetchOperation_IOperation;
		public virtual RMethod RMOnExtraFetchOperation_IOperation
		{
			get
			{
				if(r_MOnExtraFetchOperation_IOperation == null)
				{
					r_MOnExtraFetchOperation_IOperation = new(this, "OnExtraFetchOperation", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IOperation"));
					r_MOnExtraFetchOperation_IOperation.SetBelong(this.GetValue());
				}
				return r_MOnExtraFetchOperation_IOperation;
			}
		}

		/// <summary>
		/// Void OnExtraFetchResult(UnityEditor.PackageManager.Requests.SearchRequest)
		/// </summary>
		protected RMethod r_MOnExtraFetchResult_SearchRequest;
		public virtual RMethod RMOnExtraFetchResult_SearchRequest
		{
			get
			{
				if(r_MOnExtraFetchResult_SearchRequest == null)
				{
					r_MOnExtraFetchResult_SearchRequest = new(this, "OnExtraFetchResult", 0, typeof(UnityEditor.PackageManager.Requests.SearchRequest));
					r_MOnExtraFetchResult_SearchRequest.SetBelong(this.GetValue());
				}
				return r_MOnExtraFetchResult_SearchRequest;
			}
		}

		/// <summary>
		/// Void OnExtraFetchError(UnityEditor.PackageManager.UI.Internal.IOperation, UnityEditor.PackageManager.UI.Internal.UIError)
		/// </summary>
		protected RMethod r_MOnExtraFetchError_IOperation_UIError;
		public virtual RMethod RMOnExtraFetchError_IOperation_UIError
		{
			get
			{
				if(r_MOnExtraFetchError_IOperation_UIError == null)
				{
					r_MOnExtraFetchError_IOperation_UIError = new(this, "OnExtraFetchError", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IOperation"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.UIError"));
					r_MOnExtraFetchError_IOperation_UIError.SetBelong(this.GetValue());
				}
				return r_MOnExtraFetchError_IOperation_UIError;
			}
		}

		/// <summary>
		/// Void OnTextFieldChange(UnityEngine.UIElements.ChangeEvent`1[System.String])
		/// </summary>
		protected RMethod r_MOnTextFieldChange_ChangeEvent_d_String_p_;
		public virtual RMethod RMOnTextFieldChange_ChangeEvent_d_String_p_
		{
			get
			{
				if(r_MOnTextFieldChange_ChangeEvent_d_String_p_ == null)
				{
					r_MOnTextFieldChange_ChangeEvent_d_String_p_ = new(this, "OnTextFieldChange", 0, typeof(UnityEngine.UIElements.ChangeEvent<>).MakeGenericType(typeof(System.String)));
					r_MOnTextFieldChange_ChangeEvent_d_String_p_.SetBelong(this.GetValue());
				}
				return r_MOnTextFieldChange_ChangeEvent_d_String_p_;
			}
		}
		...
		/// <summary>
		/// Void ShowWithNewWindowSize()
		/// </summary>
		protected RMethod r_MShowWithNewWindowSize;
		public virtual RMethod RMShowWithNewWindowSize
		{
			get
			{
				if(r_MShowWithNewWindowSize == null)
				{
					r_MShowWithNewWindowSize = new(this, "ShowWithNewWindowSize", 0);
					r_MShowWithNewWindowSize.SetBelong(this.GetValue());
				}
				return r_MShowWithNewWindowSize;
			}
		}
        ...
        public virtual void ResolveDependencies(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RResourceLoader @resourceLoader, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageFiltering @packageFiltering, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUpmClient @upmClient, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageDatabase @packageDatabase, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPageManager @packageManager)
        {
            ...
            var ___parameters = new object[]{@resourceLoader.Value, @packageFiltering.Value, @upmClient.Value, @packageDatabase.Value, @packageManager.Value};
            var ___result = RMResolveDependencies_ResourceLoader_PackageFiltering_UpmClient_PackageDatabase_PageManager.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Init(UnityEditor.EditorWindow @anchorWindow)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@anchorWindow};
            var ___result = RMInit_EditorWindow.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnDropdownShown()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMOnDropdownShown.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnDropdownClosed()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMOnDropdownClosed.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SubmitClicked()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMSubmitClicked.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void InstallByNameAndVersion(System.String @packageName, System.String @packageVersion)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@packageName, @packageVersion};
            var ___result = RMInstallByNameAndVersion_String_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnExtraFetchOperation(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIOperation @operation)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@operation.Value};
            var ___result = RMOnExtraFetchOperation_IOperation.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnExtraFetchResult(UnityEditor.PackageManager.Requests.SearchRequest @request)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@request};
            var ___result = RMOnExtraFetchResult_SearchRequest.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void OnExtraFetchError(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIOperation @operation, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUIError @error)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@operation.Value, @error.Value};
            var ___result = RMOnExtraFetchError_IOperation_UIError.Invoke(___genericsType, ___parameters);
        ...
        public virtual void OnTextFieldChange(UnityEngine.UIElements.ChangeEvent<System.String> @evt)
        {
            ...
            var ___result = RMOnTextFieldChange_ChangeEvent_d_String_p_.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ShowWithNewWindowSize()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMShowWithNewWindowSize.Invoke(___genericsType, ___parameters);
