...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.MultiSelectFoldout
	/// </summary>
    public partial class RMultiSelectFoldout : RMember //
    {

		/// <summary>
		/// System.String <headerTextTemplate>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_F__0__headerTextTemplate__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RF__0__headerTextTemplate__1__k__BackingField
		{
			get
			{
				if(r_F__0__headerTextTemplate__1__k__BackingField == null)
				{
					r_F__0__headerTextTemplate__1__k__BackingField = new(this, "<headerTextTemplate>k__BackingField");
					r_F__0__headerTextTemplate__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__headerTextTemplate__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton r_Fm_Button;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton RFm_Button
		{
			get
			{
				if(r_Fm_Button == null)
				{
					r_Fm_Button = new(this, "m_Button");
					r_Fm_Button.SetBelong(this.GetValue());
				}
				return r_Fm_Button;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_Container
		{
			get
			{
				if(r_Fm_Container == null)
				{
					...
					r_Fm_Container.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// System.String headerTextTemplate
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_PheaderTextTemplate;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPheaderTextTemplate
		{
			get
			{
				if(r_PheaderTextTemplate == null)
				{
					r_PheaderTextTemplate = new(this, "headerTextTemplate", -1);
					r_PheaderTextTemplate.SetBelong(this.GetValue());
				}
				return r_PheaderTextTemplate;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEditor.PackageManager.UI.Internal.IPackageVersion] versions
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion> r_Pversions;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion> RPversions
		{
			get
			{
				if(r_Pversions == null)
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageToolBarRegularButton button
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton r_Pbutton;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageToolBarRegularButton RPbutton
		{
			get
			{
				if(r_Pbutton == null)
		...
		/// Void RefreshHeader()
		/// </summary>
		protected RMethod r_MRefreshHeader;
		public virtual RMethod RMRefreshHeader
		{
			get
			{
				if(r_MRefreshHeader == null)
				{
					r_MRefreshHeader = new(this, "RefreshHeader", 0);
					r_MRefreshHeader.SetBelong(this.GetValue());
				}
				return r_MRefreshHeader;
			}
		}
		...
		public virtual RMethod RMRefreshContent
		{
			get
			{
				if(r_MRefreshContent == null)
				{
					...
					r_MRefreshContent.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.MultiSelectItem CreateMultiSelectItem(UnityEditor.PackageManager.UI.Internal.IPackageVersion)
		/// </summary>
		protected RMethod r_MCreateMultiSelectItem_IPackageVersion;
		public virtual RMethod RMCreateMultiSelectItem_IPackageVersion
		{
			get
			{
				if(r_MCreateMultiSelectItem_IPackageVersion == null)
				{
					r_MCreateMultiSelectItem_IPackageVersion = new(this, "CreateMultiSelectItem", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
					r_MCreateMultiSelectItem_IPackageVersion.SetBelong(this.GetValue());
				}
				return r_MCreateMultiSelectItem_IPackageVersion;
			}
		}
		...
		public virtual RMethod RMAddPackageVersion_IPackageVersion
		{
			get
			{
				if(r_MAddPackageVersion_IPackageVersion == null)
				{
					...
					r_MAddPackageVersion_IPackageVersion.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMClearVersions
		{
			get
			{
				if(r_MClearVersions == null)
				{
					...
					r_MClearVersions.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSetExpanded_Boolean
		{
			get
			{
				if(r_MSetExpanded_Boolean == null)
				{
					...
					r_MSetExpanded_Boolean.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void <.ctor>b__12_0(UnityEngine.UIElements.ChangeEvent`1[System.Boolean])
		/// </summary>
		protected RMethod r_M__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_;
		public virtual RMethod RM__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_
		{
			get
			{
				if(r_M__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_ == null)
				{
					r_M__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_ = new(this, "<.ctor>b__12_0", 0, typeof(UnityEngine.UIElements.ChangeEvent<>).MakeGenericType(typeof(System.Boolean)));
					r_M__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_.SetBelong(this.GetValue());
				}
				return r_M__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_;
			}
		}
        ...
        public RMultiSelectFoldout() : base("UnityEditor.PackageManager.UI.Internal.MultiSelectFoldout")
        {
        }

        public RMultiSelectFoldout(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.MultiSelectFoldout")
		{
            SetInstance(instance);
		}

        public RMultiSelectFoldout(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMultiSelectFoldout(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void RefreshHeader()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshHeader.Invoke(___genericsType, ___parameters);
        ...
        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMultiSelectItem CreateMultiSelectItem(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @version)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@version.Value};
            var ___result = RMCreateMultiSelectItem_IPackageVersion.Invoke(___genericsType, ___parameters);

            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMultiSelectItem(___result);
        }
        ...
        public virtual void __0____2__ctor__1__b__12_0(UnityEngine.UIElements.ChangeEvent<System.Boolean> @evt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evt};
            var ___result = RM__0____2__ctor__1__b__12_0_ChangeEvent_d_Boolean_p_.Invoke(___genericsType, ___parameters);
