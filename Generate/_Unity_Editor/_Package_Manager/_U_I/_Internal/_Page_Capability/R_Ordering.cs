...
{public partial class RPageCapability
{
	...
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PageCapability+Ordering
	/// </summary>
    public partial class ROrdering : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RForderBy
		{
			get
			{
				if(r_ForderBy == null)
				{
					r_ForderBy = new(this, "orderBy");
					r_ForderBy.SetBelong(this.GetValue());
				}
				return r_ForderBy;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPageCapability.ROrder RForder
		{
			get
			{
				if(r_Forder == null)
				{
					r_Forder = new(this, "order");
					r_Forder.SetBelong(this.GetValue());
				}
				return r_Forder;
			}
		}
