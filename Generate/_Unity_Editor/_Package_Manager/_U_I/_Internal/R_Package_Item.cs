...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageItem
	/// </summary>
    public partial class RPackageItem : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RInt32 r_Fk_MainItemHeight;
		public static Hvak.Editor.Refleaction.RSystem.RInt32 RFk_MainItemHeight
		{
			get
			{
				if(r_Fk_MainItemHeight == null)
				{
					r_Fk_MainItemHeight = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), "k_MainItemHeight");
					r_Fk_MainItemHeight.SetBelong(null);
				}
				return r_Fk_MainItemHeight;
			}
		}

		/// <summary>
		/// System.String k_SelectedClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_Fk_SelectedClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_SelectedClassName
		{
			get
			{
				if(r_Fk_SelectedClassName == null)
				{
					r_Fk_SelectedClassName = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), "k_SelectedClassName");
					r_Fk_SelectedClassName.SetBelong(null);
				}
				return r_Fk_SelectedClassName;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_CurrentStateClass
		{
			get
			{
				if(r_Fm_CurrentStateClass == null)
				{
					r_Fm_CurrentStateClass = new(this, "m_CurrentStateClass");
					r_Fm_CurrentStateClass.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_CurrentFeatureState
		{
			get
			{
				if(r_Fm_CurrentFeatureState == null)
				{
					...
					r_Fm_CurrentFeatureState.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackage RF__0__package__1__k__BackingField
		{
			get
			{
				if(r_F__0__package__1__k__BackingField == null)
				{
					...
					r_F__0__package__1__k__BackingField.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.VisualState <visualState>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState r_F__0__visualState__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState RF__0__visualState__1__k__BackingField
		{
			get
			{
				if(r_F__0__visualState__1__k__BackingField == null)
				{
					r_F__0__visualState__1__k__BackingField = new(this, "<visualState>k__BackingField");
					r_F__0__visualState__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__visualState__1__k__BackingField;
			}
		}

		/// <summary>
		/// System.Nullable`1[System.Boolean] m_IsFeatureLayout
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RNullable<Hvak.Editor.Refleaction.RSystem.RBoolean> r_Fm_IsFeatureLayout;
		public virtual Hvak.Editor.Refleaction.RSystem.RNullable<Hvak.Editor.Refleaction.RSystem.RBoolean> RFm_IsFeatureLayout
		{
			get
			{
				if(r_Fm_IsFeatureLayout == null)
				{
					r_Fm_IsFeatureLayout = new(this, "m_IsFeatureLayout");
					r_Fm_IsFeatureLayout.SetBelong(this.GetValue());
				}
				return r_Fm_IsFeatureLayout;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageGroup <packageGroup>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup r_F__0__packageGroup__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup RF__0__packageGroup__1__k__BackingField
		{
			get
			{
				if(r_F__0__packageGroup__1__k__BackingField == null)
				{
					r_F__0__packageGroup__1__k__BackingField = new(this, "<packageGroup>k__BackingField");
					r_F__0__packageGroup__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__packageGroup__1__k__BackingField;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.Label m_NameLabel
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_NameLabel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_NameLabel
		{
			get
			{
				if(r_Fm_NameLabel == null)
				{
					r_Fm_NameLabel = new(this, "m_NameLabel");
					r_Fm_NameLabel.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_TagContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_TagContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_TagContainer
		{
			get
			{
				if(r_Fm_TagContainer == null)
				{
					r_Fm_TagContainer = new(this, "m_TagContainer");
					r_Fm_TagContainer.SetBelong(this.GetValue());
				}
				return r_Fm_TagContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_MainItem
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_MainItem;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_MainItem
		{
			get
			{
				if(r_Fm_MainItem == null)
				{
					r_Fm_MainItem = new(this, "m_MainItem");
					r_Fm_MainItem.SetBelong(this.GetValue());
				}
				return r_Fm_MainItem;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_StateIcon
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_StateIcon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_StateIcon
		{
			get
			{
				if(r_Fm_StateIcon == null)
				{
					r_Fm_StateIcon = new(this, "m_StateIcon");
					r_Fm_StateIcon.SetBelong(this.GetValue());
				}
				return r_Fm_StateIcon;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_InfoStateIcon
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_InfoStateIcon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_InfoStateIcon
		{
			get
			{
				if(r_Fm_InfoStateIcon == null)
				{
					r_Fm_InfoStateIcon = new(this, "m_InfoStateIcon");
					r_Fm_InfoStateIcon.SetBelong(this.GetValue());
				}
				return r_Fm_InfoStateIcon;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_StateContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_StateContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_StateContainer
		{
			get
			{
				if(r_Fm_StateContainer == null)
				{
					r_Fm_StateContainer = new(this, "m_StateContainer");
					r_Fm_StateContainer.SetBelong(this.GetValue());
				}
				return r_Fm_StateContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label m_EntitlementLabel
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_EntitlementLabel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_EntitlementLabel
		{
			get
			{
				if(r_Fm_EntitlementLabel == null)
				{
					r_Fm_EntitlementLabel = new(this, "m_EntitlementLabel");
					r_Fm_EntitlementLabel.SetBelong(this.GetValue());
				}
				return r_Fm_EntitlementLabel;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label m_VersionLabel
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_VersionLabel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_VersionLabel
		{
			get
			{
				if(r_Fm_VersionLabel == null)
				{
					r_Fm_VersionLabel = new(this, "m_VersionLabel");
					r_Fm_VersionLabel.SetBelong(this.GetValue());
				}
				return r_Fm_VersionLabel;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.LoadingSpinner m_Spinner
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RLoadingSpinner r_Fm_Spinner;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RLoadingSpinner RFm_Spinner
		{
			get
			{
				if(r_Fm_Spinner == null)
				{
					r_Fm_Spinner = new(this, "m_Spinner");
					r_Fm_Spinner.SetBelong(this.GetValue());
				}
				return r_Fm_Spinner;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_LockedIcon
		{
			get
			{
				if(r_Fm_LockedIcon == null)
				{
					r_Fm_LockedIcon = new(this, "m_LockedIcon");
					r_Fm_LockedIcon.SetBelong(this.GetValue());
				}
				return r_Fm_LockedIcon;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_DependencyIcon
		{
			get
			{
				if(r_Fm_DependencyIcon == null)
				{
					...
					r_Fm_DependencyIcon.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_ExpanderHidden
		{
			get
			{
				if(r_Fm_ExpanderHidden == null)
				{
					r_Fm_ExpanderHidden = new(this, "m_ExpanderHidden");
					r_Fm_ExpanderHidden.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_LeftContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_LeftContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_LeftContainer
		{
			get
			{
				if(r_Fm_LeftContainer == null)
				{
					r_Fm_LeftContainer = new(this, "m_LeftContainer");
					r_Fm_LeftContainer.SetBelong(this.GetValue());
				}
				return r_Fm_LeftContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement m_RightContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_RightContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_RightContainer
		{
			get
			{
				if(r_Fm_RightContainer == null)
				{
					r_Fm_RightContainer = new(this, "m_RightContainer");
					r_Fm_RightContainer.SetBelong(this.GetValue());
				}
				return r_Fm_RightContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Label m_NumPackagesInFeature
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_NumPackagesInFeature;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_NumPackagesInFeature
		{
			get
			{
				if(r_Fm_NumPackagesInFeature == null)
				{
					r_Fm_NumPackagesInFeature = new(this, "m_NumPackagesInFeature");
					r_Fm_NumPackagesInFeature.SetBelong(this.GetValue());
				}
				return r_Fm_NumPackagesInFeature;
			}
		}

		/// <summary>
		/// System.String[] k_TooltipsByState
		/// </summary>
		protected static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> r_Fk_TooltipsByState;
		public static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> RFk_TooltipsByState
		{
			get
			{
				if(r_Fk_TooltipsByState == null)
				{
					r_Fk_TooltipsByState = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), "k_TooltipsByState");
					r_Fk_TooltipsByState.SetBelong(null);
				}
				return r_Fk_TooltipsByState;
			}
		}

		/// <summary>
		/// System.String[] k_TooltipsByProgress
		/// </summary>
		protected static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> r_Fk_TooltipsByProgress;
		public static Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RString> RFk_TooltipsByProgress
		{
			get
			{
				if(r_Fk_TooltipsByProgress == null)
				{
					r_Fk_TooltipsByProgress = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageItem"), "k_TooltipsByProgress");
					r_Fk_TooltipsByProgress.SetBelong(null);
				}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.VisualState visualState
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState r_PvisualState;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState RPvisualState
		{
			get
			{
				if(r_PvisualState == null)
				{
					r_PvisualState = new(this, "visualState", -1);
					r_PvisualState.SetBelong(this.GetValue());
				}
				return r_PvisualState;
			}
		}
		...
		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.PackageGroup packageGroup
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup r_PpackageGroup;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageGroup RPpackageGroup
		{
			get
			{
				if(r_PpackageGroup == null)
				{
					r_PpackageGroup = new(this, "packageGroup", -1);
					r_PpackageGroup.SetBelong(this.GetValue());
				}
				return r_PpackageGroup;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.IPackageVersion selectedVersion
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion r_PselectedVersion;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion RPselectedVersion
		{
			get
			{
				if(r_PselectedVersion == null)
				{
					r_PselectedVersion = new(this, "selectedVersion", -1);
					r_PselectedVersion.SetBelong(this.GetValue());
				}
				return r_PselectedVersion;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPisDependency
		{
			get
			{
				if(r_PisDependency == null)
				{
					...
					r_PisDependency.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSetPackageAndVisualState_IPackage_VisualState
		{
			get
			{
				if(r_MSetPackageAndVisualState_IPackage_VisualState == null)
				{
					r_MSetPackageAndVisualState_IPackage_VisualState = new(this, "SetPackageAndVisualState", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackage"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"));
					r_MSetPackageAndVisualState_IPackage_VisualState.SetBelong(this.GetValue());
				}
				return r_MSetPackageAndVisualState_IPackage_VisualState;
			}
		}

		/// <summary>
		/// Void BuildMainItem(Boolean)
		/// </summary>
		protected RMethod r_MBuildMainItem_Boolean;
		public virtual RMethod RMBuildMainItem_Boolean
		{
			get
			{
				if(r_MBuildMainItem_Boolean == null)
				{
					r_MBuildMainItem_Boolean = new(this, "BuildMainItem", 0, typeof(System.Boolean));
					r_MBuildMainItem_Boolean.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void UpdateVisualState(UnityEditor.PackageManager.UI.Internal.VisualState)
		/// </summary>
		protected RMethod r_MUpdateVisualState_VisualState;
		public virtual RMethod RMUpdateVisualState_VisualState
		{
			get
			{
				if(r_MUpdateVisualState_VisualState == null)
				{
					r_MUpdateVisualState_VisualState = new(this, "UpdateVisualState", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"));
					r_MUpdateVisualState_VisualState.SetBelong(this.GetValue());
				}
				return r_MUpdateVisualState_VisualState;
			}
		}

		/// <summary>
		/// Void Refresh(UnityEditor.PackageManager.UI.Internal.VisualState)
		/// </summary>
		protected RMethod r_MRefresh_VisualState;
		public virtual RMethod RMRefresh_VisualState
		{
			get
			{
				if(r_MRefresh_VisualState == null)
				{
					r_MRefresh_VisualState = new(this, "Refresh", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState"));
					r_MRefresh_VisualState.SetBelong(this.GetValue());
				}
				return r_MRefresh_VisualState;
			}
		}

		/// <summary>
		/// Void SetPackage(UnityEditor.PackageManager.UI.Internal.IPackage)
		/// </summary>
		protected RMethod r_MSetPackage_IPackage;
		public virtual RMethod RMSetPackage_IPackage
		{
			get
			{
				if(r_MSetPackage_IPackage == null)
				{
					r_MSetPackage_IPackage = new(this, "SetPackage", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackage"));
					r_MSetPackage_IPackage.SetBelong(this.GetValue());
				}
				return r_MSetPackage_IPackage;
			}
		}
		...
		/// Void RefreshState()
		/// </summary>
		protected RMethod r_MRefreshState;
		public virtual RMethod RMRefreshState
		{
			get
			{
				if(r_MRefreshState == null)
				{
					r_MRefreshState = new(this, "RefreshState", 0);
					r_MRefreshState.SetBelong(this.GetValue());
				}
				return r_MRefreshState;
			}
		}
		...
		/// Void GetState()
		/// </summary>
		protected RMethod r_MGetState;
		public virtual RMethod RMGetState
		{
			get
			{
				if(r_MGetState == null)
				{
					r_MGetState = new(this, "GetState", 0);
					r_MGetState.SetBelong(this.GetValue());
				}
				return r_MGetState;
			}
		}
		...
		/// Void RefreshTags()
		/// </summary>
		protected RMethod r_MRefreshTags;
		public virtual RMethod RMRefreshTags
		{
			get
			{
				if(r_MRefreshTags == null)
				{
					r_MRefreshTags = new(this, "RefreshTags", 0);
					r_MRefreshTags.SetBelong(this.GetValue());
				}
				return r_MRefreshTags;
			}
		}
		...
		public virtual RMethod RMRefreshEntitlement
		{
			get
			{
				if(r_MRefreshEntitlement == null)
				{
					...
					r_MRefreshEntitlement.SetBelong(this.GetValue());
				}
		...
		/// Void SelectMainItem()
		/// </summary>
		protected RMethod r_MSelectMainItem;
		public virtual RMethod RMSelectMainItem
		{
			get
			{
				if(r_MSelectMainItem == null)
				{
					r_MSelectMainItem = new(this, "SelectMainItem", 0);
					r_MSelectMainItem.SetBelong(this.GetValue());
				}
				return r_MSelectMainItem;
			}
		}
		...
		public virtual RMethod RMToggleSelectMainItem
		{
			get
			{
				if(r_MToggleSelectMainItem == null)
				{
					...
					r_MToggleSelectMainItem.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMUpdateLockedUI_Boolean
		{
			get
			{
				if(r_MUpdateLockedUI_Boolean == null)
				{
					...
					r_MUpdateLockedUI_Boolean.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMUpdateDependencyUI_Boolean
		{
			get
			{
				if(r_MUpdateDependencyUI_Boolean == null)
				{
					...
					r_MUpdateDependencyUI_Boolean.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// Void SeeAllVersionsClick()
		/// </summary>
		protected RMethod r_MSeeAllVersionsClick;
		public virtual RMethod RMSeeAllVersionsClick
		{
			get
			{
				if(r_MSeeAllVersionsClick == null)
				{
					r_MSeeAllVersionsClick = new(this, "SeeAllVersionsClick", 0);
					r_MSeeAllVersionsClick.SetBelong(this.GetValue());
				}
				return r_MSeeAllVersionsClick;
			}
		}
		...
		/// Void StartSpinner()
		/// </summary>
		protected RMethod r_MStartSpinner;
		public virtual RMethod RMStartSpinner
		{
			get
			{
				if(r_MStartSpinner == null)
				{
					r_MStartSpinner = new(this, "StartSpinner", 0);
					r_MStartSpinner.SetBelong(this.GetValue());
				}
				return r_MStartSpinner;
			}
		}
		...
		/// Void StopSpinner()
		/// </summary>
		protected RMethod r_MStopSpinner;
		public virtual RMethod RMStopSpinner
		{
			get
			{
				if(r_MStopSpinner == null)
				{
					r_MStopSpinner = new(this, "StopSpinner", 0);
					r_MStopSpinner.SetBelong(this.GetValue());
				}
				return r_MStopSpinner;
			}
		}

		/// <summary>
		/// System.String GetTooltipByState(UnityEditor.PackageManager.UI.Internal.PackageState)
		/// </summary>
		protected RMethod r_MGetTooltipByState_PackageState;
		public virtual RMethod RMGetTooltipByState_PackageState
		{
			get
			{
				if(r_MGetTooltipByState_PackageState == null)
				{
					r_MGetTooltipByState_PackageState = new(this, "GetTooltipByState", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageState"));
					r_MGetTooltipByState_PackageState.SetBelong(this.GetValue());
				}
				return r_MGetTooltipByState_PackageState;
			}
		}

		/// <summary>
		/// System.String GetTooltipByProgress(UnityEditor.PackageManager.UI.Internal.PackageProgress)
		/// </summary>
		protected RMethod r_MGetTooltipByProgress_PackageProgress;
		public virtual RMethod RMGetTooltipByProgress_PackageProgress
		{
			get
			{
				if(r_MGetTooltipByProgress_PackageProgress == null)
				{
					r_MGetTooltipByProgress_PackageProgress = new(this, "GetTooltipByProgress", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageProgress"));
					r_MGetTooltipByProgress_PackageProgress.SetBelong(this.GetValue());
				}
				return r_MGetTooltipByProgress_PackageProgress;
			}
		}
        ...
        public virtual void SetPackageAndVisualState(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackage @package, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState @state)
        {
            ...
            var ___parameters = new object[]{@package.Value, @state.Value};
            var ___result = RMSetPackageAndVisualState_IPackage_VisualState.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void BuildMainItem(System.Boolean @isFeature)
        {
        ...
        public virtual void UpdateVisualState(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState @newVisualState)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@newVisualState.Value};
            var ___result = RMUpdateVisualState_VisualState.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void Refresh(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RVisualState @newVisualState)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@newVisualState.Value};
            var ___result = RMRefresh_VisualState.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void SetPackage(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackage @package)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@package.Value};
            var ___result = RMSetPackage_IPackage.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RefreshState()
        {
            ...
            var ___result = RMRefreshState.Invoke(___genericsType, ___parameters);
        ...
        public virtual void GetState()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMGetState.Invoke(___genericsType, ___parameters);
        ...
        public virtual void RefreshTags()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshTags.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SelectMainItem()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMSelectMainItem.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SeeAllVersionsClick()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMSeeAllVersionsClick.Invoke(___genericsType, ___parameters);
        ...
        public virtual void StartSpinner()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMStartSpinner.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void StopSpinner()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMStopSpinner.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.String GetTooltipByState(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageState @state)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@state.Value};
            var ___result = RMGetTooltipByState_PackageState.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual System.String GetTooltipByProgress(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageProgress @progress)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@progress.Value};
            var ___result = RMGetTooltipByProgress_PackageProgress.Invoke(___genericsType, ___parameters);
