...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.Alert
	/// </summary>
    public partial class RAlert : RMember //
    {
		...
		/// <summary>
		/// System.Action m_OnActionButtonClicked
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RAction r_Fm_OnActionButtonClicked;
		public virtual Hvak.Editor.Refleaction.RSystem.RAction RFm_OnActionButtonClicked
		{
			get
			{
				if(r_Fm_OnActionButtonClicked == null)
				{
					r_Fm_OnActionButtonClicked = new(this, "m_OnActionButtonClicked");
					r_Fm_OnActionButtonClicked.SetBelong(this.GetValue());
				}
				return r_Fm_OnActionButtonClicked;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.Label alertMessage
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_PalertMessage;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RPalertMessage
		{
			get
			{
				if(r_PalertMessage == null)
				{
					r_PalertMessage = new(this, "alertMessage", -1);
					r_PalertMessage.SetBelong(this.GetValue());
				}
				return r_PalertMessage;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualElement alertContainer
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_PalertContainer;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPalertContainer
		{
			get
			{
				if(r_PalertContainer == null)
				{
					r_PalertContainer = new(this, "alertContainer", -1);
					r_PalertContainer.SetBelong(this.GetValue());
				}
				return r_PalertContainer;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Button alertActionButton
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton r_PalertActionButton;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RPalertActionButton
		{
			get
			{
				if(r_PalertActionButton == null)
				{
					r_PalertActionButton = new(this, "alertActionButton", -1);
					r_PalertActionButton.SetBelong(this.GetValue());
				}
				return r_PalertActionButton;
			}
		}
		...
		/// <summary>
		/// Void RefreshError(UnityEditor.PackageManager.UI.Internal.UIError, UnityEditor.PackageManager.UI.Internal.IPackageVersion)
		/// </summary>
		protected RMethod r_MRefreshError_UIError_IPackageVersion;
		public virtual RMethod RMRefreshError_UIError_IPackageVersion
		{
			get
			{
				if(r_MRefreshError_UIError_IPackageVersion == null)
				{
					r_MRefreshError_UIError_IPackageVersion = new(this, "RefreshError", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.UIError"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
					r_MRefreshError_UIError_IPackageVersion.SetBelong(this.GetValue());
				}
				return r_MRefreshError_UIError_IPackageVersion;
			}
		}

		/// <summary>
		/// Void RefreshActionButton(UnityEditor.PackageManager.UI.Internal.UIError, UnityEditor.PackageManager.UI.Internal.IPackageVersion)
		/// </summary>
		protected RMethod r_MRefreshActionButton_UIError_IPackageVersion;
		public virtual RMethod RMRefreshActionButton_UIError_IPackageVersion
		{
			get
			{
				if(r_MRefreshActionButton_UIError_IPackageVersion == null)
				{
					r_MRefreshActionButton_UIError_IPackageVersion = new(this, "RefreshActionButton", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.UIError"),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
					r_MRefreshActionButton_UIError_IPackageVersion.SetBelong(this.GetValue());
				}
				return r_MRefreshActionButton_UIError_IPackageVersion;
			}
		}
		...
		/// Void <.ctor>b__5_0()
		/// </summary>
		protected RMethod r_M__0____2__ctor__1__b__5_0;
		public virtual RMethod RM__0____2__ctor__1__b__5_0
		{
			get
			{
				if(r_M__0____2__ctor__1__b__5_0 == null)
				{
					r_M__0____2__ctor__1__b__5_0 = new(this, "<.ctor>b__5_0", 0);
					r_M__0____2__ctor__1__b__5_0.SetBelong(this.GetValue());
				}
				return r_M__0____2__ctor__1__b__5_0;
			}
		}
        ...
        public RAlert() : base("UnityEditor.PackageManager.UI.Internal.Alert")
        {
        }

        public RAlert(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.Alert")
		{
            SetInstance(instance);
		}

        public RAlert(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAlert(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void RefreshError(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUIError @error, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @packageVersion)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@error.Value, @packageVersion.Value};
            var ___result = RMRefreshError_UIError_IPackageVersion.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RefreshActionButton(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUIError @error, Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIPackageVersion @packageVersion)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@error.Value, @packageVersion.Value};
            var ___result = RMRefreshActionButton_UIError_IPackageVersion.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void __0____2__ctor__1__b__5_0()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RM__0____2__ctor__1__b__5_0.Invoke(___genericsType, ___parameters);
