    ...
    public partial class RPackageDetailsTabView : RMember //
    {
		...
		public virtual RMethod RMRefreshTabs_IEnumerable_d_String_p__IPackageVersion
		{
			get
			{
				...
				{
					r_MRefreshTabs_IEnumerable_d_String_p__IPackageVersion = new(this, "RefreshTabs", 0,  ReflectionUtils.GetType("System.Collections.Generic.IEnumerable`1").MakeGenericType(typeof(System.String)),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
				}
		...
		public virtual RMethod RMRefreshTabs_IEnumerable_d_PackageDetailsTabElement_p__IPackageVersion
		{
			get
			{
				...
				{
					r_MRefreshTabs_IEnumerable_d_PackageDetailsTabElement_p__IPackageVersion = new(this, "RefreshTabs", 0,  ReflectionUtils.GetType("System.Collections.Generic.IEnumerable`1").MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.PackageDetailsTabElement")),  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.IPackageVersion"));
				}
