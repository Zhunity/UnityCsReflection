		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_SpecialUniqueId
		{
			get
			{
				if(r_Fm_SpecialUniqueId == null)
				{
					...
					r_Fm_SpecialUniqueId.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag RFm_PackageTag
		{
			get
			{
				if(r_Fm_PackageTag == null)
				{
					...
					r_Fm_PackageTag.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPspecialUniqueId
		{
			get
			{
				if(r_PspecialUniqueId == null)
				{
					...
					r_PspecialUniqueId.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageTag RPpackageTag
		{
			get
			{
				if(r_PpackageTag == null)
				{
					...
					r_PpackageTag.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMAdd_String_String
		{
			get
			{
				if(r_MAdd_String_String == null)
				{
					...
					r_MAdd_String_String.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMAddByUrlOrPath_String_PackageTag
		{
			get
			{
				if(r_MAddByUrlOrPath_String_PackageTag == null)
				{
					...
					r_MAddByUrlOrPath_String_PackageTag.SetBelong(this.GetValue());
				}
