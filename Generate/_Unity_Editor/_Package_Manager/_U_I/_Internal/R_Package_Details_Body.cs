...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageDetailsBody
	/// </summary>
    public partial class RPackageDetailsBody : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RPackageDetailsTabView RFm_TabView
		{
			get
			{
				if(r_Fm_TabView == null)
				{
					...
					r_Fm_TabView.SetBelong(this.GetValue());
				}
				return r_Fm_TabView;
			}
		}
		...
		public virtual RMethod RMAddTabs
		{
			get
			{
				if(r_MAddTabs == null)
				{
					...
					r_MAddTabs.SetBelong(this.GetValue());
				}
				return r_MAddTabs;
			}
		}
		...
		public virtual RMethod RMRefreshTabs
		{
			get
			{
				if(r_MRefreshTabs == null)
				{
					...
					r_MRefreshTabs.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshDependencies
		{
			get
			{
				if(r_MRefreshDependencies == null)
				{
					r_MRefreshDependencies = new(this, "RefreshDependencies", 0);
					r_MRefreshDependencies.SetBelong(this.GetValue());
				}
				return r_MRefreshDependencies;
			}
		}

		/// <summary>
		/// Void RefreshDependencies(Boolean)
		/// </summary>
		protected RMethod r_MRefreshDependencies_Boolean;
		public virtual RMethod RMRefreshDependencies_Boolean
		{
			get
			{
				if(r_MRefreshDependencies_Boolean == null)
				{
					r_MRefreshDependencies_Boolean = new(this, "RefreshDependencies", 0, typeof(System.Boolean));
					r_MRefreshDependencies_Boolean.SetBelong(this.GetValue());
				}
				return r_MRefreshDependencies_Boolean;
			}
		}
		...
		public virtual RMethod RMRefreshDependencies_PackagesChangeArgs
		{
			get
			{
				if(r_MRefreshDependencies_PackagesChangeArgs == null)
				{
					...
					r_MRefreshDependencies_PackagesChangeArgs.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMOnTabSwitched_PackageDetailsTabElement_PackageDetailsTabElement
		{
			get
			{
				if(r_MOnTabSwitched_PackageDetailsTabElement_PackageDetailsTabElement == null)
				{
					...
					r_MOnTabSwitched_PackageDetailsTabElement_PackageDetailsTabElement.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMRefreshVersionsHistory_IEnumerable_d_VisualState_p_
		{
			get
			{
				...
				{
					r_MRefreshVersionsHistory_IEnumerable_d_VisualState_p_ = new(this, "RefreshVersionsHistory", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.VisualState")));
					r_MRefreshVersionsHistory_IEnumerable_d_VisualState_p_.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RM__0__RefreshVersionsHistory__1__b__25_0_VisualState
		{
			get
			{
				if(r_M__0__RefreshVersionsHistory__1__b__25_0_VisualState == null)
				{
					...
					r_M__0__RefreshVersionsHistory__1__b__25_0_VisualState.SetBelong(this.GetValue());
				}
        ...
        public RPackageDetailsBody() : base("UnityEditor.PackageManager.UI.Internal.PackageDetailsBody")
        {
        }

        public RPackageDetailsBody(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageDetailsBody")
		{
            SetInstance(instance);
		}

        public RPackageDetailsBody(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageDetailsBody(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void RefreshDependencies()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshDependencies.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void RefreshDependencies(System.Boolean @_)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_};
            var ___result = RMRefreshDependencies_Boolean.Invoke(___genericsType, ___parameters);
