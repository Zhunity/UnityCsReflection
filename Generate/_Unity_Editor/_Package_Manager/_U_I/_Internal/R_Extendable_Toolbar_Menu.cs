...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RExtendableToolbarMenu : RMember //
    {
		...
		/// </summary>
		protected REvent r_EonClick;
		public virtual REvent REonClick
		{
			get
			{
				if(r_EonClick == null)
				{
					r_EonClick = new(this, "onClick");
					r_EonClick.SetBelong(this.GetValue());
				}
				return r_EonClick;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RFm_NeedRefresh
		{
			get
			{
				if(r_Fm_NeedRefresh == null)
				{
					...
					r_Fm_NeedRefresh.SetBelong(this.GetValue());
				}
		...
		/// <summary>
		/// System.Collections.Generic.List`1[UnityEditor.PackageManager.UI.Internal.MenuDropdownItem] m_BuiltInItems
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem> r_Fm_BuiltInItems;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem> RFm_BuiltInItems
		{
			get
			{
				if(r_Fm_BuiltInItems == null)
				{
					r_Fm_BuiltInItems = new(this, "m_BuiltInItems");
					r_Fm_BuiltInItems.SetBelong(this.GetValue());
				}
				return r_Fm_BuiltInItems;
			}
		}

		/// <summary>
		/// System.Collections.Generic.List`1[UnityEditor.PackageManager.UI.Internal.MenuDropdownItem] m_DropdownItems
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem> r_Fm_DropdownItems;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem> RFm_DropdownItems
		{
			get
			{
				if(r_Fm_DropdownItems == null)
				{
					...
					r_Fm_DropdownItems.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDropdownMenu r_F__0__menu__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDropdownMenu RF__0__menu__1__k__BackingField
		{
			get
			{
				if(r_F__0__menu__1__k__BackingField == null)
				{
					r_F__0__menu__1__k__BackingField = new(this, "<menu>k__BackingField");
					r_F__0__menu__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__menu__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RMethod r_MRefreshDropdown;
		public virtual RMethod RMRefreshDropdown
		{
			get
			{
				if(r_MRefreshDropdown == null)
				{
					r_MRefreshDropdown = new(this, "RefreshDropdown", 0);
					r_MRefreshDropdown.SetBelong(this.GetValue());
				}
				return r_MRefreshDropdown;
			}
		}

		/// <summary>
		/// UnityEditor.PackageManager.UI.Internal.MenuDropdownItem AddBuiltInDropdownItem()
		/// </summary>
		protected RMethod r_MAddBuiltInDropdownItem;
		public virtual RMethod RMAddBuiltInDropdownItem
		{
			get
			{
				if(r_MAddBuiltInDropdownItem == null)
				{
					r_MAddBuiltInDropdownItem = new(this, "AddBuiltInDropdownItem", 0);
					r_MAddBuiltInDropdownItem.SetBelong(this.GetValue());
				}
				return r_MAddBuiltInDropdownItem;
			}
		}
		...
		/// <summary>
		/// Void Remove(UnityEditor.PackageManager.UI.Internal.MenuDropdownItem)
		/// </summary>
		protected RMethod r_MRemove_MenuDropdownItem;
		public virtual RMethod RMRemove_MenuDropdownItem
		{
			get
			{
				if(r_MRemove_MenuDropdownItem == null)
				{
					r_MRemove_MenuDropdownItem = new(this, "Remove", 0,  ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Internal.MenuDropdownItem"));
					r_MRemove_MenuDropdownItem.SetBelong(this.GetValue());
				}
				return r_MRemove_MenuDropdownItem;
			}
		}
        ...
        public virtual void RefreshDropdown()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMRefreshDropdown.Invoke(___genericsType, ___parameters);

            
        }


        public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem AddBuiltInDropdownItem()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMAddBuiltInDropdownItem.Invoke(___genericsType, ___parameters);

            return new Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem(___result);
        }
        ...
        public virtual void Remove(Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RMenuDropdownItem @item)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@item.Value};
            var ___result = RMRemove_MenuDropdownItem.Invoke(___genericsType, ___parameters);
