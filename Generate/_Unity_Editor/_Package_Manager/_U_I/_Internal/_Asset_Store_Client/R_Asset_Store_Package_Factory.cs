...
{public partial class RAssetStoreClient
{
    ...
    public partial class RAssetStorePackageFactory : RMember //
    {
		...
		public virtual RMethod RMResolveDependencies_AssetStoreCache_AssetStoreClient_AssetStoreUtils_FetchStatusTracker_UpmCache_IOProxy
		{
			get
			{
				if(r_MResolveDependencies_AssetStoreCache_AssetStoreClient_AssetStoreUtils_FetchStatusTracker_UpmCache_IOProxy == null)
				{
					...
					r_MResolveDependencies_AssetStoreCache_AssetStoreClient_AssetStoreUtils_FetchStatusTracker_UpmCache_IOProxy.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMOnUpdatesFound_IEnumerable_d_AssetStoreUpdateInfo_p_
		{
			get
			{
				if(r_MOnUpdatesFound_IEnumerable_d_AssetStoreUpdateInfo_p_ == null)
				{
					...
					r_MOnUpdatesFound_IEnumerable_d_AssetStoreUpdateInfo_p_.SetBelong(this.instance);
				}
		...
		public virtual RMethod RM__0__OnLocalInfosChanged__1__b__10_2_String
		{
			get
			{
				if(r_M__0__OnLocalInfosChanged__1__b__10_2_String == null)
				{
					...
					r_M__0__OnLocalInfosChanged__1__b__10_2_String.SetBelong(this.instance);
				}
		...
		public virtual RMethod RM__0__OnUpdatesFound__1__b__11_1_String
		{
			get
			{
				if(r_M__0__OnUpdatesFound__1__b__11_1_String == null)
				{
					...
					r_M__0__OnUpdatesFound__1__b__11_1_String.SetBelong(this.instance);
				}
        ...
        public virtual void ResolveDependencies(SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RAssetStoreCache @assetStoreCache, SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RAssetStoreClient @assetStoreClient, SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RAssetStoreUtils @assetStoreUtils, SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RFetchStatusTracker @fetchStatusTracker, SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RUpmCache @upmCache, SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RIOProxy @ioProxy)
        {
        ...
        public virtual void OnUpdatesFound(SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RIEnumerable<SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal.RAssetStoreUpdateInfo> @updateInfos)
        {
