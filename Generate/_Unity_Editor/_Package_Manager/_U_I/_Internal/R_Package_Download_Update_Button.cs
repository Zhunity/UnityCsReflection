...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.PackageDownloadUpdateButton
	/// </summary>
    public partial class RPackageDownloadUpdateButton : RMember //
    {
        ...
        public RPackageDownloadUpdateButton() : base("UnityEditor.PackageManager.UI.Internal.PackageDownloadUpdateButton")
        {
        }

        public RPackageDownloadUpdateButton(System.Object instance) : base("UnityEditor.PackageManager.UI.Internal.PackageDownloadUpdateButton")
		{
            SetInstance(instance);
		}

        public RPackageDownloadUpdateButton(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPackageDownloadUpdateButton(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
