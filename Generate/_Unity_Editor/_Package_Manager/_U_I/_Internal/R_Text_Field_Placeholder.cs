...
{
	/// <summary>
	/// UnityEditor.PackageManager.UI.Internal.TextFieldPlaceholder
	/// </summary>
    public partial class RTextFieldPlaceholder : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_Fm_ParentTextField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RFm_ParentTextField
		{
			get
			{
				if(r_Fm_ParentTextField == null)
				{
					r_Fm_ParentTextField = new(this, "m_ParentTextField");
					r_Fm_ParentTextField.SetBelong(this.GetValue());
				}
				return r_Fm_ParentTextField;
			}
		}
