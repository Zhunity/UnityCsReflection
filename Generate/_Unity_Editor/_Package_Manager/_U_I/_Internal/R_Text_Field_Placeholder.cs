...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RInternal
{
    ...
    public partial class RTextFieldPlaceholder : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_Fm_ParentTextField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RFm_ParentTextField
		{
			get
			{
				if(r_Fm_ParentTextField == null)
				{
					...
					r_Fm_ParentTextField.SetBelong(this.instance);
				}
