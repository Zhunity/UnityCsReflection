...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI
{
    ...
    public partial class RIWindowDestroyHandler : RMember //
    {
		...
		public virtual RMethod RMOnWindowDestroy_WindowDestroyArgs
		{
			get
			{
				if(r_MOnWindowDestroy_WindowDestroyArgs == null)
				{
					...
					r_MOnWindowDestroy_WindowDestroyArgs.SetBelong(this.instance);
				}
        ...
        public virtual void OnWindowDestroy(SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RWindowDestroyArgs @args)
        {
