    ...
    public partial class RImportOptions : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RSample.RImportOptions RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Sample+ImportOptions"), "None");
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RSample.RImportOptions RFOverridePreviousImports
		{
			get
			{
				if(r_FOverridePreviousImports == null)
				{
					r_FOverridePreviousImports = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Sample+ImportOptions"), "OverridePreviousImports");
					r_FOverridePreviousImports.SetBelong(null);
				}
				return r_FOverridePreviousImports;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RUI.RSample.RImportOptions RFHideImportWindow
		{
			get
			{
				if(r_FHideImportWindow == null)
				{
					r_FHideImportWindow = new( ReflectionUtils.GetType("UnityEditor.PackageManager.UI.Sample+ImportOptions"), "HideImportWindow");
					r_FHideImportWindow.SetBelong(null);
				}
				return r_FHideImportWindow;
			}
		}
