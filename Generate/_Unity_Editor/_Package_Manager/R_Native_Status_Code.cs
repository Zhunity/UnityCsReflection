...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RNativeStatusCode : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFInQueue
		{
			get
			{
				if(r_FInQueue == null)
				{
					r_FInQueue = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "InQueue");
					r_FInQueue.SetBelong(null);
				}
				return r_FInQueue;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFInProgress
		{
			get
			{
				...
				{
					r_FInProgress = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "InProgress");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFDone
		{
			get
			{
				if(r_FDone == null)
				{
					r_FDone = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "Done");
					r_FDone.SetBelong(null);
				}
				return r_FDone;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFError
		{
			get
			{
				if(r_FError == null)
				{
					r_FError = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "Error");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFNotFound
		{
			get
			{
				if(r_FNotFound == null)
				{
					r_FNotFound = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "NotFound");
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RFCancelled
		{
			get
			{
				...
				{
					r_FCancelled = new( ReflectionUtils.GetType("UnityEditor.PackageManager.NativeStatusCode"), "Cancelled");
        ...
        public RNativeStatusCode() : base("UnityEditor.PackageManager.NativeStatusCode")
        {
        }

        public RNativeStatusCode(System.Object instance) : base("UnityEditor.PackageManager.NativeStatusCode")
		{
            SetInstance(instance);
		}

        public RNativeStatusCode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RNativeStatusCode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
