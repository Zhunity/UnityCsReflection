...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RStatusCode : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(UnityEditor.PackageManager.StatusCode);
            }
        }

        public RStatusCode() : base("UnityEditor.PackageManager.StatusCode")
        {
        }

        public RStatusCode(System.Object instance) : base("UnityEditor.PackageManager.StatusCode")
		{
            SetInstance(instance);
		}

        public RStatusCode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RStatusCode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RStatusCode RFInProgress
		{
			get
			{
				...
				{
					r_FInProgress = new(typeof(UnityEditor.PackageManager.StatusCode), "InProgress");
				}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RStatusCode RFSuccess
		{
			get
			{
				if(r_FSuccess == null)
				{
					r_FSuccess = new(typeof(UnityEditor.PackageManager.StatusCode), "Success");
				}
				return r_FSuccess;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RStatusCode RFFailure
		{
			get
			{
				if(r_FFailure == null)
				{
					r_FFailure = new(typeof(UnityEditor.PackageManager.StatusCode), "Failure");
				}
				return r_FFailure;
			}
		}
