...
{
	/// <summary>
	/// UnityEditor.PackageManager.Requests.AddScopedRegistryRequest
	/// </summary>
    public partial class RAddScopedRegistryRequest : RMember //
    {
		...
		public static RMethod RMGetOperationData_Int64
		{
			get
			{
				...
				{
					r_MGetOperationData_Int64 = new( ReflectionUtils.GetType("UnityEditor.PackageManager.Requests.AddScopedRegistryRequest"), "GetOperationData", 0, typeof(System.Int64));
