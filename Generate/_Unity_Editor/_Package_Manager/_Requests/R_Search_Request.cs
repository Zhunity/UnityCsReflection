...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
    ...
    public partial class RSearchRequest : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_PackageIdOrName
		{
			get
			{
				if(r_Fm_PackageIdOrName == null)
				{
					...
					r_Fm_PackageIdOrName.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPPackageIdOrName
		{
			get
			{
				if(r_PPackageIdOrName == null)
				{
					...
					r_PPackageIdOrName.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RPropertyArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo> r_PResult;
		public virtual Hvak.Editor.Refleaction.RPropertyArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo> RPResult
		{
			get
			{
				if(r_PResult == null)
