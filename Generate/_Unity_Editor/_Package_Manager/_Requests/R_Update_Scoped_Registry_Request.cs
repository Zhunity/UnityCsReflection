    ...
    public partial class RUpdateScopedRegistryRequest : RMember //
    {
		...
		public static RMethod RMGetOperationData_Int64
		{
			get
			{
				...
				{
					r_MGetOperationData_Int64 = new( ReflectionUtils.GetType("UnityEditor.PackageManager.Requests.UpdateScopedRegistryRequest"), "GetOperationData", 0, typeof(System.Int64));
