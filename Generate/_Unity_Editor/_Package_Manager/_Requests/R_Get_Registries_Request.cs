...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
    ...
    public partial class RGetRegistriesRequest : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RPropertyArray<SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRegistryInfo> r_PResult;
		public virtual SMFrame.Editor.Refleaction.RPropertyArray<SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRegistryInfo> RPResult
		{
			get
			{
				if(r_PResult == null)
