...
{
	/// <summary>
	/// UnityEditor.PackageManager.Requests.GetRegistriesRequest
	/// </summary>
    public partial class RGetRegistriesRequest : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RPropertyArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RRegistryInfo> r_PResult;
		public virtual Hvak.Editor.Refleaction.RPropertyArray<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RRegistryInfo> RPResult
		{
			get
			{
				if(r_PResult == null)
		...
		/// <summary>
		/// UnityEditor.PackageManager.RegistryInfo[] GetResult()
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.RegistryInfo[] GetOperationData(Int64)
		/// </summary>
		...
		public static RMethod RMGetOperationData_Int64
		{
			get
			{
				...
				{
					r_MGetOperationData_Int64 = new( ReflectionUtils.GetType("UnityEditor.PackageManager.Requests.GetRegistriesRequest"), "GetOperationData", 0, typeof(System.Int64));
