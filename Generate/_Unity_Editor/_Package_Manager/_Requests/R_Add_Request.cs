...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
    ...
    public partial class RAddRequest : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo r_PResult;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo RPResult
		{
			get
			{
				if(r_PResult == null)
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RNativeStatusCode RPNativeStatus
		{
			get
			{
				if(r_PNativeStatus == null)
				{
					...
					r_PNativeStatus.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RError RPError
		{
			get
			{
				if(r_PError == null)
				{
					...
					r_PError.SetBelong(this.GetValue());
				}
				return r_PError;
			}
		}
		...
		public virtual RMethod RMFetchNativeData
		{
			get
			{
				if(r_MFetchNativeData == null)
				{
					...
					r_MFetchNativeData.SetBelong(this.GetValue());
				}
