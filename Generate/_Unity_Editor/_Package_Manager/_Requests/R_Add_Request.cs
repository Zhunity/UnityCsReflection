...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
	...
	/// </summary>
    public partial class RAddRequest : RMember //
    {
		...
		public virtual REvent REprogressUpdated
		{
			get
			{
				if(r_EprogressUpdated == null)
				{
					...
					r_EprogressUpdated.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequestProgress r_Fm_Progress;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequestProgress RFm_Progress
		{
			get
			{
		...
		/// <summary>
		/// UnityEditor.PackageManager.PackageInfo Result
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo r_PResult;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageInfo RPResult
		{
			get
			{
				if(r_PResult == null)
		...
		/// <summary>
		/// UnityEditor.PackageManager.PackageInfo GetResult()
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.PackageInfo GetOperationData(Int64)
		/// </summary>
		...
		public static RMethod RMGetOperationData_Int64
		{
			get
			{
				...
				{
					r_MGetOperationData_Int64 = new(typeof(UnityEditor.PackageManager.Requests.AddRequest), "GetOperationData", 0, typeof(System.Int64));
					r_MGetOperationData_Int64.SetBelong(null);
				}
        ...
        public RAddRequest() : base("UnityEditor.PackageManager.Requests.AddRequest")
        {
        }

        public RAddRequest(System.Object instance) : base("UnityEditor.PackageManager.Requests.AddRequest")
		{
            SetInstance(instance);
		}

        public RAddRequest(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAddRequest(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual UnityEditor.PackageManager.PackageInfo GetResult()
        {
