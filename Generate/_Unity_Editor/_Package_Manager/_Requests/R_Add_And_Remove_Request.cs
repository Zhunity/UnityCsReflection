...
namespace SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
    ...
    public partial class RAddAndRemoveRequest : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageCollection r_PResult;
		public virtual SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.RPackageCollection RPResult
		{
			get
			{
				if(r_PResult == null)
		...
		/// <summary>
		/// UnityEditor.PackageManager.PackageCollection GetResult()
		/// </summary>
		...
		/// <summary>
		/// UnityEditor.PackageManager.OperationStatus GetOperationData(Int64)
		/// </summary>
		...
		public static RMethod RMGetOperationData_Int64
		{
			get
			{
				...
				{
					r_MGetOperationData_Int64 = new(typeof(UnityEditor.PackageManager.Requests.AddAndRemoveRequest), "GetOperationData", 0, typeof(System.Int64));
        ...
        public virtual UnityEditor.PackageManager.PackageCollection GetResult()
        {
            ...
            return (UnityEditor.PackageManager.PackageCollection)___result;
        }


        public static SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.ROperationStatus GetOperationData(System.Int64 @operationId)
        {
            ...
            return new SMFrame.Editor.Refleaction.RUnityEditor.RPackageManager.ROperationStatus(___result);
        }
