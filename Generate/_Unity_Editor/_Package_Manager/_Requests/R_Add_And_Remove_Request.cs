...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RRequests
{
    ...
    public partial class RAddAndRemoveRequest : RMember //
    {
        ...
        public virtual UnityEditor.PackageManager.PackageCollection GetResult()
        {
            ...
            return ReflectionUtils.Convert<UnityEditor.PackageManager.PackageCollection>(___result);
        }
        ...
        public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.ROperationStatus GetOperationData(System.Int64 @operationId)
        {
            ...
            return ReflectionUtils.Convert<Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.ROperationStatus>(___result);
        }
