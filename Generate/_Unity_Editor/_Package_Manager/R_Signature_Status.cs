...
namespace Hvak.Editor.Refleaction.RUnityEditor.RPackageManager
{
	...
	/// </summary>
    public partial class RSignatureStatus : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus");
            }
        }

        public RSignatureStatus() : base("UnityEditor.PackageManager.SignatureStatus")
        {
        }

        public RSignatureStatus(System.Object instance) : base("UnityEditor.PackageManager.SignatureStatus")
		{
            SetInstance(instance);
		}

        public RSignatureStatus(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSignatureStatus(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSignatureStatus RFUnchecked
		{
			get
			{
				if(r_FUnchecked == null)
				{
					r_FUnchecked = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus"), "Unchecked");
				}
				return r_FUnchecked;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSignatureStatus RFValid
		{
			get
			{
				if(r_FValid == null)
				{
					r_FValid = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus"), "Valid");
				}
				return r_FValid;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSignatureStatus RFInvalid
		{
			get
			{
				if(r_FInvalid == null)
				{
					r_FInvalid = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus"), "Invalid");
				}
				return r_FInvalid;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSignatureStatus RFUnsigned
		{
			get
			{
				if(r_FUnsigned == null)
				{
					r_FUnsigned = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus"), "Unsigned");
				}
				return r_FUnsigned;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEditor.RPackageManager.RSignatureStatus RFError
		{
			get
			{
				if(r_FError == null)
				{
					r_FError = new( ReflectionUtils.GetType("UnityEditor.PackageManager.SignatureStatus"), "Error");
				}
				return r_FError;
			}
		}
