...
{public partial class RAsyncHTTPClient
{
    ...
    public partial class RDoneCallback : RMember //
    {
		...
		public virtual RMethod RMInvoke_IAsyncHTTPClient
		{
			get
			{
				if(r_MInvoke_IAsyncHTTPClient == null)
				{
					...
					r_MInvoke_IAsyncHTTPClient.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object.SetBelong(this.instance);
				}
        ...
        public virtual void Invoke(SMFrame.Editor.Refleaction.RUnityEditor.RIAsyncHTTPClient @client)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(SMFrame.Editor.Refleaction.RUnityEditor.RIAsyncHTTPClient @client, System.AsyncCallback @callback, System.Object @object)
        {
