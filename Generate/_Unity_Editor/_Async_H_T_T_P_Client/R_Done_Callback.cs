...
{public partial class RAsyncHTTPClient
{
	...
	/// <summary>
	/// UnityEditor.AsyncHTTPClient+DoneCallback
	/// </summary>
    public partial class RDoneCallback : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEditor.IAsyncHTTPClient)
		/// </summary>
		protected RMethod r_MInvoke_IAsyncHTTPClient;
		public virtual RMethod RMInvoke_IAsyncHTTPClient
		{
			get
			{
				if(r_MInvoke_IAsyncHTTPClient == null)
				{
					r_MInvoke_IAsyncHTTPClient = new(this, "Invoke", 0,  ReflectionUtils.GetType("UnityEditor.IAsyncHTTPClient"));
					r_MInvoke_IAsyncHTTPClient.SetBelong(this.GetValue());
				}
				return r_MInvoke_IAsyncHTTPClient;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditor.IAsyncHTTPClient, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReflectionUtils.GetType("UnityEditor.IAsyncHTTPClient"), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object;
			}
		}
        ...
        public RDoneCallback() : base("UnityEditor.AsyncHTTPClient+DoneCallback")
        {
        }

        public RDoneCallback(System.Object instance) : base("UnityEditor.AsyncHTTPClient+DoneCallback")
		{
            SetInstance(instance);
		}

        public RDoneCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDoneCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(Hvak.Editor.Refleaction.RUnityEditor.RIAsyncHTTPClient @client)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@client.Value};
            var ___result = RMInvoke_IAsyncHTTPClient.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(Hvak.Editor.Refleaction.RUnityEditor.RIAsyncHTTPClient @client, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@client.Value, @callback, @object};
            var ___result = RMBeginInvoke_IAsyncHTTPClient_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
