...
{public partial class RPopupList
{
	...
	/// <summary>
	/// UnityEditor.PopupList+OnSelectCallback
	/// </summary>
    public partial class ROnSelectCallback : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(ListElement)
		/// </summary>
		protected RMethod r_MInvoke_ListElement;
		public virtual RMethod RMInvoke_ListElement
		{
			get
			{
				if(r_MInvoke_ListElement == null)
				{
					r_MInvoke_ListElement = new(this, "Invoke", 0,  ReflectionUtils.GetType("UnityEditor.PopupList+ListElement"));
					r_MInvoke_ListElement.SetBelong(this.GetValue());
				}
				return r_MInvoke_ListElement;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(ListElement, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_ListElement_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_ListElement_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_ListElement_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_ListElement_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReflectionUtils.GetType("UnityEditor.PopupList+ListElement"), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_ListElement_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_ListElement_AsyncCallback_Object;
			}
		}
        ...
        public ROnSelectCallback() : base("UnityEditor.PopupList+OnSelectCallback")
        {
        }

        public ROnSelectCallback(System.Object instance) : base("UnityEditor.PopupList+OnSelectCallback")
		{
            SetInstance(instance);
		}

        public ROnSelectCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public ROnSelectCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(Hvak.Editor.Refleaction.RUnityEditor.RPopupList.RListElement @element)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@element.Value};
            var ___result = RMInvoke_ListElement.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(Hvak.Editor.Refleaction.RUnityEditor.RPopupList.RListElement @element, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@element.Value, @callback, @object};
            var ___result = RMBeginInvoke_ListElement_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
