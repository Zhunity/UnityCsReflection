    ...
    public partial class RToolbarSearchField : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFtextUssClassName
		{
			get
			{
				...
				{
					r_FtextUssClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "textUssClassName");
		...
		/// <summary>
		/// System.String searchButtonUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FsearchButtonUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFsearchButtonUssClassName
		{
			get
			{
				if(r_FsearchButtonUssClassName == null)
				{
					r_FsearchButtonUssClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "searchButtonUssClassName");
					r_FsearchButtonUssClassName.SetBelong(null);
				}
				return r_FsearchButtonUssClassName;
			}
		}

		/// <summary>
		/// System.String cancelButtonUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FcancelButtonUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFcancelButtonUssClassName
		{
			get
			{
				if(r_FcancelButtonUssClassName == null)
				{
					r_FcancelButtonUssClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "cancelButtonUssClassName");
					r_FcancelButtonUssClassName.SetBelong(null);
				}
				return r_FcancelButtonUssClassName;
			}
		}

		/// <summary>
		/// System.String cancelButtonOffVariantUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FcancelButtonOffVariantUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFcancelButtonOffVariantUssClassName
		{
			get
			{
				if(r_FcancelButtonOffVariantUssClassName == null)
				{
					r_FcancelButtonOffVariantUssClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "cancelButtonOffVariantUssClassName");
					r_FcancelButtonOffVariantUssClassName.SetBelong(null);
				}
				return r_FcancelButtonOffVariantUssClassName;
			}
		}

		/// <summary>
		/// System.String popupVariantUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FpopupVariantUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFpopupVariantUssClassName
		{
			get
			{
				if(r_FpopupVariantUssClassName == null)
				{
					r_FpopupVariantUssClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "popupVariantUssClassName");
					r_FpopupVariantUssClassName.SetBelong(null);
				}
				return r_FpopupVariantUssClassName;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEditor.UIElements.ToolbarSearchField), "ussClassName");
		...
		/// <summary>
		/// UnityEngine.UIElements.Button searchButton
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton r_PsearchButton;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RPsearchButton
		{
			get
			{
				if(r_PsearchButton == null)
				{
					r_PsearchButton = new(this, "searchButton", -1);
					r_PsearchButton.SetBelong(this.GetValue());
				}
				return r_PsearchButton;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.TextField textInputField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_PtextInputField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RPtextInputField
		{
			get
			{
				if(r_PtextInputField == null)
				{
					...
					r_PtextInputField.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSetValueWithoutNotify_String
		{
			get
			{
				if(r_MSetValueWithoutNotify_String == null)
				{
					r_MSetValueWithoutNotify_String = new(this, "SetValueWithoutNotify", 0, typeof(System.String));
					r_MSetValueWithoutNotify_String.SetBelong(this.GetValue());
				}
		...
		/// Void ClearTextField()
		/// </summary>
		protected RMethod r_MClearTextField;
		public virtual RMethod RMClearTextField
		{
			get
			{
				if(r_MClearTextField == null)
				{
					r_MClearTextField = new(this, "ClearTextField", 0);
					r_MClearTextField.SetBelong(this.GetValue());
				}
				return r_MClearTextField;
			}
		}

		/// <summary>
		/// Boolean FieldIsEmpty(System.String)
		/// </summary>
		protected RMethod r_MFieldIsEmpty_String;
		public virtual RMethod RMFieldIsEmpty_String
		{
			get
			{
				if(r_MFieldIsEmpty_String == null)
				{
					r_MFieldIsEmpty_String = new(this, "FieldIsEmpty", 0, typeof(System.String));
					r_MFieldIsEmpty_String.SetBelong(this.GetValue());
				}
				return r_MFieldIsEmpty_String;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Button get_searchButton()
		/// </summary>
		protected RMethod r_Mget_searchButton;
		public virtual RMethod RMget_searchButton
		{
			get
			{
				if(r_Mget_searchButton == null)
				{
					r_Mget_searchButton = new(this, "get_searchButton", 0);
					r_Mget_searchButton.SetBelong(this.GetValue());
				}
				return r_Mget_searchButton;
			}
		}
		...
		public virtual RMethod RMget_value
		{
			get
			{
				if(r_Mget_value == null)
				{
					...
					r_Mget_value.SetBelong(this.GetValue());
				}
				return r_Mget_value;
			}
		}
		...
		/// </summary>
		protected RMethod r_Mset_value_String;
		public virtual RMethod RMset_value_String
		{
			get
			{
				if(r_Mset_value_String == null)
				{
					r_Mset_value_String = new(this, "set_value", 0, typeof(System.String));
					r_Mset_value_String.SetBelong(this.GetValue());
				}
				return r_Mset_value_String;
			}
		}
        ...
        public virtual void ClearTextField()
        {
            ...
            var ___result = RMClearTextField.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean FieldIsEmpty(System.String @fieldValue)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@fieldValue};
            var ___result = RMFieldIsEmpty_String.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual UnityEngine.UIElements.Button get_searchButton()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMget_searchButton.Invoke(___genericsType, ___parameters);
        ...
        public virtual void set_value(System.String @value)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RMset_value_String.Invoke(___genericsType, ___parameters);
