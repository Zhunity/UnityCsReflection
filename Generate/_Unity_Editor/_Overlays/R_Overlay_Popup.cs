    ...
    public partial class ROverlayPopup : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_OutsideToolbar
		{
			get
			{
				...
				{
					r_Fk_OutsideToolbar = new(Type, "k_OutsideToolbar");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_FromHorizontal
		{
			get
			{
				...
				{
					r_Fk_FromHorizontal = new(Type, "k_FromHorizontal");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_FromVertical
		{
			get
			{
				...
				{
					r_Fk_FromVertical = new(Type, "k_FromVertical");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_Clamped
		{
			get
			{
				...
				{
					r_Fk_Clamped = new(Type, "k_Clamped");
				}
				return r_Fk_Clamped;
			}
		}
