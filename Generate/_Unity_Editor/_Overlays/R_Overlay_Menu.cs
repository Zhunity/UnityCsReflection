...
{
	/// <summary>
	/// UnityEditor.Overlays.OverlayMenu
	/// </summary>
    public partial class ROverlayMenu : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RBoolean r_Fs_KeepAlive;
		public static Hvak.Editor.Refleaction.RSystem.RBoolean RFs_KeepAlive
		{
			get
			{
				if(r_Fs_KeepAlive == null)
				{
					r_Fs_KeepAlive = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_KeepAlive");
					r_Fs_KeepAlive.SetBelong(null);
				}
				return r_Fs_KeepAlive;
			}
		}

		/// <summary>
		/// System.Action s_DelayUntilCanHide
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RAction r_Fs_DelayUntilCanHide;
		public static Hvak.Editor.Refleaction.RSystem.RAction RFs_DelayUntilCanHide
		{
			get
			{
				if(r_Fs_DelayUntilCanHide == null)
				{
					r_Fs_DelayUntilCanHide = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_DelayUntilCanHide");
					r_Fs_DelayUntilCanHide.SetBelong(null);
				}
				return r_Fs_DelayUntilCanHide;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFk_UxmlPath
		{
			get
			{
				...
				{
					r_Fk_UxmlPath = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "k_UxmlPath");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "ussClassName");
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualTreeAsset RFs_TreeAsset
		{
			get
			{
				...
				{
					r_Fs_TreeAsset = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "s_TreeAsset");
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RScrollView RFm_ListRoot
		{
			get
			{
				if(r_Fm_ListRoot == null)
				{
					r_Fm_ListRoot = new(this, "m_ListRoot");
					r_Fm_ListRoot.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle RFm_Toggle
		{
			get
			{
				if(r_Fm_Toggle == null)
				{
					r_Fm_Toggle = new(this, "m_Toggle");
					r_Fm_Toggle.SetBelong(this.GetValue());
				}
				return r_Fm_Toggle;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.TextElement m_DropdownText
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextElement r_Fm_DropdownText;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextElement RFm_DropdownText
		{
			get
			{
				if(r_Fm_DropdownText == null)
				{
					r_Fm_DropdownText = new(this, "m_DropdownText");
					r_Fm_DropdownText.SetBelong(this.GetValue());
				}
				return r_Fm_DropdownText;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.Button m_Dropdown
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton r_Fm_Dropdown;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RButton RFm_Dropdown
		{
			get
			{
				if(r_Fm_Dropdown == null)
				{
					r_Fm_Dropdown = new(this, "m_Dropdown");
					r_Fm_Dropdown.SetBelong(this.GetValue());
				}
				return r_Fm_Dropdown;
			}
		}

		/// <summary>
		/// UnityEditor.Overlays.OverlayCanvas m_Canvas
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEditor.ROverlays.ROverlayCanvas r_Fm_Canvas;
		public virtual Hvak.Editor.Refleaction.RUnityEditor.ROverlays.ROverlayCanvas RFm_Canvas
		{
			get
			{
				if(r_Fm_Canvas == null)
				{
					...
					r_Fm_Canvas.SetBelong(this.GetValue());
				}
				return r_Fm_Canvas;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleFloat RFm_InitialMinWidth
		{
			get
			{
				if(r_Fm_InitialMinWidth == null)
				{
					...
					r_Fm_InitialMinWidth.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleFloat RFm_InitialMinHeight
		{
			get
			{
				if(r_Fm_InitialMinHeight == null)
				{
					...
					r_Fm_InitialMinHeight.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleFloat RFm_InitialMaxWidth
		{
			get
			{
				if(r_Fm_InitialMaxWidth == null)
				{
					...
					r_Fm_InitialMaxWidth.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleFloat RFm_InitialMaxHeight
		{
			get
			{
				if(r_Fm_InitialMaxHeight == null)
				{
					...
					r_Fm_InitialMaxHeight.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPisShown
		{
			get
			{
				if(r_PisShown == null)
				{
					...
					r_PisShown.SetBelong(this.GetValue());
				}
				return r_PisShown;
			}
		}
		...
		public virtual RMethod RMOnOverlayEnabledChanged_Boolean
		{
			get
			{
				if(r_MOnOverlayEnabledChanged_Boolean == null)
				{
					r_MOnOverlayEnabledChanged_Boolean = new(this, "OnOverlayEnabledChanged", 0, typeof(System.Boolean));
					r_MOnOverlayEnabledChanged_Boolean.SetBelong(this.GetValue());
				}
				return r_MOnOverlayEnabledChanged_Boolean;
			}
		}

		/// <summary>
		/// Void CheckIfShouldHide(UnityEngine.UIElements.VisualElement)
		/// </summary>
		protected RMethod r_MCheckIfShouldHide_VisualElement;
		public virtual RMethod RMCheckIfShouldHide_VisualElement
		{
			get
			{
				if(r_MCheckIfShouldHide_VisualElement == null)
				{
					r_MCheckIfShouldHide_VisualElement = new(this, "CheckIfShouldHide", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_MCheckIfShouldHide_VisualElement.SetBelong(this.GetValue());
				}
				return r_MCheckIfShouldHide_VisualElement;
			}
		}
		...
		/// </summary>
		protected RMethod r_MDropdownOnClicked;
		public virtual RMethod RMDropdownOnClicked
		{
			get
			{
				if(r_MDropdownOnClicked == null)
				{
					r_MDropdownOnClicked = new(this, "DropdownOnClicked", 0);
					r_MDropdownOnClicked.SetBelong(this.GetValue());
				}
				return r_MDropdownOnClicked;
			}
		}
		...
		public virtual RMethod RMRebuildMenu_IEnumerable_d_Overlay_p_
		{
			get
			{
				...
				{
					r_MRebuildMenu_IEnumerable_d_Overlay_p_ = new(this, "RebuildMenu", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType(typeof(UnityEditor.Overlays.Overlay)));
					r_MRebuildMenu_IEnumerable_d_Overlay_p_.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMShow_IEnumerable_d_Overlay_p__Boolean
		{
			get
			{
				...
				{
					r_MShow_IEnumerable_d_Overlay_p__Boolean = new(this, "Show", 0, typeof(System.Collections.Generic.IEnumerable<>).MakeGenericType(typeof(UnityEditor.Overlays.Overlay)), typeof(System.Boolean));
					r_MShow_IEnumerable_d_Overlay_p__Boolean.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single
		{
			get
			{
				if(r_MResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single == null)
				{
					...
					r_MResolveSizeLimits_Out_Single_Out_Single_Out_Single_Out_Single.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMAdjustToParentSize
		{
			get
			{
				if(r_MAdjustToParentSize == null)
				{
					...
					r_MAdjustToParentSize.SetBelong(this.GetValue());
				}
		...
		/// Void Hide()
		/// </summary>
		protected RMethod r_MHide;
		public virtual RMethod RMHide
		{
			get
			{
				if(r_MHide == null)
				{
					r_MHide = new(this, "Hide", 0);
					r_MHide.SetBelong(this.GetValue());
				}
				return r_MHide;
			}
		}
		...
		/// </summary>
		protected static RMethod r_MSetKeepAlive_Boolean;
		public static RMethod RMSetKeepAlive_Boolean
		{
			get
			{
				if(r_MSetKeepAlive_Boolean == null)
				{
					r_MSetKeepAlive_Boolean = new( ReflectionUtils.GetType("UnityEditor.Overlays.OverlayMenu"), "SetKeepAlive", 0, typeof(System.Boolean));
					r_MSetKeepAlive_Boolean.SetBelong(null);
				}
				return r_MSetKeepAlive_Boolean;
			}
		}
        ...
        public virtual void OnOverlayEnabledChanged(System.Boolean @visibility)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@visibility};
            var ___result = RMOnOverlayEnabledChanged_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void CheckIfShouldHide(UnityEngine.UIElements.VisualElement @focused)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@focused};
            var ___result = RMCheckIfShouldHide_VisualElement.Invoke(___genericsType, ___parameters);

            
        }


        public virtual void DropdownOnClicked()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMDropdownOnClicked.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ResolveSizeLimits(out System.Single @minWidth, out System.Single @minHeight, out System.Single @maxWidth, out System.Single @maxHeight)
        {
			...
			@minWidth = (System.Single)___parameters[0];
			@minHeight = (System.Single)___parameters[1];
			@maxWidth = (System.Single)___parameters[2];
			@maxHeight = (System.Single)___parameters[3];
        ...
        public virtual void Hide()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMHide.Invoke(___genericsType, ___parameters);

            
        }


        public static void SetKeepAlive(System.Boolean @keepAlive)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@keepAlive};
            var ___result = RMSetKeepAlive_Boolean.Invoke(___genericsType, ___parameters);
