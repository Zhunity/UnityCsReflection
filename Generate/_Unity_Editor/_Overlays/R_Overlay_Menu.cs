    ...
    public partial class ROverlayMenu : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RBoolean RFs_KeepAlive
		{
			get
			{
				...
				{
					r_Fs_KeepAlive = new(Type, "s_KeepAlive");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RAction RFs_DelayUntilCanHide
		{
			get
			{
				...
				{
					r_Fs_DelayUntilCanHide = new(Type, "s_DelayUntilCanHide");
				}
		...
		public static RMethod RMSetKeepAlive_Boolean
		{
			get
			{
				...
				{
					r_MSetKeepAlive_Boolean = new(Type, "SetKeepAlive", 0, typeof(System.Boolean));
				}
