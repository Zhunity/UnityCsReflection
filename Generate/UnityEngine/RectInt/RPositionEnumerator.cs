...
{public partial class RRectInt
{
    ...
    public partial class RPositionEnumerator : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r_F_min;
		public virtual RUnityEngine.RVector2Int RF_min
		{
			get
			{
				if(r_F_min == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r_F_max;
		public virtual RUnityEngine.RVector2Int RF_max
		{
			get
			{
				if(r_F_max == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r_F_current;
		public virtual RUnityEngine.RVector2Int RF_current
		{
			get
			{
				if(r_F_current == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r_PCurrent;
		public virtual RUnityEngine.RVector2Int RPCurrent
		{
			get
			{
				if(r_PCurrent == null)
        ...
        public virtual RUnityEngine.RRectInt.RPositionEnumerator GetEnumerator()
        {
            ...
            return new RUnityEngine.RRectInt.RPositionEnumerator(___result);
        }
