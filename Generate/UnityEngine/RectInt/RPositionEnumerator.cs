...
{public partial class RRectInt
{
    ...
    public partial class RPositionEnumerator : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r__min;
		public virtual RUnityEngine.RVector2Int R_min
		{
			get
			{
				if(r__min == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r__max;
		public virtual RUnityEngine.RVector2Int R_max
		{
			get
			{
				if(r__max == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r__current;
		public virtual RUnityEngine.RVector2Int R_current
		{
			get
			{
				if(r__current == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2Int r_Current;
		public virtual RUnityEngine.RVector2Int RCurrent
		{
			get
			{
				if(r_Current == null)
