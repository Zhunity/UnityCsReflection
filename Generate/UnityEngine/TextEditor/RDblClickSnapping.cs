...
{public partial class RTextEditor
{
    ...
    public partial class RDblClickSnapping : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RTextEditor.RDblClickSnapping r_FWORDS;
		public static RUnityEngine.RTextEditor.RDblClickSnapping RFWORDS
		{
			get
			{
				if(r_FWORDS == null)
				{
					r_FWORDS = new( ReflectionUtils.GetType("UnityEngine.TextEditor+DblClickSnapping"), "WORDS");
					r_FWORDS.SetBelong(null);
				}
				return r_FWORDS;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RTextEditor.RDblClickSnapping r_FPARAGRAPHS;
		public static RUnityEngine.RTextEditor.RDblClickSnapping RFPARAGRAPHS
		{
			get
			{
				if(r_FPARAGRAPHS == null)
				{
					r_FPARAGRAPHS = new( ReflectionUtils.GetType("UnityEngine.TextEditor+DblClickSnapping"), "PARAGRAPHS");
					r_FPARAGRAPHS.SetBelong(null);
				}
				return r_FPARAGRAPHS;
			}
		}
