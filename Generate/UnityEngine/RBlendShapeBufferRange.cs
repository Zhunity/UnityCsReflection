...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RBlendShapeBufferRange : RMember //
    {
		...
		/// </summary>
		protected RSystem.RUInt32 r_Fm_StartIndex;
		public virtual RSystem.RUInt32 RFm_StartIndex
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RUInt32 r_Fm_EndIndex;
		public virtual RSystem.RUInt32 RFm_EndIndex
		{
			get
			{
		...
		/// UInt32 startIndex
		/// </summary>
		protected RSystem.RUInt32 r_PstartIndex;
		public virtual RSystem.RUInt32 RPstartIndex
		{
			get
			{
		...
		/// UInt32 endIndex
		/// </summary>
		protected RSystem.RUInt32 r_PendIndex;
		public virtual RSystem.RUInt32 RPendIndex
		{
			get
			{
				if(r_PendIndex == null)
