...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RReflectionProbe : RMember //
    {
		...
		/// System.Action`2[UnityEngine.ReflectionProbe,UnityEngine.ReflectionProbe+ReflectionProbeEvent] reflectionProbeChanged
		/// </summary>
		protected static RSystem.RAction<RUnityEngine.RReflectionProbe, RUnityEngine.RReflectionProbe.RReflectionProbeEvent> r_FreflectionProbeChanged;
		public static RSystem.RAction<RUnityEngine.RReflectionProbe, RUnityEngine.RReflectionProbe.RReflectionProbeEvent> RFreflectionProbeChanged
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RDictionary<RSystem.RInt32, RSystem.RAction<RUnityEngine.RTexture>> r_FregisteredDefaultReflectionSetActions;
		public static RSystem.RCollections.RGeneric.RDictionary<RSystem.RInt32, RSystem.RAction<RUnityEngine.RTexture>> RFregisteredDefaultReflectionSetActions
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RCollections.RGeneric.RList<RSystem.RAction<RUnityEngine.RTexture>> r_FregisteredDefaultReflectionTextureActions;
		public static RSystem.RCollections.RGeneric.RList<RSystem.RAction<RUnityEngine.RTexture>> RFregisteredDefaultReflectionTextureActions
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRendering.RReflectionProbeType r_Ptype;
		public virtual RUnityEngine.RRendering.RReflectionProbeType RPtype
		{
			get
			{
				if(r_Ptype == null)
		...
		/// Single intensity
		/// </summary>
		protected RSystem.RSingle r_Pintensity;
		public virtual RSystem.RSingle RPintensity
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PrenderDynamicObjects;
		public virtual RSystem.RBoolean RPrenderDynamicObjects
		{
			get
			{
		...
		/// Int32 resolution
		/// </summary>
		protected RSystem.RInt32 r_Presolution;
		public virtual RSystem.RInt32 RPresolution
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRendering.RReflectionProbeClearFlags r_PclearFlags;
		public virtual RUnityEngine.RRendering.RReflectionProbeClearFlags RPclearFlags
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RSingle r_PblendDistance;
		public virtual RSystem.RSingle RPblendDistance
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PboxProjection;
		public virtual RSystem.RBoolean RPboxProjection
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRendering.RReflectionProbeMode r_Pmode;
		public virtual RUnityEngine.RRendering.RReflectionProbeMode RPmode
		{
			get
			{
				if(r_Pmode == null)
		...
		/// Int32 importance
		/// </summary>
		protected RSystem.RInt32 r_Pimportance;
		public virtual RSystem.RInt32 RPimportance
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRendering.RReflectionProbeRefreshMode r_PrefreshMode;
		public virtual RUnityEngine.RRendering.RReflectionProbeRefreshMode RPrefreshMode
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode r_PtimeSlicingMode;
		public virtual RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode RPtimeSlicingMode
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RTexture r_PbakedTexture;
		public virtual RUnityEngine.RTexture RPbakedTexture
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RTexture r_PcustomBakedTexture;
		public virtual RUnityEngine.RTexture RPcustomBakedTexture
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RRenderTexture r_PrealtimeTexture;
		public virtual RUnityEngine.RRenderTexture RPrealtimeTexture
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RTexture r_Ptexture;
		public virtual RUnityEngine.RTexture RPtexture
		{
			get
			{
				if(r_Ptexture == null)
		...
		/// </summary>
		protected RUnityEngine.RVector4 r_PtextureHDRDecodeValues;
		public virtual RUnityEngine.RVector4 RPtextureHDRDecodeValues
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_PminBakedCubemapResolution;
		public static RSystem.RInt32 RPminBakedCubemapResolution
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_PmaxBakedCubemapResolution;
		public static RSystem.RInt32 RPmaxBakedCubemapResolution
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RVector4 r_PdefaultTextureHDRDecodeValues;
		public static RUnityEngine.RVector4 RPdefaultTextureHDRDecodeValues
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RTexture r_PdefaultTexture;
		public static RUnityEngine.RTexture RPdefaultTexture
		{
			get
			{
        ...
        public static void CallReflectionProbeEvent(UnityEngine.ReflectionProbe @probe, RUnityEngine.RReflectionProbe.RReflectionProbeEvent @probeEvent)
        {
