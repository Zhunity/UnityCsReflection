...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RCoroutine : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_RReleaseCoroutine_IntPtr;
		public static RMethod RReleaseCoroutine_IntPtr
		{
			get
			{
				if(r_RReleaseCoroutine_IntPtr == null)
				{
					r_RReleaseCoroutine_IntPtr = new(typeof(UnityEngine.Coroutine), "ReleaseCoroutine", 0, typeof(System.IntPtr));
					r_RReleaseCoroutine_IntPtr.SetBelong(null);
				}
				return r_RReleaseCoroutine_IntPtr;
			}
		}
