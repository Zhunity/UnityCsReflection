...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RCoroutine : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_ReleaseCoroutine_IntPtr;
		public static RMethod RReleaseCoroutine_IntPtr
		{
			get
			{
				if(r_ReleaseCoroutine_IntPtr == null)
				{
					r_ReleaseCoroutine_IntPtr = new(typeof(UnityEngine.Coroutine), "ReleaseCoroutine", 0, typeof(System.IntPtr));
					r_ReleaseCoroutine_IntPtr.SetBelong(null);
				}
				return r_ReleaseCoroutine_IntPtr;
			}
		}
        ...
        public static void ReleaseCoroutine(System.IntPtr  @ptr)
        {
            ...
            var ___result = RReleaseCoroutine_IntPtr.Invoke(___genericsType, ___parameters);
