...
{public partial class RBoundsInt
{
    ...
    public partial class RPositionEnumerator : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector3Int r_F_min;
		public virtual RUnityEngine.RVector3Int RF_min
		{
			get
			{
				if(r_F_min == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3Int r_F_max;
		public virtual RUnityEngine.RVector3Int RF_max
		{
			get
			{
				if(r_F_max == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3Int r_F_current;
		public virtual RUnityEngine.RVector3Int RF_current
		{
			get
			{
				if(r_F_current == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3Int r_PCurrent;
		public virtual RUnityEngine.RVector3Int RPCurrent
		{
			get
			{
				if(r_PCurrent == null)
