...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RAsyncRequestNativeArrayData : RMember //
    {
		...
		/// </summary>
		protected RFieldPointer<RField> r_FnativeArrayBuffer;
		public virtual RFieldPointer<RField> RFnativeArrayBuffer
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_FlengthInBytes;
		public virtual RSystem.RInt64 RFlengthInBytes
		{
			get
			{
		...
		/// </summary>
		protected RUnity.RCollections.RLowLevel.RUnsafe.RAtomicSafetyHandle r_FsafetyHandle;
		public virtual RUnity.RCollections.RLowLevel.RUnsafe.RAtomicSafetyHandle RFsafetyHandle
		{
			get
			{
