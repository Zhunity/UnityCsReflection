...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RReflectionProbeBlendInfo : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RReflectionProbe r_Fprobe;
		public virtual RUnityEngine.RReflectionProbe RFprobe
		{
			get
			{
				if(r_Fprobe == null)
				{
					r_Fprobe = new(this, "probe");
					r_Fprobe.SetBelong(this.instance);
				}
				return r_Fprobe;
			}
		}
		...
		/// </summary>
		protected RSystem.RSingle r_Fweight;
		public virtual RSystem.RSingle RFweight
		{
			get
			{
				if(r_Fweight == null)
				{
					r_Fweight = new(this, "weight");
					r_Fweight.SetBelong(this.instance);
				}
				return r_Fweight;
			}
		}
