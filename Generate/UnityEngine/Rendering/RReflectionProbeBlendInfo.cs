...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RReflectionProbeBlendInfo : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RReflectionProbe r_probe;
		public virtual RUnityEngine.RReflectionProbe Rprobe
		{
			get
			{
				if(r_probe == null)
				{
					r_probe = new(this, "probe");
					r_probe.SetBelong(this.instance);
				}
				return r_probe;
			}
		}
