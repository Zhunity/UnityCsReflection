...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RCameraLateLatchMatrixType : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RCameraLateLatchMatrixType r_FView;
		public static RUnityEngine.RRendering.RCameraLateLatchMatrixType RFView
		{
			get
			{
				if(r_FView == null)
				{
					r_FView = new(typeof(UnityEngine.Rendering.CameraLateLatchMatrixType), "View");
					r_FView.SetBelong(null);
				}
				return r_FView;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RCameraLateLatchMatrixType r_FInverseView;
		public static RUnityEngine.RRendering.RCameraLateLatchMatrixType RFInverseView
		{
			get
			{
				if(r_FInverseView == null)
				{
					r_FInverseView = new(typeof(UnityEngine.Rendering.CameraLateLatchMatrixType), "InverseView");
					r_FInverseView.SetBelong(null);
				}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RCameraLateLatchMatrixType r_FViewProjection;
		public static RUnityEngine.RRendering.RCameraLateLatchMatrixType RFViewProjection
		{
			get
			{
				if(r_FViewProjection == null)
				{
					r_FViewProjection = new(typeof(UnityEngine.Rendering.CameraLateLatchMatrixType), "ViewProjection");
					r_FViewProjection.SetBelong(null);
				}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RCameraLateLatchMatrixType r_FInverseViewProjection;
		public static RUnityEngine.RRendering.RCameraLateLatchMatrixType RFInverseViewProjection
		{
			get
			{
				if(r_FInverseViewProjection == null)
				{
					r_FInverseViewProjection = new(typeof(UnityEngine.Rendering.CameraLateLatchMatrixType), "InverseViewProjection");
					r_FInverseViewProjection.SetBelong(null);
				}
