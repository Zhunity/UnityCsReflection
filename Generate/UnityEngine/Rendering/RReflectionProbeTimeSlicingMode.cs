...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RReflectionProbeTimeSlicingMode : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode r_FAllFacesAtOnce;
		public static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode RFAllFacesAtOnce
		{
			get
			{
				if(r_FAllFacesAtOnce == null)
				{
					r_FAllFacesAtOnce = new(typeof(UnityEngine.Rendering.ReflectionProbeTimeSlicingMode), "AllFacesAtOnce");
					r_FAllFacesAtOnce.SetBelong(null);
				}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode r_FIndividualFaces;
		public static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode RFIndividualFaces
		{
			get
			{
				if(r_FIndividualFaces == null)
				{
					r_FIndividualFaces = new(typeof(UnityEngine.Rendering.ReflectionProbeTimeSlicingMode), "IndividualFaces");
					r_FIndividualFaces.SetBelong(null);
				}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode r_FNoTimeSlicing;
		public static RUnityEngine.RRendering.RReflectionProbeTimeSlicingMode RFNoTimeSlicing
		{
			get
			{
				if(r_FNoTimeSlicing == null)
				{
					r_FNoTimeSlicing = new(typeof(UnityEngine.Rendering.ReflectionProbeTimeSlicingMode), "NoTimeSlicing");
					r_FNoTimeSlicing.SetBelong(null);
				}
