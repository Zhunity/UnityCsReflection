...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RShaderTagId : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RRendering.RShaderTagId r_Fnone;
		public static RUnityEngine.RRendering.RShaderTagId RFnone
		{
			get
			{
				if(r_Fnone == null)
		...
		public virtual RMethod RMEquals_ShaderTagId
		{
			get
			{
				if(r_MEquals_ShaderTagId == null)
				{
					...
					r_MEquals_ShaderTagId.SetBelong(this.instance);
				}
