...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class RCoreCameraValues : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_FfilterMode;
		public virtual RSystem.RInt32 RFfilterMode
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RUInt32 r_FcullingMask;
		public virtual RSystem.RUInt32 RFcullingMask
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_FinstanceID;
		public virtual RSystem.RInt32 RFinstanceID
		{
			get
			{
