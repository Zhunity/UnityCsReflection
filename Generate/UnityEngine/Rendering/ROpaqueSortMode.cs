...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RRendering
{
    ...
    public partial class ROpaqueSortMode : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RRendering.ROpaqueSortMode r_FDefault;
		public static RUnityEngine.RRendering.ROpaqueSortMode RFDefault
		{
			get
			{
				if(r_FDefault == null)
				{
					r_FDefault = new(typeof(UnityEngine.Rendering.OpaqueSortMode), "Default");
		...
		/// </summary>
		protected static RUnityEngine.RRendering.ROpaqueSortMode r_FFrontToBack;
		public static RUnityEngine.RRendering.ROpaqueSortMode RFFrontToBack
		{
			get
			{
				if(r_FFrontToBack == null)
				{
					r_FFrontToBack = new(typeof(UnityEngine.Rendering.OpaqueSortMode), "FrontToBack");
					r_FFrontToBack.SetBelong(null);
				}
				return r_FFrontToBack;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RRendering.ROpaqueSortMode r_FNoDistanceSort;
		public static RUnityEngine.RRendering.ROpaqueSortMode RFNoDistanceSort
		{
			get
			{
				if(r_FNoDistanceSort == null)
				{
					r_FNoDistanceSort = new(typeof(UnityEngine.Rendering.OpaqueSortMode), "NoDistanceSort");
					r_FNoDistanceSort.SetBelong(null);
				}
				return r_FNoDistanceSort;
			}
		}
