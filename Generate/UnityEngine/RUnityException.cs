...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RUnityException : RMember //
    {
		...
		/// System.Int32 Result
		/// </summary>
		protected static RSystem.RInt32 r_Result;
		public static RSystem.RInt32 RResult
		{
			get
			{
				if(r_Result == null)
				{
					r_Result = new(typeof(UnityEngine.UnityException), "Result");
					r_Result.SetBelong(null);
				}
				return r_Result;
			}
		}
		...
		/// </summary>
		protected RSystem.RString r_unityStackTrace;
		public virtual RSystem.RString RunityStackTrace
		{
			get
			{
				if(r_unityStackTrace == null)
				{
					r_unityStackTrace = new(this, "unityStackTrace");
					r_unityStackTrace.SetBelong(this.instance);
				}
				return r_unityStackTrace;
			}
		}
