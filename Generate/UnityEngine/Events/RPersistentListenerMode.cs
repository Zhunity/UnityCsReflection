...
namespace SMFrame.Editor.Refleaction.RUnityEngine.REvents
{
    ...
    public partial class RPersistentListenerMode : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FEventDefined;
		public static RUnityEngine.REvents.RPersistentListenerMode RFEventDefined
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FVoid;
		public static RUnityEngine.REvents.RPersistentListenerMode RFVoid
		{
			get
			{
				if(r_FVoid == null)
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FObject;
		public static RUnityEngine.REvents.RPersistentListenerMode RFObject
		{
			get
			{
				if(r_FObject == null)
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FInt;
		public static RUnityEngine.REvents.RPersistentListenerMode RFInt
		{
			get
			{
				if(r_FInt == null)
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FFloat;
		public static RUnityEngine.REvents.RPersistentListenerMode RFFloat
		{
			get
			{
				if(r_FFloat == null)
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FString;
		public static RUnityEngine.REvents.RPersistentListenerMode RFString
		{
			get
			{
				if(r_FString == null)
		...
		/// </summary>
		protected static RUnityEngine.REvents.RPersistentListenerMode r_FBool;
		public static RUnityEngine.REvents.RPersistentListenerMode RFBool
		{
			get
			{
				if(r_FBool == null)
