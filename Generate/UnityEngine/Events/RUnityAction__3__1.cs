    ...
    public partial class RUnityAction<T0> : RMember //
    {
		...
		public virtual RMethod RInvoke_T0
		{
			get
			{
				if(r_Invoke_T0 == null)
				{
					r_Invoke_T0 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_Invoke_T0.SetBelong(this.instance);
				}
				return r_Invoke_T0;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T0_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T0_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T0_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T0_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T0_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T0_AsyncCallback_Object;
			}
		}
