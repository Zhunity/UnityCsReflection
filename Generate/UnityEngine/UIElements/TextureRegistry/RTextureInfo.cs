...
{public partial class RTextureRegistry
{
    ...
    public partial class RTextureInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RBoolean r_Fdynamic;
		public virtual RSystem.RBoolean RFdynamic
		{
			get
			{
				if(r_Fdynamic == null)
				{
					...
					r_Fdynamic.SetBelong(this.instance);
				}
				return r_Fdynamic;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_FrefCount;
		public virtual RSystem.RInt32 RFrefCount
		{
			get
			{
				if(r_FrefCount == null)
				{
					...
					r_FrefCount.SetBelong(this.instance);
				}
				return r_FrefCount;
			}
		}
