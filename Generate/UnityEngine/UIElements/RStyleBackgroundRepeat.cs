...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleBackgroundRepeat : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundRepeat r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RBackgroundRepeat RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundRepeat r_Pvalue;
		public virtual RUnityEngine.RUIElements.RBackgroundRepeat RPvalue
		{
			get
			{
				if(r_Pvalue == null)
