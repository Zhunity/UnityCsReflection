...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleList<T> : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_op_Equality_StyleList_d_T_p__StyleList_d_T_p_;
		public static RMethod Rop_Equality_StyleList_d_T_p__StyleList_d_T_p_
		{
			get
			{
				if(r_op_Equality_StyleList_d_T_p__StyleList_d_T_p_ == null)
				{
					r_op_Equality_StyleList_d_T_p__StyleList_d_T_p_ = new(typeof(UnityEngine.UIElements.StyleList<>), "op_Equality", 0, typeof(UnityEngine.UIElements.StyleList<>), typeof(UnityEngine.UIElements.StyleList<>));
					r_op_Equality_StyleList_d_T_p__StyleList_d_T_p_.SetBelong(null);
				}
				return r_op_Equality_StyleList_d_T_p__StyleList_d_T_p_;
			}
		}
		...
		/// </summary>
		protected static RMethod r_op_Inequality_StyleList_d_T_p__StyleList_d_T_p_;
		public static RMethod Rop_Inequality_StyleList_d_T_p__StyleList_d_T_p_
		{
			get
			{
				if(r_op_Inequality_StyleList_d_T_p__StyleList_d_T_p_ == null)
				{
					r_op_Inequality_StyleList_d_T_p__StyleList_d_T_p_ = new(typeof(UnityEngine.UIElements.StyleList<>), "op_Inequality", 0, typeof(UnityEngine.UIElements.StyleList<>), typeof(UnityEngine.UIElements.StyleList<>));
					r_op_Inequality_StyleList_d_T_p__StyleList_d_T_p_.SetBelong(null);
				}
				return r_op_Inequality_StyleList_d_T_p__StyleList_d_T_p_;
			}
		}
		...
		public static RMethod Rop_Implicit_StyleKeyword
		{
			get
			{
				...
				{
					r_op_Implicit_StyleKeyword = new(typeof(UnityEngine.UIElements.StyleList<>), "op_Implicit", 0, typeof(UnityEngine.UIElements.StyleKeyword));
		...
		/// </summary>
		protected static RMethod r_op_Implicit_List_d_T_p_;
		public static RMethod Rop_Implicit_List_d_T_p_
		{
			get
			{
				if(r_op_Implicit_List_d_T_p_ == null)
				{
					r_op_Implicit_List_d_T_p_ = new(typeof(UnityEngine.UIElements.StyleList<>), "op_Implicit", 0, typeof(System.Collections.Generic.List<>).MakeGenericType(Type.MakeGenericMethodParameter(0)));
					r_op_Implicit_List_d_T_p_.SetBelong(null);
				}
				return r_op_Implicit_List_d_T_p_;
			}
		}
		...
		/// </summary>
		protected RMethod r_Equals_StyleList_d_T_p_;
		public virtual RMethod REquals_StyleList_d_T_p_
		{
			get
			{
				if(r_Equals_StyleList_d_T_p_ == null)
				{
					r_Equals_StyleList_d_T_p_ = new(this, "Equals", 0, typeof(UnityEngine.UIElements.StyleList<>));
					r_Equals_StyleList_d_T_p_.SetBelong(this.instance);
				}
				return r_Equals_StyleList_d_T_p_;
			}
		}
