    ...
    public partial class RMouseMoveEvent : RMember //
    {
		...
		public static RMethod RGetPooled_Event
		{
			get
			{
				...
				{
					r_RGetPooled_Event = new(typeof(UnityEngine.UIElements.MouseMoveEvent), "GetPooled", 0, typeof(UnityEngine.Event));
		...
		public static RMethod RGetPooled_PointerMoveEvent
		{
			get
			{
				...
				{
					r_RGetPooled_PointerMoveEvent = new(typeof(UnityEngine.UIElements.MouseMoveEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerMoveEvent));
