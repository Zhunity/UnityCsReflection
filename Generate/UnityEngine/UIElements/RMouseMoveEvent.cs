    ...
    public partial class RMouseMoveEvent : RMember //
    {
		...
		public static RMethod RGetPooled_Event
		{
			get
			{
				...
				{
					r_GetPooled_Event = new(typeof(UnityEngine.UIElements.MouseMoveEvent), "GetPooled", 0, typeof(UnityEngine.Event));
		...
		public static RMethod RGetPooled_PointerMoveEvent
		{
			get
			{
				...
				{
					r_GetPooled_PointerMoveEvent = new(typeof(UnityEngine.UIElements.MouseMoveEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerMoveEvent));
