...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleBackgroundSize : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundSize r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RBackgroundSize RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundSize r_Pvalue;
		public virtual RUnityEngine.RUIElements.RBackgroundSize RPvalue
		{
			get
			{
				if(r_Pvalue == null)
