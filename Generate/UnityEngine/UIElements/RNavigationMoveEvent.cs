...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RNavigationMoveEvent : RMember //
    {
		...
		/// </summary>
		protected RField r___0__direction__1__k__BackingField;
		public virtual RField R__0__direction__1__k__BackingField
		{
			get
			{
				if(r___0__direction__1__k__BackingField == null)
				{
					r___0__direction__1__k__BackingField = new(this, "<direction>k__BackingField");
					r___0__direction__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__direction__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RVector2 r___0__move__1__k__BackingField;
		public virtual RUnityEngine.RVector2 R__0__move__1__k__BackingField
		{
			get
			{
				if(r___0__move__1__k__BackingField == null)
				{
					r___0__move__1__k__BackingField = new(this, "<move>k__BackingField");
					r___0__move__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__move__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected static RMethod r_DetermineMoveDirection_Single_Single_Single;
		public static RMethod RDetermineMoveDirection_Single_Single_Single
		{
			get
			{
				if(r_DetermineMoveDirection_Single_Single_Single == null)
				{
					r_DetermineMoveDirection_Single_Single_Single = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "DetermineMoveDirection", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_DetermineMoveDirection_Single_Single_Single.SetBelong(null);
				}
				return r_DetermineMoveDirection_Single_Single_Single;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_Vector2_EventModifiers;
		public static RMethod RGetPooled_Vector2_EventModifiers
		{
			get
			{
				if(r_GetPooled_Vector2_EventModifiers == null)
				{
					r_GetPooled_Vector2_EventModifiers = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "GetPooled", 0, typeof(UnityEngine.Vector2), typeof(UnityEngine.EventModifiers));
					r_GetPooled_Vector2_EventModifiers.SetBelong(null);
				}
				return r_GetPooled_Vector2_EventModifiers;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_Vector2_NavigationDeviceType_EventModifiers;
		...
		/// </summary>
		protected static RMethod r_GetPooled_Direction_EventModifiers;
		...
		/// </summary>
		protected static RMethod r_GetPooled_Direction_NavigationDeviceType_EventModifiers;
