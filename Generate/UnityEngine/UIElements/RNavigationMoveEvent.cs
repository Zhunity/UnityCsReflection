...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RNavigationMoveEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_F__0__direction__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RF__0__direction__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_F__0__move__1__k__BackingField;
		public virtual RUnityEngine.RVector2 RF__0__move__1__k__BackingField
		{
			get
			{
		...
		/// Direction direction
		/// </summary>
		protected RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_Pdirection;
		public virtual RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RPdirection
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_Pmove;
		public virtual RUnityEngine.RVector2 RPmove
		{
			get
			{
				if(r_Pmove == null)
        ...
        public static RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection DetermineMoveDirection(System.Single @x, System.Single @y, System.Single @deadZone)
        {
            ...
            return new RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection(___result);
        }
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(UnityEngine.Vector2 @moveVector, RUnityEngine.RUIElements.RNavigationDeviceType @deviceType, UnityEngine.EventModifiers @modifiers)
        {
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection @direction, UnityEngine.EventModifiers @modifiers)
        {
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection @direction, RUnityEngine.RUIElements.RNavigationDeviceType @deviceType, UnityEngine.EventModifiers @modifiers)
        {
