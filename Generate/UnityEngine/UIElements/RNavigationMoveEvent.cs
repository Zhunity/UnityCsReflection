...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RNavigationMoveEvent : RMember //
    {
		...
		/// </summary>
		protected RField r___1__direction__2__k__BackingField;
		public virtual RField R__1__direction__2__k__BackingField
		{
			get
			{
				if(r___1__direction__2__k__BackingField == null)
				{
					r___1__direction__2__k__BackingField = new(this, "<direction>k__BackingField");
					r___1__direction__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__direction__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RVector2 r___1__move__2__k__BackingField;
		public virtual RUnityEngine.RVector2 R__1__move__2__k__BackingField
		{
			get
			{
				if(r___1__move__2__k__BackingField == null)
				{
					r___1__move__2__k__BackingField = new(this, "<move>k__BackingField");
					r___1__move__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__move__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_move;
		public virtual RUnityEngine.RVector2 Rmove
		{
			get
			{
				if(r_move == null)
				{
					r_move = new(this, "move", -1);
					r_move.SetBelong(this.instance);
				}
				return r_move;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RDetermineMoveDirection_Single_Single_Single;
		public static RMethod RDetermineMoveDirection_Single_Single_Single
		{
			get
			{
				if(r_RDetermineMoveDirection_Single_Single_Single == null)
				{
					r_RDetermineMoveDirection_Single_Single_Single = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "DetermineMoveDirection", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_RDetermineMoveDirection_Single_Single_Single.SetBelong(null);
				}
				return r_RDetermineMoveDirection_Single_Single_Single;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_Vector2_EventModifiers;
		public static RMethod RGetPooled_Vector2_EventModifiers
		{
			get
			{
				if(r_RGetPooled_Vector2_EventModifiers == null)
				{
					r_RGetPooled_Vector2_EventModifiers = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "GetPooled", 0, typeof(UnityEngine.Vector2), typeof(UnityEngine.EventModifiers));
					r_RGetPooled_Vector2_EventModifiers.SetBelong(null);
				}
				return r_RGetPooled_Vector2_EventModifiers;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_Vector2_NavigationDeviceType_EventModifiers;
		public static RMethod RGetPooled_Vector2_NavigationDeviceType_EventModifiers
		{
			get
			{
				if(r_RGetPooled_Vector2_NavigationDeviceType_EventModifiers == null)
				{
					r_RGetPooled_Vector2_NavigationDeviceType_EventModifiers = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "GetPooled", 0, typeof(UnityEngine.Vector2),  ReleactionUtils.GetType("UnityEngine.UIElements.NavigationDeviceType"), typeof(UnityEngine.EventModifiers));
					r_RGetPooled_Vector2_NavigationDeviceType_EventModifiers.SetBelong(null);
				}
				return r_RGetPooled_Vector2_NavigationDeviceType_EventModifiers;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_Direction_EventModifiers;
		public static RMethod RGetPooled_Direction_EventModifiers
		{
			get
			{
				if(r_RGetPooled_Direction_EventModifiers == null)
				{
					r_RGetPooled_Direction_EventModifiers = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "GetPooled", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.NavigationMoveEvent+Direction"), typeof(UnityEngine.EventModifiers));
					r_RGetPooled_Direction_EventModifiers.SetBelong(null);
				}
				return r_RGetPooled_Direction_EventModifiers;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_Direction_NavigationDeviceType_EventModifiers;
		public static RMethod RGetPooled_Direction_NavigationDeviceType_EventModifiers
		{
			get
			{
				if(r_RGetPooled_Direction_NavigationDeviceType_EventModifiers == null)
				{
					r_RGetPooled_Direction_NavigationDeviceType_EventModifiers = new(typeof(UnityEngine.UIElements.NavigationMoveEvent), "GetPooled", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.NavigationMoveEvent+Direction"),  ReleactionUtils.GetType("UnityEngine.UIElements.NavigationDeviceType"), typeof(UnityEngine.EventModifiers));
					r_RGetPooled_Direction_NavigationDeviceType_EventModifiers.SetBelong(null);
				}
				return r_RGetPooled_Direction_NavigationDeviceType_EventModifiers;
			}
		}
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(UnityEngine.Vector2  @moveVector, UnityEngine.EventModifiers  @modifiers)
        {
            ...
            var ___result = RGetPooled_Vector2_EventModifiers.Invoke(___genericsType, ___parameters);
