...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleTranslate : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTranslate r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RTranslate RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTranslate r_Pvalue;
		public virtual RUnityEngine.RUIElements.RTranslate RPvalue
		{
			get
			{
				if(r_Pvalue == null)
