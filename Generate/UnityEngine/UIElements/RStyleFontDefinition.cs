    ...
    public partial class RStyleFontDefinition : RMember //
    {
		...
		public static RMethod Rop_Implicit_StyleKeyword
		{
			get
			{
				...
				{
					r_Rop_Implicit_StyleKeyword = new(typeof(UnityEngine.UIElements.StyleFontDefinition), "op_Implicit", 0, typeof(UnityEngine.UIElements.StyleKeyword));
		...
		/// </summary>
		protected static RMethod r_Rop_Implicit_FontDefinition;
		public static RMethod Rop_Implicit_FontDefinition
		{
			get
			{
				if(r_Rop_Implicit_FontDefinition == null)
				{
					r_Rop_Implicit_FontDefinition = new(typeof(UnityEngine.UIElements.StyleFontDefinition), "op_Implicit", 0, typeof(UnityEngine.UIElements.FontDefinition));
					r_Rop_Implicit_FontDefinition.SetBelong(null);
				}
				return r_Rop_Implicit_FontDefinition;
			}
		}
		...
		/// </summary>
		protected RMethod r_REquals_StyleFontDefinition;
		public virtual RMethod REquals_StyleFontDefinition
		{
			get
			{
				if(r_REquals_StyleFontDefinition == null)
				{
					r_REquals_StyleFontDefinition = new(this, "Equals", 0, typeof(UnityEngine.UIElements.StyleFontDefinition));
					r_REquals_StyleFontDefinition.SetBelong(this.instance);
				}
				return r_REquals_StyleFontDefinition;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Rop_Equality_StyleFontDefinition_StyleFontDefinition;
		public static RMethod Rop_Equality_StyleFontDefinition_StyleFontDefinition
		{
			get
			{
				if(r_Rop_Equality_StyleFontDefinition_StyleFontDefinition == null)
				{
					r_Rop_Equality_StyleFontDefinition_StyleFontDefinition = new(typeof(UnityEngine.UIElements.StyleFontDefinition), "op_Equality", 0, typeof(UnityEngine.UIElements.StyleFontDefinition), typeof(UnityEngine.UIElements.StyleFontDefinition));
					r_Rop_Equality_StyleFontDefinition_StyleFontDefinition.SetBelong(null);
				}
				return r_Rop_Equality_StyleFontDefinition_StyleFontDefinition;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Rop_Inequality_StyleFontDefinition_StyleFontDefinition;
		public static RMethod Rop_Inequality_StyleFontDefinition_StyleFontDefinition
		{
			get
			{
				if(r_Rop_Inequality_StyleFontDefinition_StyleFontDefinition == null)
				{
					r_Rop_Inequality_StyleFontDefinition_StyleFontDefinition = new(typeof(UnityEngine.UIElements.StyleFontDefinition), "op_Inequality", 0, typeof(UnityEngine.UIElements.StyleFontDefinition), typeof(UnityEngine.UIElements.StyleFontDefinition));
					r_Rop_Inequality_StyleFontDefinition_StyleFontDefinition.SetBelong(null);
				}
				return r_Rop_Inequality_StyleFontDefinition_StyleFontDefinition;
			}
		}
