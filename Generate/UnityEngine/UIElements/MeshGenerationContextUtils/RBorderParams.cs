...
{public partial class RMeshGenerationContextUtils
{
    ...
    public partial class RBorderParams : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RToNativeParams;
		public virtual RMethod RToNativeParams
		{
			get
			{
				if(r_RToNativeParams == null)
				{
					r_RToNativeParams = new(this, "ToNativeParams", 0);
					r_RToNativeParams.SetBelong(this.instance);
				}
				return r_RToNativeParams;
			}
		}
        ...
        public virtual System.Object ToNativeParams()
        {
