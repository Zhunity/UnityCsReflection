...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleTextShadow : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextShadow r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RTextShadow RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextShadow r_Pvalue;
		public virtual RUnityEngine.RUIElements.RTextShadow RPvalue
		{
			get
			{
				if(r_Pvalue == null)
