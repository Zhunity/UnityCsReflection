...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RDebuggerEventDispatchingStrategy : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RIGlobalPanelDebugger r_Fs_GlobalPanelDebug;
		public static RUnityEngine.RUIElements.RIGlobalPanelDebugger RFs_GlobalPanelDebug
		{
			get
			{
