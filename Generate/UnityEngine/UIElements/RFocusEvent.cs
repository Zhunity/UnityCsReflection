...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RFocusEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RFocusable r_relatedTarget;
		public virtual RUnityEngine.RUIElements.RFocusable RrelatedTarget
		{
			get
			{
				if(r_relatedTarget == null)
				{
					r_relatedTarget = new(this, "relatedTarget", -1);
					r_relatedTarget.SetBelong(this.instance);
				}
				return r_relatedTarget;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RFocusChangeDirection r_direction;
		public virtual RUnityEngine.RUIElements.RFocusChangeDirection Rdirection
		{
			get
			{
				if(r_direction == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_IsFocusDelegated;
		public virtual RSystem.RBoolean RIsFocusDelegated
		{
			get
			{
				if(r_IsFocusDelegated == null)
				{
					r_IsFocusDelegated = new(this, "IsFocusDelegated", -1);
					r_IsFocusDelegated.SetBelong(this.instance);
				}
				return r_IsFocusDelegated;
			}
		}
