...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RHierarchyEvent : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_VisualElement_HierarchyChangeType;
		public virtual RMethod RInvoke_VisualElement_HierarchyChangeType
		{
			get
			{
				if(r_RInvoke_VisualElement_HierarchyChangeType == null)
				{
					r_RInvoke_VisualElement_HierarchyChangeType = new(this, "Invoke", 0, typeof(UnityEngine.UIElements.VisualElement),  ReleactionUtils.GetType("UnityEngine.UIElements.HierarchyChangeType"));
					r_RInvoke_VisualElement_HierarchyChangeType.SetBelong(this.instance);
				}
				return r_RInvoke_VisualElement_HierarchyChangeType;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.UIElements.VisualElement),  ReleactionUtils.GetType("UnityEngine.UIElements.HierarchyChangeType"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object;
			}
		}
