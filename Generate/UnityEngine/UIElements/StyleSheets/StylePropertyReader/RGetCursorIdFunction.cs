...
{public partial class RStylePropertyReader
{
    ...
    public partial class RGetCursorIdFunction : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_StyleSheet_StyleValueHandle;
		public virtual RMethod RInvoke_StyleSheet_StyleValueHandle
		{
			get
			{
				if(r_RInvoke_StyleSheet_StyleValueHandle == null)
				{
					r_RInvoke_StyleSheet_StyleValueHandle = new(this, "Invoke", 0, typeof(UnityEngine.UIElements.StyleSheet),  ReleactionUtils.GetType("UnityEngine.UIElements.StyleValueHandle"));
					r_RInvoke_StyleSheet_StyleValueHandle.SetBelong(this.instance);
				}
				return r_RInvoke_StyleSheet_StyleValueHandle;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.UIElements.StyleSheet),  ReleactionUtils.GetType("UnityEngine.UIElements.StyleValueHandle"), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object;
			}
		}
