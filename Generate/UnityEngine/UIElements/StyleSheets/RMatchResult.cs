...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RStyleSheets
{
    ...
    public partial class RMatchResult : RMember //
    {
		...
		/// </summary>
		protected RField r_errorCode;
		public virtual RField RerrorCode
		{
			get
			{
				if(r_errorCode == null)
				{
					r_errorCode = new(this, "errorCode");
		...
		public virtual RField RerrorValue
		{
			get
			{
				if(r_errorValue == null)
				{
					r_errorValue = new(this, "errorValue");
					r_errorValue.SetBelong(this.instance);
				}
				return r_errorValue;
			}
		}
