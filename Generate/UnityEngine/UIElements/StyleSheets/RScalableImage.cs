...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RStyleSheets
{
    ...
    public partial class RScalableImage : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RTexture2D r_FnormalImage;
		public virtual RUnityEngine.RTexture2D RFnormalImage
		{
			get
			{
				if(r_FnormalImage == null)
				{
					...
					r_FnormalImage.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RUnityEngine.RTexture2D r_FhighResolutionImage;
		public virtual RUnityEngine.RTexture2D RFhighResolutionImage
		{
			get
			{
				if(r_FhighResolutionImage == null)
				{
					...
					r_FhighResolutionImage.SetBelong(this.instance);
				}
