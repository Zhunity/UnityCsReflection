...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RStyleSheets
{
    ...
    public partial class RScalableImage : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RTexture2D r_normalImage;
		public virtual RUnityEngine.RTexture2D RnormalImage
		{
			get
			{
				if(r_normalImage == null)
				{
					r_normalImage = new(this, "normalImage");
					r_normalImage.SetBelong(this.instance);
				}
				return r_normalImage;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTexture2D r_highResolutionImage;
		public virtual RUnityEngine.RTexture2D RhighResolutionImage
		{
			get
			{
				if(r_highResolutionImage == null)
				{
					r_highResolutionImage = new(this, "highResolutionImage");
					r_highResolutionImage.SetBelong(this.instance);
				}
				return r_highResolutionImage;
			}
		}
