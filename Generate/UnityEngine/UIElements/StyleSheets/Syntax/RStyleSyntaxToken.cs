...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RStyleSheets.RSyntax
{
    ...
    public partial class RStyleSyntaxToken : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSheets.RSyntax.RStyleSyntaxTokenType r_Ftype;
		public virtual RUnityEngine.RUIElements.RStyleSheets.RSyntax.RStyleSyntaxTokenType RFtype
		{
			get
			{
				if(r_Ftype == null)
		...
		/// System.Int32 number
		/// </summary>
		protected RSystem.RInt32 r_Fnumber;
		public virtual RSystem.RInt32 RFnumber
		{
			get
			{
				if(r_Fnumber == null)
