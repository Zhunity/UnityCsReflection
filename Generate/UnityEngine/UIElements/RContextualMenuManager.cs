...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RContextualMenuManager : RMember //
    {
		...
		/// </summary>
		protected RSystem.RBoolean r_F__0__displayMenuHandledOSX__1__k__BackingField;
		public virtual RSystem.RBoolean RF__0__displayMenuHandledOSX__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PdisplayMenuHandledOSX;
		public virtual RSystem.RBoolean RPdisplayMenuHandledOSX
		{
			get
			{
