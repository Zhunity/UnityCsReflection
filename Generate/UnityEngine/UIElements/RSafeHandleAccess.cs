...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RSafeHandleAccess : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_Rop_Implicit_SafeHandleAccess;
		public static RMethod Rop_Implicit_SafeHandleAccess
		{
			get
			{
				if(r_Rop_Implicit_SafeHandleAccess == null)
				{
					r_Rop_Implicit_SafeHandleAccess = new( ReleactionUtils.GetType("UnityEngine.UIElements.SafeHandleAccess"), "op_Implicit", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.SafeHandleAccess"));
					r_Rop_Implicit_SafeHandleAccess.SetBelong(null);
				}
				return r_Rop_Implicit_SafeHandleAccess;
			}
		}
