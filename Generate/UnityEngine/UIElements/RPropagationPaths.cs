...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RPropagationPaths : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RObjectPool<RUnityEngine.RUIElements.RPropagationPaths> r_Fs_Pool;
		public static RUnityEngine.RUIElements.RObjectPool<RUnityEngine.RUIElements.RPropagationPaths> RFs_Pool
		{
			get
			{
				if(r_Fs_Pool == null)
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> r_FtrickleDownPath;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> RFtrickleDownPath
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> r_FtargetElements;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> RFtargetElements
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> r_FbubbleUpPath;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualElement> RFbubbleUpPath
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_Fk_DefaultPropagationDepth;
		public static RSystem.RInt32 RFk_DefaultPropagationDepth
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_Fk_DefaultTargetCount;
		public static RSystem.RInt32 RFk_DefaultTargetCount
		{
			get
			{
