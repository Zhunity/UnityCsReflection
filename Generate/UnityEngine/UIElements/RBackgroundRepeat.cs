...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RBackgroundRepeat : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRepeat r_Fx;
		public virtual RUnityEngine.RUIElements.RRepeat RFx
		{
			get
			{
				if(r_Fx == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRepeat r_Fy;
		public virtual RUnityEngine.RUIElements.RRepeat RFy
		{
			get
			{
				if(r_Fy == null)
