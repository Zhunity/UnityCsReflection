...
{public partial class REventDispatcher
{
    ...
    public partial class REventRecord : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.REventBase r_Fm_Event;
		public virtual RUnityEngine.RUIElements.REventBase RFm_Event
		{
			get
			{
				if(r_Fm_Event == null)
				{
					...
					r_Fm_Event.SetBelong(this.instance);
				}
				return r_Fm_Event;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIPanel r_Fm_Panel;
		public virtual RUnityEngine.RUIElements.RIPanel RFm_Panel
		{
			get
			{
				if(r_Fm_Panel == null)
		...
		/// </summary>
		protected RSystem.RDiagnostics.RStackTrace r_Fm_StackTrace;
		public virtual RSystem.RDiagnostics.RStackTrace RFm_StackTrace
		{
			get
			{
