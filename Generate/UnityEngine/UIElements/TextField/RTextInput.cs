...
{public partial class RTextField
{
    ...
    public partial class RTextInput : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Rget_isPasswordField;
		public virtual RMethod Rget_isPasswordField
		{
			get
			{
				if(r_Rget_isPasswordField == null)
				{
					r_Rget_isPasswordField = new(this, "get_isPasswordField", 0);
					r_Rget_isPasswordField.SetBelong(this.instance);
				}
				return r_Rget_isPasswordField;
			}
		}
