...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTimeValue : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTimeUnit r_Fm_Unit;
		public virtual RUnityEngine.RUIElements.RTimeUnit RFm_Unit
		{
			get
			{
				if(r_Fm_Unit == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTimeUnit r_Punit;
		public virtual RUnityEngine.RUIElements.RTimeUnit RPunit
		{
			get
			{
				if(r_Punit == null)
