...
{public partial class RTemplateAsset
{
    ...
    public partial class RAttributeOverride : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_Fm_ElementName;
		public virtual RSystem.RString RFm_ElementName
		{
			get
			{
				if(r_Fm_ElementName == null)
				{
					r_Fm_ElementName = new(this, "m_ElementName");
					r_Fm_ElementName.SetBelong(this.instance);
				}
				return r_Fm_ElementName;
			}
		}
		...
		/// </summary>
		protected RSystem.RString r_Fm_AttributeName;
		public virtual RSystem.RString RFm_AttributeName
		{
			get
			{
				if(r_Fm_AttributeName == null)
				{
					r_Fm_AttributeName = new(this, "m_AttributeName");
					r_Fm_AttributeName.SetBelong(this.instance);
				}
				return r_Fm_AttributeName;
			}
		}
		...
		/// </summary>
		protected RSystem.RString r_Fm_Value;
		public virtual RSystem.RString RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
