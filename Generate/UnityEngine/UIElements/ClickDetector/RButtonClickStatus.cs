...
{public partial class RClickDetector
{
    ...
    public partial class RButtonClickStatus : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualElement r_Fm_Target;
		public virtual RUnityEngine.RUIElements.RVisualElement RFm_Target
		{
			get
			{
				if(r_Fm_Target == null)
		...
		/// </summary>
		protected RUnityEngine.RVector3 r_Fm_PointerDownPosition;
		public virtual RUnityEngine.RVector3 RFm_PointerDownPosition
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Fm_LastPointerDownTime;
		public virtual RSystem.RInt64 RFm_LastPointerDownTime
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_ClickCount;
		public virtual RSystem.RInt32 RFm_ClickCount
		{
			get
			{
