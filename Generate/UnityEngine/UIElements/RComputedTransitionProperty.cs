...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RComputedTransitionProperty : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_FdurationMs;
		public virtual RSystem.RInt32 RFdurationMs
		{
			get
			{
				if(r_FdurationMs == null)
				{
					r_FdurationMs = new(this, "durationMs");
					r_FdurationMs.SetBelong(this.instance);
				}
				return r_FdurationMs;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_FdelayMs;
		public virtual RSystem.RInt32 RFdelayMs
		{
			get
			{
				if(r_FdelayMs == null)
				{
					r_FdelayMs = new(this, "delayMs");
					r_FdelayMs.SetBelong(this.instance);
				}
				return r_FdelayMs;
			}
		}
		...
		/// </summary>
		protected RSystem.RFunc<RSystem.RSingle, RSystem.RSingle> r_FeasingCurve;
		public virtual RSystem.RFunc<RSystem.RSingle, RSystem.RSingle> RFeasingCurve
		{
			get
			{
				if(r_FeasingCurve == null)
				{
					r_FeasingCurve = new(this, "easingCurve");
					r_FeasingCurve.SetBelong(this.instance);
				}
				return r_FeasingCurve;
			}
		}
