...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventBase<T> : RMember // where T : UnityEngine.UIElements.EventBase<T>, new()
    {
		...
		/// </summary>
		protected static RSystem.RInt64 r_Fs_TypeId;
		public static RSystem.RInt64 RFs_TypeId
		{
			get
			{
				if(r_Fs_TypeId == null)
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RObjectPool<RField> r_Fs_Pool;
		public static RUnityEngine.RUIElements.RObjectPool<RField> RFs_Pool
		{
			get
			{
				if(r_Fs_Pool == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_RefCount;
		public virtual RSystem.RInt32 RFm_RefCount
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.REventCategory r_FEventCategory;
		public static RUnityEngine.RUIElements.REventCategory RFEventCategory
		{
			get
			{
