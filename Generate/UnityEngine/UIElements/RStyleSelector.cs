...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleSelector : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RUIElements.RStyleSelectorPart> r_Fm_Parts;
		public virtual RFieldArray<RUnityEngine.RUIElements.RStyleSelectorPart> RFm_Parts
		{
			get
			{
				if(r_Fm_Parts == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSelectorRelationship r_Fm_PreviousRelationship;
		public virtual RUnityEngine.RUIElements.RStyleSelectorRelationship RFm_PreviousRelationship
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_FpseudoStateMask;
		public virtual RSystem.RInt32 RFpseudoStateMask
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_FnegatedPseudoStateMask;
		public virtual RSystem.RInt32 RFnegatedPseudoStateMask
		{
			get
			{
		...
		/// </summary>
		protected RPropertyArray<RUnityEngine.RUIElements.RStyleSelectorPart> r_Pparts;
		public virtual RPropertyArray<RUnityEngine.RUIElements.RStyleSelectorPart> RPparts
		{
			get
			{
				if(r_Pparts == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSelectorRelationship r_PpreviousRelationship;
		public virtual RUnityEngine.RUIElements.RStyleSelectorRelationship RPpreviousRelationship
		{
			get
			{
