...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RChangeEvent<T> : RMember //
    {
		...
		/// </summary>
		protected RField r___1__newValue__2__k__BackingField;
		public virtual RField R__1__newValue__2__k__BackingField
		{
			get
			{
				if(r___1__newValue__2__k__BackingField == null)
				{
					r___1__newValue__2__k__BackingField = new(this, "<newValue>k__BackingField");
					r___1__newValue__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__newValue__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_T_T;
		public static RMethod RGetPooled_T_T
		{
			get
			{
				if(r_RGetPooled_T_T == null)
				{
					r_RGetPooled_T_T = new(typeof(UnityEngine.UIElements.ChangeEvent<>), "GetPooled", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0));
					r_RGetPooled_T_T.SetBelong(null);
				}
				return r_RGetPooled_T_T;
			}
		}
