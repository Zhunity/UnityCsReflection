...
{public partial class RFocusController
{
    ...
    public partial class RFocusedElement : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualElement r_m_SubTreeRoot;
		public virtual RUnityEngine.RUIElements.RVisualElement Rm_SubTreeRoot
		{
			get
			{
				if(r_m_SubTreeRoot == null)
				{
					r_m_SubTreeRoot = new(this, "m_SubTreeRoot");
					r_m_SubTreeRoot.SetBelong(this.instance);
				}
				return r_m_SubTreeRoot;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RFocusable r_m_FocusedElement;
		public virtual RUnityEngine.RUIElements.RFocusable Rm_FocusedElement
		{
			get
			{
				if(r_m_FocusedElement == null)
				{
					r_m_FocusedElement = new(this, "m_FocusedElement");
					r_m_FocusedElement.SetBelong(this.instance);
				}
				return r_m_FocusedElement;
			}
		}
