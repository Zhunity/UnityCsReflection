...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTemplateAsset : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_Fm_TemplateAlias;
		public virtual RSystem.RString RFm_TemplateAlias
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RTemplateAsset.RAttributeOverride> r_Fm_AttributeOverrides;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RTemplateAsset.RAttributeOverride> RFm_AttributeOverrides
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualTreeAsset.RSlotUsageEntry> r_Fm_SlotUsages;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualTreeAsset.RSlotUsageEntry> RFm_SlotUsages
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RString> r_Fm_Properties;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RString> RFm_Properties
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PtemplateAlias;
		public virtual RSystem.RString RPtemplateAlias
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualTreeAsset.RSlotUsageEntry> r_PslotUsages;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RVisualTreeAsset.RSlotUsageEntry> RPslotUsages
		{
			get
			{
		...
		/// Int32 ruleIndex
		/// </summary>
		protected RSystem.RInt32 r_PruleIndex;
		public virtual RSystem.RInt32 RPruleIndex
		{
			get
			{
		...
		/// </summary>
		protected RPropertyArray<RSystem.RString> r_Pclasses;
		public virtual RPropertyArray<RSystem.RString> RPclasses
		{
			get
			{
				if(r_Pclasses == null)
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RString> r_PstylesheetPaths;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RString> RPstylesheetPaths
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PhasStylesheetPaths;
		public virtual RSystem.RBoolean RPhasStylesheetPaths
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheet> r_Pstylesheets;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheet> RPstylesheets
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PhasStylesheets;
		public virtual RSystem.RBoolean RPhasStylesheets
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_PorderInDocument;
		public virtual RSystem.RInt32 RPorderInDocument
		{
			get
			{
		...
		/// Int32 parentId
		/// </summary>
		protected RSystem.RInt32 r_PparentId;
		public virtual RSystem.RInt32 RPparentId
		{
			get
			{
				if(r_PparentId == null)
