...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RScroller : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RSlider r___1__slider__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RSlider R__1__slider__2__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRepeatButton r___1__lowButton__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RRepeatButton R__1__lowButton__2__k__BackingField
		{
			get
			{
				if(r___1__lowButton__2__k__BackingField == null)
				{
					r___1__lowButton__2__k__BackingField = new(this, "<lowButton>k__BackingField");
					r___1__lowButton__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__lowButton__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRepeatButton r___1__highButton__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RRepeatButton R__1__highButton__2__k__BackingField
		{
			get
			{
				if(r___1__highButton__2__k__BackingField == null)
				{
					r___1__highButton__2__k__BackingField = new(this, "<highButton>k__BackingField");
					r___1__highButton__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__highButton__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected static RField r_sliderUssClassName;
		public static RField RsliderUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RField r_lowButtonUssClassName;
		public static RField RlowButtonUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RField r_highButtonUssClassName;
		public static RField RhighButtonUssClassName
		{
			get
			{
		...
		/// Void Adjust(Single)
		/// </summary>
		protected RMethod r_RAdjust_Single;
		public virtual RMethod RAdjust_Single
		{
			get
			{
				if(r_RAdjust_Single == null)
				{
					r_RAdjust_Single = new(this, "Adjust", 0, typeof(System.Single));
					r_RAdjust_Single.SetBelong(this.instance);
				}
				return r_RAdjust_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_ROnSliderValueChange_ChangeEvent_d_Single_p_;
		public virtual RMethod ROnSliderValueChange_ChangeEvent_d_Single_p_
		{
			get
			{
				if(r_ROnSliderValueChange_ChangeEvent_d_Single_p_ == null)
				{
					r_ROnSliderValueChange_ChangeEvent_d_Single_p_ = new(this, "OnSliderValueChange", 0, typeof(UnityEngine.UIElements.ChangeEvent<>).MakeGenericType(typeof(System.Single)));
					r_ROnSliderValueChange_ChangeEvent_d_Single_p_.SetBelong(this.instance);
				}
				return r_ROnSliderValueChange_ChangeEvent_d_Single_p_;
			}
		}
		...
		/// Void ScrollPageUp()
		/// </summary>
		protected RMethod r_RScrollPageUp;
		public virtual RMethod RScrollPageUp
		{
			get
			{
				if(r_RScrollPageUp == null)
				{
					r_RScrollPageUp = new(this, "ScrollPageUp", 0);
					r_RScrollPageUp.SetBelong(this.instance);
				}
				return r_RScrollPageUp;
			}
		}
		...
		/// Void ScrollPageDown()
		/// </summary>
		protected RMethod r_RScrollPageDown;
		public virtual RMethod RScrollPageDown
		{
			get
			{
				if(r_RScrollPageDown == null)
				{
					r_RScrollPageDown = new(this, "ScrollPageDown", 0);
					r_RScrollPageDown.SetBelong(this.instance);
				}
				return r_RScrollPageDown;
			}
		}
		...
		/// </summary>
		protected RMethod r_RScrollPageUp_Single;
		public virtual RMethod RScrollPageUp_Single
		{
			get
			{
				if(r_RScrollPageUp_Single == null)
				{
					r_RScrollPageUp_Single = new(this, "ScrollPageUp", 0, typeof(System.Single));
					r_RScrollPageUp_Single.SetBelong(this.instance);
				}
				return r_RScrollPageUp_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RScrollPageDown_Single;
		public virtual RMethod RScrollPageDown_Single
		{
			get
			{
				if(r_RScrollPageDown_Single == null)
				{
					r_RScrollPageDown_Single = new(this, "ScrollPageDown", 0, typeof(System.Single));
					r_RScrollPageDown_Single.SetBelong(this.instance);
				}
				return r_RScrollPageDown_Single;
			}
		}
