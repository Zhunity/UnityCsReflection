...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleValueHandle : RMember //
    {
		...
		/// </summary>
		protected RField r_m_ValueType;
		public virtual RField Rm_ValueType
		{
			get
			{
				if(r_m_ValueType == null)
				{
					r_m_ValueType = new(this, "m_ValueType");
					r_m_ValueType.SetBelong(this.instance);
				}
				return r_m_ValueType;
			}
		}
		...
		public virtual RField RvalueIndex
		{
			get
			{
				if(r_valueIndex == null)
				{
					r_valueIndex = new(this, "valueIndex");
					r_valueIndex.SetBelong(this.instance);
				}
				return r_valueIndex;
			}
		}
		...
		/// </summary>
		protected RProperty r_valueType;
		public virtual RProperty RvalueType
		{
			get
			{
				if(r_valueType == null)
