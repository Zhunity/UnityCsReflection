...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class REventCallback<TEventType> : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(TEventType)
		/// </summary>
		protected RMethod r_MInvoke_TEventType;
		public virtual RMethod RMInvoke_TEventType
		{
			get
			{
				if(r_MInvoke_TEventType == null)
				{
					r_MInvoke_TEventType = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_MInvoke_TEventType.SetBelong(this.instance);
				}
				return r_MInvoke_TEventType;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(TEventType, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_TEventType_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_TEventType_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_TEventType_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_TEventType_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_TEventType_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_TEventType_AsyncCallback_Object;
			}
		}
        ...
        public REventCallback() : base("UnityEngine.UIElements.EventCallback`1")
        {
        }

        public REventCallback(System.Object instance) : base("UnityEngine.UIElements.EventCallback`1")
		{
        ...
        public virtual void Invoke(TEventType @evt)
        {
            ...
            var ___result = RMInvoke_TEventType.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(TEventType @evt, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evt, @callback, @object};
            var ___result = RMBeginInvoke_TEventType_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
