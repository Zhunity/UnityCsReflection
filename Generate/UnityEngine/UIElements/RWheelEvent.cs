    ...
    public partial class RWheelEvent : RMember //
    {
		...
		public static RMethod RGetPooled_Event
		{
			get
			{
				...
				{
					r_GetPooled_Event = new(typeof(UnityEngine.UIElements.WheelEvent), "GetPooled", 0, typeof(UnityEngine.Event));
		...
		/// </summary>
		protected static RMethod r_GetPooled_Vector3_Vector3;
		public static RMethod RGetPooled_Vector3_Vector3
		{
			get
			{
				if(r_GetPooled_Vector3_Vector3 == null)
				{
					r_GetPooled_Vector3_Vector3 = new(typeof(UnityEngine.UIElements.WheelEvent), "GetPooled", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.Vector3));
					r_GetPooled_Vector3_Vector3.SetBelong(null);
				}
				return r_GetPooled_Vector3_Vector3;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_Vector3_IPointerEvent;
		public static RMethod RGetPooled_Vector3_IPointerEvent
		{
			get
			{
				if(r_GetPooled_Vector3_IPointerEvent == null)
				{
					r_GetPooled_Vector3_IPointerEvent = new(typeof(UnityEngine.UIElements.WheelEvent), "GetPooled", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.UIElements.IPointerEvent));
					r_GetPooled_Vector3_IPointerEvent.SetBelong(null);
				}
				return r_GetPooled_Vector3_IPointerEvent;
			}
		}
