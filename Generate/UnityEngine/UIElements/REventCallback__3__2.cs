...
{
	/// <summary>
	/// UnityEngine.UIElements.EventCallback`2
	/// </summary>
    public partial class REventCallback<TEventType, TCallbackArgs> : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(TEventType, TCallbackArgs)
		/// </summary>
		protected RMethod r_MInvoke_TEventType_TCallbackArgs;
		public virtual RMethod RMInvoke_TEventType_TCallbackArgs
		{
			get
			{
				if(r_MInvoke_TEventType_TCallbackArgs == null)
				{
					r_MInvoke_TEventType_TCallbackArgs = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_MInvoke_TEventType_TCallbackArgs.SetBelong(this.instance);
				}
				return r_MInvoke_TEventType_TCallbackArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(TEventType, TCallbackArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
			}
		}
        ...
        public REventCallback() : base("UnityEngine.UIElements.EventCallback`2")
        {
        }

        public REventCallback(System.Object instance) : base("UnityEngine.UIElements.EventCallback`2")
		{
            SetInstance(instance);
		}

        public REventCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REventCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Invoke(TEventType @evt, TCallbackArgs @userArgs)
        {
            ...
            var ___parameters = new object[]{@evt, @userArgs};
            var ___result = RMInvoke_TEventType_TCallbackArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(TEventType @evt, TCallbackArgs @userArgs, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evt, @userArgs, @callback, @object};
            var ___result = RMBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
