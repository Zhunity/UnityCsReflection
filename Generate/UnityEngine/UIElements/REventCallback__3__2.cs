...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventCallback<TEventType, TCallbackArgs> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_TEventType_TCallbackArgs;
		public virtual RMethod RInvoke_TEventType_TCallbackArgs
		{
			get
			{
				if(r_Invoke_TEventType_TCallbackArgs == null)
				{
					r_Invoke_TEventType_TCallbackArgs = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_Invoke_TEventType_TCallbackArgs.SetBelong(this.instance);
				}
				return r_Invoke_TEventType_TCallbackArgs;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object == null)
				{
					r_BeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
			}
		}
