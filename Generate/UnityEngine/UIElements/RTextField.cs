    ...
    public partial class RTextField : RMember //
    {
		...
		public static RField RussClassName
		{
			get
			{
				...
				{
					r_ussClassName = new(typeof(UnityEngine.UIElements.TextField), "ussClassName");
		...
		public static RField RlabelUssClassName
		{
			get
			{
				...
				{
					r_labelUssClassName = new(typeof(UnityEngine.UIElements.TextField), "labelUssClassName");
		...
		public static RField RinputUssClassName
		{
			get
			{
				...
				{
					r_inputUssClassName = new(typeof(UnityEngine.UIElements.TextField), "inputUssClassName");
		...
		/// TextInput textInput
		/// </summary>
		protected RUnityEngine.RUIElements.RTextField.RTextInput r_textInput;
		public virtual RUnityEngine.RUIElements.RTextField.RTextInput RtextInput
		{
			get
			{
				if(r_textInput == null)
				{
					r_textInput = new(this, "textInput", -1);
					r_textInput.SetBelong(this.instance);
				}
				return r_textInput;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextInputBaseField<RProperty>.RTextInputBase r_textInputBase;
		public virtual RUnityEngine.RUIElements.RTextInputBaseField<RProperty>.RTextInputBase RtextInputBase
		{
			get
			{
				if(r_textInputBase == null)
				{
					r_textInputBase = new(this, "textInputBase", -1);
					r_textInputBase.SetBelong(this.instance);
				}
				return r_textInputBase;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSetValueWithoutNotify_String;
		public virtual RMethod RSetValueWithoutNotify_String
		{
			get
			{
				if(r_RSetValueWithoutNotify_String == null)
				{
					r_RSetValueWithoutNotify_String = new(this, "SetValueWithoutNotify", 0, typeof(System.String));
					r_RSetValueWithoutNotify_String.SetBelong(this.instance);
				}
				return r_RSetValueWithoutNotify_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_RValueToString_String;
		public virtual RMethod RValueToString_String
		{
			get
			{
				if(r_RValueToString_String == null)
				{
					r_RValueToString_String = new(this, "ValueToString", 0, typeof(System.String));
					r_RValueToString_String.SetBelong(this.instance);
				}
				return r_RValueToString_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_RValidatedValue_String;
		public virtual RMethod RValidatedValue_String
		{
			get
			{
				if(r_RValidatedValue_String == null)
				{
					r_RValidatedValue_String = new(this, "ValidatedValue", 0, typeof(System.String));
					r_RValidatedValue_String.SetBelong(this.instance);
				}
				return r_RValidatedValue_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSetValueWithoutValidation_String;
		public virtual RMethod RSetValueWithoutValidation_String
		{
			get
			{
				if(r_RSetValueWithoutValidation_String == null)
				{
					r_RSetValueWithoutValidation_String = new(this, "SetValueWithoutValidation", 0, typeof(System.String));
					r_RSetValueWithoutValidation_String.SetBelong(this.instance);
				}
				return r_RSetValueWithoutValidation_String;
			}
		}
        ...
        public virtual void SetValueWithoutNotify(System.String  @newValue)
        {
            ...
            var ___result = RSetValueWithoutNotify_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String ValueToString(System.String  @value)
        {
            ...
            var ___result = RValueToString_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.String ValidatedValue(System.String  @value)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RValidatedValue_String.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetValueWithoutValidation(System.String  @newValue)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@newValue};
            var ___result = RSetValueWithoutValidation_String.Invoke(___genericsType, ___parameters);
