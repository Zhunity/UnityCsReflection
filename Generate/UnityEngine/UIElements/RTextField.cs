...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTextField : RMember //
    {
		...
		/// </summary>
		protected RMethod r_SetValueWithoutNotify_String;
		public virtual RMethod RSetValueWithoutNotify_String
		{
			get
			{
				if(r_SetValueWithoutNotify_String == null)
				{
					r_SetValueWithoutNotify_String = new(this, "SetValueWithoutNotify", 0, typeof(System.String));
					r_SetValueWithoutNotify_String.SetBelong(this.instance);
				}
				return r_SetValueWithoutNotify_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_ValueToString_String;
		public virtual RMethod RValueToString_String
		{
			get
			{
				if(r_ValueToString_String == null)
				{
					r_ValueToString_String = new(this, "ValueToString", 0, typeof(System.String));
					r_ValueToString_String.SetBelong(this.instance);
				}
				return r_ValueToString_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_ValidatedValue_String;
		public virtual RMethod RValidatedValue_String
		{
			get
			{
				if(r_ValidatedValue_String == null)
				{
					r_ValidatedValue_String = new(this, "ValidatedValue", 0, typeof(System.String));
					r_ValidatedValue_String.SetBelong(this.instance);
				}
				return r_ValidatedValue_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_SetValueWithoutValidation_String;
		public virtual RMethod RSetValueWithoutValidation_String
		{
			get
			{
				if(r_SetValueWithoutValidation_String == null)
				{
					r_SetValueWithoutValidation_String = new(this, "SetValueWithoutValidation", 0, typeof(System.String));
					r_SetValueWithoutValidation_String.SetBelong(this.instance);
				}
				return r_SetValueWithoutValidation_String;
			}
		}
