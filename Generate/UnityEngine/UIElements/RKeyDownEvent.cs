...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RKeyDownEvent : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RGetEquivalentImguiEvent_Event;
		public virtual RMethod RGetEquivalentImguiEvent_Event
		{
			get
			{
				if(r_RGetEquivalentImguiEvent_Event == null)
				{
					r_RGetEquivalentImguiEvent_Event = new(this, "GetEquivalentImguiEvent", 0, typeof(UnityEngine.Event));
					r_RGetEquivalentImguiEvent_Event.SetBelong(this.instance);
				}
				return r_RGetEquivalentImguiEvent_Event;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSendEquivalentNavigationEventIfAny_IPanel;
		public virtual RMethod RSendEquivalentNavigationEventIfAny_IPanel
		{
			get
			{
				if(r_RSendEquivalentNavigationEventIfAny_IPanel == null)
				{
					r_RSendEquivalentNavigationEventIfAny_IPanel = new(this, "SendEquivalentNavigationEventIfAny", 0, typeof(UnityEngine.UIElements.IPanel));
					r_RSendEquivalentNavigationEventIfAny_IPanel.SetBelong(this.instance);
				}
				return r_RSendEquivalentNavigationEventIfAny_IPanel;
			}
		}
