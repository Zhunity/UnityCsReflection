...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RButton : RMember //
    {
		...
		/// </summary>
		protected RMethod r_OnNavigationSubmit_NavigationSubmitEvent;
		public virtual RMethod ROnNavigationSubmit_NavigationSubmitEvent
		{
			get
			{
				if(r_OnNavigationSubmit_NavigationSubmitEvent == null)
				{
					r_OnNavigationSubmit_NavigationSubmitEvent = new(this, "OnNavigationSubmit", 0, typeof(UnityEngine.UIElements.NavigationSubmitEvent));
					r_OnNavigationSubmit_NavigationSubmitEvent.SetBelong(this.instance);
				}
				return r_OnNavigationSubmit_NavigationSubmitEvent;
			}
		}
