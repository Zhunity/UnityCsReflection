    ...
    public partial class RButton : RMember //
    {
		...
		public static RField RussClassName
		{
			get
			{
				...
				{
					r_ussClassName = new(typeof(UnityEngine.UIElements.Button), "ussClassName");
		...
		/// </summary>
		protected static RField r_NonEmptyString;
		public static RField RNonEmptyString
		{
			get
			{
				if(r_NonEmptyString == null)
				{
					r_NonEmptyString = new(typeof(UnityEngine.UIElements.Button), "NonEmptyString");
					r_NonEmptyString.SetBelong(null);
				}
				return r_NonEmptyString;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RClickable r_clickable;
		public virtual RUnityEngine.RUIElements.RClickable Rclickable
		{
			get
			{
				if(r_clickable == null)
				{
					r_clickable = new(this, "clickable", -1);
					r_clickable.SetBelong(this.instance);
				}
				return r_clickable;
			}
		}
		...
		/// </summary>
		protected RMethod r_ROnNavigationSubmit_NavigationSubmitEvent;
		public virtual RMethod ROnNavigationSubmit_NavigationSubmitEvent
		{
			get
			{
				if(r_ROnNavigationSubmit_NavigationSubmitEvent == null)
				{
					r_ROnNavigationSubmit_NavigationSubmitEvent = new(this, "OnNavigationSubmit", 0, typeof(UnityEngine.UIElements.NavigationSubmitEvent));
					r_ROnNavigationSubmit_NavigationSubmitEvent.SetBelong(this.instance);
				}
				return r_ROnNavigationSubmit_NavigationSubmitEvent;
			}
		}
        ...
        public virtual void OnNavigationSubmit(UnityEngine.UIElements.NavigationSubmitEvent  @evt)
        {
            ...
            var ___result = ROnNavigationSubmit_NavigationSubmitEvent.Invoke(___genericsType, ___parameters);
