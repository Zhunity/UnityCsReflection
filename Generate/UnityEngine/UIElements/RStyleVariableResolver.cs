...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleVariableResolver : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RInt32 r_FkMaxResolves;
		public static RSystem.RInt32 RFkMaxResolves
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RStyleSheets.RSyntax.RStyleSyntaxParser r_Fs_SyntaxParser;
		public static RUnityEngine.RUIElements.RStyleSheets.RSyntax.RStyleSyntaxParser RFs_SyntaxParser
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValueMatcher r_Fm_Matcher;
		public virtual RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValueMatcher RFm_Matcher
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValue> r_Fm_ResolvedValues;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValue> RFm_ResolvedValues
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RStack<RSystem.RString> r_Fm_ResolvedVarStack;
		public virtual RSystem.RCollections.RGeneric.RStack<RSystem.RString> RFm_ResolvedVarStack
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleProperty r_Fm_Property;
		public virtual RUnityEngine.RUIElements.RStyleProperty RFm_Property
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RStack<RUnityEngine.RUIElements.RStyleVariableResolver.RResolveContext> r_Fm_ContextStack;
		public virtual RSystem.RCollections.RGeneric.RStack<RUnityEngine.RUIElements.RStyleVariableResolver.RResolveContext> RFm_ContextStack
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleVariableResolver.RResolveContext r_Fm_CurrentContext;
		public virtual RUnityEngine.RUIElements.RStyleVariableResolver.RResolveContext RFm_CurrentContext
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleVariableContext r_F__0__variableContext__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.RStyleVariableContext RF__0__variableContext__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSheet r_PcurrentSheet;
		public virtual RUnityEngine.RUIElements.RStyleSheet RPcurrentSheet
		{
			get
			{
		...
		/// </summary>
		protected RPropertyArray<RUnityEngine.RUIElements.RStyleValueHandle> r_PcurrentHandles;
		public virtual RPropertyArray<RUnityEngine.RUIElements.RStyleValueHandle> RPcurrentHandles
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValue> r_PresolvedValues;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleSheets.RStylePropertyValue> RPresolvedValues
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleVariableContext r_PvariableContext;
		public virtual RUnityEngine.RUIElements.RStyleVariableContext RPvariableContext
		{
			get
			{
        ...
        public virtual RUnityEngine.RUIElements.RStyleVariableResolver.RResult ResolveVarFunction(ref System.Int32 @index, System.Int32 @argc, System.String @varName)
        {
            ...
            return new RUnityEngine.RUIElements.RStyleVariableResolver.RResult(___result);
        }
        ...
        public virtual RUnityEngine.RUIElements.RStyleVariableResolver.RResult ResolveVariable(System.String @variableName)
        {
        ...
        public virtual RUnityEngine.RUIElements.RStyleVariableResolver.RResult ResolveFallback(ref System.Int32 @index)
        {
