...
{public partial class RBaseSlider<TValueType>
{
    ...
    public partial class RSliderKey : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FNone;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFNone
		{
			get
			{
				if(r_FNone == null)
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FLowest;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFLowest
		{
			get
			{
				if(r_FLowest == null)
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FLowerPage;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFLowerPage
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FLower;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFLower
		{
			get
			{
				if(r_FLower == null)
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FHigher;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFHigher
		{
			get
			{
				if(r_FHigher == null)
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FHigherPage;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFHigherPage
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey r_FHighest;
		public static RUnityEngine.RUIElements.RBaseSlider<RField>.RSliderKey RFHighest
		{
			get
			{
				if(r_FHighest == null)
