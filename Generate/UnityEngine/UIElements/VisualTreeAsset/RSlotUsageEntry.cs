...
{public partial class RVisualTreeAsset
{
    ...
    public partial class RSlotUsageEntry : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_FslotName;
		public virtual RSystem.RString RFslotName
		{
			get
			{
				if(r_FslotName == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_FassetId;
		public virtual RSystem.RInt32 RFassetId
		{
			get
			{
				if(r_FassetId == null)
