...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleBackgroundPosition : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundPosition r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RBackgroundPosition RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RBackgroundPosition r_Pvalue;
		public virtual RUnityEngine.RUIElements.RBackgroundPosition RPvalue
		{
			get
			{
				if(r_Pvalue == null)
