...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RGeometryChangedEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RRect r___0__oldRect__1__k__BackingField;
		public virtual RUnityEngine.RRect R__0__oldRect__1__k__BackingField
		{
			get
			{
				if(r___0__oldRect__1__k__BackingField == null)
				{
					r___0__oldRect__1__k__BackingField = new(this, "<oldRect>k__BackingField");
					r___0__oldRect__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__oldRect__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RRect r___0__newRect__1__k__BackingField;
		public virtual RUnityEngine.RRect R__0__newRect__1__k__BackingField
		{
			get
			{
				if(r___0__newRect__1__k__BackingField == null)
				{
					r___0__newRect__1__k__BackingField = new(this, "<newRect>k__BackingField");
					r___0__newRect__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__newRect__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r___0__layoutPass__1__k__BackingField;
		public virtual RSystem.RInt32 R__0__layoutPass__1__k__BackingField
		{
			get
			{
				if(r___0__layoutPass__1__k__BackingField == null)
				{
					r___0__layoutPass__1__k__BackingField = new(this, "<layoutPass>k__BackingField");
					r___0__layoutPass__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__layoutPass__1__k__BackingField;
			}
		}
		...
		/// Int32 layoutPass
		/// </summary>
		protected RSystem.RInt32 r_layoutPass;
		public virtual RSystem.RInt32 RlayoutPass
		{
			get
			{
		...
		/// </summary>
		protected static RMethod r_GetPooled_Rect_Rect;
		public static RMethod RGetPooled_Rect_Rect
		{
			get
			{
				if(r_GetPooled_Rect_Rect == null)
				{
					r_GetPooled_Rect_Rect = new(typeof(UnityEngine.UIElements.GeometryChangedEvent), "GetPooled", 0, typeof(UnityEngine.Rect), typeof(UnityEngine.Rect));
					r_GetPooled_Rect_Rect.SetBelong(null);
				}
				return r_GetPooled_Rect_Rect;
			}
		}
