...
{public partial class RScrollView
{
    ...
    public partial class RTouchScrollingResult : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult r_FApply;
		public static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult RFApply
		{
			get
			{
				if(r_FApply == null)
				{
					r_FApply = new( ReflectionUtils.GetType("UnityEngine.UIElements.ScrollView+TouchScrollingResult"), "Apply");
					r_FApply.SetBelong(null);
				}
				return r_FApply;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult r_FForward;
		public static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult RFForward
		{
			get
			{
				if(r_FForward == null)
				{
					r_FForward = new( ReflectionUtils.GetType("UnityEngine.UIElements.ScrollView+TouchScrollingResult"), "Forward");
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult r_FBlock;
		public static RUnityEngine.RUIElements.RScrollView.RTouchScrollingResult RFBlock
		{
			get
			{
				if(r_FBlock == null)
				{
					r_FBlock = new( ReflectionUtils.GetType("UnityEngine.UIElements.ScrollView+TouchScrollingResult"), "Block");
					r_FBlock.SetBelong(null);
				}
				return r_FBlock;
			}
		}
