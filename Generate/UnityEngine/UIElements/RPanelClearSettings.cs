...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RPanelClearSettings : RMember //
    {
		...
		public virtual RField RclearDepthStencil
		{
			get
			{
				if(r_clearDepthStencil == null)
				{
					r_clearDepthStencil = new(this, "clearDepthStencil");
					r_clearDepthStencil.SetBelong(this.instance);
				}
				return r_clearDepthStencil;
			}
		}
		...
		public virtual RField RclearColor
		{
			get
			{
				...
				{
					r_clearColor = new(this, "clearColor");
					r_clearColor.SetBelong(this.instance);
				}
				return r_clearColor;
			}
		}
