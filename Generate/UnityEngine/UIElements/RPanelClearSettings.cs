...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RPanelClearSettings : RMember //
    {
		...
		/// </summary>
		protected RSystem.RBoolean r_FclearDepthStencil;
		public virtual RSystem.RBoolean RFclearDepthStencil
		{
			get
			{
				if(r_FclearDepthStencil == null)
				{
					r_FclearDepthStencil = new(this, "clearDepthStencil");
					r_FclearDepthStencil.SetBelong(this.instance);
				}
				return r_FclearDepthStencil;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_FclearColor;
		public virtual RSystem.RBoolean RFclearColor
		{
			get
			{
				if(r_FclearColor == null)
				{
					r_FclearColor = new(this, "clearColor");
					r_FclearColor.SetBelong(this.instance);
				}
