...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RMouseUpEvent : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_GetPooled_Event;
		public static RMethod RGetPooled_Event
		{
			get
			{
				if(r_GetPooled_Event == null)
				{
					r_GetPooled_Event = new(typeof(UnityEngine.UIElements.MouseUpEvent), "GetPooled", 0, typeof(UnityEngine.Event));
					r_GetPooled_Event.SetBelong(null);
				}
				return r_GetPooled_Event;
			}
		}
		...
		/// </summary>
		protected static RMethod r_MakeFromPointerEvent_IPointerEvent;
		public static RMethod RMakeFromPointerEvent_IPointerEvent
		{
			get
			{
				if(r_MakeFromPointerEvent_IPointerEvent == null)
				{
					r_MakeFromPointerEvent_IPointerEvent = new(typeof(UnityEngine.UIElements.MouseUpEvent), "MakeFromPointerEvent", 0, typeof(UnityEngine.UIElements.IPointerEvent));
					r_MakeFromPointerEvent_IPointerEvent.SetBelong(null);
				}
				return r_MakeFromPointerEvent_IPointerEvent;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_PointerUpEvent;
		public static RMethod RGetPooled_PointerUpEvent
		{
			get
			{
				if(r_GetPooled_PointerUpEvent == null)
				{
					r_GetPooled_PointerUpEvent = new(typeof(UnityEngine.UIElements.MouseUpEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerUpEvent));
					r_GetPooled_PointerUpEvent.SetBelong(null);
				}
				return r_GetPooled_PointerUpEvent;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_PointerMoveEvent;
		public static RMethod RGetPooled_PointerMoveEvent
		{
			get
			{
				if(r_GetPooled_PointerMoveEvent == null)
				{
					r_GetPooled_PointerMoveEvent = new(typeof(UnityEngine.UIElements.MouseUpEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerMoveEvent));
					r_GetPooled_PointerMoveEvent.SetBelong(null);
				}
				return r_GetPooled_PointerMoveEvent;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_PointerCancelEvent;
		public static RMethod RGetPooled_PointerCancelEvent
		{
			get
			{
				if(r_GetPooled_PointerCancelEvent == null)
				{
					r_GetPooled_PointerCancelEvent = new(typeof(UnityEngine.UIElements.MouseUpEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerCancelEvent));
					r_GetPooled_PointerCancelEvent.SetBelong(null);
				}
				return r_GetPooled_PointerCancelEvent;
			}
		}
