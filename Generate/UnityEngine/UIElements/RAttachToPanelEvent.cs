...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RAttachToPanelEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIPanel r_PoriginPanel;
		public virtual RUnityEngine.RUIElements.RIPanel RPoriginPanel
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIPanel r_PdestinationPanel;
		public virtual RUnityEngine.RUIElements.RIPanel RPdestinationPanel
		{
			get
			{
