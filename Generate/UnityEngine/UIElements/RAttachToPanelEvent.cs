...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RAttachToPanelEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIPanel r_originPanel;
		public virtual RUnityEngine.RUIElements.RIPanel RoriginPanel
		{
			get
			{
				if(r_originPanel == null)
				{
					r_originPanel = new(this, "originPanel", -1);
					r_originPanel.SetBelong(this.instance);
				}
				return r_originPanel;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIPanel r_destinationPanel;
		public virtual RUnityEngine.RUIElements.RIPanel RdestinationPanel
		{
			get
			{
				if(r_destinationPanel == null)
				{
					r_destinationPanel = new(this, "destinationPanel", -1);
					r_destinationPanel.SetBelong(this.instance);
				}
				return r_destinationPanel;
			}
		}
