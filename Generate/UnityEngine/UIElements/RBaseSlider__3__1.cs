    ...
    public partial class RBaseSlider<TValueType> : RMember // where TValueType : System.IComparable<TValueType>
    {
		...
		public virtual RMethod RComputeValueFromKey_SliderKey_Boolean
		{
			get
			{
				...
				{
					r_ComputeValueFromKey_SliderKey_Boolean = new(this, "ComputeValueFromKey", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.BaseSlider`1+SliderKey").MakeGenericType(Type.MakeGenericMethodParameter(0)), typeof(System.Boolean));
