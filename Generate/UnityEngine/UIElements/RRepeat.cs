...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RRepeat : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RRepeat r_FNoRepeat;
		public static RUnityEngine.RUIElements.RRepeat RFNoRepeat
		{
			get
			{
				if(r_FNoRepeat == null)
				{
					r_FNoRepeat = new(typeof(UnityEngine.UIElements.Repeat), "NoRepeat");
					r_FNoRepeat.SetBelong(null);
				}
				return r_FNoRepeat;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RRepeat r_FSpace;
		public static RUnityEngine.RUIElements.RRepeat RFSpace
		{
			get
			{
				if(r_FSpace == null)
				{
					r_FSpace = new(typeof(UnityEngine.UIElements.Repeat), "Space");
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RRepeat r_FRound;
		public static RUnityEngine.RUIElements.RRepeat RFRound
		{
			get
			{
				if(r_FRound == null)
				{
					r_FRound = new(typeof(UnityEngine.UIElements.Repeat), "Round");
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RRepeat r_FRepeat;
		public static RUnityEngine.RUIElements.RRepeat RFRepeat
		{
			get
			{
				if(r_FRepeat == null)
				{
					r_FRepeat = new(typeof(UnityEngine.UIElements.Repeat), "Repeat");
