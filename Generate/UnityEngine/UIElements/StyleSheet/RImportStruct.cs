...
{public partial class RStyleSheet
{
    ...
    public partial class RImportStruct : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSheet r_styleSheet;
		public virtual RUnityEngine.RUIElements.RStyleSheet RstyleSheet
		{
			get
			{
		...
		public virtual RFieldArray<RField> RmediaQueries
		{
			get
			{
				if(r_mediaQueries == null)
				{
					r_mediaQueries = new(this, "mediaQueries");
					r_mediaQueries.SetBelong(this.instance);
				}
				return r_mediaQueries;
			}
		}
