...
{public partial class RStyleSheet
{
    ...
    public partial class RImportStruct : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RStyleSheet r_FstyleSheet;
		public virtual RUnityEngine.RUIElements.RStyleSheet RFstyleSheet
		{
			get
			{
		...
		/// </summary>
		protected RFieldArray<RSystem.RString> r_FmediaQueries;
		public virtual RFieldArray<RSystem.RString> RFmediaQueries
		{
			get
			{
				if(r_FmediaQueries == null)
				{
					...
					r_FmediaQueries.SetBelong(this.instance);
				}
