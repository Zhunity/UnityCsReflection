...
{public partial class RTextInputBaseField<TValueType>
{
    ...
    public partial class RTextInputBase : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextElement r_F__0__textElement__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.RTextElement RF__0__textElement__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RScrollView r_FscrollView;
		public virtual RUnityEngine.RUIElements.RScrollView RFscrollView
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualElement r_FmultilineContainer;
		public virtual RUnityEngine.RUIElements.RVisualElement RFmultilineContainer
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerComponentsModifierName;
		public static RSystem.RString RFinnerComponentsModifierName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerTextElementUssClassName;
		public static RSystem.RString RFinnerTextElementUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerTextElementWithScrollViewUssClassName;
		public static RSystem.RString RFinnerTextElementWithScrollViewUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FhorizontalVariantInnerTextElementUssClassName;
		public static RSystem.RString RFhorizontalVariantInnerTextElementUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FverticalVariantInnerTextElementUssClassName;
		public static RSystem.RString RFverticalVariantInnerTextElementUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FverticalHorizontalVariantInnerTextElementUssClassName;
		public static RSystem.RString RFverticalHorizontalVariantInnerTextElementUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerScrollviewUssClassName;
		public static RSystem.RString RFinnerScrollviewUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerViewportUssClassName;
		public static RSystem.RString RFinnerViewportUssClassName
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RString r_FinnerContentContainerUssClassName;
		public static RSystem.RString RFinnerContentContainerUssClassName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_F__0__isDragging__1__k__BackingField;
		public virtual RSystem.RBoolean RF__0__isDragging__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_FscrollOffset;
		public virtual RUnityEngine.RVector2 RFscrollOffset
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_ScrollViewWasClamped;
		public virtual RSystem.RBoolean RFm_ScrollViewWasClamped
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_FlastCursorPos;
		public virtual RUnityEngine.RVector2 RFlastCursorPos
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextElement r_PtextElement;
		public virtual RUnityEngine.RUIElements.RTextElement RPtextElement
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RITextSelection r_PtextSelection;
		public virtual RUnityEngine.RUIElements.RITextSelection RPtextSelection
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RITextEdition r_PtextEdition;
		public virtual RUnityEngine.RUIElements.RITextEdition RPtextEdition
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PisPasswordField;
		public virtual RSystem.RBoolean RPisPasswordField
		{
			get
			{
		...
		/// Boolean isDragging
		/// </summary>
		protected RSystem.RBoolean r_PisDragging;
		public virtual RSystem.RBoolean RPisDragging
		{
			get
			{
		...
		/// </summary>
		protected RMethod r_MGetScrollOffset_Single_Single_Single_Boolean;
		public virtual RMethod RMGetScrollOffset_Single_Single_Single_Boolean
		{
			get
			{
				if(r_MGetScrollOffset_Single_Single_Single_Boolean == null)
				{
					r_MGetScrollOffset_Single_Single_Single_Boolean = new(this, "GetScrollOffset", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single), typeof(System.Boolean));
					r_MGetScrollOffset_Single_Single_Single_Boolean.SetBelong(this.instance);
				}
				return r_MGetScrollOffset_Single_Single_Single_Boolean;
			}
		}
        ...
        public virtual UnityEngine.Vector2 GetScrollOffset(System.Single @xOffset, System.Single @yOffset, System.Single @contentViewportWidth, System.Boolean @isBackspace)
        {
            ...
            var ___result = RMGetScrollOffset_Single_Single_Single_Boolean.Invoke(___genericsType, ___parameters);
