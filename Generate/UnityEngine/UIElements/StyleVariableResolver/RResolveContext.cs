...
{public partial class RStyleVariableResolver
{
    ...
    public partial class RResolveContext : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RUIElements.RStyleValueHandle> r_Fhandles;
		public virtual RFieldArray<RUnityEngine.RUIElements.RStyleValueHandle> RFhandles
		{
			get
			{
				if(r_Fhandles == null)
				{
					r_Fhandles = new(this, "handles");
					r_Fhandles.SetBelong(this.instance);
				}
				return r_Fhandles;
			}
		}
