...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventDebuggerTrace : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.REventDebuggerEventRecord r___1__eventBase__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.REventDebuggerEventRecord R__1__eventBase__2__k__BackingField
		{
			get
			{
				if(r___1__eventBase__2__k__BackingField == null)
				{
					r___1__eventBase__2__k__BackingField = new(this, "<eventBase>k__BackingField");
					r___1__eventBase__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__eventBase__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIEventHandler r___1__focusedElement__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RIEventHandler R__1__focusedElement__2__k__BackingField
		{
			get
			{
				if(r___1__focusedElement__2__k__BackingField == null)
				{
					r___1__focusedElement__2__k__BackingField = new(this, "<focusedElement>k__BackingField");
					r___1__focusedElement__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__focusedElement__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RIEventHandler r___1__mouseCapture__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RIEventHandler R__1__mouseCapture__2__k__BackingField
		{
			get
			{
				if(r___1__mouseCapture__2__k__BackingField == null)
				{
					r___1__mouseCapture__2__k__BackingField = new(this, "<mouseCapture>k__BackingField");
					r___1__mouseCapture__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__mouseCapture__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___1__duration__2__k__BackingField;
		public virtual RField R__1__duration__2__k__BackingField
		{
			get
			{
				if(r___1__duration__2__k__BackingField == null)
				{
					r___1__duration__2__k__BackingField = new(this, "<duration>k__BackingField");
					r___1__duration__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__duration__2__k__BackingField;
			}
		}
