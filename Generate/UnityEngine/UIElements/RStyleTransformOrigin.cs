...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleTransformOrigin : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTransformOrigin r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RTransformOrigin RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTransformOrigin r_Pvalue;
		public virtual RUnityEngine.RUIElements.RTransformOrigin RPvalue
		{
			get
			{
				if(r_Pvalue == null)
