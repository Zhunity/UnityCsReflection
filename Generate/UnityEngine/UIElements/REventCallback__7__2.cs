...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventCallback<TEventType, TCallbackArgs> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_TEventType_TCallbackArgs;
		public virtual RMethod RInvoke_TEventType_TCallbackArgs
		{
			get
			{
				if(r_RInvoke_TEventType_TCallbackArgs == null)
				{
					r_RInvoke_TEventType_TCallbackArgs = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_RInvoke_TEventType_TCallbackArgs.SetBelong(this.instance);
				}
				return r_RInvoke_TEventType_TCallbackArgs;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(TEventType  @evt, TCallbackArgs  @userArgs)
        {
            ...
            var ___result = RInvoke_TEventType_TCallbackArgs.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(TEventType  @evt, TCallbackArgs  @userArgs, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_TEventType_TCallbackArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
