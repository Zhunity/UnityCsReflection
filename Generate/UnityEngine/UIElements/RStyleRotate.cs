...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleRotate : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_op_Equality_StyleRotate_StyleRotate;
		public static RMethod Rop_Equality_StyleRotate_StyleRotate
		{
			get
			{
				if(r_op_Equality_StyleRotate_StyleRotate == null)
				{
					r_op_Equality_StyleRotate_StyleRotate = new(typeof(UnityEngine.UIElements.StyleRotate), "op_Equality", 0, typeof(UnityEngine.UIElements.StyleRotate), typeof(UnityEngine.UIElements.StyleRotate));
					r_op_Equality_StyleRotate_StyleRotate.SetBelong(null);
				}
				return r_op_Equality_StyleRotate_StyleRotate;
			}
		}
		...
		/// </summary>
		protected static RMethod r_op_Inequality_StyleRotate_StyleRotate;
		public static RMethod Rop_Inequality_StyleRotate_StyleRotate
		{
			get
			{
				if(r_op_Inequality_StyleRotate_StyleRotate == null)
				{
					r_op_Inequality_StyleRotate_StyleRotate = new(typeof(UnityEngine.UIElements.StyleRotate), "op_Inequality", 0, typeof(UnityEngine.UIElements.StyleRotate), typeof(UnityEngine.UIElements.StyleRotate));
					r_op_Inequality_StyleRotate_StyleRotate.SetBelong(null);
				}
				return r_op_Inequality_StyleRotate_StyleRotate;
			}
		}
		...
		public static RMethod Rop_Implicit_StyleKeyword
		{
			get
			{
				...
				{
					r_op_Implicit_StyleKeyword = new(typeof(UnityEngine.UIElements.StyleRotate), "op_Implicit", 0, typeof(UnityEngine.UIElements.StyleKeyword));
		...
		/// </summary>
		protected static RMethod r_op_Implicit_Rotate;
		public static RMethod Rop_Implicit_Rotate
		{
			get
			{
				if(r_op_Implicit_Rotate == null)
				{
					r_op_Implicit_Rotate = new(typeof(UnityEngine.UIElements.StyleRotate), "op_Implicit", 0, typeof(UnityEngine.UIElements.Rotate));
					r_op_Implicit_Rotate.SetBelong(null);
				}
				return r_op_Implicit_Rotate;
			}
		}
		...
		/// </summary>
		protected RMethod r_Equals_StyleRotate;
		public virtual RMethod REquals_StyleRotate
		{
			get
			{
				if(r_Equals_StyleRotate == null)
				{
					r_Equals_StyleRotate = new(this, "Equals", 0, typeof(UnityEngine.UIElements.StyleRotate));
					r_Equals_StyleRotate.SetBelong(this.instance);
				}
				return r_Equals_StyleRotate;
			}
		}
