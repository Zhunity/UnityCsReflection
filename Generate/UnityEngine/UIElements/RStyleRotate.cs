...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleRotate : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRotate r_Fm_Value;
		public virtual RUnityEngine.RUIElements.RRotate RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RRotate r_Pvalue;
		public virtual RUnityEngine.RUIElements.RRotate RPvalue
		{
			get
			{
				if(r_Pvalue == null)
