...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RPointerMoveEvent : RMember //
    {
		...
		/// </summary>
		protected RSystem.RBoolean r___0__isHandledByDraggable__1__k__BackingField;
		public virtual RSystem.RBoolean R__0__isHandledByDraggable__1__k__BackingField
		{
			get
			{
				if(r___0__isHandledByDraggable__1__k__BackingField == null)
				{
					r___0__isHandledByDraggable__1__k__BackingField = new(this, "<isHandledByDraggable>k__BackingField");
					r___0__isHandledByDraggable__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__isHandledByDraggable__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_isHandledByDraggable;
		public virtual RSystem.RBoolean RisHandledByDraggable
		{
			get
			{
				if(r_isHandledByDraggable == null)
				{
					r_isHandledByDraggable = new(this, "isHandledByDraggable", -1);
					r_isHandledByDraggable.SetBelong(this.instance);
				}
				return r_isHandledByDraggable;
			}
		}
