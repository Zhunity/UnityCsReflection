...
{public partial class RStyleComplexSelector
{
    ...
    public partial class RPseudoStateData : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RPseudoStates r_Fstate;
		public virtual RUnityEngine.RUIElements.RPseudoStates RFstate
		{
			get
			{
				if(r_Fstate == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fnegate;
		public virtual RSystem.RBoolean RFnegate
		{
			get
			{
				if(r_Fnegate == null)
				{
					r_Fnegate = new(this, "negate");
					r_Fnegate.SetBelong(this.instance);
				}
				return r_Fnegate;
			}
		}
