    ...
    public partial class RMouseDownEvent : RMember //
    {
		...
		public static RMethod RGetPooled_Event
		{
			get
			{
				...
				{
					r_RGetPooled_Event = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.Event));
		...
		public static RMethod RMakeFromPointerEvent_IPointerEvent
		{
			get
			{
				...
				{
					r_RMakeFromPointerEvent_IPointerEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "MakeFromPointerEvent", 0, typeof(UnityEngine.UIElements.IPointerEvent));
		...
		/// </summary>
		protected static RMethod r_RGetPooled_PointerDownEvent;
		public static RMethod RGetPooled_PointerDownEvent
		{
			get
			{
				if(r_RGetPooled_PointerDownEvent == null)
				{
					r_RGetPooled_PointerDownEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerDownEvent));
					r_RGetPooled_PointerDownEvent.SetBelong(null);
				}
				return r_RGetPooled_PointerDownEvent;
			}
		}
		...
		public static RMethod RGetPooled_PointerMoveEvent
		{
			get
			{
				...
				{
					r_RGetPooled_PointerMoveEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerMoveEvent));
        ...
        public static UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.UIElements.PointerDownEvent  @pointerEvent)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pointerEvent};
            var ___result = RGetPooled_PointerDownEvent.Invoke(___genericsType, ___parameters);
