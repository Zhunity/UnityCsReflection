...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTemplateContainer : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r___0__templateId__1__k__BackingField;
		public virtual RSystem.RString R__0__templateId__1__k__BackingField
		{
			get
			{
				if(r___0__templateId__1__k__BackingField == null)
				{
					r___0__templateId__1__k__BackingField = new(this, "<templateId>k__BackingField");
					r___0__templateId__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__templateId__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualTreeAsset r_m_TemplateSource;
		public virtual RUnityEngine.RUIElements.RVisualTreeAsset Rm_TemplateSource
		{
			get
			{
				if(r_m_TemplateSource == null)
				{
					r_m_TemplateSource = new(this, "m_TemplateSource");
					r_m_TemplateSource.SetBelong(this.instance);
				}
				return r_m_TemplateSource;
			}
		}
		...
		/// </summary>
		protected RSystem.RString r_templateId;
		public virtual RSystem.RString RtemplateId
		{
			get
			{
				if(r_templateId == null)
				{
					r_templateId = new(this, "templateId", -1);
					r_templateId.SetBelong(this.instance);
				}
				return r_templateId;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RVisualTreeAsset r_templateSource;
		public virtual RUnityEngine.RUIElements.RVisualTreeAsset RtemplateSource
		{
			get
			{
				if(r_templateSource == null)
				{
					r_templateSource = new(this, "templateSource", -1);
					r_templateSource.SetBelong(this.instance);
				}
				return r_templateSource;
			}
		}
		...
		/// </summary>
		protected RMethod r_SetContentContainer_VisualElement;
		public virtual RMethod RSetContentContainer_VisualElement
		{
			get
			{
				if(r_SetContentContainer_VisualElement == null)
				{
					r_SetContentContainer_VisualElement = new(this, "SetContentContainer", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_SetContentContainer_VisualElement.SetBelong(this.instance);
				}
				return r_SetContentContainer_VisualElement;
			}
		}
        ...
        public virtual void SetContentContainer(UnityEngine.UIElements.VisualElement @content)
        {
            ...
            var ___result = RSetContentContainer_VisualElement.Invoke(___genericsType, ___parameters);
