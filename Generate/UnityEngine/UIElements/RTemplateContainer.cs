...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTemplateContainer : RMember //
    {
		...
		/// </summary>
		protected RField r___1__templateId__2__k__BackingField;
		public virtual RField R__1__templateId__2__k__BackingField
		{
			get
			{
				if(r___1__templateId__2__k__BackingField == null)
				{
					r___1__templateId__2__k__BackingField = new(this, "<templateId>k__BackingField");
					r___1__templateId__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__templateId__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RProperty r_templateId;
		public virtual RProperty RtemplateId
		{
			get
			{
		...
		/// </summary>
		protected RMethod r_RSetContentContainer_VisualElement;
		public virtual RMethod RSetContentContainer_VisualElement
		{
			get
			{
				if(r_RSetContentContainer_VisualElement == null)
				{
					r_RSetContentContainer_VisualElement = new(this, "SetContentContainer", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_RSetContentContainer_VisualElement.SetBelong(this.instance);
				}
				return r_RSetContentContainer_VisualElement;
			}
		}
