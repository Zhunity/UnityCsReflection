...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventDebuggerDefaultActionTrace : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RPropagationPhase r_F__0__phase__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.RPropagationPhase RF__0__phase__1__k__BackingField
		{
			get
			{
				if(r_F__0__phase__1__k__BackingField == null)
				{
					...
					r_F__0__phase__1__k__BackingField.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RPropagationPhase r_Pphase;
		public virtual RUnityEngine.RUIElements.RPropagationPhase RPphase
		{
			get
			{
				if(r_Pphase == null)
				{
					...
					r_Pphase.SetBelong(this.instance);
				}
				return r_Pphase;
			}
		}
		...
		/// </summary>
		protected RSystem.RString r_PtargetName;
		public virtual RSystem.RString RPtargetName
		{
			get
			{
				if(r_PtargetName == null)
				{
					...
					r_PtargetName.SetBelong(this.instance);
				}
