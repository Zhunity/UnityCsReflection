...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventDebuggerDefaultActionTrace : RMember //
    {
		...
		/// </summary>
		protected RField r___1__phase__2__k__BackingField;
		public virtual RField R__1__phase__2__k__BackingField
		{
			get
			{
				if(r___1__phase__2__k__BackingField == null)
				{
					r___1__phase__2__k__BackingField = new(this, "<phase>k__BackingField");
					r___1__phase__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__phase__2__k__BackingField;
			}
		}
