    ...
    public partial class RSlider : RMember //
    {
		...
		public virtual RMethod RComputeValueFromKey_SliderKey_Boolean
		{
			get
			{
				...
				{
					r_ComputeValueFromKey_SliderKey_Boolean = new(this, "ComputeValueFromKey", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.BaseSlider`1+SliderKey").MakeGenericType(typeof(System.Single)), typeof(System.Boolean));
