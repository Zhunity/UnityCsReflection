...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RSlider : RMember //
    {
		...
		/// </summary>
		protected static RField r_kDefaultHighValue;
		public static RField RkDefaultHighValue
		{
			get
			{
		...
		/// </summary>
		protected RMethod r_RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single;
		public virtual RMethod RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single
		{
			get
			{
				if(r_RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single == null)
				{
					r_RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single = new(this, "ApplyInputDeviceDelta", 0, typeof(UnityEngine.Vector3), typeof(UnityEngine.UIElements.DeltaSpeed), typeof(System.Single));
					r_RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single.SetBelong(this.instance);
				}
				return r_RApplyInputDeviceDelta_Vector3_DeltaSpeed_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSliderLerpUnclamped_Single_Single_Single;
		public virtual RMethod RSliderLerpUnclamped_Single_Single_Single
		{
			get
			{
				if(r_RSliderLerpUnclamped_Single_Single_Single == null)
				{
					r_RSliderLerpUnclamped_Single_Single_Single = new(this, "SliderLerpUnclamped", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_RSliderLerpUnclamped_Single_Single_Single.SetBelong(this.instance);
				}
				return r_RSliderLerpUnclamped_Single_Single_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSliderNormalizeValue_Single_Single_Single;
		public virtual RMethod RSliderNormalizeValue_Single_Single_Single
		{
			get
			{
				if(r_RSliderNormalizeValue_Single_Single_Single == null)
				{
					r_RSliderNormalizeValue_Single_Single_Single = new(this, "SliderNormalizeValue", 0, typeof(System.Single), typeof(System.Single), typeof(System.Single));
					r_RSliderNormalizeValue_Single_Single_Single.SetBelong(this.instance);
				}
				return r_RSliderNormalizeValue_Single_Single_Single;
			}
		}
		...
		public virtual RMethod RComputeValueFromKey_SliderKey_Boolean
		{
			get
			{
				...
				{
					r_RComputeValueFromKey_SliderKey_Boolean = new(this, "ComputeValueFromKey", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.BaseSlider`1+SliderKey").MakeGenericType(typeof(System.Single)), typeof(System.Boolean));
		...
		/// </summary>
		protected RMethod r_RSetHighValueWithoutNotify_Single;
		public virtual RMethod RSetHighValueWithoutNotify_Single
		{
			get
			{
				if(r_RSetHighValueWithoutNotify_Single == null)
				{
					r_RSetHighValueWithoutNotify_Single = new(this, "SetHighValueWithoutNotify", 0, typeof(System.Single));
					r_RSetHighValueWithoutNotify_Single.SetBelong(this.instance);
				}
				return r_RSetHighValueWithoutNotify_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSetValueWithoutNotify_Single;
		public virtual RMethod RSetValueWithoutNotify_Single
		{
			get
			{
				if(r_RSetValueWithoutNotify_Single == null)
				{
					r_RSetValueWithoutNotify_Single = new(this, "SetValueWithoutNotify", 0, typeof(System.Single));
					r_RSetValueWithoutNotify_Single.SetBelong(this.instance);
				}
				return r_RSetValueWithoutNotify_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RValidatedValue_Single;
		public virtual RMethod RValidatedValue_Single
		{
			get
			{
				if(r_RValidatedValue_Single == null)
				{
					r_RValidatedValue_Single = new(this, "ValidatedValue", 0, typeof(System.Single));
					r_RValidatedValue_Single.SetBelong(this.instance);
				}
				return r_RValidatedValue_Single;
			}
		}
		...
		/// </summary>
		protected RMethod r_RSetValueWithoutValidation_Single;
		public virtual RMethod RSetValueWithoutValidation_Single
		{
			get
			{
				if(r_RSetValueWithoutValidation_Single == null)
				{
					r_RSetValueWithoutValidation_Single = new(this, "SetValueWithoutValidation", 0, typeof(System.Single));
					r_RSetValueWithoutValidation_Single.SetBelong(this.instance);
				}
				return r_RSetValueWithoutValidation_Single;
			}
		}
