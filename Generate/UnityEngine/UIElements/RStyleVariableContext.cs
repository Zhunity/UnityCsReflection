...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleVariableContext : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RStyleVariableContext r_Fnone;
		public static RUnityEngine.RUIElements.RStyleVariableContext RFnone
		{
			get
			{
				if(r_Fnone == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_VariableHash;
		public virtual RSystem.RInt32 RFm_VariableHash
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleVariable> r_Fm_Variables;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleVariable> RFm_Variables
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RSystem.RInt32> r_Fm_SortedHash;
		public virtual RSystem.RCollections.RGeneric.RList<RSystem.RInt32> RFm_SortedHash
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleVariable> r_Pvariables;
		public virtual RSystem.RCollections.RGeneric.RList<RUnityEngine.RUIElements.RStyleVariable> RPvariables
		{
			get
			{
