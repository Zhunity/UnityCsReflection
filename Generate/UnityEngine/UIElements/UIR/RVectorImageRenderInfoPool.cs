...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RVectorImageRenderInfoPool : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RReturn_VectorImageRenderInfo;
		public virtual RMethod RReturn_VectorImageRenderInfo
		{
			get
			{
				if(r_RReturn_VectorImageRenderInfo == null)
				{
					r_RReturn_VectorImageRenderInfo = new(this, "Return", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.UIR.VectorImageRenderInfo"));
					r_RReturn_VectorImageRenderInfo.SetBelong(this.instance);
				}
				return r_RReturn_VectorImageRenderInfo;
			}
		}
