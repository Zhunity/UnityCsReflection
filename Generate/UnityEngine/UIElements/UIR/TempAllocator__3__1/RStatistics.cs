...
{public partial class RTempAllocator<T>
{
    ...
    public partial class RStatistics : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RTempAllocator<RField>.RPageStatistics r_Fpool;
		public virtual RUnityEngine.RUIElements.RUIR.RTempAllocator<RField>.RPageStatistics RFpool
		{
			get
			{
				if(r_Fpool == null)
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RUIElements.RUIR.RTempAllocator<RField>.RPageStatistics> r_Fexcess;
		public virtual RFieldArray<RUnityEngine.RUIElements.RUIR.RTempAllocator<RField>.RPageStatistics> RFexcess
		{
			get
			{
				if(r_Fexcess == null)
