...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RGfxUpdateBufferRange : RMember //
    {
		...
		public virtual RField RoffsetFromWriteStart
		{
			get
			{
				if(r_offsetFromWriteStart == null)
				{
					r_offsetFromWriteStart = new(this, "offsetFromWriteStart");
					r_offsetFromWriteStart.SetBelong(this.instance);
				}
				return r_offsetFromWriteStart;
			}
		}
