...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RGfxUpdateBufferRange : RMember //
    {
		...
		/// </summary>
		protected RSystem.RUInt32 r_FoffsetFromWriteStart;
		public virtual RSystem.RUInt32 RFoffsetFromWriteStart
		{
			get
			{
				if(r_FoffsetFromWriteStart == null)
				{
					...
					r_FoffsetFromWriteStart.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RSystem.RUIntPtr r_Fsource;
		public virtual RSystem.RUIntPtr RFsource
		{
			get
			{
				if(r_Fsource == null)
