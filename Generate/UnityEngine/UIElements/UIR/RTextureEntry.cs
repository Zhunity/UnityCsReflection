...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RTextureEntry : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RTexture r_source;
		public virtual RUnityEngine.RTexture Rsource
		{
			get
			{
				if(r_source == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RTextureId r_actual;
		public virtual RUnityEngine.RUIElements.RTextureId Ractual
		{
			get
			{
				if(r_actual == null)
				{
					r_actual = new(this, "actual");
					r_actual.SetBelong(this.instance);
				}
				return r_actual;
			}
		}
		...
		public virtual RField Rreplaced
		{
			get
			{
				if(r_replaced == null)
				{
					r_replaced = new(this, "replaced");
					r_replaced.SetBelong(this.instance);
				}
				return r_replaced;
			}
		}
