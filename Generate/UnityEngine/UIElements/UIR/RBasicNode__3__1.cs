...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RBasicNode<T> : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RBasicNode<RField> r_Fnext;
		public virtual RUnityEngine.RUIElements.RUIR.RBasicNode<RField> RFnext
		{
			get
			{
				if(r_Fnext == null)
		...
		/// T data
		/// </summary>
		protected RField r_Fdata;
		public virtual RField RFdata
		{
			get
			{
				if(r_Fdata == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RBasicNode<RField> r_FpoolNext;
		public virtual RUnityEngine.RUIElements.RUIR.RBasicNode<RField> RFpoolNext
		{
			get
			{
				if(r_FpoolNext == null)
		...
		public virtual RMethod RMAppendTo_Ref_BasicNode_d_T_p_
		{
			get
			{
				if(r_MAppendTo_Ref_BasicNode_d_T_p_ == null)
				{
					...
					r_MAppendTo_Ref_BasicNode_d_T_p_.SetBelong(this.instance);
				}
