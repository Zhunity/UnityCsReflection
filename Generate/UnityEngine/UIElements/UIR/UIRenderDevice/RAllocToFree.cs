...
{public partial class RUIRenderDevice
{
    ...
    public partial class RAllocToFree : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RAlloc r_Falloc;
		public virtual RUnityEngine.RUIElements.RUIR.RAlloc RFalloc
		{
			get
			{
				if(r_Falloc == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RPage r_Fpage;
		public virtual RUnityEngine.RUIElements.RUIR.RPage RFpage
		{
			get
			{
				if(r_Fpage == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fvertices;
		public virtual RSystem.RBoolean RFvertices
		{
			get
			{
				if(r_Fvertices == null)
