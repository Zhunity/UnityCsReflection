	...
	public partial class RAllocationStatistics
{
    ...
    public partial class RPageStatistics : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RHeapStatistics r_vertices;
		public virtual RUnityEngine.RUIElements.RUIR.RHeapStatistics Rvertices
		{
			get
			{
				if(r_vertices == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RHeapStatistics r_indices;
		public virtual RUnityEngine.RUIElements.RUIR.RHeapStatistics Rindices
		{
			get
			{
				if(r_indices == null)
