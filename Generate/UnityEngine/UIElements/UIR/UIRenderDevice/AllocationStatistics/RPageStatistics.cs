	...
	public partial class RAllocationStatistics
{
    ...
    public partial class RPageStatistics : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RHeapStatistics r_Fvertices;
		public virtual RUnityEngine.RUIElements.RUIR.RHeapStatistics RFvertices
		{
			get
			{
				if(r_Fvertices == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RUIR.RHeapStatistics r_Findices;
		public virtual RUnityEngine.RUIElements.RUIR.RHeapStatistics RFindices
		{
			get
			{
				if(r_Findices == null)
        ...
        public RPageStatistics() : base("UnityEngine.UIElements.UIR.UIRenderDevice+AllocationStatistics+PageStatistics")
        {
        }

        public RPageStatistics(System.Object instance) : base("UnityEngine.UIElements.UIR.UIRenderDevice+AllocationStatistics+PageStatistics")
		{
