...
{public partial class RUIRenderDevice
{
    ...
    public partial class RAllocationStatistics : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RUIElements.RUIR.RUIRenderDevice.RAllocationStatistics.RPageStatistics> r_Fpages;
		public virtual RFieldArray<RUnityEngine.RUIElements.RUIR.RUIRenderDevice.RAllocationStatistics.RPageStatistics> RFpages
		{
			get
			{
				if(r_Fpages == null)
		...
		/// </summary>
		protected RFieldArray<RSystem.RInt32> r_FfreesDeferred;
		public virtual RFieldArray<RSystem.RInt32> RFfreesDeferred
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_FcompleteInit;
		public virtual RSystem.RBoolean RFcompleteInit
		{
			get
			{
