...
{public partial class RUIRenderDevice
{
    ...
    public partial class RAllocationStatistics : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RUIElements.RUIR.RUIRenderDevice.RAllocationStatistics.RPageStatistics> r_pages;
		public virtual RFieldArray<RUnityEngine.RUIElements.RUIR.RUIRenderDevice.RAllocationStatistics.RPageStatistics> Rpages
		{
			get
			{
				if(r_pages == null)
				{
					r_pages = new(this, "pages");
					r_pages.SetBelong(this.instance);
				}
				return r_pages;
			}
		}
		...
		public virtual RFieldArray<RField> RfreesDeferred
		{
			get
			{
				if(r_freesDeferred == null)
				{
					r_freesDeferred = new(this, "freesDeferred");
					r_freesDeferred.SetBelong(this.instance);
				}
				return r_freesDeferred;
			}
		}
		...
		public virtual RField RcompleteInit
		{
			get
			{
				if(r_completeInit == null)
				{
					r_completeInit = new(this, "completeInit");
					r_completeInit.SetBelong(this.instance);
				}
				return r_completeInit;
			}
		}
