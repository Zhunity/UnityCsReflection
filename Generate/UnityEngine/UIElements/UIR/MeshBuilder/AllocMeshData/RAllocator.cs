	...
	public partial class RAllocMeshData
{
    ...
    public partial class RAllocator : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.UIElements.MeshWriteData Invoke(UInt32, UInt32, AllocMeshData ByRef)
		/// </summary>
		protected RMethod r_MInvoke_UInt32_UInt32_Ref_AllocMeshData;
		public virtual RMethod RMInvoke_UInt32_UInt32_Ref_AllocMeshData
		{
			get
			{
				if(r_MInvoke_UInt32_UInt32_Ref_AllocMeshData == null)
				{
					r_MInvoke_UInt32_UInt32_Ref_AllocMeshData = new(this, "Invoke", 0, typeof(System.UInt32), typeof(System.UInt32),  ReflectionUtils.GetType("UnityEngine.UIElements.UIR.MeshBuilder+AllocMeshData").MakeByRefType());
					r_MInvoke_UInt32_UInt32_Ref_AllocMeshData.SetBelong(this.instance);
				}
				return r_MInvoke_UInt32_UInt32_Ref_AllocMeshData;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UInt32, UInt32, AllocMeshData ByRef, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.UInt32), typeof(System.UInt32),  ReflectionUtils.GetType("UnityEngine.UIElements.UIR.MeshBuilder+AllocMeshData").MakeByRefType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_UInt32_UInt32_Ref_AllocMeshData_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.MeshWriteData EndInvoke(AllocMeshData ByRef, System.IAsyncResult)
		/// </summary>
		protected RMethod r_MEndInvoke_Ref_AllocMeshData_IAsyncResult;
		public virtual RMethod RMEndInvoke_Ref_AllocMeshData_IAsyncResult
		{
			get
			{
				if(r_MEndInvoke_Ref_AllocMeshData_IAsyncResult == null)
				{
					r_MEndInvoke_Ref_AllocMeshData_IAsyncResult = new(this, "EndInvoke", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.UIR.MeshBuilder+AllocMeshData").MakeByRefType(), typeof(System.IAsyncResult));
					r_MEndInvoke_Ref_AllocMeshData_IAsyncResult.SetBelong(this.instance);
				}
				return r_MEndInvoke_Ref_AllocMeshData_IAsyncResult;
			}
		}
        ...
        public RAllocator() : base("UnityEngine.UIElements.UIR.MeshBuilder+AllocMeshData+Allocator")
        {
        }

        public RAllocator(System.Object instance) : base("UnityEngine.UIElements.UIR.MeshBuilder+AllocMeshData+Allocator")
		{
            SetInstance(instance);
		}

        public RAllocator(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAllocator(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
