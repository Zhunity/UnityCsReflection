...
{public partial class RBitmapAllocator32
{
    ...
    public partial class RPage : RMember //
    {
		...
		/// System.UInt16 x
		/// </summary>
		protected RSystem.RUInt16 r_Fx;
		public virtual RSystem.RUInt16 RFx
		{
			get
			{
				if(r_Fx == null)
		...
		/// System.UInt16 y
		/// </summary>
		protected RSystem.RUInt16 r_Fy;
		public virtual RSystem.RUInt16 RFy
		{
			get
			{
				if(r_Fy == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_FfreeSlots;
		public virtual RSystem.RInt32 RFfreeSlots
		{
			get
			{
				if(r_FfreeSlots == null)
				{
					r_FfreeSlots = new(this, "freeSlots");
					r_FfreeSlots.SetBelong(this.instance);
				}
				return r_FfreeSlots;
			}
		}
