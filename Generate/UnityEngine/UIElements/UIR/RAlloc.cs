...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RAlloc : RMember //
    {
		...
		/// System.UInt32 size
		/// </summary>
		protected RSystem.RUInt32 r_Fsize;
		public virtual RSystem.RUInt32 RFsize
		{
			get
			{
				if(r_Fsize == null)
		...
		/// </summary>
		protected RSystem.RObject r_Fhandle;
		public virtual RSystem.RObject RFhandle
		{
			get
			{
				if(r_Fhandle == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_FshortLived;
		public virtual RSystem.RBoolean RFshortLived
		{
			get
			{
				if(r_FshortLived == null)
				{
					...
					r_FshortLived.SetBelong(this.instance);
				}
