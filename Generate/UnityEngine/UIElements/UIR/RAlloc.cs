...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RAlloc : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_handle;
		public virtual RSystem.RObject Rhandle
		{
			get
			{
				if(r_handle == null)
		...
		public virtual RSystem.RBoolean RshortLived
		{
			get
			{
				if(r_shortLived == null)
				{
					r_shortLived = new(this, "shortLived");
					r_shortLived.SetBelong(this.instance);
				}
				return r_shortLived;
			}
		}
