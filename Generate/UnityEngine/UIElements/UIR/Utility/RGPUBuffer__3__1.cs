...
{public partial class RUtility
{
    ...
    public partial class RGPUBuffer<T> : RMember // where T : struct
    {
		...
		/// </summary>
		protected RSystem.RIntPtr r_Fbuffer;
		public virtual RSystem.RIntPtr RFbuffer
		{
			get
			{
				if(r_Fbuffer == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_FelemCount;
		public virtual RSystem.RInt32 RFelemCount
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_FelemStride;
		public virtual RSystem.RInt32 RFelemStride
		{
			get
			{
		...
		/// Int32 ElementStride
		/// </summary>
		protected RSystem.RInt32 r_PElementStride;
		public virtual RSystem.RInt32 RPElementStride
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RIntPtr r_PBufferPointer;
		public virtual RSystem.RIntPtr RPBufferPointer
		{
			get
			{
