...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RRenderChainVEData : RMember //
    {
		...
		/// </summary>
		protected static RMethod r_RAllocatesID_BMPAlloc;
		public static RMethod RAllocatesID_BMPAlloc
		{
			get
			{
				if(r_RAllocatesID_BMPAlloc == null)
				{
					r_RAllocatesID_BMPAlloc = new( ReleactionUtils.GetType("UnityEngine.UIElements.UIR.RenderChainVEData"), "AllocatesID", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.UIR.BMPAlloc"));
					r_RAllocatesID_BMPAlloc.SetBelong(null);
				}
				return r_RAllocatesID_BMPAlloc;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RInheritsID_BMPAlloc;
		public static RMethod RInheritsID_BMPAlloc
		{
			get
			{
				if(r_RInheritsID_BMPAlloc == null)
				{
					r_RInheritsID_BMPAlloc = new( ReleactionUtils.GetType("UnityEngine.UIElements.UIR.RenderChainVEData"), "InheritsID", 0,  ReleactionUtils.GetType("UnityEngine.UIElements.UIR.BMPAlloc"));
					r_RInheritsID_BMPAlloc.SetBelong(null);
				}
				return r_RInheritsID_BMPAlloc;
			}
		}
