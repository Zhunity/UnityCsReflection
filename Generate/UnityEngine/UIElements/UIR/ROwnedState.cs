...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class ROwnedState : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RUIR.ROwnedState r_FInherited;
		public static RUnityEngine.RUIElements.RUIR.ROwnedState RFInherited
		{
			get
			{
				if(r_FInherited == null)
				{
					r_FInherited = new( ReflectionUtils.GetType("UnityEngine.UIElements.UIR.OwnedState"), "Inherited");
		...
		/// </summary>
		protected static RUnityEngine.RUIElements.RUIR.ROwnedState r_FOwned;
		public static RUnityEngine.RUIElements.RUIR.ROwnedState RFOwned
		{
			get
			{
				if(r_FOwned == null)
				{
					r_FOwned = new( ReflectionUtils.GetType("UnityEngine.UIElements.UIR.OwnedState"), "Owned");
					r_FOwned.SetBelong(null);
				}
				return r_FOwned;
			}
		}
