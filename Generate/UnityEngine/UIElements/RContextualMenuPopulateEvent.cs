...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RContextualMenuPopulateEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RDropdownMenu r___0__menu__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.RDropdownMenu R__0__menu__1__k__BackingField
		{
			get
			{
				if(r___0__menu__1__k__BackingField == null)
				{
					r___0__menu__1__k__BackingField = new(this, "<menu>k__BackingField");
					r___0__menu__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__menu__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.REventBase r___0__triggerEvent__1__k__BackingField;
		public virtual RUnityEngine.RUIElements.REventBase R__0__triggerEvent__1__k__BackingField
		{
			get
			{
				if(r___0__triggerEvent__1__k__BackingField == null)
				{
					r___0__triggerEvent__1__k__BackingField = new(this, "<triggerEvent>k__BackingField");
					r___0__triggerEvent__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__triggerEvent__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected static RMethod r_GetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager;
		public static RMethod RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager
		{
			get
			{
				if(r_GetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager == null)
				{
					r_GetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager = new(typeof(UnityEngine.UIElements.ContextualMenuPopulateEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.EventBase), typeof(UnityEngine.UIElements.DropdownMenu), typeof(UnityEngine.UIElements.IEventHandler), typeof(UnityEngine.UIElements.ContextualMenuManager));
					r_GetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager.SetBelong(null);
				}
				return r_GetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager;
			}
		}
