...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RContextualMenuPopulateEvent : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RDropdownMenu r___1__menu__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.RDropdownMenu R__1__menu__2__k__BackingField
		{
			get
			{
				if(r___1__menu__2__k__BackingField == null)
				{
					r___1__menu__2__k__BackingField = new(this, "<menu>k__BackingField");
					r___1__menu__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__menu__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.REventBase r___1__triggerEvent__2__k__BackingField;
		public virtual RUnityEngine.RUIElements.REventBase R__1__triggerEvent__2__k__BackingField
		{
			get
			{
				if(r___1__triggerEvent__2__k__BackingField == null)
				{
					r___1__triggerEvent__2__k__BackingField = new(this, "<triggerEvent>k__BackingField");
					r___1__triggerEvent__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__triggerEvent__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RContextualMenuManager r_m_ContextualMenuManager;
		public virtual RUnityEngine.RUIElements.RContextualMenuManager Rm_ContextualMenuManager
		{
			get
			{
				if(r_m_ContextualMenuManager == null)
				{
					r_m_ContextualMenuManager = new(this, "m_ContextualMenuManager");
					r_m_ContextualMenuManager.SetBelong(this.instance);
				}
				return r_m_ContextualMenuManager;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RUIElements.RDropdownMenu r_menu;
		public virtual RUnityEngine.RUIElements.RDropdownMenu Rmenu
		{
			get
			{
				if(r_menu == null)
		...
		/// </summary>
		protected RUnityEngine.RUIElements.REventBase r_triggerEvent;
		public virtual RUnityEngine.RUIElements.REventBase RtriggerEvent
		{
			get
			{
				if(r_triggerEvent == null)
				{
					r_triggerEvent = new(this, "triggerEvent", -1);
					r_triggerEvent.SetBelong(this.instance);
				}
				return r_triggerEvent;
			}
		}
		...
		/// </summary>
		protected static RMethod r_RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager;
		public static RMethod RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager
		{
			get
			{
				if(r_RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager == null)
				{
					r_RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager = new(typeof(UnityEngine.UIElements.ContextualMenuPopulateEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.EventBase), typeof(UnityEngine.UIElements.DropdownMenu), typeof(UnityEngine.UIElements.IEventHandler), typeof(UnityEngine.UIElements.ContextualMenuManager));
					r_RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager.SetBelong(null);
				}
				return r_RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager;
			}
		}
        ...
        public static UnityEngine.UIElements.ContextualMenuPopulateEvent GetPooled(UnityEngine.UIElements.EventBase  @triggerEvent, UnityEngine.UIElements.DropdownMenu  @menu, UnityEngine.UIElements.IEventHandler  @target, UnityEngine.UIElements.ContextualMenuManager  @menuManager)
        {
            ...
            var ___result = RGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager.Invoke(___genericsType, ___parameters);
