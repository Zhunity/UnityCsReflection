...
{public partial class RCamera
{
    ...
    public partial class RProjectionMatrixMode : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RCamera.RProjectionMatrixMode r_FExplicit;
		public static RUnityEngine.RCamera.RProjectionMatrixMode RFExplicit
		{
			get
			{
				if(r_FExplicit == null)
				{
					r_FExplicit = new( ReflectionUtils.GetType("UnityEngine.Camera+ProjectionMatrixMode"), "Explicit");
		...
		/// </summary>
		protected static RUnityEngine.RCamera.RProjectionMatrixMode r_FImplicit;
		public static RUnityEngine.RCamera.RProjectionMatrixMode RFImplicit
		{
			get
			{
				if(r_FImplicit == null)
				{
					r_FImplicit = new( ReflectionUtils.GetType("UnityEngine.Camera+ProjectionMatrixMode"), "Implicit");
					r_FImplicit.SetBelong(null);
				}
				return r_FImplicit;
			}
		}
		...
		/// </summary>
		protected static RUnityEngine.RCamera.RProjectionMatrixMode r_FPhysicalPropertiesBased;
		public static RUnityEngine.RCamera.RProjectionMatrixMode RFPhysicalPropertiesBased
		{
			get
			{
				if(r_FPhysicalPropertiesBased == null)
				{
					r_FPhysicalPropertiesBased = new( ReflectionUtils.GetType("UnityEngine.Camera+ProjectionMatrixMode"), "PhysicalPropertiesBased");
					r_FPhysicalPropertiesBased.SetBelong(null);
				}
				return r_FPhysicalPropertiesBased;
			}
		}
