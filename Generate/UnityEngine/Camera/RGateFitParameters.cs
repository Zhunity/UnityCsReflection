...
{public partial class RCamera
{
    ...
    public partial class RGateFitParameters : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RCamera.RGateFitMode r_F__0__mode__1__k__BackingField;
		public virtual RUnityEngine.RCamera.RGateFitMode RF__0__mode__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RSingle r_F__0__aspect__1__k__BackingField;
		public virtual RSystem.RSingle RF__0__aspect__1__k__BackingField
		{
			get
			{
		...
		/// GateFitMode mode
		/// </summary>
		protected RUnityEngine.RCamera.RGateFitMode r_Pmode;
		public virtual RUnityEngine.RCamera.RGateFitMode RPmode
		{
			get
			{
				if(r_Pmode == null)
