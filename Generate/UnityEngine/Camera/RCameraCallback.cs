...
{public partial class RCamera
{
	...
	/// </summary>
    public partial class RCameraCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Camera;
		public virtual RMethod RMInvoke_Camera
		{
			get
			{
				if(r_MInvoke_Camera == null)
				{
					r_MInvoke_Camera = new(this, "Invoke", 0, typeof(UnityEngine.Camera));
					r_MInvoke_Camera.SetBelong(this.instance);
				}
				return r_MInvoke_Camera;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.Camera, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Camera_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Camera_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Camera_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Camera_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Camera), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Camera_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Camera_AsyncCallback_Object;
			}
		}
        ...
        public RCameraCallback() : base("UnityEngine.Camera+CameraCallback")
        {
        }

        public RCameraCallback(System.Object instance) : base("UnityEngine.Camera+CameraCallback")
		{
            SetInstance(instance);
		}

        public RCameraCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCameraCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEngine.Camera @cam)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam};
            var ___result = RMInvoke_Camera.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Camera @cam, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@cam, @callback, @object};
            var ___result = RMBeginInvoke_Camera_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
