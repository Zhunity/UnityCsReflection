...
{public partial class RCamera
{
    ...
    public partial class RCameraCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_Camera;
		public virtual RMethod RInvoke_Camera
		{
			get
			{
				if(r_Invoke_Camera == null)
				{
					r_Invoke_Camera = new(this, "Invoke", 0, typeof(UnityEngine.Camera));
					r_Invoke_Camera.SetBelong(this.instance);
				}
				return r_Invoke_Camera;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_Camera_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Camera_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_Camera_AsyncCallback_Object == null)
				{
					r_BeginInvoke_Camera_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Camera), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_Camera_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_Camera_AsyncCallback_Object;
			}
		}
