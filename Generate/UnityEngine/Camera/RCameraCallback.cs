...
{public partial class RCamera
{
    ...
    public partial class RCameraCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Camera;
		public virtual RMethod RInvoke_Camera
		{
			get
			{
				if(r_RInvoke_Camera == null)
				{
					r_RInvoke_Camera = new(this, "Invoke", 0, typeof(UnityEngine.Camera));
					r_RInvoke_Camera.SetBelong(this.instance);
				}
				return r_RInvoke_Camera;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Camera_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Camera_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Camera_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Camera_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Camera), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Camera_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Camera_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(UnityEngine.Camera  @cam)
        {
            ...
            var ___result = RInvoke_Camera.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Camera  @cam, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_Camera_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
