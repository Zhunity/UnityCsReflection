...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore.RLowLevel
{
    ...
    public partial class RLigatureSubstitutionRecord : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RUInt32> r_Fm_ComponentGlyphIDs;
		public virtual RFieldArray<RSystem.RUInt32> RFm_ComponentGlyphIDs
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RUInt32 r_Fm_LigatureGlyphID;
		public virtual RSystem.RUInt32 RFm_LigatureGlyphID
		{
			get
			{
		...
		/// </summary>
		protected RPropertyArray<RSystem.RUInt32> r_PcomponentGlyphIDs;
		public virtual RPropertyArray<RSystem.RUInt32> RPcomponentGlyphIDs
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RUInt32 r_PligatureGlyphID;
		public virtual RSystem.RUInt32 RPligatureGlyphID
		{
			get
			{
