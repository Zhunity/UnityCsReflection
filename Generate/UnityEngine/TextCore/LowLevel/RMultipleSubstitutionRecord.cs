...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore.RLowLevel
{
    ...
    public partial class RMultipleSubstitutionRecord : RMember //
    {
		...
		/// </summary>
		protected RSystem.RUInt32 r_Fm_TargetGlyphID;
		public virtual RSystem.RUInt32 RFm_TargetGlyphID
		{
			get
			{
		...
		/// </summary>
		protected RFieldArray<RSystem.RUInt32> r_Fm_SubstituteGlyphIDs;
		public virtual RFieldArray<RSystem.RUInt32> RFm_SubstituteGlyphIDs
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RUInt32 r_PtargetGlyphID;
		public virtual RSystem.RUInt32 RPtargetGlyphID
		{
			get
			{
		...
		/// </summary>
		protected RPropertyArray<RSystem.RUInt32> r_PsubstituteGlyphIDs;
		public virtual RPropertyArray<RSystem.RUInt32> RPsubstituteGlyphIDs
		{
			get
			{
