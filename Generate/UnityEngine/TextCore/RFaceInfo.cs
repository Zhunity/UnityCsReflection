...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore
{
    ...
    public partial class RFaceInfo : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RCompare_FaceInfo;
		public virtual RMethod RCompare_FaceInfo
		{
			get
			{
				if(r_RCompare_FaceInfo == null)
				{
					r_RCompare_FaceInfo = new(this, "Compare", 0, typeof(UnityEngine.TextCore.FaceInfo));
					r_RCompare_FaceInfo.SetBelong(this.instance);
				}
				return r_RCompare_FaceInfo;
			}
		}
