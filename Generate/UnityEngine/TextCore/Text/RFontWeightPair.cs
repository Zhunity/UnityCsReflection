...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore.RText
{
    ...
    public partial class RFontWeightPair : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RTextCore.RText.RFontAsset r_regularTypeface;
		public virtual RUnityEngine.RTextCore.RText.RFontAsset RregularTypeface
		{
			get
			{
				if(r_regularTypeface == null)
				{
					r_regularTypeface = new(this, "regularTypeface");
					r_regularTypeface.SetBelong(this.instance);
				}
				return r_regularTypeface;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RTextCore.RText.RFontAsset r_italicTypeface;
		public virtual RUnityEngine.RTextCore.RText.RFontAsset RitalicTypeface
		{
			get
			{
				if(r_italicTypeface == null)
				{
					r_italicTypeface = new(this, "italicTypeface");
					r_italicTypeface.SetBelong(this.instance);
				}
				return r_italicTypeface;
			}
		}
