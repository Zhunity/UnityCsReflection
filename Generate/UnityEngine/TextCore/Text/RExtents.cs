...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore.RText
{
    ...
    public partial class RExtents : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_Fmin;
		public virtual RUnityEngine.RVector2 RFmin
		{
			get
			{
				if(r_Fmin == null)
		...
		/// </summary>
		protected RUnityEngine.RVector2 r_Fmax;
		public virtual RUnityEngine.RVector2 RFmax
		{
			get
			{
				if(r_Fmax == null)
