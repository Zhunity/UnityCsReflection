...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RTextCore.RText
{
    ...
    public partial class RVertexSortingOrder : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RTextCore.RText.RVertexSortingOrder r_FNormal;
		public static RUnityEngine.RTextCore.RText.RVertexSortingOrder RFNormal
		{
			get
			{
				if(r_FNormal == null)
				{
					r_FNormal = new( ReflectionUtils.GetType("UnityEngine.TextCore.Text.VertexSortingOrder"), "Normal");
		...
		/// </summary>
		protected static RUnityEngine.RTextCore.RText.RVertexSortingOrder r_FReverse;
		public static RUnityEngine.RTextCore.RText.RVertexSortingOrder RFReverse
		{
			get
			{
				if(r_FReverse == null)
				{
					r_FReverse = new( ReflectionUtils.GetType("UnityEngine.TextCore.Text.VertexSortingOrder"), "Reverse");
					r_FReverse.SetBelong(null);
				}
				return r_FReverse;
			}
		}
