...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceMaterialConfig : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_FrenderQueueLowerBound;
		public virtual RSystem.RInt32 RFrenderQueueLowerBound
		{
			get
			{
				if(r_FrenderQueueLowerBound == null)
				{
					...
					r_FrenderQueueLowerBound.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RSystem.RInt32 r_FrenderQueueUpperBound;
		public virtual RSystem.RInt32 RFrenderQueueUpperBound
		{
			get
			{
				if(r_FrenderQueueUpperBound == null)
				{
					...
					r_FrenderQueueUpperBound.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceCullingShaderTagConfig> r_FoptionalShaderTags;
		public virtual RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceCullingShaderTagConfig> RFoptionalShaderTags
		{
			get
			{
				if(r_FoptionalShaderTags == null)
				{
					...
					r_FoptionalShaderTags.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RFieldArray<RSystem.RString> r_FoptionalShaderKeywords;
		public virtual RFieldArray<RSystem.RString> RFoptionalShaderKeywords
		{
			get
			{
				if(r_FoptionalShaderKeywords == null)
				{
					...
					r_FoptionalShaderKeywords.SetBelong(this.instance);
				}
