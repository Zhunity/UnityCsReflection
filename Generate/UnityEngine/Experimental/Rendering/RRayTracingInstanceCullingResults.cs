...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceCullingResults : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceMaterialCRC> r_materialsCRC;
		public virtual RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceMaterialCRC> RmaterialsCRC
		{
			get
			{
				if(r_materialsCRC == null)
				{
					r_materialsCRC = new(this, "materialsCRC");
					r_materialsCRC.SetBelong(this.instance);
				}
				return r_materialsCRC;
			}
		}
		...
		public virtual RField RtransformsChanged
		{
			get
			{
				if(r_transformsChanged == null)
				{
					r_transformsChanged = new(this, "transformsChanged");
					r_transformsChanged.SetBelong(this.instance);
				}
				return r_transformsChanged;
			}
		}
