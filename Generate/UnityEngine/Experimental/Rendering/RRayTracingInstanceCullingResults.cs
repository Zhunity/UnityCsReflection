...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceCullingResults : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceMaterialCRC> r_FmaterialsCRC;
		public virtual RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceMaterialCRC> RFmaterialsCRC
		{
			get
			{
				if(r_FmaterialsCRC == null)
				{
					r_FmaterialsCRC = new(this, "materialsCRC");
					r_FmaterialsCRC.SetBelong(this.instance);
				}
				return r_FmaterialsCRC;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_FtransformsChanged;
		public virtual RSystem.RBoolean RFtransformsChanged
		{
			get
			{
				if(r_FtransformsChanged == null)
				{
					r_FtransformsChanged = new(this, "transformsChanged");
					r_FtransformsChanged.SetBelong(this.instance);
				}
				return r_FtransformsChanged;
			}
		}
