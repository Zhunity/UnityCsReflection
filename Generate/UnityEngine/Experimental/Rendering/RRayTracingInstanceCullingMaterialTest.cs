...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceCullingMaterialTest : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RString> r_FdeniedShaderPasses;
		public virtual RFieldArray<RSystem.RString> RFdeniedShaderPasses
		{
			get
			{
		...
		/// </summary>
		protected RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceCullingShaderTagConfig> r_FrequiredShaderTags;
		public virtual RFieldArray<RUnityEngine.RExperimental.RRendering.RRayTracingInstanceCullingShaderTagConfig> RFrequiredShaderTags
		{
			get
			{
