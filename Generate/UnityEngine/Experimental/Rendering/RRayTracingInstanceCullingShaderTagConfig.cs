...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceCullingShaderTagConfig : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RRendering.RShaderTagId r_FtagId;
		public virtual RUnityEngine.RRendering.RShaderTagId RFtagId
		{
			get
			{
				if(r_FtagId == null)
				{
					r_FtagId = new(this, "tagId");
					r_FtagId.SetBelong(this.instance);
				}
				return r_FtagId;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RRendering.RShaderTagId r_FtagValueId;
		public virtual RUnityEngine.RRendering.RShaderTagId RFtagValueId
		{
			get
			{
				if(r_FtagValueId == null)
				{
					r_FtagValueId = new(this, "tagValueId");
					r_FtagValueId.SetBelong(this.instance);
				}
				return r_FtagValueId;
			}
		}
