...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RExperimental.RRendering
{
    ...
    public partial class RRayTracingInstanceCullingShaderTagConfig : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RRendering.RShaderTagId r_tagId;
		public virtual RUnityEngine.RRendering.RShaderTagId RtagId
		{
			get
			{
				if(r_tagId == null)
				{
					r_tagId = new(this, "tagId");
					r_tagId.SetBelong(this.instance);
				}
				return r_tagId;
			}
		}
		...
		/// </summary>
		protected RUnityEngine.RRendering.RShaderTagId r_tagValueId;
		public virtual RUnityEngine.RRendering.RShaderTagId RtagValueId
		{
			get
			{
				if(r_tagValueId == null)
				{
					r_tagValueId = new(this, "tagValueId");
					r_tagValueId.SetBelong(this.instance);
				}
				return r_tagValueId;
			}
		}
