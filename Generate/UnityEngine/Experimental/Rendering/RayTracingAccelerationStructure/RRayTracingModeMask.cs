...
{public partial class RRayTracingAccelerationStructure
{
    ...
    public partial class RRayTracingModeMask : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FNothing;
		public static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFNothing
		{
			get
			{
				if(r_FNothing == null)
		...
		/// </summary>
		protected static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FStatic;
		public static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFStatic
		{
			get
			{
				if(r_FStatic == null)
		...
		/// </summary>
		protected static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FDynamicTransform;
		public static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFDynamicTransform
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FDynamicGeometry;
		public static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFDynamicGeometry
		{
			get
			{
		...
		/// </summary>
		protected static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FEverything;
		public static RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFEverything
		{
			get
			{
