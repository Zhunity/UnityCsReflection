...
{public partial class RRayTracingAccelerationStructure
{
    ...
    public partial class RRASSettings : RMember //
    {
		...
		/// </summary>
		protected RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RManagementMode r_FmanagementMode;
		public virtual RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RManagementMode RFmanagementMode
		{
			get
			{
		...
		/// </summary>
		protected RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask r_FrayTracingModeMask;
		public virtual RUnityEngine.RExperimental.RRendering.RRayTracingAccelerationStructure.RRayTracingModeMask RFrayTracingModeMask
		{
			get
			{
