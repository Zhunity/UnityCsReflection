...
{public partial class RRayTracingAccelerationStructure
{
    ...
    public partial class RRASSettings : RMember //
    {
		...
		/// </summary>
		protected RField r_managementMode;
		public virtual RField RmanagementMode
		{
			get
			{
				if(r_managementMode == null)
				{
					r_managementMode = new(this, "managementMode");
					r_managementMode.SetBelong(this.instance);
				}
				return r_managementMode;
			}
		}
		...
		/// </summary>
		protected RField r_rayTracingModeMask;
		public virtual RField RrayTracingModeMask
		{
			get
			{
				if(r_rayTracingModeMask == null)
				{
					r_rayTracingModeMask = new(this, "rayTracingModeMask");
					r_rayTracingModeMask.SetBelong(this.instance);
				}
				return r_rayTracingModeMask;
			}
		}
