...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RFrustumPlanes : RMember //
    {
		...
		/// System.Single left
		/// </summary>
		protected RSystem.RSingle r_Fleft;
		public virtual RSystem.RSingle RFleft
		{
			get
			{
				if(r_Fleft == null)
		...
		/// System.Single right
		/// </summary>
		protected RSystem.RSingle r_Fright;
		public virtual RSystem.RSingle RFright
		{
			get
			{
				if(r_Fright == null)
		...
		/// </summary>
		protected RSystem.RSingle r_Fbottom;
		public virtual RSystem.RSingle RFbottom
		{
			get
			{
				if(r_Fbottom == null)
		...
		/// System.Single top
		/// </summary>
		protected RSystem.RSingle r_Ftop;
		public virtual RSystem.RSingle RFtop
		{
			get
			{
				if(r_Ftop == null)
		...
		/// System.Single zNear
		/// </summary>
		protected RSystem.RSingle r_FzNear;
		public virtual RSystem.RSingle RFzNear
		{
			get
			{
				if(r_FzNear == null)
				{
					...
					r_FzNear.SetBelong(this.instance);
				}
				return r_FzNear;
			}
		}
		...
		/// System.Single zFar
		/// </summary>
		protected RSystem.RSingle r_FzFar;
		public virtual RSystem.RSingle RFzFar
		{
			get
			{
				if(r_FzFar == null)
				{
					...
					r_FzFar.SetBelong(this.instance);
				}
				return r_FzFar;
			}
		}
