...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RYogaPositionType : RMember //
    {
		...
		/// </summary>
		protected static RUnityEngine.RYoga.RYogaPositionType r_FRelative;
		public static RUnityEngine.RYoga.RYogaPositionType RFRelative
		{
			get
			{
				if(r_FRelative == null)
		...
		/// </summary>
		protected static RUnityEngine.RYoga.RYogaPositionType r_FAbsolute;
		public static RUnityEngine.RYoga.RYogaPositionType RFAbsolute
		{
			get
			{
				if(r_FAbsolute == null)
