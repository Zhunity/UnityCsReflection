...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RLogger : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_YogaConfig_YogaNode_YogaLogLevel_String;
		...
		/// </summary>
		protected RMethod r_BeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object;
