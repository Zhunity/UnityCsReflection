...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RLogger : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_YogaConfig_YogaNode_YogaLogLevel_String;
		public virtual RMethod RInvoke_YogaConfig_YogaNode_YogaLogLevel_String
		{
			get
			{
				if(r_RInvoke_YogaConfig_YogaNode_YogaLogLevel_String == null)
				{
					r_RInvoke_YogaConfig_YogaNode_YogaLogLevel_String = new(this, "Invoke", 0,  ReleactionUtils.GetType("UnityEngine.Yoga.YogaConfig"),  ReleactionUtils.GetType("UnityEngine.Yoga.YogaNode"),  ReleactionUtils.GetType("UnityEngine.Yoga.YogaLogLevel"), typeof(System.String));
					r_RInvoke_YogaConfig_YogaNode_YogaLogLevel_String.SetBelong(this.instance);
				}
				return r_RInvoke_YogaConfig_YogaNode_YogaLogLevel_String;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReleactionUtils.GetType("UnityEngine.Yoga.YogaConfig"),  ReleactionUtils.GetType("UnityEngine.Yoga.YogaNode"),  ReleactionUtils.GetType("UnityEngine.Yoga.YogaLogLevel"), typeof(System.String), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object;
			}
		}
