...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RLogger : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEngine.Yoga.YogaConfig, UnityEngine.Yoga.YogaNode, UnityEngine.Yoga.YogaLogLevel, System.String)
		/// </summary>
		protected RMethod r_MInvoke_YogaConfig_YogaNode_YogaLogLevel_String;
		public virtual RMethod RMInvoke_YogaConfig_YogaNode_YogaLogLevel_String
		{
			get
			{
				if(r_MInvoke_YogaConfig_YogaNode_YogaLogLevel_String == null)
				{
					r_MInvoke_YogaConfig_YogaNode_YogaLogLevel_String = new(this, "Invoke", 0,  ReflectionUtils.GetType("UnityEngine.Yoga.YogaConfig"),  ReflectionUtils.GetType("UnityEngine.Yoga.YogaNode"),  ReflectionUtils.GetType("UnityEngine.Yoga.YogaLogLevel"), typeof(System.String));
					r_MInvoke_YogaConfig_YogaNode_YogaLogLevel_String.SetBelong(this.instance);
				}
				return r_MInvoke_YogaConfig_YogaNode_YogaLogLevel_String;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.Yoga.YogaConfig, UnityEngine.Yoga.YogaNode, UnityEngine.Yoga.YogaLogLevel, System.String, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReflectionUtils.GetType("UnityEngine.Yoga.YogaConfig"),  ReflectionUtils.GetType("UnityEngine.Yoga.YogaNode"),  ReflectionUtils.GetType("UnityEngine.Yoga.YogaLogLevel"), typeof(System.String), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(RUnityEngine.RYoga.RYogaConfig @config, RUnityEngine.RYoga.RYogaNode @node, RUnityEngine.RYoga.RYogaLogLevel @level, System.String @message)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config.Value, @node.Value, @level.Value, @message};
            var ___result = RMInvoke_YogaConfig_YogaNode_YogaLogLevel_String.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(RUnityEngine.RYoga.RYogaConfig @config, RUnityEngine.RYoga.RYogaNode @node, RUnityEngine.RYoga.RYogaLogLevel @level, System.String @message, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@config.Value, @node.Value, @level.Value, @message, @callback, @object};
            var ___result = RMBeginInvoke_YogaConfig_YogaNode_YogaLogLevel_String_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
