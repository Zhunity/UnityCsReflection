...
{public partial class RNativeArray<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected RUnity.RCollections.RNativeArray<RField> r_Fm_Array;
		public virtual RUnity.RCollections.RNativeArray<RField> RFm_Array
		{
			get
			{
				if(r_Fm_Array == null)
        ...
        public REnumerator() : base("Unity.Collections.NativeArray`1+Enumerator")
        {
        }

        public REnumerator(System.Object instance) : base("Unity.Collections.NativeArray`1+Enumerator")
		{
