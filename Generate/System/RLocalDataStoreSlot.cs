...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RLocalDataStoreSlot : RMember //
    {
		...
		/// </summary>
		protected RSystem.RLocalDataStoreMgr r_Fm_mgr;
		public virtual RSystem.RLocalDataStoreMgr RFm_mgr
		{
			get
			{
				if(r_Fm_mgr == null)
		...
		/// System.Int32 m_slot
		/// </summary>
		protected RSystem.RInt32 r_Fm_slot;
		public virtual RSystem.RInt32 RFm_slot
		{
			get
			{
				if(r_Fm_slot == null)
		...
		/// </summary>
		protected RSystem.RLocalDataStoreMgr r_PManager;
		public virtual RSystem.RLocalDataStoreMgr RPManager
		{
			get
			{
				if(r_PManager == null)
		...
		/// Int32 Slot
		/// </summary>
		protected RSystem.RInt32 r_PSlot;
		public virtual RSystem.RInt32 RPSlot
		{
			get
			{
				if(r_PSlot == null)
