...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RArraySegment<T> : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RArraySegment<RField> r_F__0__Empty__1__k__BackingField;
		public static RSystem.RArraySegment<RField> RF__0__Empty__1__k__BackingField
		{
			get
			{
		...
		/// T[] _array
		/// </summary>
		protected RFieldArray<RField> r_F_array;
		public virtual RFieldArray<RField> RF_array
		{
			get
			{
				if(r_F_array == null)
		...
		/// </summary>
		protected static RSystem.RArraySegment<RProperty> r_PEmpty;
		public static RSystem.RArraySegment<RProperty> RPEmpty
		{
			get
			{
				if(r_PEmpty == null)
		...
		/// T[] Array
		/// </summary>
		protected RPropertyArray<RProperty> r_PArray;
		public virtual RPropertyArray<RProperty> RPArray
		{
			get
			{
				if(r_PArray == null)
				{
					...
					r_PArray.SetBelong(this.instance);
				}
				return r_PArray;
			}
		}
		...
		/// Int32 Offset
		/// </summary>
		protected RSystem.RInt32 r_POffset;
		public virtual RSystem.RInt32 RPOffset
		{
			get
			{
				if(r_POffset == null)
				{
					...
					r_POffset.SetBelong(this.instance);
				}
				return r_POffset;
			}
		}
		...
		/// </summary>
		protected RProperty r_PSystem__2__Collections__2__Generic__2__IList__0__T__1____2__Item_Int32;
		public virtual RProperty RPSystem__2__Collections__2__Generic__2__IList__0__T__1____2__Item_Int32
		{
			get
			{
		...
		/// </summary>
		protected RProperty r_PSystem__2__Collections__2__Generic__2__IReadOnlyList__0__T__1____2__Item_Int32;
		public virtual RProperty RPSystem__2__Collections__2__Generic__2__IReadOnlyList__0__T__1____2__Item_Int32
		{
			get
			{
				if(r_PSystem__2__Collections__2__Generic__2__IReadOnlyList__0__T__1____2__Item_Int32 == null)
				{
					...
					r_PSystem__2__Collections__2__Generic__2__IReadOnlyList__0__T__1____2__Item_Int32.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMCopyTo_ArraySegment_d_T_p_
		{
			get
			{
				if(r_MCopyTo_ArraySegment_d_T_p_ == null)
				{
					...
					r_MCopyTo_ArraySegment_d_T_p_.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMEquals_ArraySegment_d_T_p_
		{
			get
			{
				if(r_MEquals_ArraySegment_d_T_p_ == null)
				{
					...
					r_MEquals_ArraySegment_d_T_p_.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Collections__2__Generic__2__IList__0__T__1____2__IndexOf_T
		{
			get
			{
				if(r_MSystem__2__Collections__2__Generic__2__IList__0__T__1____2__IndexOf_T == null)
				{
					...
					r_MSystem__2__Collections__2__Generic__2__IList__0__T__1____2__IndexOf_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Collections__2__Generic__2__ICollection__0__T__1____2__Contains_T
		{
			get
			{
				if(r_MSystem__2__Collections__2__Generic__2__ICollection__0__T__1____2__Contains_T == null)
				{
					...
					r_MSystem__2__Collections__2__Generic__2__ICollection__0__T__1____2__Contains_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMThrowInvalidOperationIfDefault
		{
			get
			{
				if(r_MThrowInvalidOperationIfDefault == null)
				{
					...
					r_MThrowInvalidOperationIfDefault.SetBelong(this.instance);
				}
