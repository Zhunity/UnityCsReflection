...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RFunc<T1, T2, T3, T4, TResult> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_T1_T2_T3_T4;
		public virtual RMethod RInvoke_T1_T2_T3_T4
		{
			get
			{
				if(r_RInvoke_T1_T2_T3_T4 == null)
				{
					r_RInvoke_T1_T2_T3_T4 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3));
					r_RInvoke_T1_T2_T3_T4.SetBelong(this.instance);
				}
				return r_RInvoke_T1_T2_T3_T4;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object;
			}
		}
        ...
        public virtual TResult Invoke(T1  @arg1, T2  @arg2, T3  @arg3, T4  @arg4)
        {
            ...
            var ___result = RInvoke_T1_T2_T3_T4.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(T1  @arg1, T2  @arg2, T3  @arg3, T4  @arg4, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
