...
namespace SMFrame.Editor.Refleaction.RSystem.RBuffers
{
	...
	/// </summary>
    public partial class RSpanAction<T, TArg> : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Span`1[T], TArg)
		/// </summary>
		protected RMethod r_Invoke_Span_d_T_p__TArg;
		public virtual RMethod RInvoke_Span_d_T_p__TArg
		{
			get
			{
				if(r_Invoke_Span_d_T_p__TArg == null)
				{
					r_Invoke_Span_d_T_p__TArg = new(this, "Invoke", 0, typeof(System.Span<>).MakeGenericType(Type.MakeGenericMethodParameter(0)), Type.MakeGenericMethodParameter(1));
					r_Invoke_Span_d_T_p__TArg.SetBelong(this.instance);
				}
				return r_Invoke_Span_d_T_p__TArg;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Span`1[T], TArg, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_BeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object == null)
				{
					r_BeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Span<>).MakeGenericType(Type.MakeGenericMethodParameter(0)), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object;
			}
		}
        ...
        public RSpanAction() : base("System.Buffers.SpanAction`2")
        {
        }

        public RSpanAction(System.Object instance) : base("System.Buffers.SpanAction`2")
		{
            SetInstance(instance);
		}

        public RSpanAction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSpanAction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(RSystem.RSpan<RType> @span, TArg @arg)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@span.Value, @arg};
            var ___result = RInvoke_Span_d_T_p__TArg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(RSystem.RSpan<RType> @span, TArg @arg, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@span.Value, @arg, @callback, @object};
            var ___result = RBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
