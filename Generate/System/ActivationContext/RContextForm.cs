...
{public partial class RActivationContext
{
    ...
    public partial class RContextForm : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RActivationContext.RContextForm r_FLoose;
		public static RSystem.RActivationContext.RContextForm RFLoose
		{
			get
			{
				if(r_FLoose == null)
				{
					r_FLoose = new( ReflectionUtils.GetType("System.ActivationContext+ContextForm"), "Loose");
					r_FLoose.SetBelong(null);
				}
				return r_FLoose;
			}
		}
		...
		/// </summary>
		protected static RSystem.RActivationContext.RContextForm r_FStoreBounded;
		public static RSystem.RActivationContext.RContextForm RFStoreBounded
		{
			get
			{
				if(r_FStoreBounded == null)
				{
					r_FStoreBounded = new( ReflectionUtils.GetType("System.ActivationContext+ContextForm"), "StoreBounded");
					r_FStoreBounded.SetBelong(null);
				}
				return r_FStoreBounded;
			}
		}
