...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RRuntimeMethodInfo : RMember //
    {
        ...
        public virtual void GetPInvoke(out RSystem.RReflection.RPInvokeAttributes @flags, out System.String @entryPoint, out System.String @dllName)
        {
			@flags = default;
			@entryPoint = default;
			@dllName = default;
			...
			@flags = new RSystem.RReflection.RPInvokeAttributes(___parameters[0]);
