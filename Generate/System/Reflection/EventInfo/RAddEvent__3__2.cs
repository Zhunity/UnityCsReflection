...
{public partial class REventInfo
{
	...
	/// </summary>
    public partial class RAddEvent<T, D> : RMember //
    {
		...
		/// Void Invoke(T, D)
		/// </summary>
		protected RMethod r_MInvoke_T_D;
		public virtual RMethod RMInvoke_T_D
		{
			get
			{
				if(r_MInvoke_T_D == null)
				{
					r_MInvoke_T_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_MInvoke_T_D.SetBelong(this.instance);
				}
				return r_MInvoke_T_D;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(T, D, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_T_D_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T_D_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T_D_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_T_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_T_D_AsyncCallback_Object;
			}
		}
        ...
        public RAddEvent() : base("System.Reflection.EventInfo+AddEvent`2")
        {
        }

        public RAddEvent(System.Object instance) : base("System.Reflection.EventInfo+AddEvent`2")
		{
            SetInstance(instance);
		}

        public RAddEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAddEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Invoke(T @_this, D @dele)
        {
            ...
            var ___result = RMInvoke_T_D.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(T @_this, D @dele, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_this, @dele, @callback, @object};
            var ___result = RMBeginInvoke_T_D_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
