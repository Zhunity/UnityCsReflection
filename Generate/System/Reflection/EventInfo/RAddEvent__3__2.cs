...
{public partial class REventInfo
{
    ...
    public partial class RAddEvent<T, D> : RMember //
    {
		...
		/// Void Invoke(T, D)
		/// </summary>
		protected RMethod r_Invoke_T_D;
		public virtual RMethod RInvoke_T_D
		{
			get
			{
				if(r_Invoke_T_D == null)
				{
					r_Invoke_T_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_Invoke_T_D.SetBelong(this.instance);
				}
				return r_Invoke_T_D;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T_D_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_D_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T_D_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T_D_AsyncCallback_Object;
			}
		}
