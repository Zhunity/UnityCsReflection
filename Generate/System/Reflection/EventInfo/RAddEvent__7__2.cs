...
{public partial class REventInfo
{
    ...
    public partial class RAddEvent<T, D> : RMember //
    {
		...
		/// Void Invoke(T, D)
		/// </summary>
		protected RMethod r_RInvoke_T_D;
		public virtual RMethod RInvoke_T_D
		{
			get
			{
				if(r_RInvoke_T_D == null)
				{
					r_RInvoke_T_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_RInvoke_T_D.SetBelong(this.instance);
				}
				return r_RInvoke_T_D;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_T_D_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_D_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_T_D_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_T_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_T_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_T_D_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(T  @_this, D  @dele)
        {
            ...
            var ___result = RInvoke_T_D.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(T  @_this, D  @dele, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_T_D_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
