...
{public partial class REventInfo
{
    ...
    public partial class RStaticAddEvent<D> : RMember //
    {
		...
		/// Void Invoke(D)
		/// </summary>
		protected RMethod r_RInvoke_D;
		public virtual RMethod RInvoke_D
		{
			get
			{
				if(r_RInvoke_D == null)
				{
					r_RInvoke_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_RInvoke_D.SetBelong(this.instance);
				}
				return r_RInvoke_D;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_D_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_D_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_D_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_D_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(D  @dele)
        {
            ...
            var ___result = RInvoke_D.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(D  @dele, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_D_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
