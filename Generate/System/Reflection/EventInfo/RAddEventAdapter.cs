...
{public partial class REventInfo
{
	
	/// <summary>
	/// System.Reflection.EventInfo+AddEventAdapter
	/// </summary>
    public partial class RAddEventAdapter : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(System.Object, System.Delegate)
		/// </summary>
		protected RMethod r_MInvoke_Object_Delegate;
		public virtual RMethod RMInvoke_Object_Delegate
		{
			get
			{
				if(r_MInvoke_Object_Delegate == null)
				{
					r_MInvoke_Object_Delegate = new(this, "Invoke", 0, typeof(System.Object), typeof(System.Delegate));
					r_MInvoke_Object_Delegate.SetBelong(this.instance);
				}
				return r_MInvoke_Object_Delegate;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, System.Delegate, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Object_Delegate_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Object_Delegate_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Object_Delegate_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Object_Delegate_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.Delegate), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Object_Delegate_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Object_Delegate_AsyncCallback_Object;
			}
		}
        ...
        public RAddEventAdapter() : base("System.Reflection.EventInfo+AddEventAdapter")
        {
        }

        public RAddEventAdapter(System.Object instance) : base("System.Reflection.EventInfo+AddEventAdapter")
		{
            SetInstance(instance);
		}

        public RAddEventAdapter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAddEventAdapter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object @_this, System.Delegate @dele)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_this, @dele};
            var ___result = RMInvoke_Object_Delegate.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object @_this, System.Delegate @dele, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_this, @dele, @callback, @object};
            var ___result = RMBeginInvoke_Object_Delegate_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
