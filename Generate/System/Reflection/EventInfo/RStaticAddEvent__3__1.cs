    ...
    public partial class RStaticAddEvent<D> : RMember //
    {
		...
		public virtual RMethod RInvoke_D
		{
			get
			{
				if(r_Invoke_D == null)
				{
					r_Invoke_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_Invoke_D.SetBelong(this.instance);
				}
				return r_Invoke_D;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_D_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_D_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_D_AsyncCallback_Object == null)
				{
					r_BeginInvoke_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_D_AsyncCallback_Object;
			}
		}
