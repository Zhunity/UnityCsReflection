...
{public partial class REventInfo
{
    ...
    public partial class RStaticAddEvent<D> : RMember //
    {
		...
		/// Void Invoke(D)
		/// </summary>
		protected RMethod r_MInvoke_D;
		public virtual RMethod RMInvoke_D
		{
			get
			{
				if(r_MInvoke_D == null)
				{
					r_MInvoke_D = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_MInvoke_D.SetBelong(this.instance);
				}
				return r_MInvoke_D;
			}
		}
		...
		/// <summary>
		/// System.IAsyncResult BeginInvoke(D, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_D_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_D_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_D_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_D_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_D_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_D_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(D @dele)
        {
            ...
            var ___parameters = new object[]{@dele};
            var ___result = RMInvoke_D.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(D @dele, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@dele, @callback, @object};
            var ___result = RMBeginInvoke_D_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
