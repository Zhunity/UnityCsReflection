...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RSequencePoint : RMember //
    {
		...
		/// System.Int32 Line
		/// </summary>
		protected RSystem.RInt32 r_FLine;
		public virtual RSystem.RInt32 RFLine
		{
			get
			{
				if(r_FLine == null)
		...
		/// System.Int32 Col
		/// </summary>
		protected RSystem.RInt32 r_FCol;
		public virtual RSystem.RInt32 RFCol
		{
			get
			{
				if(r_FCol == null)
				{
					r_FCol = new(this, "Col");
					r_FCol.SetBelong(this.instance);
				}
				return r_FCol;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_FEndLine;
		public virtual RSystem.RInt32 RFEndLine
		{
			get
			{
				if(r_FEndLine == null)
				{
					...
					r_FEndLine.SetBelong(this.instance);
				}
				return r_FEndLine;
			}
		}
		...
		/// System.Int32 EndCol
		/// </summary>
		protected RSystem.RInt32 r_FEndCol;
		public virtual RSystem.RInt32 RFEndCol
		{
			get
			{
				if(r_FEndCol == null)
				{
					...
					r_FEndCol.SetBelong(this.instance);
				}
				return r_FEndCol;
			}
		}
