...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RILTokenInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RMemberInfo r_Fmember;
		public virtual RSystem.RReflection.RMemberInfo RFmember
		{
			get
			{
				if(r_Fmember == null)
				{
					r_Fmember = new(this, "member");
					r_Fmember.SetBelong(this.instance);
				}
				return r_Fmember;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_Fcode_pos;
		public virtual RSystem.RInt32 RFcode_pos
		{
			get
			{
				if(r_Fcode_pos == null)
				{
					r_Fcode_pos = new(this, "code_pos");
					r_Fcode_pos.SetBelong(this.instance);
				}
				return r_Fcode_pos;
			}
		}
