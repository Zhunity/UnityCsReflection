...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RMonoWin32Resource : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_Fres_type;
		public virtual RSystem.RInt32 RFres_type
		{
			get
			{
				if(r_Fres_type == null)
		...
		/// System.Int32 res_id
		/// </summary>
		protected RSystem.RInt32 r_Fres_id;
		public virtual RSystem.RInt32 RFres_id
		{
			get
			{
				if(r_Fres_id == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Flang_id;
		public virtual RSystem.RInt32 RFlang_id
		{
			get
			{
				if(r_Flang_id == null)
