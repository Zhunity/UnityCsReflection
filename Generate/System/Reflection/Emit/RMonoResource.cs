...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RMonoResource : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RResourceAttributes r_Fattrs;
		public virtual RSystem.RReflection.RResourceAttributes RFattrs
		{
			get
			{
				if(r_Fattrs == null)
		...
		/// </summary>
		protected RSystem.RIO.RStream r_Fstream;
		public virtual RSystem.RIO.RStream RFstream
		{
			get
			{
				if(r_Fstream == null)
