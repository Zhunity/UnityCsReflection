    ...
    public partial class RGetter<T, R> : RMember //
    {
		...
		public virtual RMethod RInvoke_T
		{
			get
			{
				if(r_Invoke_T == null)
				{
					r_Invoke_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_Invoke_T.SetBelong(this.instance);
				}
				return r_Invoke_T;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T_AsyncCallback_Object;
			}
		}
