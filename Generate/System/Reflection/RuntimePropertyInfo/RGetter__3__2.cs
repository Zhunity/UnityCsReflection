...
{public partial class RRuntimePropertyInfo
{
	
	/// <summary>
	/// System.Reflection.RuntimePropertyInfo+Getter`2
	/// </summary>
    public partial class RGetter<T, R> : RMember //
    {
		...
		/// R Invoke(T)
		/// </summary>
		protected RMethod r_MInvoke_T;
		public virtual RMethod RMInvoke_T
		{
			get
			{
				if(r_MInvoke_T == null)
				{
					r_MInvoke_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_MInvoke_T.SetBelong(this.instance);
				}
				return r_MInvoke_T;
			}
		}
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_T_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_T_AsyncCallback_Object;
			}
		}
        ...
        public RGetter() : base("System.Reflection.RuntimePropertyInfo+Getter`2")
        {
        }

        public RGetter(System.Object instance) : base("System.Reflection.RuntimePropertyInfo+Getter`2")
		{
            SetInstance(instance);
		}

        public RGetter(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGetter(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual R Invoke(T @_this)
        {
            ...
            var ___parameters = new object[]{@_this};
            var ___result = RMInvoke_T.Invoke(___genericsType, ___parameters);

            return (R)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(T @_this, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@_this, @callback, @object};
            var ___result = RMBeginInvoke_T_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

            return (System.IAsyncResult)___result;
        }


        public virtual R EndInvoke(System.IAsyncResult @result)
        {
