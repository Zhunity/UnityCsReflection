...
{public partial class RRuntimePropertyInfo
{
    ...
    public partial class RGetter<T, R> : RMember //
    {
		...
		/// R Invoke(T)
		/// </summary>
		protected RMethod r_RInvoke_T;
		public virtual RMethod RInvoke_T
		{
			get
			{
				if(r_RInvoke_T == null)
				{
					r_RInvoke_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_RInvoke_T.SetBelong(this.instance);
				}
				return r_RInvoke_T;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_T_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_T_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_T_AsyncCallback_Object;
			}
		}
        ...
        public virtual R Invoke(T  @_this)
        {
            ...
            var ___result = RInvoke_T.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(T  @_this, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_T_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
