...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RParameterModifier : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RBoolean> r_F_byRef;
		public virtual RFieldArray<RSystem.RBoolean> RF_byRef
		{
			get
			{
				if(r_F_byRef == null)
		...
		/// Boolean Item [Int32]
		/// </summary>
		protected RSystem.RBoolean r_PItem_Int32;
		public virtual RSystem.RBoolean RPItem_Int32
		{
			get
			{
