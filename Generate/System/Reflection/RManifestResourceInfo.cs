...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RManifestResourceInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RAssembly r___0__ReferencedAssembly__1__k__BackingField;
		public virtual RSystem.RReflection.RAssembly R__0__ReferencedAssembly__1__k__BackingField
		{
			get
			{
				if(r___0__ReferencedAssembly__1__k__BackingField == null)
				{
					r___0__ReferencedAssembly__1__k__BackingField = new(this, "<ReferencedAssembly>k__BackingField");
					r___0__ReferencedAssembly__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__ReferencedAssembly__1__k__BackingField;
			}
		}
		...
		public virtual RField R__0__FileName__1__k__BackingField
		{
			get
			{
				if(r___0__FileName__1__k__BackingField == null)
				{
					r___0__FileName__1__k__BackingField = new(this, "<FileName>k__BackingField");
					r___0__FileName__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__FileName__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___0__ResourceLocation__1__k__BackingField;
		public virtual RField R__0__ResourceLocation__1__k__BackingField
		{
			get
			{
				if(r___0__ResourceLocation__1__k__BackingField == null)
				{
					r___0__ResourceLocation__1__k__BackingField = new(this, "<ResourceLocation>k__BackingField");
					r___0__ResourceLocation__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__ResourceLocation__1__k__BackingField;
			}
		}
		...
		public virtual RSystem.RReflection.RAssembly RReferencedAssembly
		{
			get
			{
		...
		public virtual RProperty RResourceLocation
		{
			get
			{
