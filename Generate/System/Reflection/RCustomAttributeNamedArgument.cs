...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RCustomAttributeNamedArgument : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RCustomAttributeTypedArgument r___1__TypedValue__2__k__BackingField;
		public virtual RSystem.RReflection.RCustomAttributeTypedArgument R__1__TypedValue__2__k__BackingField
		{
			get
			{
				if(r___1__TypedValue__2__k__BackingField == null)
				{
					r___1__TypedValue__2__k__BackingField = new(this, "<TypedValue>k__BackingField");
					r___1__TypedValue__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__TypedValue__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___1__IsField__2__k__BackingField;
		public virtual RField R__1__IsField__2__k__BackingField
		{
			get
			{
				if(r___1__IsField__2__k__BackingField == null)
				{
					r___1__IsField__2__k__BackingField = new(this, "<IsField>k__BackingField");
					r___1__IsField__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__IsField__2__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RField r___1__MemberName__2__k__BackingField;
		public virtual RField R__1__MemberName__2__k__BackingField
		{
			get
			{
				if(r___1__MemberName__2__k__BackingField == null)
				{
					r___1__MemberName__2__k__BackingField = new(this, "<MemberName>k__BackingField");
					r___1__MemberName__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__MemberName__2__k__BackingField;
			}
		}
