...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RAssemblyName : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_Fcodebase;
		public virtual RSystem.RString RFcodebase
		{
			get
			{
				if(r_Fcodebase == null)
		...
		/// System.Int32 major
		/// </summary>
		protected RSystem.RInt32 r_Fmajor;
		public virtual RSystem.RInt32 RFmajor
		{
			get
			{
				if(r_Fmajor == null)
		...
		/// System.Int32 minor
		/// </summary>
		protected RSystem.RInt32 r_Fminor;
		public virtual RSystem.RInt32 RFminor
		{
			get
			{
				if(r_Fminor == null)
		...
		/// System.Int32 build
		/// </summary>
		protected RSystem.RInt32 r_Fbuild;
		public virtual RSystem.RInt32 RFbuild
		{
			get
			{
				if(r_Fbuild == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Frevision;
		public virtual RSystem.RInt32 RFrevision
		{
			get
			{
				if(r_Frevision == null)
		...
		/// </summary>
		protected RSystem.RGlobalization.RCultureInfo r_Fcultureinfo;
		public virtual RSystem.RGlobalization.RCultureInfo RFcultureinfo
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RReflection.RAssemblyNameFlags r_Fflags;
		public virtual RSystem.RReflection.RAssemblyNameFlags RFflags
		{
			get
			{
				if(r_Fflags == null)
		...
		/// </summary>
		protected RSystem.RConfiguration.RAssemblies.RAssemblyHashAlgorithm r_Fhashalg;
		public virtual RSystem.RConfiguration.RAssemblies.RAssemblyHashAlgorithm RFhashalg
		{
			get
			{
				if(r_Fhashalg == null)
		...
		/// </summary>
		protected RSystem.RReflection.RStrongNameKeyPair r_Fkeypair;
		public virtual RSystem.RReflection.RStrongNameKeyPair RFkeypair
		{
			get
			{
				if(r_Fkeypair == null)
		...
		/// </summary>
		protected RSystem.RConfiguration.RAssemblies.RAssemblyVersionCompatibility r_Fversioncompat;
		public virtual RSystem.RConfiguration.RAssemblies.RAssemblyVersionCompatibility RFversioncompat
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RReflection.RProcessorArchitecture r_Fprocessor_architecture;
		public virtual RSystem.RReflection.RProcessorArchitecture RFprocessor_architecture
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RReflection.RAssemblyContentType r_FcontentType;
		public virtual RSystem.RReflection.RAssemblyContentType RFcontentType
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RReflection.RProcessorArchitecture r_PProcessorArchitecture;
		public virtual RSystem.RReflection.RProcessorArchitecture RPProcessorArchitecture
		{
			get
			{
		...
		/// System.Globalization.CultureInfo CultureInfo
		/// </summary>
		protected RSystem.RGlobalization.RCultureInfo r_PCultureInfo;
		public virtual RSystem.RGlobalization.RCultureInfo RPCultureInfo
		{
			get
			{
		...
		/// System.Reflection.AssemblyNameFlags Flags
		/// </summary>
		protected RSystem.RReflection.RAssemblyNameFlags r_PFlags;
		public virtual RSystem.RReflection.RAssemblyNameFlags RPFlags
		{
			get
			{
				if(r_PFlags == null)
		...
		/// </summary>
		protected RSystem.RConfiguration.RAssemblies.RAssemblyHashAlgorithm r_PHashAlgorithm;
		public virtual RSystem.RConfiguration.RAssemblies.RAssemblyHashAlgorithm RPHashAlgorithm
		{
			get
			{
		...
		/// System.Reflection.StrongNameKeyPair KeyPair
		/// </summary>
		protected RSystem.RReflection.RStrongNameKeyPair r_PKeyPair;
		public virtual RSystem.RReflection.RStrongNameKeyPair RPKeyPair
		{
			get
			{
				if(r_PKeyPair == null)
		...
		/// </summary>
		protected RSystem.RConfiguration.RAssemblies.RAssemblyVersionCompatibility r_PVersionCompatibility;
		public virtual RSystem.RConfiguration.RAssemblies.RAssemblyVersionCompatibility RPVersionCompatibility
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PIsPublicKeyValid;
		public virtual RSystem.RBoolean RPIsPublicKeyValid
		{
			get
			{
		...
		/// System.Reflection.AssemblyContentType ContentType
		/// </summary>
		protected RSystem.RReflection.RAssemblyContentType r_PContentType;
		public virtual RSystem.RReflection.RAssemblyContentType RPContentType
		{
			get
			{
