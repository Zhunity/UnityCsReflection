...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RInterfaceMapping : RMember //
    {
		...
		/// </summary>
		protected RSystem.RType r_FTargetType;
		public virtual RSystem.RType RFTargetType
		{
			get
			{
				if(r_FTargetType == null)
				{
					...
					r_FTargetType.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RSystem.RType r_FInterfaceType;
		public virtual RSystem.RType RFInterfaceType
		{
			get
			{
				if(r_FInterfaceType == null)
				{
					...
					r_FInterfaceType.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RFieldArray<RSystem.RReflection.RMethodInfo> r_FTargetMethods;
		public virtual RFieldArray<RSystem.RReflection.RMethodInfo> RFTargetMethods
		{
			get
			{
				if(r_FTargetMethods == null)
				{
					...
					r_FTargetMethods.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RFieldArray<RSystem.RReflection.RMethodInfo> r_FInterfaceMethods;
		public virtual RFieldArray<RSystem.RReflection.RMethodInfo> RFInterfaceMethods
		{
			get
			{
				if(r_FInterfaceMethods == null)
				{
					...
					r_FInterfaceMethods.SetBelong(this.instance);
				}
