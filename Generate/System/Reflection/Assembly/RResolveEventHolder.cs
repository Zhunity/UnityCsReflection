...
{public partial class RAssembly
{
    ...
    public partial class RResolveEventHolder : RMember //
    {
		...
		/// System.Reflection.ModuleResolveEventHandler ModuleResolve
		/// </summary>
		protected RSystem.RReflection.RModuleResolveEventHandler r_FModuleResolve;
		public virtual RSystem.RReflection.RModuleResolveEventHandler RFModuleResolve
		{
			get
			{
				if(r_FModuleResolve == null)
				{
					...
					r_FModuleResolve.SetBelong(this.instance);
				}
