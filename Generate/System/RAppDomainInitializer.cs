...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RAppDomainInitializer : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_StringArray;
		public virtual RMethod RInvoke_StringArray
		{
			get
			{
				if(r_Invoke_StringArray == null)
				{
					r_Invoke_StringArray = new(this, "Invoke", 0, typeof(System.String).MakeArrayType());
					r_Invoke_StringArray.SetBelong(this.instance);
				}
				return r_Invoke_StringArray;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_StringArray_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_StringArray_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_StringArray_AsyncCallback_Object == null)
				{
					r_BeginInvoke_StringArray_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String).MakeArrayType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_StringArray_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_StringArray_AsyncCallback_Object;
			}
		}
