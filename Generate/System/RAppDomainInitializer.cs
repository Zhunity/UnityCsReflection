...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RAppDomainInitializer : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_StringArray;
		public virtual RMethod RMInvoke_StringArray
		{
			get
			{
				if(r_MInvoke_StringArray == null)
				{
					r_MInvoke_StringArray = new(this, "Invoke", 0, typeof(System.String).MakeArrayType());
					r_MInvoke_StringArray.SetBelong(this.instance);
				}
				return r_MInvoke_StringArray;
			}
		}
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_StringArray_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_StringArray_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_StringArray_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_StringArray_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String).MakeArrayType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_StringArray_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_StringArray_AsyncCallback_Object;
			}
		}
        ...
        public RAppDomainInitializer() : base("System.AppDomainInitializer")
        {
        }

        public RAppDomainInitializer(System.Object instance) : base("System.AppDomainInitializer")
		{
            SetInstance(instance);
		}

        public RAppDomainInitializer(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAppDomainInitializer(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.String[] @args)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@args};
            var ___result = RMInvoke_StringArray.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.String[] @args, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@args, @callback, @object};
            var ___result = RMBeginInvoke_StringArray_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
