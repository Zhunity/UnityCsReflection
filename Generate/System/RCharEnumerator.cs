...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RCharEnumerator : RMember //
    {
		...
		/// System.String _str
		/// </summary>
		protected RSystem.RString r_F_str;
		public virtual RSystem.RString RF_str
		{
			get
			{
				if(r_F_str == null)
				{
					...
					r_F_str.SetBelong(this.instance);
				}
				return r_F_str;
			}
		}
		...
		/// </summary>
		protected RSystem.RChar r_F_currentElement;
		public virtual RSystem.RChar RF_currentElement
		{
			get
			{
		...
		/// Char Current
		/// </summary>
		protected RSystem.RChar r_PCurrent;
		public virtual RSystem.RChar RPCurrent
		{
			get
			{
				if(r_PCurrent == null)
