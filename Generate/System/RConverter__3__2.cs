...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RConverter<TInput, TOutput> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_TInput;
		public virtual RMethod RInvoke_TInput
		{
			get
			{
				if(r_Invoke_TInput == null)
				{
					r_Invoke_TInput = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_Invoke_TInput.SetBelong(this.instance);
				}
				return r_Invoke_TInput;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_TInput_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TInput_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_TInput_AsyncCallback_Object == null)
				{
					r_BeginInvoke_TInput_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_TInput_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_TInput_AsyncCallback_Object;
			}
		}
