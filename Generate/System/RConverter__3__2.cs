...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RConverter<TInput, TOutput> : RMember //
    {
		...
		/// <summary>
		/// TOutput Invoke(TInput)
		/// </summary>
		protected RMethod r_MInvoke_TInput;
		public virtual RMethod RMInvoke_TInput
		{
			get
			{
				if(r_MInvoke_TInput == null)
				{
					r_MInvoke_TInput = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_MInvoke_TInput.SetBelong(this.instance);
				}
				return r_MInvoke_TInput;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(TInput, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_TInput_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_TInput_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_TInput_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_TInput_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_TInput_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_TInput_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// TOutput EndInvoke(System.IAsyncResult)
		/// </summary>
        ...
        public virtual TOutput Invoke(TInput @input)
        {
            ...
            var ___result = RMInvoke_TInput.Invoke(___genericsType, ___parameters);

            return (TOutput)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(TInput @input, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@input, @callback, @object};
            var ___result = RMBeginInvoke_TInput_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
