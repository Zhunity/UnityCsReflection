...
namespace SMFrame.Editor.Refleaction.RSystem.RResources
{
    ...
    public partial class RWin32VersionResource : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RString> r_FWellKnownProperties;
		public virtual RFieldArray<RSystem.RString> RFWellKnownProperties
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Fsignature;
		public virtual RSystem.RInt64 RFsignature
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Fstruct_version;
		public virtual RSystem.RInt32 RFstruct_version
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Ffile_version;
		public virtual RSystem.RInt64 RFfile_version
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Fproduct_version;
		public virtual RSystem.RInt64 RFproduct_version
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_flags_mask;
		public virtual RSystem.RInt32 RFfile_flags_mask
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_flags;
		public virtual RSystem.RInt32 RFfile_flags
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_os;
		public virtual RSystem.RInt32 RFfile_os
		{
			get
			{
				if(r_Ffile_os == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_type;
		public virtual RSystem.RInt32 RFfile_type
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_subtype;
		public virtual RSystem.RInt32 RFfile_subtype
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Ffile_date;
		public virtual RSystem.RInt64 RFfile_date
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_lang;
		public virtual RSystem.RInt32 RFfile_lang
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Ffile_codepage;
		public virtual RSystem.RInt32 RFfile_codepage
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RHashtable r_Fproperties;
		public virtual RSystem.RCollections.RHashtable RFproperties
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PItem_String;
		public virtual RSystem.RString RPItem_String
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PComments;
		public virtual RSystem.RString RPComments
		{
			get
			{
				if(r_PComments == null)
		...
		/// </summary>
		protected RSystem.RString r_PCompanyName;
		public virtual RSystem.RString RPCompanyName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PLegalCopyright;
		public virtual RSystem.RString RPLegalCopyright
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PLegalTrademarks;
		public virtual RSystem.RString RPLegalTrademarks
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_POriginalFilename;
		public virtual RSystem.RString RPOriginalFilename
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PProductName;
		public virtual RSystem.RString RPProductName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PProductVersion;
		public virtual RSystem.RString RPProductVersion
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PFileDescription;
		public virtual RSystem.RString RPFileDescription
		{
			get
			{
		...
		/// Int32 FileLanguage
		/// </summary>
		protected RSystem.RInt32 r_PFileLanguage;
		public virtual RSystem.RInt32 RPFileLanguage
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PFileVersion;
		public virtual RSystem.RString RPFileVersion
		{
			get
			{
