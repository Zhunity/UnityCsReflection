...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RFunc<T1, T2, T3, TResult> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_T1_T2_T3;
		public virtual RMethod RInvoke_T1_T2_T3
		{
			get
			{
				if(r_Invoke_T1_T2_T3 == null)
				{
					r_Invoke_T1_T2_T3 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2));
					r_Invoke_T1_T2_T3.SetBelong(this.instance);
				}
				return r_Invoke_T1_T2_T3;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T1_T2_T3_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T1_T2_T3_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T1_T2_T3_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T1_T2_T3_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T1_T2_T3_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T1_T2_T3_AsyncCallback_Object;
			}
		}
