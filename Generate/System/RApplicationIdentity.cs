...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RApplicationIdentity : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_F_fullName;
		public virtual RSystem.RString RF_fullName
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_F_codeBase;
		public virtual RSystem.RString RF_codeBase
		{
			get
			{
