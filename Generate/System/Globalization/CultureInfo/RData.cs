...
{public partial class RCultureInfo
{
    ...
    public partial class RData : RMember //
    {
		...
		/// System.Int32 ansi
		/// </summary>
		protected RSystem.RInt32 r_Fansi;
		public virtual RSystem.RInt32 RFansi
		{
			get
			{
				if(r_Fansi == null)
		...
		/// System.Int32 ebcdic
		/// </summary>
		protected RSystem.RInt32 r_Febcdic;
		public virtual RSystem.RInt32 RFebcdic
		{
			get
			{
				if(r_Febcdic == null)
		...
		/// System.Int32 mac
		/// </summary>
		protected RSystem.RInt32 r_Fmac;
		public virtual RSystem.RInt32 RFmac
		{
			get
			{
				if(r_Fmac == null)
		...
		/// System.Int32 oem
		/// </summary>
		protected RSystem.RInt32 r_Foem;
		public virtual RSystem.RInt32 RFoem
		{
			get
			{
				if(r_Foem == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fright_to_left;
		public virtual RSystem.RBoolean RFright_to_left
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RByte r_Flist_sep;
		public virtual RSystem.RByte RFlist_sep
		{
			get
			{
				if(r_Flist_sep == null)
