...
{public partial class RCultureInfo
{
    ...
    public partial class ROnCultureInfoChangedDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_String_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_String_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_String_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_String_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_String_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_String_AsyncCallback_Object;
			}
		}
        ...
        public virtual System.IAsyncResult BeginInvoke(System.String @language, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@language, @callback, @object};
            var ___result = RMBeginInvoke_String_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
