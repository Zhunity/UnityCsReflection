...
{public partial class RCultureInfo
{
    ...
    public partial class ROnCultureInfoChangedDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_BeginInvoke_String_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_String_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_String_AsyncCallback_Object == null)
				{
					r_BeginInvoke_String_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.String), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_String_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_String_AsyncCallback_Object;
			}
		}
