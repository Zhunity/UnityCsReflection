...
namespace SMFrame.Editor.Refleaction.RSystem.RGlobalization
{
    ...
    public partial class RTimeSpanStyles : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RGlobalization.RTimeSpanStyles r_FNone;
		public static RSystem.RGlobalization.RTimeSpanStyles RFNone
		{
			get
			{
				if(r_FNone == null)
		...
		/// </summary>
		protected static RSystem.RGlobalization.RTimeSpanStyles r_FAssumeNegative;
		public static RSystem.RGlobalization.RTimeSpanStyles RFAssumeNegative
		{
			get
			{
