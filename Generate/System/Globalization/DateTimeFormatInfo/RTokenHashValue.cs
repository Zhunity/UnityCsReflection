...
{public partial class RDateTimeFormatInfo
{
    ...
    public partial class RTokenHashValue : RMember //
    {
		...
		public virtual RField RtokenString
		{
			get
			{
				if(r_tokenString == null)
				{
					r_tokenString = new(this, "tokenString");
					r_tokenString.SetBelong(this.instance);
				}
				return r_tokenString;
			}
		}
		...
		/// </summary>
		protected RField r_tokenType;
		public virtual RField RtokenType
		{
			get
			{
				if(r_tokenType == null)
				{
					r_tokenType = new(this, "tokenType");
					r_tokenType.SetBelong(this.instance);
				}
				return r_tokenType;
			}
		}
		...
		public virtual RField RtokenValue
		{
			get
			{
				if(r_tokenValue == null)
				{
					r_tokenValue = new(this, "tokenValue");
					r_tokenValue.SetBelong(this.instance);
				}
				return r_tokenValue;
			}
		}
