...
{public partial class RDateTimeFormatInfo
{
    ...
    public partial class RTokenHashValue : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_FtokenString;
		public virtual RSystem.RString RFtokenString
		{
			get
			{
				if(r_FtokenString == null)
				{
					...
					r_FtokenString.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RSystem.RTokenType r_FtokenType;
		public virtual RSystem.RTokenType RFtokenType
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_FtokenValue;
		public virtual RSystem.RInt32 RFtokenValue
		{
			get
			{
				if(r_FtokenValue == null)
				{
					...
					r_FtokenValue.SetBelong(this.instance);
				}
