...
namespace SMFrame.Editor.Refleaction.RSystem.RGlobalization
{
    ...
    public partial class RDateTimeFormatFlags : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FNone;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFNone
		{
			get
			{
				if(r_FNone == null)
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseGenitiveMonth;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseGenitiveMonth
		{
			get
			{
				if(r_FUseGenitiveMonth == null)
				{
					...
					r_FUseGenitiveMonth.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseLeapYearMonth;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseLeapYearMonth
		{
			get
			{
				if(r_FUseLeapYearMonth == null)
				{
					...
					r_FUseLeapYearMonth.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseSpacesInMonthNames;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseSpacesInMonthNames
		{
			get
			{
				if(r_FUseSpacesInMonthNames == null)
				{
					...
					r_FUseSpacesInMonthNames.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseHebrewRule;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseHebrewRule
		{
			get
			{
				if(r_FUseHebrewRule == null)
				{
					...
					r_FUseHebrewRule.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseSpacesInDayNames;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseSpacesInDayNames
		{
			get
			{
				if(r_FUseSpacesInDayNames == null)
				{
					...
					r_FUseSpacesInDayNames.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FUseDigitPrefixInTokens;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFUseDigitPrefixInTokens
		{
			get
			{
				if(r_FUseDigitPrefixInTokens == null)
				{
					...
					r_FUseDigitPrefixInTokens.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RGlobalization.RDateTimeFormatFlags r_FNotInitialized;
		public static RSystem.RGlobalization.RDateTimeFormatFlags RFNotInitialized
		{
			get
			{
				if(r_FNotInitialized == null)
				{
					...
					r_FNotInitialized.SetBelong(null);
				}
