...
{public partial class RList<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RList<RField> r__list;
		public virtual RSystem.RCollections.RGeneric.RList<RField> R_list
		{
			get
			{
				if(r__list == null)
		...
		/// </summary>
		protected RMethod r_RMoveNextRare;
		public virtual RMethod RMoveNextRare
		{
			get
			{
				if(r_RMoveNextRare == null)
				{
					r_RMoveNextRare = new(this, "MoveNextRare", 0);
					r_RMoveNextRare.SetBelong(this.instance);
				}
				return r_RMoveNextRare;
			}
		}
        ...
        public virtual System.Boolean MoveNextRare()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMoveNextRare.Invoke(___genericsType, ___parameters);
