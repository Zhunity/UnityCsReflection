...
{public partial class RHashSet<T>
{
    ...
    public partial class RElementCount : RMember //
    {
		...
		public virtual RField RuniqueCount
		{
			get
			{
				if(r_uniqueCount == null)
				{
					r_uniqueCount = new(this, "uniqueCount");
					r_uniqueCount.SetBelong(this.instance);
				}
				return r_uniqueCount;
			}
		}
		...
		public virtual RField RunfoundCount
		{
			get
			{
				if(r_unfoundCount == null)
				{
					r_unfoundCount = new(this, "unfoundCount");
					r_unfoundCount.SetBelong(this.instance);
				}
				return r_unfoundCount;
			}
		}
