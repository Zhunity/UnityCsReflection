...
{public partial class RList<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MoveNextRare;
		public virtual RMethod RMoveNextRare
		{
			get
			{
				if(r_MoveNextRare == null)
				{
					r_MoveNextRare = new(this, "MoveNextRare", 0);
					r_MoveNextRare.SetBelong(this.instance);
				}
				return r_MoveNextRare;
			}
		}
