...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RKeyValuePair<TKey, TValue> : RMember //
    {
		...
		/// TKey key
		/// </summary>
		protected RField r_key;
		public virtual RField Rkey
		{
			get
			{
				if(r_key == null)
		...
		/// TKey Key
		/// </summary>
		protected RProperty r_Key;
		public virtual RProperty RKey
		{
			get
			{
				if(r_Key == null)
		...
		/// </summary>
		protected RMethod r_RDeconstruct_Out_TKey_Out_TValue;
		public virtual RMethod RDeconstruct_Out_TKey_Out_TValue
		{
			get
			{
				if(r_RDeconstruct_Out_TKey_Out_TValue == null)
				{
					r_RDeconstruct_Out_TKey_Out_TValue = new(this, "Deconstruct", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), Type.MakeGenericMethodParameter(1).MakeByRefType());
					r_RDeconstruct_Out_TKey_Out_TValue.SetBelong(this.instance);
				}
				return r_RDeconstruct_Out_TKey_Out_TValue;
			}
		}
        ...
        public virtual void Deconstruct(out TKey  @key, out TValue  @value)
        {
            ...
            var ___result = RDeconstruct_Out_TKey_Out_TValue.Invoke(___genericsType, ___parameters);
