	...
	public partial class RKeyCollection
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// TKey _currentKey
		/// </summary>
		protected RField r__currentKey;
		public virtual RField R_currentKey
		{
			get
			{
				if(r__currentKey == null)
				{
					r__currentKey = new(this, "_currentKey");
					r__currentKey.SetBelong(this.instance);
				}
				return r__currentKey;
			}
		}
