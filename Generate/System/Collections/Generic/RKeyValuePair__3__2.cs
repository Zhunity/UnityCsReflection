...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RKeyValuePair<TKey, TValue> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Deconstruct_Out_TKey_Out_TValue;
		public virtual RMethod RDeconstruct_Out_TKey_Out_TValue
		{
			get
			{
				if(r_Deconstruct_Out_TKey_Out_TValue == null)
				{
					r_Deconstruct_Out_TKey_Out_TValue = new(this, "Deconstruct", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), Type.MakeGenericMethodParameter(1).MakeByRefType());
					r_Deconstruct_Out_TKey_Out_TValue.SetBelong(this.instance);
				}
				return r_Deconstruct_Out_TKey_Out_TValue;
			}
		}
