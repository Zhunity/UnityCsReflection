...
{public partial class RHashSet<T>
{
    ...
    public partial class RElementCount : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_FuniqueCount;
		public virtual RSystem.RInt32 RFuniqueCount
		{
			get
			{
				if(r_FuniqueCount == null)
				{
					r_FuniqueCount = new(this, "uniqueCount");
					r_FuniqueCount.SetBelong(this.instance);
				}
				return r_FuniqueCount;
			}
		}
		...
		/// </summary>
		protected RSystem.RInt32 r_FunfoundCount;
		public virtual RSystem.RInt32 RFunfoundCount
		{
			get
			{
				if(r_FunfoundCount == null)
				{
					r_FunfoundCount = new(this, "unfoundCount");
					r_FunfoundCount.SetBelong(this.instance);
				}
				return r_FunfoundCount;
			}
		}
