...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RList<T> : RMember //
    {
		...
		/// T[] _items
		/// </summary>
		protected RFieldArray<RField> r_F_items;
		public virtual RFieldArray<RField> RF_items
		{
			get
			{
				if(r_F_items == null)
		...
		/// T[] s_emptyArray
		/// </summary>
		protected static RFieldArray<RField> r_Fs_emptyArray;
		public static RFieldArray<RField> RFs_emptyArray
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_PSystem__2__Collections__2__IList__2__IsFixedSize;
		public virtual RSystem.RBoolean RPSystem__2__Collections__2__IList__2__IsFixedSize
		{
			get
			{
