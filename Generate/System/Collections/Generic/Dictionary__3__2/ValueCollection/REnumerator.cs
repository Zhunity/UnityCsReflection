	...
	public partial class RValueCollection
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected RField r__currentValue;
		public virtual RField R_currentValue
		{
			get
			{
				if(r__currentValue == null)
				{
					r__currentValue = new(this, "_currentValue");
					r__currentValue.SetBelong(this.instance);
				}
				return r__currentValue;
			}
		}
