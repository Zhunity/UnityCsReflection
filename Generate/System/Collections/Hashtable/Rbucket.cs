...
{public partial class RHashtable
{
    ...
    public partial class Rbucket : RMember //
    {
		...
		/// System.Object key
		/// </summary>
		protected RSystem.RObject r_Fkey;
		public virtual RSystem.RObject RFkey
		{
			get
			{
				if(r_Fkey == null)
		...
		/// System.Object val
		/// </summary>
		protected RSystem.RObject r_Fval;
		public virtual RSystem.RObject RFval
		{
			get
			{
				if(r_Fval == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Fhash_coll;
		public virtual RSystem.RInt32 RFhash_coll
		{
			get
			{
