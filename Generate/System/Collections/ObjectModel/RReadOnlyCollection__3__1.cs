...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RObjectModel
{
    ...
    public partial class RReadOnlyCollection<T> : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIList<RField> r_Flist;
		public virtual RSystem.RCollections.RGeneric.RIList<RField> RFlist
		{
			get
			{
				if(r_Flist == null)
		...
		/// </summary>
		protected RSystem.RCollections.RGeneric.RIList<RProperty> r_PItems;
		public virtual RSystem.RCollections.RGeneric.RIList<RProperty> RPItems
		{
			get
			{
				if(r_PItems == null)
