...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections
{
    ...
    public partial class RQueue : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Enqueue_Object;
		public virtual RMethod REnqueue_Object
		{
			get
			{
				if(r_Enqueue_Object == null)
				{
					r_Enqueue_Object = new(this, "Enqueue", 0, typeof(System.Object));
					r_Enqueue_Object.SetBelong(this.instance);
				}
				return r_Enqueue_Object;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Synchronized_Queue;
		public static RMethod RSynchronized_Queue
		{
			get
			{
				if(r_Synchronized_Queue == null)
				{
					r_Synchronized_Queue = new(typeof(System.Collections.Queue), "Synchronized", 0, typeof(System.Collections.Queue));
					r_Synchronized_Queue.SetBelong(null);
				}
				return r_Synchronized_Queue;
			}
		}
		...
		/// </summary>
		protected RMethod r_GetElement_Int32;
		public virtual RMethod RGetElement_Int32
		{
			get
			{
				if(r_GetElement_Int32 == null)
				{
					r_GetElement_Int32 = new(this, "GetElement", 0, typeof(System.Int32));
					r_GetElement_Int32.SetBelong(this.instance);
				}
				return r_GetElement_Int32;
			}
		}
