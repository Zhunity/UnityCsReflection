...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RLocalDataStore : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RLocalDataStoreElement> r_Fm_DataTable;
		public virtual RFieldArray<RSystem.RLocalDataStoreElement> RFm_DataTable
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RLocalDataStoreMgr r_Fm_Manager;
		public virtual RSystem.RLocalDataStoreMgr RFm_Manager
		{
			get
			{
