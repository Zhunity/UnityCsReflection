...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RMonoTypeInfo : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_Ffull_name;
		public virtual RSystem.RString RFfull_name
		{
			get
			{
				if(r_Ffull_name == null)
				{
					r_Ffull_name = new(this, "full_name");
					r_Ffull_name.SetBelong(this.instance);
				}
				return r_Ffull_name;
			}
		}
		...
		/// </summary>
		protected RSystem.RReflection.RRuntimeConstructorInfo r_Fdefault_ctor;
		public virtual RSystem.RReflection.RRuntimeConstructorInfo RFdefault_ctor
		{
			get
			{
				if(r_Fdefault_ctor == null)
				{
					r_Fdefault_ctor = new(this, "default_ctor");
					r_Fdefault_ctor.SetBelong(this.instance);
				}
				return r_Fdefault_ctor;
			}
		}
