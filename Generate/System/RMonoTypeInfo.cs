    ...
    public partial class RMonoTypeInfo : RMember //
    {
		...
		public virtual RField Rfull_name
		{
			get
			{
				if(r_full_name == null)
				{
					r_full_name = new(this, "full_name");
					r_full_name.SetBelong(this.instance);
				}
				return r_full_name;
			}
		}
		...
		/// </summary>
		protected RSystem.RReflection.RRuntimeConstructorInfo r_default_ctor;
		public virtual RSystem.RReflection.RRuntimeConstructorInfo Rdefault_ctor
		{
			get
			{
				if(r_default_ctor == null)
				{
					r_default_ctor = new(this, "default_ctor");
					r_default_ctor.SetBelong(this.instance);
				}
				return r_default_ctor;
			}
		}
