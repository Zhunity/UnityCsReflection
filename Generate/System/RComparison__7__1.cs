...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RComparison<T> : RMember //
    {
		...
		/// Int32 Invoke(T, T)
		/// </summary>
		protected RMethod r_RInvoke_T_T;
		public virtual RMethod RInvoke_T_T
		{
			get
			{
				if(r_RInvoke_T_T == null)
				{
					r_RInvoke_T_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0));
					r_RInvoke_T_T.SetBelong(this.instance);
				}
				return r_RInvoke_T_T;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_T_T_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_T_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_T_T_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_T_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_T_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_T_T_AsyncCallback_Object;
			}
		}
        ...
        public virtual System.Int32 Invoke(T  @x, T  @y)
        {
            ...
            var ___result = RInvoke_T_T.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(T  @x, T  @y, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_T_T_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
