...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RAggregateException : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> r_Fm_innerExceptions;
		public virtual RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> RFm_innerExceptions
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> r_PInnerExceptions;
		public virtual RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> RPInnerExceptions
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_PInnerExceptionCount;
		public virtual RSystem.RInt32 RPInnerExceptionCount
		{
			get
			{
