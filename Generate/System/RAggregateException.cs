...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RAggregateException : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Handle_Func_d_Exception_Boolean_p_;
		public virtual RMethod RHandle_Func_d_Exception_Boolean_p_
		{
			get
			{
				if(r_Handle_Func_d_Exception_Boolean_p_ == null)
				{
					r_Handle_Func_d_Exception_Boolean_p_ = new(this, "Handle", 0, typeof(System.Func<, >).MakeGenericType(typeof(System.Exception), typeof(System.Boolean)));
					r_Handle_Func_d_Exception_Boolean_p_.SetBelong(this.instance);
				}
				return r_Handle_Func_d_Exception_Boolean_p_;
			}
		}
		...
		public virtual RMethod RFlatten
		{
			get
			{
				if(r_Flatten == null)
				{
					r_Flatten = new(this, "Flatten", 0);
					r_Flatten.SetBelong(this.instance);
				}
				return r_Flatten;
			}
		}
