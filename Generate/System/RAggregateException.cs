...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RAggregateException : RMember //
    {
		...
		/// </summary>
		protected RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> r_m_innerExceptions;
		public virtual RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> Rm_innerExceptions
		{
			get
			{
				if(r_m_innerExceptions == null)
				{
					r_m_innerExceptions = new(this, "m_innerExceptions");
					r_m_innerExceptions.SetBelong(this.instance);
				}
				return r_m_innerExceptions;
			}
		}
		...
		/// </summary>
		protected RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> r_InnerExceptions;
		public virtual RSystem.RCollections.RObjectModel.RReadOnlyCollection<RSystem.RException> RInnerExceptions
		{
			get
			{
				if(r_InnerExceptions == null)
				{
					r_InnerExceptions = new(this, "InnerExceptions", -1);
					r_InnerExceptions.SetBelong(this.instance);
				}
				return r_InnerExceptions;
			}
		}
		...
		public virtual RProperty RInnerExceptionCount
		{
			get
			{
				if(r_InnerExceptionCount == null)
				{
					r_InnerExceptionCount = new(this, "InnerExceptionCount", -1);
					r_InnerExceptionCount.SetBelong(this.instance);
				}
				return r_InnerExceptionCount;
			}
		}
		...
		/// </summary>
		protected RMethod r_RHandle_Func_d_Exception_Boolean_p_;
		public virtual RMethod RHandle_Func_d_Exception_Boolean_p_
		{
			get
			{
				if(r_RHandle_Func_d_Exception_Boolean_p_ == null)
				{
					r_RHandle_Func_d_Exception_Boolean_p_ = new(this, "Handle", 0, typeof(System.Func<, >).MakeGenericType(typeof(System.Exception), typeof(System.Boolean)));
					r_RHandle_Func_d_Exception_Boolean_p_.SetBelong(this.instance);
				}
				return r_RHandle_Func_d_Exception_Boolean_p_;
			}
		}
		...
		/// </summary>
		protected RMethod r_RFlatten;
		public virtual RMethod RFlatten
		{
			get
			{
				if(r_RFlatten == null)
				{
					r_RFlatten = new(this, "Flatten", 0);
					r_RFlatten.SetBelong(this.instance);
				}
				return r_RFlatten;
			}
		}
        ...
        public virtual void Handle(System.Func<System.Exception, System.Boolean>  @predicate)
        {
            ...
            var ___result = RHandle_Func_d_Exception_Boolean_p_.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.AggregateException Flatten()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RFlatten.Invoke(___genericsType, ___parameters);
