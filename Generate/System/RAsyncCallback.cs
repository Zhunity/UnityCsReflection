...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RAsyncCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_IAsyncResult;
		public virtual RMethod RMInvoke_IAsyncResult
		{
			get
			{
				if(r_MInvoke_IAsyncResult == null)
				{
					r_MInvoke_IAsyncResult = new(this, "Invoke", 0, typeof(System.IAsyncResult));
					r_MInvoke_IAsyncResult.SetBelong(this.instance);
				}
				return r_MInvoke_IAsyncResult;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.IAsyncResult, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_IAsyncResult_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_IAsyncResult_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_IAsyncResult_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_IAsyncResult_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.IAsyncResult), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_IAsyncResult_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_IAsyncResult_AsyncCallback_Object;
			}
		}
        ...
        public RAsyncCallback() : base("System.AsyncCallback")
        {
        }

        public RAsyncCallback(System.Object instance) : base("System.AsyncCallback")
		{
            SetInstance(instance);
		}

        public RAsyncCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAsyncCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.IAsyncResult @ar)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ar};
            var ___result = RMInvoke_IAsyncResult.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.IAsyncResult @ar, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ar, @callback, @object};
            var ___result = RMBeginInvoke_IAsyncResult_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
