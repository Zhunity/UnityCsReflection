...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RMemory<T> : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_F_object;
		public virtual RSystem.RObject RF_object
		{
			get
			{
				if(r_F_object == null)
		...
		/// </summary>
		protected static RSystem.RInt32 r_FRemoveFlagsBitMask;
		public static RSystem.RInt32 RFRemoveFlagsBitMask
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RMemory<RProperty> r_PEmpty;
		public static RSystem.RMemory<RProperty> RPEmpty
		{
			get
			{
				if(r_PEmpty == null)
		...
		/// </summary>
		protected RSystem.RSpan<RProperty> r_PSpan;
		public virtual RSystem.RSpan<RProperty> RPSpan
		{
			get
			{
				if(r_PSpan == null)
