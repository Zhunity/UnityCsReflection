    ...
    public partial class RMemory<T> : RMember //
    {
		...
		public static RField RRemoveFlagsBitMask
		{
			get
			{
				...
				{
					r_RemoveFlagsBitMask = new(typeof(System.Memory<>), "RemoveFlagsBitMask");
		...
		/// <summary>
		/// System.Memory`1[T] Empty
		/// </summary>
		protected static RSystem.RMemory<RProperty> r_Empty;
		public static RSystem.RMemory<RProperty> REmpty
		{
			get
			{
				if(r_Empty == null)
				{
					r_Empty = new(typeof(System.Memory<>), "Empty", -1);
		...
		/// <summary>
		/// System.Span`1[T] Span
		/// </summary>
		protected RSystem.RSpan<RProperty> r_Span;
		public virtual RSystem.RSpan<RProperty> RSpan
		{
			get
			{
				if(r_Span == null)
		...
		/// <summary>
		/// System.Memory`1[T] op_Implicit(T[])
		/// </summary>
		...
		public static RMethod Rop_Implicit_TArray
		{
			get
			{
				...
				{
					r_op_Implicit_TArray = new(typeof(System.Memory<>), "op_Implicit", 0, Type.MakeGenericMethodParameter(0).MakeArrayType());
		...
		/// <summary>
		/// System.Memory`1[T] op_Implicit(System.ArraySegment`1[T])
		/// </summary>
		...
		public static RMethod Rop_Implicit_ArraySegment_d_T_p_
		{
			get
			{
				...
				{
					r_op_Implicit_ArraySegment_d_T_p_ = new(typeof(System.Memory<>), "op_Implicit", 0, typeof(System.ArraySegment<>).MakeGenericType(Type.MakeGenericMethodParameter(0)));
		...
		/// <summary>
		/// System.ReadOnlyMemory`1[T] op_Implicit(System.Memory`1[T])
		/// </summary>
		protected static RMethod r_op_Implicit_Memory_d_T_p_;
		public static RMethod Rop_Implicit_Memory_d_T_p_
		{
			get
			{
				if(r_op_Implicit_Memory_d_T_p_ == null)
				{
					r_op_Implicit_Memory_d_T_p_ = new(typeof(System.Memory<>), "op_Implicit", 0, typeof(System.Memory<>));
					r_op_Implicit_Memory_d_T_p_.SetBelong(null);
				}
				return r_op_Implicit_Memory_d_T_p_;
			}
		}
		...
		/// <summary>
		/// System.Memory`1[T] Slice(Int32, Int32)
		/// </summary>
		...
		/// </summary>
		protected RMethod r_CopyTo_Memory_d_T_p_;
		public virtual RMethod RCopyTo_Memory_d_T_p_
		{
			get
			{
				if(r_CopyTo_Memory_d_T_p_ == null)
				{
					r_CopyTo_Memory_d_T_p_ = new(this, "CopyTo", 0, typeof(System.Memory<>));
					r_CopyTo_Memory_d_T_p_.SetBelong(this.instance);
				}
				return r_CopyTo_Memory_d_T_p_;
			}
		}
		...
		/// </summary>
		protected RMethod r_TryCopyTo_Memory_d_T_p_;
		public virtual RMethod RTryCopyTo_Memory_d_T_p_
		{
			get
			{
				if(r_TryCopyTo_Memory_d_T_p_ == null)
				{
					r_TryCopyTo_Memory_d_T_p_ = new(this, "TryCopyTo", 0, typeof(System.Memory<>));
					r_TryCopyTo_Memory_d_T_p_.SetBelong(this.instance);
				}
				return r_TryCopyTo_Memory_d_T_p_;
			}
		}
		...
		public virtual RMethod RPin
		{
			get
			{
				if(r_Pin == null)
				{
					r_Pin = new(this, "Pin", 0);
					r_Pin.SetBelong(this.instance);
				}
				return r_Pin;
			}
		}
		...
		/// <summary>
		/// Boolean Equals(System.Memory`1[T])
		/// </summary>
		protected RMethod r_Equals_Memory_d_T_p_;
		public virtual RMethod REquals_Memory_d_T_p_
		{
			get
			{
				if(r_Equals_Memory_d_T_p_ == null)
				{
					r_Equals_Memory_d_T_p_ = new(this, "Equals", 0, typeof(System.Memory<>));
					r_Equals_Memory_d_T_p_.SetBelong(this.instance);
				}
				return r_Equals_Memory_d_T_p_;
			}
		}
		...
		public static RMethod RCombineHashCodes_Int32_Int32
		{
			get
			{
				...
				{
					r_CombineHashCodes_Int32_Int32 = new(typeof(System.Memory<>), "CombineHashCodes", 0, typeof(System.Int32), typeof(System.Int32));
		...
		/// </summary>
		protected static RMethod r_CombineHashCodes_Int32_Int32_Int32;
		public static RMethod RCombineHashCodes_Int32_Int32_Int32
		{
			get
			{
				if(r_CombineHashCodes_Int32_Int32_Int32 == null)
				{
					r_CombineHashCodes_Int32_Int32_Int32 = new(typeof(System.Memory<>), "CombineHashCodes", 0, typeof(System.Int32), typeof(System.Int32), typeof(System.Int32));
					r_CombineHashCodes_Int32_Int32_Int32.SetBelong(null);
				}
				return r_CombineHashCodes_Int32_Int32_Int32;
			}
		}
        ...
        public static System.Memory<T> op_Implicit(T[] @array)
        {
            ...
            return (System.Memory<T>)___result;
        }
        ...
        public static System.ReadOnlyMemory<T> op_Implicit(System.Memory<T> @memory)
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@memory};
            var ___result = Rop_Implicit_Memory_d_T_p_.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.Boolean Equals(System.Memory<T> @other)
        {
            ...
            var ___result = REquals_Memory_d_T_p_.Invoke(___genericsType, ___parameters);
