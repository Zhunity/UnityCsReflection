...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RResolveEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RAssembly r___0__RequestingAssembly__1__k__BackingField;
		public virtual RSystem.RReflection.RAssembly R__0__RequestingAssembly__1__k__BackingField
		{
			get
			{
				if(r___0__RequestingAssembly__1__k__BackingField == null)
				{
					r___0__RequestingAssembly__1__k__BackingField = new(this, "<RequestingAssembly>k__BackingField");
					r___0__RequestingAssembly__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__RequestingAssembly__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RReflection.RAssembly r_RequestingAssembly;
		public virtual RSystem.RReflection.RAssembly RRequestingAssembly
		{
			get
			{
				if(r_RequestingAssembly == null)
				{
					r_RequestingAssembly = new(this, "RequestingAssembly", -1);
					r_RequestingAssembly.SetBelong(this.instance);
				}
				return r_RequestingAssembly;
			}
		}
