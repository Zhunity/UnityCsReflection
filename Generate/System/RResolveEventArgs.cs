...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RResolveEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RReflection.RAssembly r___1__RequestingAssembly__2__k__BackingField;
		public virtual RSystem.RReflection.RAssembly R__1__RequestingAssembly__2__k__BackingField
		{
			get
			{
				if(r___1__RequestingAssembly__2__k__BackingField == null)
				{
					r___1__RequestingAssembly__2__k__BackingField = new(this, "<RequestingAssembly>k__BackingField");
					r___1__RequestingAssembly__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__RequestingAssembly__2__k__BackingField;
			}
		}
		...
		public virtual RSystem.RReflection.RAssembly RequestingAssembly
		{
			get
			{
