...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting
{
    ...
    public partial class RObjectHandle : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r__wrapped;
		public virtual RSystem.RObject R_wrapped
		{
			get
			{
				if(r__wrapped == null)
				{
					r__wrapped = new(this, "_wrapped");
					r__wrapped.SetBelong(this.instance);
				}
				return r__wrapped;
			}
		}
		...
		/// </summary>
		protected RMethod r_Unwrap;
		public virtual RMethod RUnwrap
		{
			get
			{
				if(r_Unwrap == null)
				{
					r_Unwrap = new(this, "Unwrap", 0);
					r_Unwrap.SetBelong(this.instance);
				}
				return r_Unwrap;
			}
		}
        ...
        public virtual System.Object Unwrap()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RUnwrap.Invoke(___genericsType, ___parameters);
