...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RHeader : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_FHeaderNamespace;
		public virtual RSystem.RString RFHeaderNamespace
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_FMustUnderstand;
		public virtual RSystem.RBoolean RFMustUnderstand
		{
			get
			{
