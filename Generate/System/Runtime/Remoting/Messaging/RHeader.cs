...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RHeader : RMember //
    {
		...
		public virtual RField RHeaderNamespace
		{
			get
			{
				if(r_HeaderNamespace == null)
				{
					r_HeaderNamespace = new(this, "HeaderNamespace");
					r_HeaderNamespace.SetBelong(this.instance);
				}
				return r_HeaderNamespace;
			}
		}
		...
		public virtual RField RMustUnderstand
		{
			get
			{
				if(r_MustUnderstand == null)
				{
					r_MustUnderstand = new(this, "MustUnderstand");
					r_MustUnderstand.SetBelong(this.instance);
				}
				return r_MustUnderstand;
			}
		}
