...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RCallContextRemotingData : RMember //
    {
		...
		public virtual RSystem.RString R_logicalCallID
		{
			get
			{
				if(r__logicalCallID == null)
				{
					r__logicalCallID = new(this, "_logicalCallID");
					r__logicalCallID.SetBelong(this.instance);
				}
				return r__logicalCallID;
			}
		}
		...
		public virtual RSystem.RString RLogicalCallID
		{
			get
			{
				if(r_LogicalCallID == null)
				{
					r_LogicalCallID = new(this, "LogicalCallID", -1);
					r_LogicalCallID.SetBelong(this.instance);
				}
				return r_LogicalCallID;
			}
		}
