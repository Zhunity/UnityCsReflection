...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RCallContextRemotingData : RMember //
    {
		...
		/// </summary>
		protected RSystem.RString r_F_logicalCallID;
		public virtual RSystem.RString RF_logicalCallID
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_PLogicalCallID;
		public virtual RSystem.RString RPLogicalCallID
		{
			get
			{
