...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RCallContextSecurityData : RMember //
    {
		...
		/// </summary>
		protected RSystem.RSecurity.RPrincipal.RIPrincipal r_F_principal;
		public virtual RSystem.RSecurity.RPrincipal.RIPrincipal RF_principal
		{
			get
			{
				if(r_F_principal == null)
				{
					...
					r_F_principal.SetBelong(this.instance);
				}
