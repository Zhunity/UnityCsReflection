...
{public partial class RLogicalCallContext
{
    ...
    public partial class RReader : RMember //
    {
		...
		/// </summary>
		protected RSystem.RRuntime.RRemoting.RMessaging.RLogicalCallContext r_m_ctx;
		public virtual RSystem.RRuntime.RRemoting.RMessaging.RLogicalCallContext Rm_ctx
		{
			get
			{
				if(r_m_ctx == null)
