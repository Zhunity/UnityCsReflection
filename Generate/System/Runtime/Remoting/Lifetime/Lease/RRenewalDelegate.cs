...
{public partial class RLease
{
    ...
    public partial class RRenewalDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_ILease;
		public virtual RMethod RInvoke_ILease
		{
			get
			{
				if(r_Invoke_ILease == null)
				{
					r_Invoke_ILease = new(this, "Invoke", 0, typeof(System.Runtime.Remoting.Lifetime.ILease));
					r_Invoke_ILease.SetBelong(this.instance);
				}
				return r_Invoke_ILease;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_ILease_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ILease_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_ILease_AsyncCallback_Object == null)
				{
					r_BeginInvoke_ILease_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Runtime.Remoting.Lifetime.ILease), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_ILease_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_ILease_AsyncCallback_Object;
			}
		}
