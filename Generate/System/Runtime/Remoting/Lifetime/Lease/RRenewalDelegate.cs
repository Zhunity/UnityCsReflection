...
{public partial class RLease
{
    ...
    public partial class RRenewalDelegate : RMember //
    {
		...
		/// <summary>
		/// System.TimeSpan Invoke(System.Runtime.Remoting.Lifetime.ILease)
		/// </summary>
		protected RMethod r_MInvoke_ILease;
		public virtual RMethod RMInvoke_ILease
		{
			get
			{
				if(r_MInvoke_ILease == null)
				{
					r_MInvoke_ILease = new(this, "Invoke", 0, typeof(System.Runtime.Remoting.Lifetime.ILease));
					r_MInvoke_ILease.SetBelong(this.instance);
				}
				return r_MInvoke_ILease;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Runtime.Remoting.Lifetime.ILease, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_ILease_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_ILease_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_ILease_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_ILease_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Runtime.Remoting.Lifetime.ILease), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_ILease_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_ILease_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// System.TimeSpan EndInvoke(System.IAsyncResult)
		/// </summary>
        ...
        public RRenewalDelegate() : base("System.Runtime.Remoting.Lifetime.Lease+RenewalDelegate")
        {
        }

        public RRenewalDelegate(System.Object instance) : base("System.Runtime.Remoting.Lifetime.Lease+RenewalDelegate")
		{
            SetInstance(instance);
		}

        public RRenewalDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RRenewalDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.TimeSpan Invoke(System.Runtime.Remoting.Lifetime.ILease @lease)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@lease};
            var ___result = RMInvoke_ILease.Invoke(___genericsType, ___parameters);

            return (System.TimeSpan)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(System.Runtime.Remoting.Lifetime.ILease @lease, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@lease, @callback, @object};
            var ___result = RMBeginInvoke_ILease_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

            return (System.IAsyncResult)___result;
        }


        public virtual System.TimeSpan EndInvoke(System.IAsyncResult @result)
        {
