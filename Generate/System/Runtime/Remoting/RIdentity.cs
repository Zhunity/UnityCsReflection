...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting
{
    ...
    public partial class RIdentity : RMember //
    {
		...
		/// </summary>
		protected RSystem.RRuntime.RRemoting.RContexts.RDynamicPropertyCollection r_F_clientDynamicProperties;
		public virtual RSystem.RRuntime.RRemoting.RContexts.RDynamicPropertyCollection RF_clientDynamicProperties
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RRuntime.RRemoting.RContexts.RDynamicPropertyCollection r_F_serverDynamicProperties;
		public virtual RSystem.RRuntime.RRemoting.RContexts.RDynamicPropertyCollection RF_serverDynamicProperties
		{
			get
			{
