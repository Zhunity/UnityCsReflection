...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RExceptionServices
{
    ...
    public partial class RFirstChanceExceptionEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RException r___0__Exception__1__k__BackingField;
		public virtual RSystem.RException R__0__Exception__1__k__BackingField
		{
			get
			{
				if(r___0__Exception__1__k__BackingField == null)
				{
					r___0__Exception__1__k__BackingField = new(this, "<Exception>k__BackingField");
					r___0__Exception__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__Exception__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected RSystem.RException r_Exception;
		public virtual RSystem.RException RException
		{
			get
			{
				if(r_Exception == null)
