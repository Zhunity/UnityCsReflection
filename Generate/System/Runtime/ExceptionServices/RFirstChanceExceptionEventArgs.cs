...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RExceptionServices
{
    ...
    public partial class RFirstChanceExceptionEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RException r___1__Exception__2__k__BackingField;
		public virtual RSystem.RException R__1__Exception__2__k__BackingField
		{
			get
			{
				if(r___1__Exception__2__k__BackingField == null)
				{
					r___1__Exception__2__k__BackingField = new(this, "<Exception>k__BackingField");
					r___1__Exception__2__k__BackingField.SetBelong(this.instance);
				}
				return r___1__Exception__2__k__BackingField;
			}
		}
