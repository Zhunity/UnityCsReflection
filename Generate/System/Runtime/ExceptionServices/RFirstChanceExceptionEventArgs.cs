...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RExceptionServices
{
    ...
    public partial class RFirstChanceExceptionEventArgs : RMember //
    {
		...
		/// </summary>
		protected RSystem.RException r_F__0__Exception__1__k__BackingField;
		public virtual RSystem.RException RF__0__Exception__1__k__BackingField
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RException r_PException;
		public virtual RSystem.RException RPException
		{
			get
			{
