...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RCompilerServices
{
    ...
    public partial class RConfiguredTaskAwaitable : RMember //
    {
		...
		/// </summary>
		protected RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable.RConfiguredTaskAwaiter r_m_configuredTaskAwaiter;
		public virtual RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable.RConfiguredTaskAwaiter Rm_configuredTaskAwaiter
		{
			get
			{
				if(r_m_configuredTaskAwaiter == null)
				{
					r_m_configuredTaskAwaiter = new(this, "m_configuredTaskAwaiter");
					r_m_configuredTaskAwaiter.SetBelong(this.instance);
				}
				return r_m_configuredTaskAwaiter;
			}
		}
        ...
        public virtual RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable.RConfiguredTaskAwaiter GetAwaiter()
        {
            ...
            return new RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable.RConfiguredTaskAwaiter(___result);
        }
