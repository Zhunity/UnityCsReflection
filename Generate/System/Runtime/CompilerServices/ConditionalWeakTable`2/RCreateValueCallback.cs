...
{public partial class RConditionalWeakTable<TKey, TValue>
{
    ...
    public partial class RCreateValueCallback : RMember //
    {
		...
		/// TValue Invoke(TKey)
		/// </summary>
		protected RMethod r_RInvoke_TKey;
		public virtual RMethod RInvoke_TKey
		{
			get
			{
				if(r_RInvoke_TKey == null)
				{
					r_RInvoke_TKey = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_RInvoke_TKey.SetBelong(this.instance);
				}
				return r_RInvoke_TKey;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_TKey_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TKey_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_TKey_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_TKey_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_TKey_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_TKey_AsyncCallback_Object;
			}
		}
        ...
        public virtual TValue Invoke(TKey  @key)
        {
            ...
            var ___result = RInvoke_TKey.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(TKey  @key, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_TKey_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
