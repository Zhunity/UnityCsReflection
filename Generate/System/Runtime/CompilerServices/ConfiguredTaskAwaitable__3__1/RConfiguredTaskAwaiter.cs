...
{public partial class RConfiguredTaskAwaitable<TResult>
{
    ...
    public partial class RConfiguredTaskAwaiter : RMember //
    {
		...
		/// </summary>
		protected RSystem.RThreading.RTasks.RTask<RField> r_Fm_task;
		public virtual RSystem.RThreading.RTasks.RTask<RField> RFm_task
		{
			get
			{
				if(r_Fm_task == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fm_continueOnCapturedContext;
		public virtual RSystem.RBoolean RFm_continueOnCapturedContext
		{
			get
			{
				if(r_Fm_continueOnCapturedContext == null)
				{
					...
					r_Fm_continueOnCapturedContext.SetBelong(this.instance);
				}
