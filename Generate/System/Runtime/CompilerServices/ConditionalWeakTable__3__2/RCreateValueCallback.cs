...
{public partial class RConditionalWeakTable<TKey, TValue>
{
    ...
    public partial class RCreateValueCallback : RMember //
    {
		...
		/// TValue Invoke(TKey)
		/// </summary>
		protected RMethod r_Invoke_TKey;
		public virtual RMethod RInvoke_TKey
		{
			get
			{
				if(r_Invoke_TKey == null)
				{
					r_Invoke_TKey = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_Invoke_TKey.SetBelong(this.instance);
				}
				return r_Invoke_TKey;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_TKey_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TKey_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_TKey_AsyncCallback_Object == null)
				{
					r_BeginInvoke_TKey_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_TKey_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_TKey_AsyncCallback_Object;
			}
		}
