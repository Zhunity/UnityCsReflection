...
{public partial class RConditionalWeakTable<TKey, TValue>
{
    ...
    public partial class RCreateValueCallback : RMember //
    {
		...
		/// TValue Invoke(TKey)
		/// </summary>
		protected RMethod r_MInvoke_TKey;
		public virtual RMethod RMInvoke_TKey
		{
			get
			{
				if(r_MInvoke_TKey == null)
				{
					r_MInvoke_TKey = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_MInvoke_TKey.SetBelong(this.instance);
				}
				return r_MInvoke_TKey;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(TKey, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_TKey_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_TKey_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_TKey_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_TKey_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_TKey_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_TKey_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// TValue EndInvoke(System.IAsyncResult)
		/// </summary>
        ...
        public virtual TValue Invoke(TKey @key)
        {
            ...
            var ___result = RMInvoke_TKey.Invoke(___genericsType, ___parameters);

            return (TValue)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(TKey @key, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@key, @callback, @object};
            var ___result = RMBeginInvoke_TKey_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
