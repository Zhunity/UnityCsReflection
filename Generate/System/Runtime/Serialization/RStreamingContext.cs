...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RSerialization
{
    ...
    public partial class RStreamingContext : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_Fm_additionalContext;
		public virtual RSystem.RObject RFm_additionalContext
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RRuntime.RSerialization.RStreamingContextStates r_Fm_state;
		public virtual RSystem.RRuntime.RSerialization.RStreamingContextStates RFm_state
		{
			get
			{
				if(r_Fm_state == null)
		...
		/// </summary>
		protected RSystem.RObject r_PContext;
		public virtual RSystem.RObject RPContext
		{
			get
			{
				if(r_PContext == null)
		...
		/// </summary>
		protected RSystem.RRuntime.RSerialization.RStreamingContextStates r_PState;
		public virtual RSystem.RRuntime.RSerialization.RStreamingContextStates RPState
		{
			get
			{
				if(r_PState == null)
