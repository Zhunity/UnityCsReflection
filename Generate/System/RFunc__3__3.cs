...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// System.Func`3
	/// </summary>
    public partial class RFunc<T1, T2, TResult> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_T1_T2;
		public virtual RMethod RMInvoke_T1_T2
		{
			get
			{
				if(r_MInvoke_T1_T2 == null)
				{
					r_MInvoke_T1_T2 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_MInvoke_T1_T2.SetBelong(this.instance);
				}
				return r_MInvoke_T1_T2;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(T1, T2, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_T1_T2_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T1_T2_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T1_T2_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T1_T2_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_T1_T2_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_T1_T2_AsyncCallback_Object;
			}
		}
        ...
        public RFunc() : base("System.Func`3")
        {
        }

        public RFunc(System.Object instance) : base("System.Func`3")
		{
        ...
        public virtual TResult Invoke(T1 @arg1, T2 @arg2)
        {
            ...
            var ___parameters = new object[]{@arg1, @arg2};
            var ___result = RMInvoke_T1_T2.Invoke(___genericsType, ___parameters);

            return (TResult)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(T1 @arg1, T2 @arg2, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@arg1, @arg2, @callback, @object};
            var ___result = RMBeginInvoke_T1_T2_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
