...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RFunc<T1, T2, TResult> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_T1_T2;
		public virtual RMethod RInvoke_T1_T2
		{
			get
			{
				if(r_Invoke_T1_T2 == null)
				{
					r_Invoke_T1_T2 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1));
					r_Invoke_T1_T2.SetBelong(this.instance);
				}
				return r_Invoke_T1_T2;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T1_T2_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T1_T2_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T1_T2_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T1_T2_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T1_T2_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T1_T2_AsyncCallback_Object;
			}
		}
