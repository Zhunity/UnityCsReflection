...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RCancellationCallbackCoreWorkArguments : RMember //
    {
		...
		/// </summary>
		protected RSystem.RThreading.RSparselyPopulatedArrayFragment<RSystem.RThreading.RCancellationCallbackInfo> r_F_currArrayFragment;
		public virtual RSystem.RThreading.RSparselyPopulatedArrayFragment<RSystem.RThreading.RCancellationCallbackInfo> RF_currArrayFragment
		{
			get
			{
				if(r_F_currArrayFragment == null)
				{
					...
					r_F_currArrayFragment.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected RSystem.RInt32 r_F_currArrayIndex;
		public virtual RSystem.RInt32 RF_currArrayIndex
		{
			get
			{
				if(r_F_currArrayIndex == null)
				{
					...
					r_F_currArrayIndex.SetBelong(this.instance);
				}
