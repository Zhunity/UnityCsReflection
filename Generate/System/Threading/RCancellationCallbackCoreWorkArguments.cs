...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RCancellationCallbackCoreWorkArguments : RMember //
    {
		...
		/// </summary>
		protected RSystem.RThreading.RSparselyPopulatedArrayFragment<RSystem.RThreading.RCancellationCallbackInfo> r__currArrayFragment;
		public virtual RSystem.RThreading.RSparselyPopulatedArrayFragment<RSystem.RThreading.RCancellationCallbackInfo> R_currArrayFragment
		{
			get
			{
				if(r__currArrayFragment == null)
				{
					r__currArrayFragment = new(this, "_currArrayFragment");
					r__currArrayFragment.SetBelong(this.instance);
				}
				return r__currArrayFragment;
			}
		}
		...
		public virtual RField R_currArrayIndex
		{
			get
			{
				if(r__currArrayIndex == null)
				{
					r__currArrayIndex = new(this, "_currArrayIndex");
					r__currArrayIndex.SetBelong(this.instance);
				}
				return r__currArrayIndex;
			}
		}
