...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RContextCallback<TState> : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(TState ByRef)
		/// </summary>
		protected RMethod r_MInvoke_Ref_TState;
		public virtual RMethod RMInvoke_Ref_TState
		{
			get
			{
				if(r_MInvoke_Ref_TState == null)
				{
					r_MInvoke_Ref_TState = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType());
					r_MInvoke_Ref_TState.SetBelong(this.instance);
				}
				return r_MInvoke_Ref_TState;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(TState ByRef, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Ref_TState_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Ref_TState_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Ref_TState_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Ref_TState_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Ref_TState_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Ref_TState_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// Void EndInvoke(TState ByRef, System.IAsyncResult)
		/// </summary>
		protected RMethod r_MEndInvoke_Ref_TState_IAsyncResult;
		public virtual RMethod RMEndInvoke_Ref_TState_IAsyncResult
		{
			get
			{
				if(r_MEndInvoke_Ref_TState_IAsyncResult == null)
				{
					r_MEndInvoke_Ref_TState_IAsyncResult = new(this, "EndInvoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), typeof(System.IAsyncResult));
					r_MEndInvoke_Ref_TState_IAsyncResult.SetBelong(this.instance);
				}
				return r_MEndInvoke_Ref_TState_IAsyncResult;
			}
		}
        ...
        public RContextCallback() : base("System.Threading.ContextCallback`1")
        {
        }

        public RContextCallback(System.Object instance) : base("System.Threading.ContextCallback`1")
		{
            SetInstance(instance);
		}

        public RContextCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RContextCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(ref TState @state)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(ref TState @state, System.AsyncCallback @callback, System.Object @object)
        {
        ...
        public virtual void EndInvoke(ref TState @state, System.IAsyncResult @result)
        {
