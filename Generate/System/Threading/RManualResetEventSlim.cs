...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RManualResetEventSlim : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RInt32 r_FDEFAULT_SPIN_SP;
		public static RSystem.RInt32 RFDEFAULT_SPIN_SP
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RObject r_Fm_lock;
		public virtual RSystem.RObject RFm_lock
		{
			get
			{
				if(r_Fm_lock == null)
		...
		/// </summary>
		protected RSystem.RThreading.RManualResetEvent r_Fm_eventObj;
		public virtual RSystem.RThreading.RManualResetEvent RFm_eventObj
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_combinedState;
		public virtual RSystem.RInt32 RFm_combinedState
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FSignalledState_BitMask;
		public static RSystem.RInt32 RFSignalledState_BitMask
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FSignalledState_ShiftCount;
		public static RSystem.RInt32 RFSignalledState_ShiftCount
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FDispose_BitMask;
		public static RSystem.RInt32 RFDispose_BitMask
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FSpinCountState_BitMask;
		public static RSystem.RInt32 RFSpinCountState_BitMask
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FSpinCountState_ShiftCount;
		public static RSystem.RInt32 RFSpinCountState_ShiftCount
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FSpinCountState_MaxValue;
		public static RSystem.RInt32 RFSpinCountState_MaxValue
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FNumWaitersState_BitMask;
		public static RSystem.RInt32 RFNumWaitersState_BitMask
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FNumWaitersState_ShiftCount;
		public static RSystem.RInt32 RFNumWaitersState_ShiftCount
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RInt32 r_FNumWaitersState_MaxValue;
		public static RSystem.RInt32 RFNumWaitersState_MaxValue
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RAction<RSystem.RObject> r_Fs_cancellationTokenCallback;
		public static RSystem.RAction<RSystem.RObject> RFs_cancellationTokenCallback
		{
			get
			{
		...
		/// Boolean IsSet
		/// </summary>
		protected RSystem.RBoolean r_PIsSet;
		public virtual RSystem.RBoolean RPIsSet
		{
			get
			{
				if(r_PIsSet == null)
		...
		/// Int32 SpinCount
		/// </summary>
		protected RSystem.RInt32 r_PSpinCount;
		public virtual RSystem.RInt32 RPSpinCount
		{
			get
			{
		...
		/// Int32 Waiters
		/// </summary>
		protected RSystem.RInt32 r_PWaiters;
		public virtual RSystem.RInt32 RPWaiters
		{
			get
			{
				if(r_PWaiters == null)
