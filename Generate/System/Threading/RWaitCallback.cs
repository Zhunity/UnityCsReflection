...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
	...
	/// </summary>
    public partial class RWaitCallback : RMember //
    {
        ...
        public RWaitCallback() : base("System.Threading.WaitCallback")
        {
        }

        public RWaitCallback(System.Object instance) : base("System.Threading.WaitCallback")
		{
            SetInstance(instance);
		}

        public RWaitCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RWaitCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
