...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading.RTasks
{
    ...
    public partial class RTaskStatus : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FCreated;
		public static RSystem.RThreading.RTasks.RTaskStatus RFCreated
		{
			get
			{
				if(r_FCreated == null)
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FWaitingForActivation;
		public static RSystem.RThreading.RTasks.RTaskStatus RFWaitingForActivation
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FWaitingToRun;
		public static RSystem.RThreading.RTasks.RTaskStatus RFWaitingToRun
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FRunning;
		public static RSystem.RThreading.RTasks.RTaskStatus RFRunning
		{
			get
			{
				if(r_FRunning == null)
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FWaitingForChildrenToComplete;
		public static RSystem.RThreading.RTasks.RTaskStatus RFWaitingForChildrenToComplete
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FRanToCompletion;
		public static RSystem.RThreading.RTasks.RTaskStatus RFRanToCompletion
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FCanceled;
		public static RSystem.RThreading.RTasks.RTaskStatus RFCanceled
		{
			get
			{
				if(r_FCanceled == null)
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTaskStatus r_FFaulted;
		public static RSystem.RThreading.RTasks.RTaskStatus RFFaulted
		{
			get
			{
				if(r_FFaulted == null)
