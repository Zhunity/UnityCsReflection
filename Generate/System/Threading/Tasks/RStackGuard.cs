...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading.RTasks
{
    ...
    public partial class RStackGuard : RMember //
    {
		...
		/// </summary>
		protected RSystem.RInt32 r_Fm_inliningDepth;
		public virtual RSystem.RInt32 RFm_inliningDepth
		{
			get
			{
				if(r_Fm_inliningDepth == null)
				{
					...
					r_Fm_inliningDepth.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected static RSystem.RInt32 r_FMAX_UNCHECKED_INLINING_DEPTH;
		public static RSystem.RInt32 RFMAX_UNCHECKED_INLINING_DEPTH
		{
			get
			{
				if(r_FMAX_UNCHECKED_INLINING_DEPTH == null)
				{
					...
					r_FMAX_UNCHECKED_INLINING_DEPTH.SetBelong(null);
				}
		...
		public virtual RMethod RMTryBeginInliningScope
		{
			get
			{
				if(r_MTryBeginInliningScope == null)
				{
					...
					r_MTryBeginInliningScope.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMEndInliningScope
		{
			get
			{
				if(r_MEndInliningScope == null)
				{
					...
					r_MEndInliningScope.SetBelong(this.instance);
				}
