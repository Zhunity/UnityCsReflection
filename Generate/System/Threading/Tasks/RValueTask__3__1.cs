...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading.RTasks
{
    ...
    public partial class RValueTask<TResult> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Equals_ValueTask_d_TResult_p_;
		public virtual RMethod REquals_ValueTask_d_TResult_p_
		{
			get
			{
				if(r_Equals_ValueTask_d_TResult_p_ == null)
				{
					r_Equals_ValueTask_d_TResult_p_ = new(this, "Equals", 0, typeof(System.Threading.Tasks.ValueTask<>));
					r_Equals_ValueTask_d_TResult_p_.SetBelong(this.instance);
				}
				return r_Equals_ValueTask_d_TResult_p_;
			}
		}
		...
		/// </summary>
		protected static RMethod r_op_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_;
		public static RMethod Rop_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_
		{
			get
			{
				if(r_op_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ == null)
				{
					r_op_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ = new(typeof(System.Threading.Tasks.ValueTask<>), "op_Equality", 0, typeof(System.Threading.Tasks.ValueTask<>), typeof(System.Threading.Tasks.ValueTask<>));
					r_op_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_.SetBelong(null);
				}
				return r_op_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_;
			}
		}
		...
		/// </summary>
		protected static RMethod r_op_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_;
		public static RMethod Rop_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_
		{
			get
			{
				if(r_op_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ == null)
				{
					r_op_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ = new(typeof(System.Threading.Tasks.ValueTask<>), "op_Inequality", 0, typeof(System.Threading.Tasks.ValueTask<>), typeof(System.Threading.Tasks.ValueTask<>));
					r_op_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_.SetBelong(null);
				}
				return r_op_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_;
			}
		}
		...
		/// </summary>
		protected RMethod r_GetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_;
		public virtual RMethod RGetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_
		{
			get
			{
				if(r_GetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_ == null)
				{
					r_GetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_ = new(this, "GetTaskForValueTaskSource", 0, typeof(System.Threading.Tasks.Sources.IValueTaskSource<>).MakeGenericType(Type.MakeGenericMethodParameter(0)));
					r_GetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_.SetBelong(this.instance);
				}
				return r_GetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_;
			}
		}
