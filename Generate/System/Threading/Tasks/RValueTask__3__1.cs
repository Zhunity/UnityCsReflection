...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading.RTasks
{
    ...
    public partial class RValueTask<TResult> : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RThreading.RTasks.RTask<RField> r_Fs_canceledTask;
		public static RSystem.RThreading.RTasks.RTask<RField> RFs_canceledTask
		{
			get
			{
		...
		/// System.Object _obj
		/// </summary>
		protected RSystem.RObject r_F_obj;
		public virtual RSystem.RObject RF_obj
		{
			get
			{
				if(r_F_obj == null)
		...
		/// TResult _result
		/// </summary>
		protected RField r_F_result;
		public virtual RField RF_result
		{
			get
			{
				if(r_F_result == null)
				{
					...
					r_F_result.SetBelong(this.instance);
				}
				return r_F_result;
			}
		}
		...
		/// System.Int16 _token
		/// </summary>
		protected RSystem.RInt16 r_F_token;
		public virtual RSystem.RInt16 RF_token
		{
			get
			{
				if(r_F_token == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_F_continueOnCapturedContext;
		public virtual RSystem.RBoolean RF_continueOnCapturedContext
		{
			get
			{
		...
		public virtual RMethod RMEquals_ValueTask_d_TResult_p_
		{
			get
			{
				if(r_MEquals_ValueTask_d_TResult_p_ == null)
				{
					...
					r_MEquals_ValueTask_d_TResult_p_.SetBelong(this.instance);
				}
		...
		public static RMethod RMop_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_
		{
			get
			{
				if(r_Mop_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ == null)
				{
					...
					r_Mop_Equality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_.SetBelong(null);
				}
		...
		public static RMethod RMop_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_
		{
			get
			{
				if(r_Mop_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_ == null)
				{
					...
					r_Mop_Inequality_ValueTask_d_TResult_p__ValueTask_d_TResult_p_.SetBelong(null);
				}
		...
		public virtual RMethod RMGetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_
		{
			get
			{
				if(r_MGetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_ == null)
				{
					...
					r_MGetTaskForValueTaskSource_IValueTaskSource_d_TResult_p_.SetBelong(this.instance);
				}
