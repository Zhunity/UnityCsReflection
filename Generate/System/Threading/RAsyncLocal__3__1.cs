...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RAsyncLocal<T> : RMember //
    {
		...
		/// </summary>
		protected RSystem.RAction<RSystem.RThreading.RAsyncLocalValueChangedArgs<RField>> r_Fm_valueChangedHandler;
		public virtual RSystem.RAction<RSystem.RThreading.RAsyncLocalValueChangedArgs<RField>> RFm_valueChangedHandler
		{
			get
			{
				if(r_Fm_valueChangedHandler == null)
				{
					...
					r_Fm_valueChangedHandler.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Threading__2__IAsyncLocal__2__OnValueChanged_Object_Object_Boolean
		{
			get
			{
				if(r_MSystem__2__Threading__2__IAsyncLocal__2__OnValueChanged_Object_Object_Boolean == null)
				{
					...
					r_MSystem__2__Threading__2__IAsyncLocal__2__OnValueChanged_Object_Object_Boolean.SetBelong(this.instance);
				}
