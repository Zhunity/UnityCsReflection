...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RAsyncLocalValueChangedArgs<T> : RMember //
    {
		...
		/// </summary>
		protected RField r___0__CurrentValue__1__k__BackingField;
		public virtual RField R__0__CurrentValue__1__k__BackingField
		{
			get
			{
				if(r___0__CurrentValue__1__k__BackingField == null)
				{
					r___0__CurrentValue__1__k__BackingField = new(this, "<CurrentValue>k__BackingField");
					r___0__CurrentValue__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__CurrentValue__1__k__BackingField;
			}
		}
		...
		public virtual RField R__0__ThreadContextChanged__1__k__BackingField
		{
			get
			{
				if(r___0__ThreadContextChanged__1__k__BackingField == null)
				{
					r___0__ThreadContextChanged__1__k__BackingField = new(this, "<ThreadContextChanged>k__BackingField");
					r___0__ThreadContextChanged__1__k__BackingField.SetBelong(this.instance);
				}
				return r___0__ThreadContextChanged__1__k__BackingField;
			}
		}
