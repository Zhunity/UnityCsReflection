...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RExecutionContextSwitcher : RMember //
    {
		...
		/// </summary>
		protected RSystem.RThreading.RExecutionContext.RReader r_FouterEC;
		public virtual RSystem.RThreading.RExecutionContext.RReader RFouterEC
		{
			get
			{
				if(r_FouterEC == null)
				{
					...
					r_FouterEC.SetBelong(this.instance);
				}
				return r_FouterEC;
			}
		}
		...
		/// </summary>
		protected RSystem.RBoolean r_FouterECBelongsToScope;
		public virtual RSystem.RBoolean RFouterECBelongsToScope
		{
			get
			{
				if(r_FouterECBelongsToScope == null)
				{
					...
					r_FouterECBelongsToScope.SetBelong(this.instance);
				}
		...
		/// System.Object hecsw
		/// </summary>
		protected RSystem.RObject r_Fhecsw;
		public virtual RSystem.RObject RFhecsw
		{
			get
			{
				if(r_Fhecsw == null)
				{
					...
					r_Fhecsw.SetBelong(this.instance);
				}
				return r_Fhecsw;
			}
		}
		...
		/// </summary>
		protected RSystem.RThreading.RThread r_Fthread;
		public virtual RSystem.RThreading.RThread RFthread
		{
			get
			{
				if(r_Fthread == null)
				{
					...
					r_Fthread.SetBelong(this.instance);
				}
				return r_Fthread;
			}
		}
		...
		public virtual RMethod RMUndoNoThrow
		{
			get
			{
				if(r_MUndoNoThrow == null)
				{
					...
					r_MUndoNoThrow.SetBelong(this.instance);
				}
