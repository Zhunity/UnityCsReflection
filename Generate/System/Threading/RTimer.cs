...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RTimer : RMember //
    {
		...
		/// </summary>
		protected RSystem.RThreading.RTimerCallback r_Fcallback;
		public virtual RSystem.RThreading.RTimerCallback RFcallback
		{
			get
			{
				if(r_Fcallback == null)
		...
		/// System.Object state
		/// </summary>
		protected RSystem.RObject r_Fstate;
		public virtual RSystem.RObject RFstate
		{
			get
			{
				if(r_Fstate == null)
		...
		/// </summary>
		protected RSystem.RInt64 r_Fdue_time_ms;
		public virtual RSystem.RInt64 RFdue_time_ms
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Fperiod_ms;
		public virtual RSystem.RInt64 RFperiod_ms
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RInt64 r_Fnext_run;
		public virtual RSystem.RInt64 RFnext_run
		{
			get
			{
				if(r_Fnext_run == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fis_dead;
		public virtual RSystem.RBoolean RFis_dead
		{
			get
			{
				if(r_Fis_dead == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_Fis_added;
		public virtual RSystem.RBoolean RFis_added
		{
			get
			{
				if(r_Fis_added == null)
		...
		/// Scheduler scheduler
		/// </summary>
		protected static RSystem.RThreading.RTimer.RScheduler r_Pscheduler;
		public static RSystem.RThreading.RTimer.RScheduler RPscheduler
		{
			get
			{
