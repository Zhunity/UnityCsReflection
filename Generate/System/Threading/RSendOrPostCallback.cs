...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
	...
	/// </summary>
    public partial class RSendOrPostCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Object;
		public virtual RMethod RMInvoke_Object
		{
			get
			{
				if(r_MInvoke_Object == null)
				{
					r_MInvoke_Object = new(this, "Invoke", 0, typeof(System.Object));
					r_MInvoke_Object.SetBelong(this.instance);
				}
				return r_MInvoke_Object;
			}
		}
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_Object_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Object_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Object_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Object_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Object_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Object_AsyncCallback_Object;
			}
		}
        ...
        public RSendOrPostCallback() : base("System.Threading.SendOrPostCallback")
        {
        }

        public RSendOrPostCallback(System.Object instance) : base("System.Threading.SendOrPostCallback")
		{
            SetInstance(instance);
		}

        public RSendOrPostCallback(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RSendOrPostCallback(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object @state)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@state};
            var ___result = RMInvoke_Object.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object @state, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@state, @callback, @object};
            var ___result = RMBeginInvoke_Object_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
