...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RContextCallback<TState> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Ref_TState;
		public virtual RMethod RInvoke_Ref_TState
		{
			get
			{
				if(r_RInvoke_Ref_TState == null)
				{
					r_RInvoke_Ref_TState = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType());
					r_RInvoke_Ref_TState.SetBelong(this.instance);
				}
				return r_RInvoke_Ref_TState;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Ref_TState_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Ref_TState_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Ref_TState_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Ref_TState_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Ref_TState_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Ref_TState_AsyncCallback_Object;
			}
		}
		...
		/// </summary>
		protected RMethod r_REndInvoke_Ref_TState_IAsyncResult;
		public virtual RMethod REndInvoke_Ref_TState_IAsyncResult
		{
			get
			{
				if(r_REndInvoke_Ref_TState_IAsyncResult == null)
				{
					r_REndInvoke_Ref_TState_IAsyncResult = new(this, "EndInvoke", 0, Type.MakeGenericMethodParameter(0).MakeByRefType(), typeof(System.IAsyncResult));
					r_REndInvoke_Ref_TState_IAsyncResult.SetBelong(this.instance);
				}
				return r_REndInvoke_Ref_TState_IAsyncResult;
			}
		}
