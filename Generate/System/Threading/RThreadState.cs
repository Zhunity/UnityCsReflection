...
namespace SMFrame.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RThreadState : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FRunning;
		public static RSystem.RThreading.RThreadState RFRunning
		{
			get
			{
				if(r_FRunning == null)
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FStopRequested;
		public static RSystem.RThreading.RThreadState RFStopRequested
		{
			get
			{
				if(r_FStopRequested == null)
				{
					...
					r_FStopRequested.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FSuspendRequested;
		public static RSystem.RThreading.RThreadState RFSuspendRequested
		{
			get
			{
				if(r_FSuspendRequested == null)
				{
					...
					r_FSuspendRequested.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FBackground;
		public static RSystem.RThreading.RThreadState RFBackground
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FUnstarted;
		public static RSystem.RThreading.RThreadState RFUnstarted
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FStopped;
		public static RSystem.RThreading.RThreadState RFStopped
		{
			get
			{
				if(r_FStopped == null)
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FWaitSleepJoin;
		public static RSystem.RThreading.RThreadState RFWaitSleepJoin
		{
			get
			{
				if(r_FWaitSleepJoin == null)
				{
					...
					r_FWaitSleepJoin.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FSuspended;
		public static RSystem.RThreading.RThreadState RFSuspended
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FAbortRequested;
		public static RSystem.RThreading.RThreadState RFAbortRequested
		{
			get
			{
				if(r_FAbortRequested == null)
				{
					...
					r_FAbortRequested.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RThreading.RThreadState r_FAborted;
		public static RSystem.RThreading.RThreadState RFAborted
		{
			get
			{
				if(r_FAborted == null)
