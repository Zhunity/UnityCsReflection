...
{public partial class RString
{
    ...
    public partial class RTrimType : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RString.RTrimType r_FHead;
		public static RSystem.RString.RTrimType RFHead
		{
			get
			{
				if(r_FHead == null)
				{
					r_FHead = new( ReflectionUtils.GetType("System.String+TrimType"), "Head");
					r_FHead.SetBelong(null);
				}
				return r_FHead;
			}
		}
		...
		/// </summary>
		protected static RSystem.RString.RTrimType r_FTail;
		public static RSystem.RString.RTrimType RFTail
		{
			get
			{
				if(r_FTail == null)
				{
					r_FTail = new( ReflectionUtils.GetType("System.String+TrimType"), "Tail");
					r_FTail.SetBelong(null);
				}
				return r_FTail;
			}
		}
		...
		/// </summary>
		protected static RSystem.RString.RTrimType r_FBoth;
		public static RSystem.RString.RTrimType RFBoth
		{
			get
			{
				if(r_FBoth == null)
				{
					r_FBoth = new( ReflectionUtils.GetType("System.String+TrimType"), "Both");
