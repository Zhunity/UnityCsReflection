...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RSByte : RMember //
    {
		...
		/// </summary>
		protected RSystem.RSByte r_Fm_value;
		public virtual RSystem.RSByte RFm_value
		{
			get
			{
				if(r_Fm_value == null)
		...
		/// </summary>
		protected static RSystem.RSByte r_FMaxValue;
		public static RSystem.RSByte RFMaxValue
		{
			get
			{
				if(r_FMaxValue == null)
		...
		/// </summary>
		protected static RSystem.RSByte r_FMinValue;
		public static RSystem.RSByte RFMinValue
		{
			get
			{
				if(r_FMinValue == null)
