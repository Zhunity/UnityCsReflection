...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RDelegateData : RMember //
    {
		...
		/// </summary>
		protected RSystem.RType r_target_type;
		public virtual RSystem.RType Rtarget_type
		{
			get
			{
				if(r_target_type == null)
				{
					r_target_type = new(this, "target_type");
					r_target_type.SetBelong(this.instance);
				}
		...
		public virtual RSystem.RString Rmethod_name
		{
			get
			{
				if(r_method_name == null)
				{
					r_method_name = new(this, "method_name");
					r_method_name.SetBelong(this.instance);
				}
				return r_method_name;
			}
		}
		...
		public virtual RSystem.RBoolean Rcurried_first_arg
		{
			get
			{
				if(r_curried_first_arg == null)
				{
					r_curried_first_arg = new(this, "curried_first_arg");
					r_curried_first_arg.SetBelong(this.instance);
				}
				return r_curried_first_arg;
			}
		}
