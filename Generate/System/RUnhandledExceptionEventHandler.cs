...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RUnhandledExceptionEventHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Object_UnhandledExceptionEventArgs;
		public virtual RMethod RMInvoke_Object_UnhandledExceptionEventArgs
		{
			get
			{
				if(r_MInvoke_Object_UnhandledExceptionEventArgs == null)
				{
					r_MInvoke_Object_UnhandledExceptionEventArgs = new(this, "Invoke", 0, typeof(System.Object), typeof(System.UnhandledExceptionEventArgs));
					r_MInvoke_Object_UnhandledExceptionEventArgs.SetBelong(this.instance);
				}
				return r_MInvoke_Object_UnhandledExceptionEventArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, System.UnhandledExceptionEventArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.UnhandledExceptionEventArgs), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object;
			}
		}
        ...
        public RUnhandledExceptionEventHandler() : base("System.UnhandledExceptionEventHandler")
        {
        }

        public RUnhandledExceptionEventHandler(System.Object instance) : base("System.UnhandledExceptionEventHandler")
		{
            SetInstance(instance);
		}

        public RUnhandledExceptionEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUnhandledExceptionEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object @sender, System.UnhandledExceptionEventArgs @e)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e};
            var ___result = RMInvoke_Object_UnhandledExceptionEventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object @sender, System.UnhandledExceptionEventArgs @e, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @e, @callback, @object};
            var ___result = RMBeginInvoke_Object_UnhandledExceptionEventArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
