    ...
    public partial class RSpan<T> : RMember //
    {
		...
		public virtual RMethod RFill_T
		{
			get
			{
				if(r_RFill_T == null)
				{
					r_RFill_T = new(this, "Fill", 0, Type.MakeGenericMethodParameter(0));
					r_RFill_T.SetBelong(this.instance);
				}
				return r_RFill_T;
			}
		}
		...
		public virtual RMethod RCopyTo_Span_d_T_p_
		{
			get
			{
				...
				{
					r_RCopyTo_Span_d_T_p_ = new(this, "CopyTo", 0, typeof(System.Span<>));
		...
		public virtual RMethod RTryCopyTo_Span_d_T_p_
		{
			get
			{
				...
				{
					r_RTryCopyTo_Span_d_T_p_ = new(this, "TryCopyTo", 0, typeof(System.Span<>));
		...
		/// </summary>
		protected static RMethod r_Rop_Equality_Span_d_T_p__Span_d_T_p_;
		public static RMethod Rop_Equality_Span_d_T_p__Span_d_T_p_
		{
			get
			{
				if(r_Rop_Equality_Span_d_T_p__Span_d_T_p_ == null)
				{
					r_Rop_Equality_Span_d_T_p__Span_d_T_p_ = new(typeof(System.Span<>), "op_Equality", 0, typeof(System.Span<>), typeof(System.Span<>));
					r_Rop_Equality_Span_d_T_p__Span_d_T_p_.SetBelong(null);
				}
				return r_Rop_Equality_Span_d_T_p__Span_d_T_p_;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Rop_Implicit_Span_d_T_p_;
		public static RMethod Rop_Implicit_Span_d_T_p_
		{
			get
			{
				if(r_Rop_Implicit_Span_d_T_p_ == null)
				{
					r_Rop_Implicit_Span_d_T_p_ = new(typeof(System.Span<>), "op_Implicit", 0, typeof(System.Span<>));
					r_Rop_Implicit_Span_d_T_p_.SetBelong(null);
				}
				return r_Rop_Implicit_Span_d_T_p_;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Rop_Inequality_Span_d_T_p__Span_d_T_p_;
		public static RMethod Rop_Inequality_Span_d_T_p__Span_d_T_p_
		{
			get
			{
				if(r_Rop_Inequality_Span_d_T_p__Span_d_T_p_ == null)
				{
					r_Rop_Inequality_Span_d_T_p__Span_d_T_p_ = new(typeof(System.Span<>), "op_Inequality", 0, typeof(System.Span<>), typeof(System.Span<>));
					r_Rop_Inequality_Span_d_T_p__Span_d_T_p_.SetBelong(null);
				}
				return r_Rop_Inequality_Span_d_T_p__Span_d_T_p_;
			}
		}
		...
		public static RMethod Rop_Implicit_TArray
		{
			get
			{
				...
				{
					r_Rop_Implicit_TArray = new(typeof(System.Span<>), "op_Implicit", 0, Type.MakeGenericMethodParameter(0).MakeArrayType());
		...
		public static RMethod Rop_Implicit_ArraySegment_d_T_p_
		{
			get
			{
				...
				{
					r_Rop_Implicit_ArraySegment_d_T_p_ = new(typeof(System.Span<>), "op_Implicit", 0, typeof(System.ArraySegment<>).MakeGenericType(Type.MakeGenericMethodParameter(0)));
