...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RComparison<T> : RMember //
    {
		...
		/// Int32 Invoke(T, T)
		/// </summary>
		protected RMethod r_Invoke_T_T;
		public virtual RMethod RInvoke_T_T
		{
			get
			{
				if(r_Invoke_T_T == null)
				{
					r_Invoke_T_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0));
					r_Invoke_T_T.SetBelong(this.instance);
				}
				return r_Invoke_T_T;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_T_T_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_T_T_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_T_T_AsyncCallback_Object == null)
				{
					r_BeginInvoke_T_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_T_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_T_T_AsyncCallback_Object;
			}
		}
