...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RComparison<T> : RMember //
    {
		...
		/// Int32 Invoke(T, T)
		/// </summary>
		protected RMethod r_MInvoke_T_T;
		public virtual RMethod RMInvoke_T_T
		{
			get
			{
				if(r_MInvoke_T_T == null)
				{
					r_MInvoke_T_T = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0));
					r_MInvoke_T_T.SetBelong(this.instance);
				}
				return r_MInvoke_T_T;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(T, T, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_T_T_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T_T_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T_T_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T_T_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_T_T_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_T_T_AsyncCallback_Object;
			}
		}
        ...
        public virtual System.Int32 Invoke(T @x, T @y)
        {
            ...
            var ___result = RMInvoke_T_T.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(T @x, T @y, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@x, @y, @callback, @object};
            var ___result = RMBeginInvoke_T_T_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
