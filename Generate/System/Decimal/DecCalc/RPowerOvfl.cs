	...
	public partial class RDecCalc
{
    ...
    public partial class RPowerOvfl : RMember //
    {
		...
		/// System.UInt32 Hi
		/// </summary>
		protected RSystem.RUInt32 r_FHi;
		public virtual RSystem.RUInt32 RFHi
		{
			get
			{
				if(r_FHi == null)
		...
		/// System.UInt64 MidLo
		/// </summary>
		protected RSystem.RUInt64 r_FMidLo;
		public virtual RSystem.RUInt64 RFMidLo
		{
			get
			{
				if(r_FMidLo == null)
				{
					r_FMidLo = new(this, "MidLo");
					r_FMidLo.SetBelong(this.instance);
				}
				return r_FMidLo;
			}
		}
