...
namespace SMFrame.Editor.Refleaction.RSystem.RText
{
    ...
    public partial class REncoderFallback : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RText.REncoderFallback r_Fs_replacementFallback;
		public static RSystem.RText.REncoderFallback RFs_replacementFallback
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RText.REncoderFallback r_Fs_exceptionFallback;
		public static RSystem.RText.REncoderFallback RFs_exceptionFallback
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RText.REncoderFallback r_PReplacementFallback;
		public static RSystem.RText.REncoderFallback RPReplacementFallback
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RText.REncoderFallback r_PExceptionFallback;
		public static RSystem.RText.REncoderFallback RPExceptionFallback
		{
			get
			{
