...
namespace SMFrame.Editor.Refleaction.RSystem.RText.RRegularExpressions
{
    ...
    public partial class RMatchEvaluator : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_Match;
		public virtual RMethod RInvoke_Match
		{
			get
			{
				if(r_Invoke_Match == null)
				{
					r_Invoke_Match = new(this, "Invoke", 0, typeof(System.Text.RegularExpressions.Match));
					r_Invoke_Match.SetBelong(this.instance);
				}
				return r_Invoke_Match;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_Match_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Match_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_Match_AsyncCallback_Object == null)
				{
					r_BeginInvoke_Match_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Text.RegularExpressions.Match), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_Match_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_Match_AsyncCallback_Object;
			}
		}
