...
namespace SMFrame.Editor.Refleaction.RSystem.RText.RRegularExpressions
{
	...
	/// </summary>
    public partial class RMatchEvaluator : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Match;
		public virtual RMethod RMInvoke_Match
		{
			get
			{
				if(r_MInvoke_Match == null)
				{
					r_MInvoke_Match = new(this, "Invoke", 0, typeof(System.Text.RegularExpressions.Match));
					r_MInvoke_Match.SetBelong(this.instance);
				}
				return r_MInvoke_Match;
			}
		}
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_Match_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Match_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Match_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Match_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Text.RegularExpressions.Match), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Match_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Match_AsyncCallback_Object;
			}
		}
        ...
        public RMatchEvaluator() : base("System.Text.RegularExpressions.MatchEvaluator")
        {
        }

        public RMatchEvaluator(System.Object instance) : base("System.Text.RegularExpressions.MatchEvaluator")
		{
            SetInstance(instance);
		}

        public RMatchEvaluator(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMatchEvaluator(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.String Invoke(System.Text.RegularExpressions.Match @match)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@match};
            var ___result = RMInvoke_Match.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(System.Text.RegularExpressions.Match @match, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@match, @callback, @object};
            var ___result = RMBeginInvoke_Match_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
