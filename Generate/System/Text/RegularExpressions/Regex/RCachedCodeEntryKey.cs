...
{public partial class RRegex
{
    ...
    public partial class RCachedCodeEntryKey : RMember //
    {
		...
		/// </summary>
		protected RMethod r_REquals_CachedCodeEntryKey;
		public virtual RMethod REquals_CachedCodeEntryKey
		{
			get
			{
				if(r_REquals_CachedCodeEntryKey == null)
				{
					r_REquals_CachedCodeEntryKey = new(this, "Equals", 0,  ReleactionUtils.GetType("System.Text.RegularExpressions.Regex+CachedCodeEntryKey"));
					r_REquals_CachedCodeEntryKey.SetBelong(this.instance);
				}
				return r_REquals_CachedCodeEntryKey;
			}
		}
		...
		/// </summary>
		protected static RMethod r_Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey;
		public static RMethod Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey
		{
			get
			{
				if(r_Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey == null)
				{
					r_Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey = new( ReleactionUtils.GetType("System.Text.RegularExpressions.Regex+CachedCodeEntryKey"), "op_Inequality", 0,  ReleactionUtils.GetType("System.Text.RegularExpressions.Regex+CachedCodeEntryKey"),  ReleactionUtils.GetType("System.Text.RegularExpressions.Regex+CachedCodeEntryKey"));
					r_Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey.SetBelong(null);
				}
				return r_Rop_Inequality_CachedCodeEntryKey_CachedCodeEntryKey;
			}
		}
