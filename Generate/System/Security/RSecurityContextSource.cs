...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity
{
    ...
    public partial class RSecurityContextSource : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RSecurityContextSource r_FCurrentAppDomain;
		public static RSystem.RSecurity.RSecurityContextSource RFCurrentAppDomain
		{
			get
			{
				if(r_FCurrentAppDomain == null)
				{
					r_FCurrentAppDomain = new(typeof(System.Security.SecurityContextSource), "CurrentAppDomain");
					r_FCurrentAppDomain.SetBelong(null);
				}
				return r_FCurrentAppDomain;
			}
		}
		...
		/// </summary>
		protected static RSystem.RSecurity.RSecurityContextSource r_FCurrentAssembly;
		public static RSystem.RSecurity.RSecurityContextSource RFCurrentAssembly
		{
			get
			{
				if(r_FCurrentAssembly == null)
				{
					r_FCurrentAssembly = new(typeof(System.Security.SecurityContextSource), "CurrentAssembly");
					r_FCurrentAssembly.SetBelong(null);
				}
				return r_FCurrentAssembly;
			}
		}
