...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity
{
    ...
    public partial class RSecurityRuleSet : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RSecurityRuleSet r_FNone;
		public static RSystem.RSecurity.RSecurityRuleSet RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new(typeof(System.Security.SecurityRuleSet), "None");
		...
		/// </summary>
		protected static RSystem.RSecurity.RSecurityRuleSet r_FLevel1;
		public static RSystem.RSecurity.RSecurityRuleSet RFLevel1
		{
			get
			{
				if(r_FLevel1 == null)
				{
					r_FLevel1 = new(typeof(System.Security.SecurityRuleSet), "Level1");
					r_FLevel1.SetBelong(null);
				}
				return r_FLevel1;
			}
		}
		...
		/// </summary>
		protected static RSystem.RSecurity.RSecurityRuleSet r_FLevel2;
		public static RSystem.RSecurity.RSecurityRuleSet RFLevel2
		{
			get
			{
				if(r_FLevel2 == null)
				{
					r_FLevel2 = new(typeof(System.Security.SecurityRuleSet), "Level2");
					r_FLevel2.SetBelong(null);
				}
				return r_FLevel2;
			}
		}
