...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity
{
    ...
    public partial class RSecurityState : RMember //
    {
		...
		/// Void EnsureState()
		/// </summary>
		protected RMethod r_EnsureState;
		public virtual RMethod REnsureState
		{
			get
			{
				if(r_EnsureState == null)
				{
					r_EnsureState = new(this, "EnsureState", 0);
					r_EnsureState.SetBelong(this.instance);
				}
				return r_EnsureState;
			}
		}
		...
		/// </summary>
		protected RMethod r_IsStateAvailable;
		public virtual RMethod RIsStateAvailable
		{
			get
			{
				if(r_IsStateAvailable == null)
				{
					r_IsStateAvailable = new(this, "IsStateAvailable", 0);
					r_IsStateAvailable.SetBelong(this.instance);
				}
				return r_IsStateAvailable;
			}
		}
