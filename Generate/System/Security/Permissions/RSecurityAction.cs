...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RPermissions
{
    ...
    public partial class RSecurityAction : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FDemand;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFDemand
		{
			get
			{
				if(r_FDemand == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FAssert;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFAssert
		{
			get
			{
				if(r_FAssert == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FDeny;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFDeny
		{
			get
			{
				if(r_FDeny == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FPermitOnly;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFPermitOnly
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FLinkDemand;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFLinkDemand
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FInheritanceDemand;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFInheritanceDemand
		{
			get
			{
				if(r_FInheritanceDemand == null)
				{
					...
					r_FInheritanceDemand.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FRequestMinimum;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFRequestMinimum
		{
			get
			{
				if(r_FRequestMinimum == null)
				{
					...
					r_FRequestMinimum.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FRequestOptional;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFRequestOptional
		{
			get
			{
				if(r_FRequestOptional == null)
				{
					...
					r_FRequestOptional.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RPermissions.RSecurityAction r_FRequestRefuse;
		public static RSystem.RSecurity.RPermissions.RSecurityAction RFRequestRefuse
		{
			get
			{
				if(r_FRequestRefuse == null)
				{
					...
					r_FRequestRefuse.SetBelong(null);
				}
