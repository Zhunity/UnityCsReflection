...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RAccessControlType : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RAccessControl.RAccessControlType r_FAllow;
		public static RSystem.RSecurity.RAccessControl.RAccessControlType RFAllow
		{
			get
			{
				if(r_FAllow == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RAccessControl.RAccessControlType r_FDeny;
		public static RSystem.RSecurity.RAccessControl.RAccessControlType RFDeny
		{
			get
			{
				if(r_FDeny == null)
