...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RFileSystemAccessRule : RMember //
    {
		...
		/// </summary>
		protected RSystem.RSecurity.RAccessControl.RFileSystemRights r_PFileSystemRights;
		public virtual RSystem.RSecurity.RAccessControl.RFileSystemRights RPFileSystemRights
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RSecurity.RAccessControl.RAccessControlType r_PAccessControlType;
		public virtual RSystem.RSecurity.RAccessControl.RAccessControlType RPAccessControlType
		{
			get
			{
