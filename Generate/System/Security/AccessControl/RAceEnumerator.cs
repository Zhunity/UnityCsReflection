...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RAceEnumerator : RMember //
    {
		...
		/// </summary>
		protected RSystem.RSecurity.RAccessControl.RGenericAcl r_Fowner;
		public virtual RSystem.RSecurity.RAccessControl.RGenericAcl RFowner
		{
			get
			{
				if(r_Fowner == null)
		...
		/// </summary>
		protected RSystem.RInt32 r_Fcurrent;
		public virtual RSystem.RInt32 RFcurrent
		{
			get
			{
				if(r_Fcurrent == null)
		...
		/// </summary>
		protected RSystem.RSecurity.RAccessControl.RGenericAce r_PCurrent;
		public virtual RSystem.RSecurity.RAccessControl.RGenericAce RPCurrent
		{
			get
			{
				if(r_PCurrent == null)
