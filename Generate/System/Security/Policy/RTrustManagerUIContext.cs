...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RPolicy
{
    ...
    public partial class RTrustManagerUIContext : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RTrustManagerUIContext r_FInstall;
		public static RSystem.RSecurity.RPolicy.RTrustManagerUIContext RFInstall
		{
			get
			{
				if(r_FInstall == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RTrustManagerUIContext r_FUpgrade;
		public static RSystem.RSecurity.RPolicy.RTrustManagerUIContext RFUpgrade
		{
			get
			{
				if(r_FUpgrade == null)
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RTrustManagerUIContext r_FRun;
		public static RSystem.RSecurity.RPolicy.RTrustManagerUIContext RFRun
		{
			get
			{
				if(r_FRun == null)
