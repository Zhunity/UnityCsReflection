...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RPolicy
{
    ...
    public partial class RPolicyStatementAttribute : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute r_FAll;
		public static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute RFAll
		{
			get
			{
				if(r_FAll == null)
				{
					r_FAll = new(typeof(System.Security.Policy.PolicyStatementAttribute), "All");
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute r_FExclusive;
		public static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute RFExclusive
		{
			get
			{
				if(r_FExclusive == null)
				{
					r_FExclusive = new(typeof(System.Security.Policy.PolicyStatementAttribute), "Exclusive");
					r_FExclusive.SetBelong(null);
				}
				return r_FExclusive;
			}
		}
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute r_FLevelFinal;
		public static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute RFLevelFinal
		{
			get
			{
				if(r_FLevelFinal == null)
				{
					r_FLevelFinal = new(typeof(System.Security.Policy.PolicyStatementAttribute), "LevelFinal");
					r_FLevelFinal.SetBelong(null);
				}
				return r_FLevelFinal;
			}
		}
		...
		/// </summary>
		protected static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute r_FNothing;
		public static RSystem.RSecurity.RPolicy.RPolicyStatementAttribute RFNothing
		{
			get
			{
				if(r_FNothing == null)
				{
					r_FNothing = new(typeof(System.Security.Policy.PolicyStatementAttribute), "Nothing");
