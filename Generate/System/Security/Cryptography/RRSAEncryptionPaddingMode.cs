...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RCryptography
{
    ...
    public partial class RRSAEncryptionPaddingMode : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RRSAEncryptionPaddingMode r_FPkcs1;
		public static RSystem.RSecurity.RCryptography.RRSAEncryptionPaddingMode RFPkcs1
		{
			get
			{
				if(r_FPkcs1 == null)
				{
					r_FPkcs1 = new(typeof(System.Security.Cryptography.RSAEncryptionPaddingMode), "Pkcs1");
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RRSAEncryptionPaddingMode r_FOaep;
		public static RSystem.RSecurity.RCryptography.RRSAEncryptionPaddingMode RFOaep
		{
			get
			{
				if(r_FOaep == null)
				{
					r_FOaep = new(typeof(System.Security.Cryptography.RSAEncryptionPaddingMode), "Oaep");
					r_FOaep.SetBelong(null);
				}
				return r_FOaep;
			}
		}
