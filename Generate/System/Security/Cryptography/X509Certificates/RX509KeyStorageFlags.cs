...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RCryptography.RX509Certificates
{
    ...
    public partial class RX509KeyStorageFlags : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FDefaultKeySet;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFDefaultKeySet
		{
			get
			{
				if(r_FDefaultKeySet == null)
				{
					...
					r_FDefaultKeySet.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FUserKeySet;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFUserKeySet
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FMachineKeySet;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFMachineKeySet
		{
			get
			{
				if(r_FMachineKeySet == null)
				{
					...
					r_FMachineKeySet.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FExportable;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFExportable
		{
			get
			{
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FUserProtected;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFUserProtected
		{
			get
			{
				if(r_FUserProtected == null)
				{
					...
					r_FUserProtected.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FPersistKeySet;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFPersistKeySet
		{
			get
			{
				if(r_FPersistKeySet == null)
				{
					...
					r_FPersistKeySet.SetBelong(null);
				}
		...
		/// </summary>
		protected static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags r_FEphemeralKeySet;
		public static RSystem.RSecurity.RCryptography.RX509Certificates.RX509KeyStorageFlags RFEphemeralKeySet
		{
			get
			{
				if(r_FEphemeralKeySet == null)
				{
					...
					r_FEphemeralKeySet.SetBelong(null);
				}
