...
{public partial class REnum
{
    ...
    public partial class RValuesAndNames : RMember //
    {
		...
		/// </summary>
		protected RFieldArray<RSystem.RUInt64> r_FValues;
		public virtual RFieldArray<RSystem.RUInt64> RFValues
		{
			get
			{
				if(r_FValues == null)
		...
		/// System.String[] Names
		/// </summary>
		protected RFieldArray<RSystem.RString> r_FNames;
		public virtual RFieldArray<RSystem.RString> RFNames
		{
			get
			{
				if(r_FNames == null)
