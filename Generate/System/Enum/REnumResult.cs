...
{public partial class REnum
{
    ...
    public partial class REnumResult : RMember //
    {
		...
		/// </summary>
		protected RSystem.RObject r_FparsedEnum;
		public virtual RSystem.RObject RFparsedEnum
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RBoolean r_FcanThrow;
		public virtual RSystem.RBoolean RFcanThrow
		{
			get
			{
				if(r_FcanThrow == null)
		...
		/// </summary>
		protected RSystem.REnum.RParseFailureKind r_Fm_failure;
		public virtual RSystem.REnum.RParseFailureKind RFm_failure
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_Fm_failureMessageID;
		public virtual RSystem.RString RFm_failureMessageID
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RString r_Fm_failureParameter;
		public virtual RSystem.RString RFm_failureParameter
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RObject r_Fm_failureMessageFormatArgument;
		public virtual RSystem.RObject RFm_failureMessageFormatArgument
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RException r_Fm_innerException;
		public virtual RSystem.RException RFm_innerException
		{
			get
			{
        ...
        public virtual void SetFailure(RSystem.REnum.RParseFailureKind @failure, System.String @failureParameter)
        {
        ...
        public virtual void SetFailure(RSystem.REnum.RParseFailureKind @failure, System.String @failureMessageID, System.Object @failureMessageFormatArgument)
        {
