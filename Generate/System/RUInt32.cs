...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RUInt32 : RMember //
    {
		...
		/// </summary>
		protected RSystem.RUInt32 r_Fm_value;
		public virtual RSystem.RUInt32 RFm_value
		{
			get
			{
				if(r_Fm_value == null)
		...
		/// </summary>
		protected static RSystem.RUInt32 r_FMaxValue;
		public static RSystem.RUInt32 RFMaxValue
		{
			get
			{
				if(r_FMaxValue == null)
		...
		/// </summary>
		protected static RSystem.RUInt32 r_FMinValue;
		public static RSystem.RUInt32 RFMinValue
		{
			get
			{
				if(r_FMinValue == null)
