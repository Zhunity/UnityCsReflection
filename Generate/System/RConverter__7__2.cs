...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RConverter<TInput, TOutput> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_TInput;
		public virtual RMethod RInvoke_TInput
		{
			get
			{
				if(r_RInvoke_TInput == null)
				{
					r_RInvoke_TInput = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0));
					r_RInvoke_TInput.SetBelong(this.instance);
				}
				return r_RInvoke_TInput;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_TInput_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_TInput_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_TInput_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_TInput_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_TInput_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_TInput_AsyncCallback_Object;
			}
		}
        ...
        public virtual TOutput Invoke(TInput  @input)
        {
            ...
            var ___result = RInvoke_TInput.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(TInput  @input, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_TInput_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
