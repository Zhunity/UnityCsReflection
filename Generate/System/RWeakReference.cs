...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RWeakReference : RMember //
    {
		...
		/// </summary>
		protected RSystem.RBoolean r_FisLongReference;
		public virtual RSystem.RBoolean RFisLongReference
		{
			get
			{
		...
		/// </summary>
		protected RSystem.RRuntime.RInteropServices.RGCHandle r_FgcHandle;
		public virtual RSystem.RRuntime.RInteropServices.RGCHandle RFgcHandle
		{
			get
			{
				if(r_FgcHandle == null)
		...
		/// </summary>
		protected RSystem.RBoolean r_PTrackResurrection;
		public virtual RSystem.RBoolean RPTrackResurrection
		{
			get
			{
