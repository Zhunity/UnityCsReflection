...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RAssemblyLoadEventHandler : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Object_AssemblyLoadEventArgs;
		public virtual RMethod RMInvoke_Object_AssemblyLoadEventArgs
		{
			get
			{
				if(r_MInvoke_Object_AssemblyLoadEventArgs == null)
				{
					r_MInvoke_Object_AssemblyLoadEventArgs = new(this, "Invoke", 0, typeof(System.Object), typeof(System.AssemblyLoadEventArgs));
					r_MInvoke_Object_AssemblyLoadEventArgs.SetBelong(this.instance);
				}
				return r_MInvoke_Object_AssemblyLoadEventArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, System.AssemblyLoadEventArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.AssemblyLoadEventArgs), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object;
			}
		}
        ...
        public RAssemblyLoadEventHandler() : base("System.AssemblyLoadEventHandler")
        {
        }

        public RAssemblyLoadEventHandler(System.Object instance) : base("System.AssemblyLoadEventHandler")
		{
            SetInstance(instance);
		}

        public RAssemblyLoadEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAssemblyLoadEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(System.Object @sender, System.AssemblyLoadEventArgs @args)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @args};
            var ___result = RMInvoke_Object_AssemblyLoadEventArgs.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object @sender, System.AssemblyLoadEventArgs @args, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @args, @callback, @object};
            var ___result = RMBeginInvoke_Object_AssemblyLoadEventArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
