...
namespace SMFrame.Editor.Refleaction.RSystem
{
	...
	/// </summary>
    public partial class RResolveEventHandler : RMember //
    {
		...
		/// <summary>
		/// System.Reflection.Assembly Invoke(System.Object, System.ResolveEventArgs)
		/// </summary>
		protected RMethod r_MInvoke_Object_ResolveEventArgs;
		public virtual RMethod RMInvoke_Object_ResolveEventArgs
		{
			get
			{
				if(r_MInvoke_Object_ResolveEventArgs == null)
				{
					r_MInvoke_Object_ResolveEventArgs = new(this, "Invoke", 0, typeof(System.Object), typeof(System.ResolveEventArgs));
					r_MInvoke_Object_ResolveEventArgs.SetBelong(this.instance);
				}
				return r_MInvoke_Object_ResolveEventArgs;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(System.Object, System.ResolveEventArgs, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(System.Object), typeof(System.ResolveEventArgs), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object;
			}
		}
        ...
        public RResolveEventHandler() : base("System.ResolveEventHandler")
        {
        }

        public RResolveEventHandler(System.Object instance) : base("System.ResolveEventHandler")
		{
            SetInstance(instance);
		}

        public RResolveEventHandler(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RResolveEventHandler(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Reflection.Assembly Invoke(System.Object @sender, System.ResolveEventArgs @args)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @args};
            var ___result = RMInvoke_Object_ResolveEventArgs.Invoke(___genericsType, ___parameters);

            return (System.Reflection.Assembly)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(System.Object @sender, System.ResolveEventArgs @args, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sender, @args, @callback, @object};
            var ___result = RMBeginInvoke_Object_ResolveEventArgs_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

            return (System.IAsyncResult)___result;
        }


        public virtual System.Reflection.Assembly EndInvoke(System.IAsyncResult @result)
        {
