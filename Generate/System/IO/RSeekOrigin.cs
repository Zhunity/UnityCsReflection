...
namespace SMFrame.Editor.Refleaction.RSystem.RIO
{
    ...
    public partial class RSeekOrigin : RMember //
    {
		...
		/// </summary>
		protected static RSystem.RIO.RSeekOrigin r_FBegin;
		public static RSystem.RIO.RSeekOrigin RFBegin
		{
			get
			{
				if(r_FBegin == null)
		...
		/// </summary>
		protected static RSystem.RIO.RSeekOrigin r_FCurrent;
		public static RSystem.RIO.RSeekOrigin RFCurrent
		{
			get
			{
				if(r_FCurrent == null)
		...
		/// </summary>
		protected static RSystem.RIO.RSeekOrigin r_FEnd;
		public static RSystem.RIO.RSeekOrigin RFEnd
		{
			get
			{
				if(r_FEnd == null)
