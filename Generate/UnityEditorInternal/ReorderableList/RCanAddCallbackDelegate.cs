...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+CanAddCallbackDelegate
	/// </summary>
    public partial class RCanAddCallbackDelegate : RMember //
    {
		...
		/// <summary>
		/// Boolean Invoke(UnityEditorInternal.ReorderableList)
		/// </summary>
        ...
        public RCanAddCallbackDelegate() : base("UnityEditorInternal.ReorderableList+CanAddCallbackDelegate")
        {
        }

        public RCanAddCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+CanAddCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RCanAddCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RCanAddCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
