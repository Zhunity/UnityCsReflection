...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+ReorderCallbackDelegateWithDetails
	/// </summary>
    public partial class RReorderCallbackDelegateWithDetails : RMember //
    {

		/// <summary>
		/// Boolean HasSingleTarget
		/// </summary>
		protected RSystem.RBoolean r_PHasSingleTarget;
		public virtual RSystem.RBoolean RPHasSingleTarget
		{
			get
			{
		...
		/// <summary>
		/// Void Invoke(UnityEditorInternal.ReorderableList, Int32, Int32)
		/// </summary>
		protected RMethod r_MInvoke_ReorderableList_Int32_Int32;
		public virtual RMethod RMInvoke_ReorderableList_Int32_Int32
		{
			get
			{
				if(r_MInvoke_ReorderableList_Int32_Int32 == null)
				{
					r_MInvoke_ReorderableList_Int32_Int32 = new(this, "Invoke", 0, typeof(UnityEditorInternal.ReorderableList), typeof(System.Int32), typeof(System.Int32));
					r_MInvoke_ReorderableList_Int32_Int32.SetBelong(this.instance);
				}
				return r_MInvoke_ReorderableList_Int32_Int32;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditorInternal.ReorderableList, Int32, Int32, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditorInternal.ReorderableList), typeof(System.Int32), typeof(System.Int32), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object;
			}
		}
        ...
        public RReorderCallbackDelegateWithDetails() : base("UnityEditorInternal.ReorderableList+ReorderCallbackDelegateWithDetails")
        {
        }

        public RReorderCallbackDelegateWithDetails(System.Object instance) : base("UnityEditorInternal.ReorderableList+ReorderCallbackDelegateWithDetails")
		{
            SetInstance(instance);
		}

        public RReorderCallbackDelegateWithDetails(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RReorderCallbackDelegateWithDetails(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEditorInternal.ReorderableList @list, System.Int32 @oldIndex, System.Int32 @newIndex)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@list, @oldIndex, @newIndex};
            var ___result = RMInvoke_ReorderableList_Int32_Int32.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEditorInternal.ReorderableList @list, System.Int32 @oldIndex, System.Int32 @newIndex, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@list, @oldIndex, @newIndex, @callback, @object};
            var ___result = RMBeginInvoke_ReorderableList_Int32_Int32_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
