...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+AddCallbackDelegate
	/// </summary>
    public partial class RAddCallbackDelegate : RMember //
    {
        ...
        public RAddCallbackDelegate() : base("UnityEditorInternal.ReorderableList+AddCallbackDelegate")
        {
        }

        public RAddCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+AddCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RAddCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAddCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
