...
{public partial class RReorderableList
{
    ...
    public partial class RDrawNoneElementCallback : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Rect;
		public virtual RMethod RInvoke_Rect
		{
			get
			{
				if(r_RInvoke_Rect == null)
				{
					r_RInvoke_Rect = new(this, "Invoke", 0, typeof(UnityEngine.Rect));
					r_RInvoke_Rect.SetBelong(this.instance);
				}
				return r_RInvoke_Rect;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Rect_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Rect_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Rect_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Rect_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Rect), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Rect_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Rect_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(UnityEngine.Rect  @rect)
        {
            ...
            var ___result = RInvoke_Rect.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Rect  @rect, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_Rect_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
