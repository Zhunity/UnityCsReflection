...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+ElementCallbackDelegate
	/// </summary>
    public partial class RElementCallbackDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEngine.Rect, Int32, Boolean, Boolean)
		/// </summary>
		protected RMethod r_MInvoke_Rect_Int32_Boolean_Boolean;
		public virtual RMethod RMInvoke_Rect_Int32_Boolean_Boolean
		{
			get
			{
				if(r_MInvoke_Rect_Int32_Boolean_Boolean == null)
				{
					r_MInvoke_Rect_Int32_Boolean_Boolean = new(this, "Invoke", 0, typeof(UnityEngine.Rect), typeof(System.Int32), typeof(System.Boolean), typeof(System.Boolean));
					r_MInvoke_Rect_Int32_Boolean_Boolean.SetBelong(this.instance);
				}
				return r_MInvoke_Rect_Int32_Boolean_Boolean;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.Rect, Int32, Boolean, Boolean, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Rect), typeof(System.Int32), typeof(System.Boolean), typeof(System.Boolean), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object;
			}
		}
        ...
        public RElementCallbackDelegate() : base("UnityEditorInternal.ReorderableList+ElementCallbackDelegate")
        {
        }

        public RElementCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+ElementCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RElementCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RElementCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEngine.Rect @rect, System.Int32 @index, System.Boolean @isActive, System.Boolean @isFocused)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rect, @index, @isActive, @isFocused};
            var ___result = RMInvoke_Rect_Int32_Boolean_Boolean.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Rect @rect, System.Int32 @index, System.Boolean @isActive, System.Boolean @isFocused, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@rect, @index, @isActive, @isFocused, @callback, @object};
            var ___result = RMBeginInvoke_Rect_Int32_Boolean_Boolean_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
