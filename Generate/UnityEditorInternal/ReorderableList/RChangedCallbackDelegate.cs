...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+ChangedCallbackDelegate
	/// </summary>
    public partial class RChangedCallbackDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEditorInternal.ReorderableList)
		/// </summary>
		protected RMethod r_RInvoke_ReorderableList;
		public virtual RMethod RInvoke_ReorderableList
		{
			get
			{
				if(r_RInvoke_ReorderableList == null)
				{
					r_RInvoke_ReorderableList = new(this, "Invoke", 0, typeof(UnityEditorInternal.ReorderableList));
					r_RInvoke_ReorderableList.SetBelong(this.instance);
				}
				return r_RInvoke_ReorderableList;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEditorInternal.ReorderableList, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_RBeginInvoke_ReorderableList_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_ReorderableList_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_ReorderableList_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_ReorderableList_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEditorInternal.ReorderableList), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_ReorderableList_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_ReorderableList_AsyncCallback_Object;
			}
		}
        ...
        public RChangedCallbackDelegate() : base("UnityEditorInternal.ReorderableList+ChangedCallbackDelegate")
        {
        }

        public RChangedCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+ChangedCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RChangedCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RChangedCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual void Invoke(UnityEditorInternal.ReorderableList  @list)
        {
            ...
            var ___result = RInvoke_ReorderableList.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEditorInternal.ReorderableList  @list, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_ReorderableList_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
