...
{public partial class RReorderableList
{
    ...
    public partial class RReorderCallbackDelegate : RMember //
    {
        ...
        public RReorderCallbackDelegate() : base("UnityEditorInternal.ReorderableList+ReorderCallbackDelegate")
        {
        }

        public RReorderCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+ReorderCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RReorderCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RReorderCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
