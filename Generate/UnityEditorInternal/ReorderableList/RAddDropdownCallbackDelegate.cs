...
{public partial class RReorderableList
{
	...
	/// <summary>
	/// UnityEditorInternal.ReorderableList+AddDropdownCallbackDelegate
	/// </summary>
    public partial class RAddDropdownCallbackDelegate : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEngine.Rect, UnityEditorInternal.ReorderableList)
		/// </summary>
		protected RMethod r_MInvoke_Rect_ReorderableList;
		public virtual RMethod RMInvoke_Rect_ReorderableList
		{
			get
			{
				if(r_MInvoke_Rect_ReorderableList == null)
				{
					r_MInvoke_Rect_ReorderableList = new(this, "Invoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList));
					r_MInvoke_Rect_ReorderableList.SetBelong(this.instance);
				}
				return r_MInvoke_Rect_ReorderableList;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.Rect, UnityEditorInternal.ReorderableList, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Rect_ReorderableList_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Rect_ReorderableList_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_Rect_ReorderableList_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_Rect_ReorderableList_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_MBeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
			}
		}
        ...
        public RAddDropdownCallbackDelegate() : base("UnityEditorInternal.ReorderableList+AddDropdownCallbackDelegate")
        {
        }

        public RAddDropdownCallbackDelegate(System.Object instance) : base("UnityEditorInternal.ReorderableList+AddDropdownCallbackDelegate")
		{
            SetInstance(instance);
		}

        public RAddDropdownCallbackDelegate(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAddDropdownCallbackDelegate(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEngine.Rect @buttonRect, UnityEditorInternal.ReorderableList @list)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@buttonRect, @list};
            var ___result = RMInvoke_Rect_ReorderableList.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Rect @buttonRect, UnityEditorInternal.ReorderableList @list, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@buttonRect, @list, @callback, @object};
            var ___result = RMBeginInvoke_Rect_ReorderableList_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
