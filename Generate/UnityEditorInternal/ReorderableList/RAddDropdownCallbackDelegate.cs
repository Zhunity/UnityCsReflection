...
{public partial class RReorderableList
{
    ...
    public partial class RAddDropdownCallbackDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_RInvoke_Rect_ReorderableList;
		public virtual RMethod RInvoke_Rect_ReorderableList
		{
			get
			{
				if(r_RInvoke_Rect_ReorderableList == null)
				{
					r_RInvoke_Rect_ReorderableList = new(this, "Invoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList));
					r_RInvoke_Rect_ReorderableList.SetBelong(this.instance);
				}
				return r_RInvoke_Rect_ReorderableList;
			}
		}
		...
		/// </summary>
		protected RMethod r_RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object
		{
			get
			{
				if(r_RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object == null)
				{
					r_RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList), typeof(System.AsyncCallback), typeof(System.Object));
					r_RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
			}
		}
        ...
        public virtual void Invoke(UnityEngine.Rect  @buttonRect, UnityEditorInternal.ReorderableList  @list)
        {
            ...
            var ___result = RInvoke_Rect_ReorderableList.Invoke(___genericsType, ___parameters);
        ...
        public virtual System.IAsyncResult BeginInvoke(UnityEngine.Rect  @buttonRect, UnityEditorInternal.ReorderableList  @list, System.AsyncCallback  @callback, System.Object  @object)
        {
            ...
            var ___result = RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
