...
{public partial class RReorderableList
{
    ...
    public partial class RAddDropdownCallbackDelegate : RMember //
    {
		...
		/// </summary>
		protected RMethod r_Invoke_Rect_ReorderableList;
		public virtual RMethod RInvoke_Rect_ReorderableList
		{
			get
			{
				if(r_Invoke_Rect_ReorderableList == null)
				{
					r_Invoke_Rect_ReorderableList = new(this, "Invoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList));
					r_Invoke_Rect_ReorderableList.SetBelong(this.instance);
				}
				return r_Invoke_Rect_ReorderableList;
			}
		}
		...
		/// </summary>
		protected RMethod r_BeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
		public virtual RMethod RBeginInvoke_Rect_ReorderableList_AsyncCallback_Object
		{
			get
			{
				if(r_BeginInvoke_Rect_ReorderableList_AsyncCallback_Object == null)
				{
					r_BeginInvoke_Rect_ReorderableList_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.Rect), typeof(UnityEditorInternal.ReorderableList), typeof(System.AsyncCallback), typeof(System.Object));
					r_BeginInvoke_Rect_ReorderableList_AsyncCallback_Object.SetBelong(this.instance);
				}
				return r_BeginInvoke_Rect_ReorderableList_AsyncCallback_Object;
			}
		}
