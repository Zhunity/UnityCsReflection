...
namespace Hvak.Editor.Refleaction.RSystem.RThreading
{
    ...
    public partial class RSparselyPopulatedArray<T> : RMember // where T : class
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Threading.SparselyPopulatedArray`1").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }
        ...
        public virtual Hvak.Editor.Refleaction.RSystem.RThreading.RSparselyPopulatedArrayAddInfo<Hvak.Editor.Refleaction.RType> Add(T @element)
        {
            ...
            return ReflectionUtils.Convert<Hvak.Editor.Refleaction.RSystem.RThreading.RSparselyPopulatedArrayAddInfo<Hvak.Editor.Refleaction.RType>>(___result);
        }
