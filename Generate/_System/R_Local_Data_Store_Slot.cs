		...
		public virtual Hvak.Editor.Refleaction.RSystem.RLocalDataStoreMgr RFm_mgr
		{
			get
			{
				if(r_Fm_mgr == null)
				{
					...
					r_Fm_mgr.SetBelong(this.GetValue());
				}
				return r_Fm_mgr;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt32 RFm_slot
		{
			get
			{
				if(r_Fm_slot == null)
				{
					...
					r_Fm_slot.SetBelong(this.GetValue());
				}
				return r_Fm_slot;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt64 RFm_cookie
		{
			get
			{
				if(r_Fm_cookie == null)
				{
					...
					r_Fm_cookie.SetBelong(this.GetValue());
				}
				return r_Fm_cookie;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RLocalDataStoreMgr RPManager
		{
			get
			{
				if(r_PManager == null)
				{
					...
					r_PManager.SetBelong(this.GetValue());
				}
				return r_PManager;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt32 RPSlot
		{
			get
			{
				if(r_PSlot == null)
				{
					...
					r_PSlot.SetBelong(this.GetValue());
				}
				return r_PSlot;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt64 RPCookie
		{
			get
			{
				if(r_PCookie == null)
				{
					...
					r_PCookie.SetBelong(this.GetValue());
				}
				return r_PCookie;
			}
		}
