...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RAggregateException : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RObjectModel.RReadOnlyCollection<Hvak.Editor.Refleaction.RSystem.RException> r_Fm_innerExceptions;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RObjectModel.RReadOnlyCollection<Hvak.Editor.Refleaction.RSystem.RException> RFm_innerExceptions
		{
			get
			{
				if(r_Fm_innerExceptions == null)
				{
					...
					r_Fm_innerExceptions.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RObjectModel.RReadOnlyCollection<Hvak.Editor.Refleaction.RSystem.RException> r_PInnerExceptions;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RObjectModel.RReadOnlyCollection<Hvak.Editor.Refleaction.RSystem.RException> RPInnerExceptions
		{
			get
			{
				if(r_PInnerExceptions == null)
				{
					...
					r_PInnerExceptions.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RInt32 r_PInnerExceptionCount;
		public virtual Hvak.Editor.Refleaction.RSystem.RInt32 RPInnerExceptionCount
		{
			get
			{
				if(r_PInnerExceptionCount == null)
				{
					...
					r_PInnerExceptionCount.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMHandle_Func_d_Exception_Boolean_p_
		{
			get
			{
				if(r_MHandle_Func_d_Exception_Boolean_p_ == null)
				{
					...
					r_MHandle_Func_d_Exception_Boolean_p_.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMFlatten
		{
			get
			{
				if(r_MFlatten == null)
				{
					...
					r_MFlatten.SetBelong(this.GetValue());
				}
				return r_MFlatten;
			}
		}
