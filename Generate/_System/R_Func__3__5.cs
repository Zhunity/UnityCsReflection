...
namespace Hvak.Editor.Refleaction.RSystem
{
	...
	/// System.Func`5
	/// </summary>
    public partial class RFunc<T1, T2, T3, T4, TResult> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Func`5").MakeGenericType(ReflectionUtils.GetType(typeof(T1)), ReflectionUtils.GetType(typeof(T2)), ReflectionUtils.GetType(typeof(T3)), ReflectionUtils.GetType(typeof(T4)), ReflectionUtils.GetType(typeof(TResult)));
            }
        }

        public RFunc() : base("System.Func`5")
        {
        }

        public RFunc(System.Object instance) : base("System.Func`5")
		{
		...
		/// <summary>
		/// TResult Invoke(T1, T2, T3, T4)
		/// </summary>
		protected RMethod r_MInvoke_T1_T2_T3_T4;
		public virtual RMethod RMInvoke_T1_T2_T3_T4
		{
			get
			{
				if(r_MInvoke_T1_T2_T3_T4 == null)
				{
					r_MInvoke_T1_T2_T3_T4 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3));
				}
				return r_MInvoke_T1_T2_T3_T4;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(T1, T2, T3, T4, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3), typeof(System.AsyncCallback), typeof(System.Object));
				}
				return r_MBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object;
			}
		}
        ...
        public virtual TResult Invoke(T1 @arg1, T2 @arg2, T3 @arg3, T4 @arg4)
        {
            ...
            var ___parameters = new object[]{@arg1, @arg2, @arg3, @arg4};
            var ___result = RMInvoke_T1_T2_T3_T4.Invoke(___genericsType, ___parameters);

            return ReflectionUtils.Convert<TResult>(___result);
        }


        public virtual System.IAsyncResult BeginInvoke(T1 @arg1, T2 @arg2, T3 @arg3, T4 @arg4, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@arg1, @arg2, @arg3, @arg4, @callback, @object};
            var ___result = RMBeginInvoke_T1_T2_T3_T4_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
