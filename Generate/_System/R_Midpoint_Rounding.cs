...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RMidpointRounding : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RMidpointRounding r_FToEven;
		public static SMFrame.Editor.Refleaction.RSystem.RMidpointRounding RFToEven
		{
			get
			{
				if(r_FToEven == null)
				{
					r_FToEven = new(typeof(System.MidpointRounding), "ToEven");
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RMidpointRounding r_FAwayFromZero;
		public static SMFrame.Editor.Refleaction.RSystem.RMidpointRounding RFAwayFromZero
		{
			get
			{
				if(r_FAwayFromZero == null)
				{
					r_FAwayFromZero = new(typeof(System.MidpointRounding), "AwayFromZero");
