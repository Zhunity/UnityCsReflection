...
namespace Hvak.Editor.Refleaction.RSystem
{
	...
	/// System.Func`6
	/// </summary>
    public partial class RFunc<T1, T2, T3, T4, T5, TResult> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Func`6").MakeGenericType(ReflectionUtils.GetType(typeof(T1)), ReflectionUtils.GetType(typeof(T2)), ReflectionUtils.GetType(typeof(T3)), ReflectionUtils.GetType(typeof(T4)), ReflectionUtils.GetType(typeof(T5)), ReflectionUtils.GetType(typeof(TResult)));
            }
        }

        public RFunc() : base("System.Func`6")
        {
        }

        public RFunc(System.Object instance) : base("System.Func`6")
		{
		...
		/// <summary>
		/// TResult Invoke(T1, T2, T3, T4, T5)
		/// </summary>
		protected RMethod r_MInvoke_T1_T2_T3_T4_T5;
		public virtual RMethod RMInvoke_T1_T2_T3_T4_T5
		{
			get
			{
				if(r_MInvoke_T1_T2_T3_T4_T5 == null)
				{
					r_MInvoke_T1_T2_T3_T4_T5 = new(this, "Invoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3), Type.MakeGenericMethodParameter(4));
				}
				return r_MInvoke_T1_T2_T3_T4_T5;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(T1, T2, T3, T4, T5, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object = new(this, "BeginInvoke", 0, Type.MakeGenericMethodParameter(0), Type.MakeGenericMethodParameter(1), Type.MakeGenericMethodParameter(2), Type.MakeGenericMethodParameter(3), Type.MakeGenericMethodParameter(4), typeof(System.AsyncCallback), typeof(System.Object));
				}
				return r_MBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// TResult EndInvoke(System.IAsyncResult)
		/// </summary>
        ...
        public virtual TResult Invoke(T1 @arg1, T2 @arg2, T3 @arg3, T4 @arg4, T5 @arg5)
        {
            ...
            var ___parameters = new object[]{@arg1, @arg2, @arg3, @arg4, @arg5};
            var ___result = RMInvoke_T1_T2_T3_T4_T5.Invoke(___genericsType, ___parameters);

            return ReflectionUtils.Convert<TResult>(___result);
        }


        public virtual System.IAsyncResult BeginInvoke(T1 @arg1, T2 @arg2, T3 @arg3, T4 @arg4, T5 @arg5, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@arg1, @arg2, @arg3, @arg4, @arg5, @callback, @object};
            var ___result = RMBeginInvoke_T1_T2_T3_T4_T5_AsyncCallback_Object.Invoke(___genericsType, ___parameters);

            return ReflectionUtils.Convert<System.IAsyncResult>(___result);
        }


        public virtual TResult EndInvoke(System.IAsyncResult @result)
        {
