...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RFunc<T1, T2, T3, T4, T5, TResult> : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(System.Func<, , , , , >).MakeGenericType(TypeToString.GetType(typeof(T1)), TypeToString.GetType(typeof(T2)), TypeToString.GetType(typeof(T3)), TypeToString.GetType(typeof(T4)), TypeToString.GetType(typeof(T5)), TypeToString.GetType(typeof(TResult)));
            }
        }
