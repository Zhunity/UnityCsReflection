...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RMarshalByRefObject : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RRuntime.RRemoting.RServerIdentity r_F_identity;
		public virtual Hvak.Editor.Refleaction.RSystem.RRuntime.RRemoting.RServerIdentity RF_identity
		{
			get
			{
				if(r_F_identity == null)
				{
					...
					r_F_identity.SetBelong(this.GetValue());
				}
				return r_F_identity;
			}
		}
