...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RMarshalByRefObject : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RServerIdentity r_F_identity;
		public virtual SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RServerIdentity RF_identity
		{
			get
			{
