...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class ROperationCanceledException : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(System.OperationCanceledException);
            }
        }
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RThreading.RCancellationToken r_F_cancellationToken;
		public virtual Hvak.Editor.Refleaction.RSystem.RThreading.RCancellationToken RF_cancellationToken
		{
			get
			{
