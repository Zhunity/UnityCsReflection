...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class ROperationCanceledException : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RThreading.RCancellationToken r_F_cancellationToken;
		public virtual SMFrame.Editor.Refleaction.RSystem.RThreading.RCancellationToken RF_cancellationToken
		{
			get
			{
				if(r_F_cancellationToken == null)
				{
					r_F_cancellationToken = new(this, "_cancellationToken");
					r_F_cancellationToken.SetBelong(this.instance);
				}
				return r_F_cancellationToken;
			}
		}
