...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RMemory<T> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Memory`1").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }
		...
		public static RMethod RMop_Implicit_Memory_d_T_p_
		{
			get
			{
				...
				{
					r_Mop_Implicit_Memory_d_T_p_ = new(Type, "op_Implicit", 0,  ReflectionUtils.GetType("System.Memory`1"));
				}
        ...
        public static System.Memory<T> op_Implicit(T[] @array)
        {
            ...
            return ReflectionUtils.Convert<System.Memory<T>>(___result);
        }
