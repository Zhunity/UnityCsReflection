...
namespace SMFrame.Editor.Refleaction.RSystem
{
    ...
    public partial class RMemory<T> : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RMemory<SMFrame.Editor.Refleaction.RProperty> r_PEmpty;
		public static SMFrame.Editor.Refleaction.RSystem.RMemory<SMFrame.Editor.Refleaction.RProperty> RPEmpty
		{
			get
			{
				if(r_PEmpty == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RSpan<SMFrame.Editor.Refleaction.RProperty> r_PSpan;
		public virtual SMFrame.Editor.Refleaction.RSystem.RSpan<SMFrame.Editor.Refleaction.RProperty> RPSpan
		{
			get
			{
				if(r_PSpan == null)
		...
		public virtual RMethod RMEquals_Memory_d_T_p_
		{
			get
			{
				if(r_MEquals_Memory_d_T_p_ == null)
				{
					...
					r_MEquals_Memory_d_T_p_.SetBelong(this.instance);
				}
