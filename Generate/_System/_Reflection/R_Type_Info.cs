...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RTypeInfo : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RReflection.RBindingFlags r_FDeclaredOnlyLookup;
		public static SMFrame.Editor.Refleaction.RSystem.RReflection.RBindingFlags RFDeclaredOnlyLookup
		{
			get
			{
				if(r_FDeclaredOnlyLookup == null)
				{
					r_FDeclaredOnlyLookup = new(typeof(System.Reflection.TypeInfo), "DeclaredOnlyLookup");
					r_FDeclaredOnlyLookup.SetBelong(null);
				}
		...
		public virtual RMethod RMSystem__2__Reflection__2__IReflectableType__2__GetTypeInfo
		{
			get
			{
				if(r_MSystem__2__Reflection__2__IReflectableType__2__GetTypeInfo == null)
				{
					...
					r_MSystem__2__Reflection__2__IReflectableType__2__GetTypeInfo.SetBelong(this.instance);
				}
