...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RCustomAttributeBuilder : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RReflection.RConstructorInfo r_Fctor;
		public virtual SMFrame.Editor.Refleaction.RSystem.RReflection.RConstructorInfo RFctor
		{
			get
			{
				if(r_Fctor == null)
				{
					...
					r_Fctor.SetBelong(this.instance);
				}
				return r_Fctor;
			}
		}
		...
		/// System.Object[] args
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> r_Fargs;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> RFargs
		{
			get
			{
				if(r_Fargs == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RReflection.RPropertyInfo> r_FnamedProperties;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RReflection.RPropertyInfo> RFnamedProperties
		{
			get
			{
				if(r_FnamedProperties == null)
				{
					...
					r_FnamedProperties.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> r_FpropertyValues;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> RFpropertyValues
		{
			get
			{
				if(r_FpropertyValues == null)
				{
					...
					r_FpropertyValues.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RReflection.RFieldInfo> r_FnamedFields;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RReflection.RFieldInfo> RFnamedFields
		{
			get
			{
				if(r_FnamedFields == null)
				{
					...
					r_FnamedFields.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> r_FfieldValues;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> RFfieldValues
		{
			get
			{
				if(r_FfieldValues == null)
				{
					...
					r_FfieldValues.SetBelong(this.instance);
				}
		...
		/// System.Reflection.ConstructorInfo Ctor
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RReflection.RConstructorInfo r_PCtor;
		public virtual SMFrame.Editor.Refleaction.RSystem.RReflection.RConstructorInfo RPCtor
		{
			get
			{
				if(r_PCtor == null)
				{
					...
					r_PCtor.SetBelong(this.instance);
				}
				return r_PCtor;
			}
		}
		...
		/// Byte[] Data
		/// </summary>
		protected SMFrame.Editor.Refleaction.RPropertyArray<SMFrame.Editor.Refleaction.RSystem.RByte> r_PData;
		public virtual SMFrame.Editor.Refleaction.RPropertyArray<SMFrame.Editor.Refleaction.RSystem.RByte> RPData
		{
			get
			{
				if(r_PData == null)
		...
		public virtual RMethod RMSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetIDsOfNames_In_Guid_IntPtr_UInt32_UInt32_IntPtr
		{
			get
			{
				if(r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetIDsOfNames_In_Guid_IntPtr_UInt32_UInt32_IntPtr == null)
				{
					...
					r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetIDsOfNames_In_Guid_IntPtr_UInt32_UInt32_IntPtr.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfo_UInt32_UInt32_IntPtr
		{
			get
			{
				if(r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfo_UInt32_UInt32_IntPtr == null)
				{
					...
					r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfo_UInt32_UInt32_IntPtr.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfoCount_Out_UInt32
		{
			get
			{
				if(r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfoCount_Out_UInt32 == null)
				{
					...
					r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__GetTypeInfoCount_Out_UInt32.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__Invoke_UInt32_In_Guid_UInt32_Int16_IntPtr_IntPtr_IntPtr_IntPtr
		{
			get
			{
				if(r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__Invoke_UInt32_In_Guid_UInt32_Int16_IntPtr_IntPtr_IntPtr_IntPtr == null)
				{
					...
					r_MSystem__2__Runtime__2__InteropServices__2___CustomAttributeBuilder__2__Invoke_UInt32_In_Guid_UInt32_Int16_IntPtr_IntPtr_IntPtr_IntPtr.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMInvoke
		{
			get
			{
				if(r_MInvoke == null)
				{
					...
					r_MInvoke.SetBelong(this.instance);
				}
				return r_MInvoke;
			}
		}
		...
		public virtual RMethod RMIsValidType_Type
		{
			get
			{
				if(r_MIsValidType_Type == null)
				{
					...
					r_MIsValidType_Type.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMIsValidParam_Object_Type
		{
			get
			{
				if(r_MIsValidParam_Object_Type == null)
				{
					...
					r_MIsValidParam_Object_Type.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMInitialize_ConstructorInfo_ObjectArray_PropertyInfoArray_ObjectArray_FieldInfoArray_ObjectArray
		{
			get
			{
				if(r_MInitialize_ConstructorInfo_ObjectArray_PropertyInfoArray_ObjectArray_FieldInfoArray_ObjectArray == null)
				{
					...
					r_MInitialize_ConstructorInfo_ObjectArray_PropertyInfoArray_ObjectArray_FieldInfoArray_ObjectArray.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMstring_arg
		{
			get
			{
				if(r_Mstring_arg == null)
				{
					...
					r_Mstring_arg.SetBelong(this.instance);
				}
        ...
        public static SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RCustomAttributeBuilder.RCustomAttributeInfo decode_cattr(System.Reflection.Emit.CustomAttributeBuilder @customBuilder)
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RCustomAttributeBuilder.RCustomAttributeInfo(___result);
        }
