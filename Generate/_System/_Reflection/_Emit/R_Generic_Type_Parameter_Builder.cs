...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RGenericTypeParameterBuilder : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RTypeBuilder r_Ftbuilder;
		public virtual SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RTypeBuilder RFtbuilder
		{
			get
			{
				if(r_Ftbuilder == null)
				{
					r_Ftbuilder = new(this, "tbuilder");
					r_Ftbuilder.SetBelong(this.instance);
				}
				return r_Ftbuilder;
			}
		}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RMethodBuilder r_Fmbuilder;
		public virtual SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RMethodBuilder RFmbuilder
		{
			get
			{
				if(r_Fmbuilder == null)
				{
					r_Fmbuilder = new(this, "mbuilder");
					r_Fmbuilder.SetBelong(this.instance);
				}
				return r_Fmbuilder;
			}
		}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RType r_Fbase_type;
		public virtual SMFrame.Editor.Refleaction.RSystem.RType RFbase_type
		{
			get
			{
				if(r_Fbase_type == null)
				{
					r_Fbase_type = new(this, "base_type");
					r_Fbase_type.SetBelong(this.instance);
				}
				return r_Fbase_type;
			}
		}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RType> r_Fiface_constraints;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RType> RFiface_constraints
		{
			get
			{
				if(r_Fiface_constraints == null)
				{
					r_Fiface_constraints = new(this, "iface_constraints");
					r_Fiface_constraints.SetBelong(this.instance);
				}
				return r_Fiface_constraints;
			}
		}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RReflection.RGenericParameterAttributes r_Fattrs;
		public virtual SMFrame.Editor.Refleaction.RSystem.RReflection.RGenericParameterAttributes RFattrs
		{
			get
			{
				if(r_Fattrs == null)
		...
		/// </summary>
		protected RMethod r_MSetBaseTypeConstraint_Type;
		public virtual RMethod RMSetBaseTypeConstraint_Type
		{
			get
			{
				if(r_MSetBaseTypeConstraint_Type == null)
				{
					r_MSetBaseTypeConstraint_Type = new(this, "SetBaseTypeConstraint", 0, typeof(System.Type));
					r_MSetBaseTypeConstraint_Type.SetBelong(this.instance);
				}
				return r_MSetBaseTypeConstraint_Type;
			}
		}
		...
		/// </summary>
		protected RMethod r_MSetInterfaceConstraints_TypeArray;
		public virtual RMethod RMSetInterfaceConstraints_TypeArray
		{
			get
			{
				if(r_MSetInterfaceConstraints_TypeArray == null)
				{
					r_MSetInterfaceConstraints_TypeArray = new(this, "SetInterfaceConstraints", 0, typeof(System.Type).MakeArrayType());
					r_MSetInterfaceConstraints_TypeArray.SetBelong(this.instance);
				}
				return r_MSetInterfaceConstraints_TypeArray;
			}
		}
		...
		/// </summary>
		protected RMethod r_MSetGenericParameterAttributes_GenericParameterAttributes;
		public virtual RMethod RMSetGenericParameterAttributes_GenericParameterAttributes
		{
			get
			{
				if(r_MSetGenericParameterAttributes_GenericParameterAttributes == null)
				{
					r_MSetGenericParameterAttributes_GenericParameterAttributes = new(this, "SetGenericParameterAttributes", 0, typeof(System.Reflection.GenericParameterAttributes));
					r_MSetGenericParameterAttributes_GenericParameterAttributes.SetBelong(this.instance);
				}
				return r_MSetGenericParameterAttributes_GenericParameterAttributes;
			}
		}
