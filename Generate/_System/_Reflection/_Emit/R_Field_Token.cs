...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class RFieldToken : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RFieldToken r_FEmpty;
		public static SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.RFieldToken RFEmpty
		{
			get
			{
				if(r_FEmpty == null)
		...
		public virtual RMethod RMEquals_FieldToken
		{
			get
			{
				if(r_MEquals_FieldToken == null)
				{
					...
					r_MEquals_FieldToken.SetBelong(this.instance);
				}
