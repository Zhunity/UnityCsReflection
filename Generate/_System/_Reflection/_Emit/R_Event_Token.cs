...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection.REmit
{
    ...
    public partial class REventToken : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.REventToken r_FEmpty;
		public static SMFrame.Editor.Refleaction.RSystem.RReflection.REmit.REventToken RFEmpty
		{
			get
			{
				if(r_FEmpty == null)
