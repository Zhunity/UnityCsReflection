...
namespace SMFrame.Editor.Refleaction.RSystem.RReflection
{
    ...
    public partial class RRuntimeMethodInfo : RMember //
    {
		...
		public virtual RMethod RMGetBaseMethod
		{
			get
			{
				if(r_MGetBaseMethod == null)
				{
					...
					r_MGetBaseMethod.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMGetPInvoke_Out_PInvokeAttributes_Out_String_Out_String
		{
			get
			{
				if(r_MGetPInvoke_Out_PInvokeAttributes_Out_String_Out_String == null)
				{
					...
					r_MGetPInvoke_Out_PInvokeAttributes_Out_String_Out_String.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMGetDllImportAttributeData
		{
			get
			{
				if(r_MGetDllImportAttributeData == null)
				{
					...
					r_MGetDllImportAttributeData.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMMakeGenericMethod_impl_TypeArray
		{
			get
			{
				if(r_MMakeGenericMethod_impl_TypeArray == null)
				{
					...
					r_MMakeGenericMethod_impl_TypeArray.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMGetGenericMethodDefinition_impl
		{
			get
			{
				if(r_MGetGenericMethodDefinition_impl == null)
				{
					...
					r_MGetGenericMethodDefinition_impl.SetBelong(this.instance);
				}
        ...
        public static SMFrame.Editor.Refleaction.RSystem.RReflection.RRuntimeMethodInfo get_base_method(SMFrame.Editor.Refleaction.RSystem.RReflection.RRuntimeMethodInfo @method, System.Boolean @definition)
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RReflection.RRuntimeMethodInfo(___result);
        }


        public static System.Int32 get_metadata_token(SMFrame.Editor.Refleaction.RSystem.RReflection.RRuntimeMethodInfo @method)
        {
        ...
        public virtual void GetPInvoke(out SMFrame.Editor.Refleaction.RSystem.RReflection.RPInvokeAttributes @flags, out System.String @entryPoint, out System.String @dllName)
        {
			@flags = default;
			@entryPoint = default;
			@dllName = default;
			...
			@flags = new SMFrame.Editor.Refleaction.RSystem.RReflection.RPInvokeAttributes(___parameters[0]);
