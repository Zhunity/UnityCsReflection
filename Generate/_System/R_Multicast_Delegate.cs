...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RMulticastDelegate : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RDelegate> r_Fdelegates;
		public virtual Hvak.Editor.Refleaction.RFieldArray<Hvak.Editor.Refleaction.RSystem.RDelegate> RFdelegates
		{
			get
			{
				if(r_Fdelegates == null)
				{
					...
					r_Fdelegates.SetBelong(this.GetValue());
				}
				return r_Fdelegates;
			}
		}
		...
		public virtual RMethod RMLastIndexOf_DelegateArray_DelegateArray
		{
			get
			{
				if(r_MLastIndexOf_DelegateArray_DelegateArray == null)
				{
					...
					r_MLastIndexOf_DelegateArray_DelegateArray.SetBelong(this.GetValue());
				}
