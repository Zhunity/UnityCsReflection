...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting
{
	...
	/// </summary>
    public partial class RObjectHandle : RMember //
    {

		/// <summary>
		/// System.Object _wrapped
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RObject r_F_wrapped;
		public virtual SMFrame.Editor.Refleaction.RSystem.RObject RF_wrapped
		{
			get
			{
				if(r_F_wrapped == null)
				{
					r_F_wrapped = new(this, "_wrapped");
					r_F_wrapped.SetBelong(this.instance);
				}
				return r_F_wrapped;
			}
		}
		...
		/// </summary>
		protected RMethod r_MUnwrap;
		public virtual RMethod RMUnwrap
		{
			get
			{
				if(r_MUnwrap == null)
				{
					r_MUnwrap = new(this, "Unwrap", 0);
					r_MUnwrap.SetBelong(this.instance);
				}
				return r_MUnwrap;
			}
		}
        ...
        public RObjectHandle() : base("System.Runtime.Remoting.ObjectHandle")
        {
        }

        public RObjectHandle(System.Object instance) : base("System.Runtime.Remoting.ObjectHandle")
		{
            SetInstance(instance);
		}

        public RObjectHandle(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RObjectHandle(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public virtual System.Object Unwrap()
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMUnwrap.Invoke(___genericsType, ___parameters);
