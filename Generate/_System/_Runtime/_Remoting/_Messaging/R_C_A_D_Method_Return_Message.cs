...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging
{
    ...
    public partial class RCADMethodReturnMessage : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RObject r_F_returnValue;
		public virtual SMFrame.Editor.Refleaction.RSystem.RObject RF_returnValue
		{
			get
			{
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RCADArgHolder r_F_exception;
		public virtual SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RCADArgHolder RF_exception
		{
			get
			{
		...
		/// System.Type[] _sig
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RType> r_F_sig;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RType> RF_sig
		{
			get
			{
				if(r_F_sig == null)
        ...
        public static SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RCADMethodReturnMessage Create(System.Runtime.Remoting.Messaging.IMessage @callMsg)
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RCADMethodReturnMessage(___result);
        }
