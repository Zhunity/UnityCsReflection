...
{public partial class RIllogicalCallContext
{
    ...
    public partial class RReader : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RIllogicalCallContext r_Fm_ctx;
		public virtual SMFrame.Editor.Refleaction.RSystem.RRuntime.RRemoting.RMessaging.RIllogicalCallContext RFm_ctx
		{
			get
			{
				if(r_Fm_ctx == null)
