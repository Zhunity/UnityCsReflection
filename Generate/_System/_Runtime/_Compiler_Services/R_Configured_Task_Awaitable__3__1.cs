...
namespace Hvak.Editor.Refleaction.RSystem.RRuntime.RCompilerServices
{
    ...
    public partial class RConfiguredTaskAwaitable<TResult> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Runtime.CompilerServices.ConfiguredTaskAwaitable`1").MakeGenericType(ReflectionUtils.GetType(typeof(TResult)));
            }
        }
        ...
        public virtual Hvak.Editor.Refleaction.RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable<Hvak.Editor.Refleaction.RType>.RConfiguredTaskAwaiter GetAwaiter()
        {
            ...
            return ReflectionUtils.Convert<Hvak.Editor.Refleaction.RSystem.RRuntime.RCompilerServices.RConfiguredTaskAwaitable<Hvak.Editor.Refleaction.RType>.RConfiguredTaskAwaiter>(___result);
        }
