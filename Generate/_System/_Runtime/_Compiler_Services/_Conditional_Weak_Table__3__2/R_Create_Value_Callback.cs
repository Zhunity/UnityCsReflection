...
{public partial class RConditionalWeakTable<TKey, TValue>
{
    ...
    public partial class RCreateValueCallback : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Runtime.CompilerServices.ConditionalWeakTable`2+CreateValueCallback").MakeGenericType(TypeToString.GetType(typeof(TKey)), TypeToString.GetType(typeof(TValue)));
            }
        }
