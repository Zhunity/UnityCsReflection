...
{public partial class RConfiguredValueTaskAwaitable<TResult>
{
    ...
    public partial class RConfiguredValueTaskAwaiter : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Runtime.CompilerServices.ConfiguredValueTaskAwaitable`1+ConfiguredValueTaskAwaiter").MakeGenericType(typeof(TResult));
            }
        }

        public RConfiguredValueTaskAwaiter() : base("System.Runtime.CompilerServices.ConfiguredValueTaskAwaitable`1+ConfiguredValueTaskAwaiter")
        {
        }

        public RConfiguredValueTaskAwaiter(System.Object instance) : base("System.Runtime.CompilerServices.ConfiguredValueTaskAwaitable`1+ConfiguredValueTaskAwaiter")
		{
