...
namespace SMFrame.Editor.Refleaction.RSystem.RRuntime.RCompilerServices
{
    ...
    public partial class RConfiguredValueTaskAwaitable<TResult> : RMember //
    {
        ...
        public virtual SMFrame.Editor.Refleaction.RSystem.RRuntime.RCompilerServices.RConfiguredValueTaskAwaitable<SMFrame.Editor.Refleaction.RType>.RConfiguredValueTaskAwaiter GetAwaiter()
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RRuntime.RCompilerServices.RConfiguredValueTaskAwaitable<SMFrame.Editor.Refleaction.RType>.RConfiguredValueTaskAwaiter(___result);
        }
