...
namespace Hvak.Editor.Refleaction.RSystem.RBuffers
{
    ...
    public partial class RSpanAction<T, TArg> : RMember //
    {
		...
		/// </summary>
		protected RMethod r_MInvoke_Span_d_T_p__TArg;
		public virtual RMethod RMInvoke_Span_d_T_p__TArg
		{
			get
			{
				if(r_MInvoke_Span_d_T_p__TArg == null)
				{
					...
					r_MInvoke_Span_d_T_p__TArg.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected RMethod r_MBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object.SetBelong(this.GetValue());
				}
        ...
        public virtual void Invoke(Hvak.Editor.Refleaction.RSystem.RSpan<Hvak.Editor.Refleaction.RType> @span, TArg @arg)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@span.Value, @arg};
            var ___result = RMInvoke_Span_d_T_p__TArg.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(Hvak.Editor.Refleaction.RSystem.RSpan<Hvak.Editor.Refleaction.RType> @span, TArg @arg, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@span.Value, @arg, @callback, @object};
            var ___result = RMBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
