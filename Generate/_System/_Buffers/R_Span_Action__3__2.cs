...
namespace SMFrame.Editor.Refleaction.RSystem.RBuffers
{
    ...
    public partial class RSpanAction<T, TArg> : RMember //
    {
		...
		public virtual RMethod RMInvoke_Span_d_T_p__TArg
		{
			get
			{
				if(r_MInvoke_Span_d_T_p__TArg == null)
				{
					...
					r_MInvoke_Span_d_T_p__TArg.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object == null)
				{
					...
					r_MBeginInvoke_Span_d_T_p__TArg_AsyncCallback_Object.SetBelong(this.instance);
				}
        ...
        public virtual void Invoke(SMFrame.Editor.Refleaction.RSystem.RSpan<SMFrame.Editor.Refleaction.RType> @span, TArg @arg)
        {
        ...
        public virtual System.IAsyncResult BeginInvoke(SMFrame.Editor.Refleaction.RSystem.RSpan<SMFrame.Editor.Refleaction.RType> @span, TArg @arg, System.AsyncCallback @callback, System.Object @object)
        {
