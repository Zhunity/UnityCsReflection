...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RFunc<T1, T2, TResult> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Func`3").MakeGenericType(ReflectionUtils.GetType(typeof(T1)), ReflectionUtils.GetType(typeof(T2)), ReflectionUtils.GetType(typeof(TResult)));
            }
        }
