    ...
    public partial class RDecimal : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RInt32 RFmid
		{
			get
			{
				...
				{
					r_Fmid = new(this, "mid");
					r_Fmid.SetBelong(this.GetValue());
				}
				return r_Fmid;
			}
		}
		...
		public virtual RMethod RMCompareTo_Decimal
		{
			get
			{
				if(r_MCompareTo_Decimal == null)
				{
					...
					r_MCompareTo_Decimal.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMEquals_Decimal
		{
			get
			{
				if(r_MEquals_Decimal == null)
				{
					...
					r_MEquals_Decimal.SetBelong(this.GetValue());
				}
