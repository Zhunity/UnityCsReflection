...
namespace Hvak.Editor.Refleaction.RSystem
{
    ...
    public partial class RIFormattable : RMember //
    {
        ...
        public RIFormattable(System.Object instance) : base("System.IFormattable")
		{
            SetInstance(instance);
		}

        public RIFormattable(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }
