...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections
{
    ...
    public partial class RQueue : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> r_F_array;
		public virtual SMFrame.Editor.Refleaction.RFieldArray<SMFrame.Editor.Refleaction.RSystem.RObject> RF_array
		{
			get
			{
				if(r_F_array == null)
		...
		/// System.Int32 _head
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RInt32 r_F_head;
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RF_head
		{
			get
			{
				if(r_F_head == null)
		...
		/// System.Int32 _tail
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RInt32 r_F_tail;
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RF_tail
		{
			get
			{
				if(r_F_tail == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RInt32 r_F_growFactor;
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RF_growFactor
		{
			get
			{
				if(r_F_growFactor == null)
				{
					...
					r_F_growFactor.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_F_MinimumGrow;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RF_MinimumGrow
		{
			get
			{
				if(r_F_MinimumGrow == null)
				{
					r_F_MinimumGrow = new(typeof(System.Collections.Queue), "_MinimumGrow");
					r_F_MinimumGrow.SetBelong(null);
				}
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_F_ShrinkThreshold;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RF_ShrinkThreshold
		{
			get
			{
				if(r_F_ShrinkThreshold == null)
				{
					r_F_ShrinkThreshold = new(typeof(System.Collections.Queue), "_ShrinkThreshold");
					r_F_ShrinkThreshold.SetBelong(null);
				}
		...
		public virtual RMethod RMEnqueue_Object
		{
			get
			{
				if(r_MEnqueue_Object == null)
				{
					...
					r_MEnqueue_Object.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMDequeue
		{
			get
			{
				if(r_MDequeue == null)
				{
					...
					r_MDequeue.SetBelong(this.instance);
				}
				return r_MDequeue;
			}
		}
		...
		public static RMethod RMSynchronized_Queue
		{
			get
			{
				...
				{
					r_MSynchronized_Queue = new(typeof(System.Collections.Queue), "Synchronized", 0, typeof(System.Collections.Queue));
					r_MSynchronized_Queue.SetBelong(null);
				}
		...
		public virtual RMethod RMGetElement_Int32
		{
			get
			{
				if(r_MGetElement_Int32 == null)
				{
					...
					r_MGetElement_Int32.SetBelong(this.instance);
				}
