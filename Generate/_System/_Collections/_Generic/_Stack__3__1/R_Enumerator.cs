...
{public partial class RStack<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RStack<SMFrame.Editor.Refleaction.RField> r_F_stack;
		public virtual SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RStack<SMFrame.Editor.Refleaction.RField> RF_stack
		{
			get
			{
				if(r_F_stack == null)
				{
					...
					r_F_stack.SetBelong(this.instance);
				}
				return r_F_stack;
			}
		}
