...
{public partial class RQueue<T>
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RQueue<Hvak.Editor.Refleaction.RField> r_F_q;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RQueue<Hvak.Editor.Refleaction.RField> RF_q
		{
			get
			{
				if(r_F_q == null)
		...
		public virtual Hvak.Editor.Refleaction.RField RF_currentElement
		{
			get
			{
				if(r_F_currentElement == null)
				{
					...
					r_F_currentElement.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMThrowEnumerationNotStartedOrEnded
		{
			get
			{
				if(r_MThrowEnumerationNotStartedOrEnded == null)
				{
					...
					r_MThrowEnumerationNotStartedOrEnded.SetBelong(this.GetValue());
				}
