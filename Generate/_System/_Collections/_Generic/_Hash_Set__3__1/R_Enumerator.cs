...
{public partial class RHashSet<T>
{
    ...
    public partial class REnumerator : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Collections.Generic.HashSet`1+Enumerator").MakeGenericType(TypeToString.GetType(typeof(T)));
            }
        }
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RHashSet<Hvak.Editor.Refleaction.RField> r_F_set;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RHashSet<Hvak.Editor.Refleaction.RField> RF_set
		{
			get
			{
				if(r_F_set == null)
				{
					r_F_set = new(this, "_set");
				}
				return r_F_set;
			}
		}
