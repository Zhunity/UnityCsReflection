		...
		public virtual RMethod RMPop
		{
			get
			{
				if(r_MPop == null)
				{
					...
					r_MPop.SetBelong(this.GetValue());
				}
				return r_MPop;
			}
		}
		...
		public virtual RMethod RMTryPop_Out_T
		{
			get
			{
				if(r_MTryPop_Out_T == null)
				{
					...
					r_MTryPop_Out_T.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMPush_T
		{
			get
			{
				if(r_MPush_T == null)
				{
					...
					r_MPush_T.SetBelong(this.GetValue());
				}
				return r_MPush_T;
			}
		}
		...
		public virtual RMethod RMPushWithResize_T
		{
			get
			{
				if(r_MPushWithResize_T == null)
				{
					...
					r_MPushWithResize_T.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMThrowForEmptyStack
		{
			get
			{
				if(r_MThrowForEmptyStack == null)
				{
					...
					r_MThrowForEmptyStack.SetBelong(this.GetValue());
				}
