...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RStack<T> : RMember //
    {
		...
		public virtual RMethod RMTryPop_Out_T
		{
			get
			{
				if(r_MTryPop_Out_T == null)
				{
					...
					r_MTryPop_Out_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMPush_T
		{
			get
			{
				if(r_MPush_T == null)
				{
					...
					r_MPush_T.SetBelong(this.instance);
				}
				return r_MPush_T;
			}
		}
		...
		public virtual RMethod RMPushWithResize_T
		{
			get
			{
				if(r_MPushWithResize_T == null)
				{
					...
					r_MPushWithResize_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMThrowForEmptyStack
		{
			get
			{
				if(r_MThrowForEmptyStack == null)
				{
					...
					r_MThrowForEmptyStack.SetBelong(this.instance);
				}
        ...
        public virtual SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RStack<SMFrame.Editor.Refleaction.RType>.REnumerator GetEnumerator()
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RStack<SMFrame.Editor.Refleaction.RType>.REnumerator(___result);
        }
