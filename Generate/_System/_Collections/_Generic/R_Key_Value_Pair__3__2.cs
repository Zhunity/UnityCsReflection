...
namespace Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RKeyValuePair<TKey, TValue> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Collections.Generic.KeyValuePair`2").MakeGenericType(ReflectionUtils.GetType(typeof(TKey)), ReflectionUtils.GetType(typeof(TValue)));
            }
        }
