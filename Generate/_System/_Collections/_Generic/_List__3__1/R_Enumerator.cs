...
{public partial class RList<T>
{
    ...
    public partial class REnumerator : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Collections.Generic.List`1+Enumerator").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }

        public REnumerator() : base("System.Collections.Generic.List`1+Enumerator")
        {
        }

        public REnumerator(System.Object instance) : base("System.Collections.Generic.List`1+Enumerator")
		{
		...
		/// <summary>
		/// System.Collections.Generic.List`1[T] _list
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RField> r_F_list;
		public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RField> RF_list
		{
			get
			{
				if(r_F_list == null)
		...
		/// </summary>
		protected RMethod r_MMoveNextRare;
		public virtual RMethod RMMoveNextRare
		{
			get
			{
				if(r_MMoveNextRare == null)
				{
					r_MMoveNextRare = new(this, "MoveNextRare", 0);
				}
				return r_MMoveNextRare;
			}
		}
