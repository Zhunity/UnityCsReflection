...
namespace SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric
{
    ...
    public partial class RQueue<T> : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_FMinimumGrow;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RFMinimumGrow
		{
			get
			{
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_FGrowFactor;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RFGrowFactor
		{
			get
			{
		...
		public virtual RMethod RMEnqueue_T
		{
			get
			{
				if(r_MEnqueue_T == null)
				{
					...
					r_MEnqueue_T.SetBelong(this.instance);
				}
				return r_MEnqueue_T;
			}
		}
		...
		public virtual RMethod RMTryDequeue_Out_T
		{
			get
			{
				if(r_MTryDequeue_Out_T == null)
				{
					...
					r_MTryDequeue_Out_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMTryPeek_Out_T
		{
			get
			{
				if(r_MTryPeek_Out_T == null)
				{
					...
					r_MTryPeek_Out_T.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMMoveNext_Ref_Int32
		{
			get
			{
				if(r_MMoveNext_Ref_Int32 == null)
				{
					...
					r_MMoveNext_Ref_Int32.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMThrowForEmptyQueue
		{
			get
			{
				if(r_MThrowForEmptyQueue == null)
				{
					...
					r_MThrowForEmptyQueue.SetBelong(this.instance);
				}
        ...
        public virtual SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RQueue<SMFrame.Editor.Refleaction.RType>.REnumerator GetEnumerator()
        {
            ...
            return new SMFrame.Editor.Refleaction.RSystem.RCollections.RGeneric.RQueue<SMFrame.Editor.Refleaction.RType>.REnumerator(___result);
        }
