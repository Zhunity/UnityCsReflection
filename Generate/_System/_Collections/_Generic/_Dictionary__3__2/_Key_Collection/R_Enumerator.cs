...
{
	public partial class RKeyCollection
{
    ...
    public partial class REnumerator : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Collections.Generic.Dictionary`2+KeyCollection+Enumerator").MakeGenericType(ReflectionUtils.GetType(typeof(TKey)), ReflectionUtils.GetType(typeof(TValue)));
            }
        }

        public REnumerator() : base("System.Collections.Generic.Dictionary`2+KeyCollection+Enumerator")
        {
        }

        public REnumerator(System.Object instance) : base("System.Collections.Generic.Dictionary`2+KeyCollection+Enumerator")
		{
		...
		/// TKey _currentKey
		/// </summary>
		protected Hvak.Editor.Refleaction.RField r_F_currentKey;
		public virtual Hvak.Editor.Refleaction.RField RF_currentKey
		{
			get
			{
				if(r_F_currentKey == null)
				{
					r_F_currentKey = new(this, "_currentKey");
				}
				return r_F_currentKey;
			}
		}
