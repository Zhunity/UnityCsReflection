	...
	public partial class RKeyCollection
{
    ...
    public partial class REnumerator : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("System.Collections.Generic.Dictionary`2+KeyCollection+Enumerator").MakeGenericType(TypeToString.GetType(typeof(TKey)), TypeToString.GetType(typeof(TValue)));
            }
        }
