	...
	public partial class RKeyCollection
{
    ...
    public partial class REnumerator : RMember //
    {
		...
		/// TKey _currentKey
		/// </summary>
		protected SMFrame.Editor.Refleaction.RField r_F_currentKey;
		public virtual SMFrame.Editor.Refleaction.RField RF_currentKey
		{
			get
			{
				if(r_F_currentKey == null)
				{
					...
					r_F_currentKey.SetBelong(this.instance);
				}
