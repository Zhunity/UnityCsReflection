...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RAccessRule : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAccessControlType r_Ftype;
		public virtual SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAccessControlType RFtype
		{
			get
			{
				if(r_Ftype == null)
