...
namespace Hvak.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RAuditRule : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAuditFlags r_FauditFlags;
		public virtual Hvak.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAuditFlags RFauditFlags
		{
			get
			{
				if(r_FauditFlags == null)
				{
					r_FauditFlags = new(this, "auditFlags");
					r_FauditFlags.SetBelong(this.GetValue());
				}
