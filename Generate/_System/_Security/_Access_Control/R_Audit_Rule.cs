...
namespace SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl
{
    ...
    public partial class RAuditRule : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAuditFlags r_FauditFlags;
		public virtual SMFrame.Editor.Refleaction.RSystem.RSecurity.RAccessControl.RAuditFlags RFauditFlags
		{
			get
			{
				if(r_FauditFlags == null)
				{
					...
					r_FauditFlags.SetBelong(this.instance);
				}
