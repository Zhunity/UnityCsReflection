		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFm_XPositionAdjustment
		{
			get
			{
				if(r_Fm_XPositionAdjustment == null)
				{
					...
					r_Fm_XPositionAdjustment.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFm_YPositionAdjustment
		{
			get
			{
				if(r_Fm_YPositionAdjustment == null)
				{
					...
					r_Fm_YPositionAdjustment.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RPxPositionAdjustment
		{
			get
			{
				if(r_PxPositionAdjustment == null)
				{
					...
					r_PxPositionAdjustment.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RPyPositionAdjustment
		{
			get
			{
				if(r_PyPositionAdjustment == null)
				{
					...
					r_PyPositionAdjustment.SetBelong(this.GetValue());
				}
