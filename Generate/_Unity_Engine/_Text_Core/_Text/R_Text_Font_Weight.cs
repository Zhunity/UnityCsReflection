    ...
    public partial class RTextFontWeight : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RTextCore.RText.RTextFontWeight RFExtraLight
		{
			get
			{
				...
				{
					r_FExtraLight = new(Type, "ExtraLight");
				}
