    ...
    public partial class RIStylePropertyAnimations : RMember //
    {
		...
		public virtual RMethod RMGetAllAnimations_List_d_StylePropertyId_p_
		{
			get
			{
				...
				{
					r_MGetAllAnimations_List_d_StylePropertyId_p_ = new(this, "GetAllAnimations", 0,  ReflectionUtils.GetType("System.Collections.Generic.List`1").MakeGenericType( ReflectionUtils.GetType("UnityEngine.UIElements.StyleSheets.StylePropertyId")));
				}
