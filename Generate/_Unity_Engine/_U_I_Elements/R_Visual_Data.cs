    ...
    public partial class RVisualData : RMember //
    {
		...
		public static RMethod RMop_Equality_VisualData_VisualData
		{
			get
			{
				...
				{
					r_Mop_Equality_VisualData_VisualData = new(Type, "op_Equality", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.VisualData"),  ReflectionUtils.GetType("UnityEngine.UIElements.VisualData"));
				}
		...
		public static RMethod RMop_Inequality_VisualData_VisualData
		{
			get
			{
				...
				{
					r_Mop_Inequality_VisualData_VisualData = new(Type, "op_Inequality", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.VisualData"),  ReflectionUtils.GetType("UnityEngine.UIElements.VisualData"));
				}
        ...
        public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualData Copy()
        {
            ...
            return ReflectionUtils.Convert<Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualData>(___result);
        }
        ...
        public virtual void CopyFrom(ref Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualData @other)
        {
			...
			@other = ReflectionUtils.Convert<Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualData>(___parameters[0]);
