...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventBase<T> : RMember // where T : UnityEngine.UIElements.EventBase<T>, new()
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt64 r_Fs_TypeId;
		public static SMFrame.Editor.Refleaction.RSystem.RInt64 RFs_TypeId
		{
			get
			{
				if(r_Fs_TypeId == null)
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RObjectPool<SMFrame.Editor.Refleaction.RField> r_Fs_Pool;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RObjectPool<SMFrame.Editor.Refleaction.RField> RFs_Pool
		{
			get
			{
				if(r_Fs_Pool == null)
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RFm_RefCount
		{
			get
			{
				if(r_Fm_RefCount == null)
				{
					...
					r_Fm_RefCount.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventCategory r_FEventCategory;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventCategory RFEventCategory
		{
			get
			{
