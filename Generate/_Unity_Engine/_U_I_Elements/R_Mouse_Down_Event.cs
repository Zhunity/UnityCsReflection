...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RMouseDownEvent : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventCategory RPeventCategory
		{
			get
			{
				if(r_PeventCategory == null)
				{
					...
					r_PeventCategory.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventBase.REventPropagation RPpropagation
		{
			get
			{
				if(r_Ppropagation == null)
				{
					...
					r_Ppropagation.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPbubbles
		{
			get
			{
				if(r_Pbubbles == null)
				{
					...
					r_Pbubbles.SetBelong(this.GetValue());
				}
				return r_Pbubbles;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPtricklesDown
		{
			get
			{
				if(r_PtricklesDown == null)
				{
					...
					r_PtricklesDown.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPbubblesOrTricklesDown
		{
			get
			{
				if(r_PbubblesOrTricklesDown == null)
				{
					...
					r_PbubblesOrTricklesDown.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPskipDisabledElements
		{
			get
			{
				if(r_PskipDisabledElements == null)
				{
					...
					r_PskipDisabledElements.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPignoreCompositeRoots
		{
			get
			{
				if(r_PignoreCompositeRoots == null)
				{
					...
					r_PignoreCompositeRoots.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIEventHandler RPleafTarget
		{
			get
			{
				if(r_PleafTarget == null)
				{
					...
					r_PleafTarget.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPprocessed
		{
			get
			{
				if(r_Pprocessed == null)
				{
					...
					r_Pprocessed.SetBelong(this.GetValue());
				}
				return r_Pprocessed;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPprocessedByFocusController
		{
			get
			{
				if(r_PprocessedByFocusController == null)
				{
					...
					r_PprocessedByFocusController.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPstopDispatch
		{
			get
			{
				if(r_PstopDispatch == null)
				{
					...
					r_PstopDispatch.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPpropagateToIMGUI
		{
			get
			{
				if(r_PpropagateToIMGUI == null)
				{
					...
					r_PpropagateToIMGUI.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.REvent RPimguiEvent
		{
			get
			{
				if(r_PimguiEvent == null)
				{
					...
					r_PimguiEvent.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventDebugger RPeventLogger
		{
			get
			{
				if(r_PeventLogger == null)
				{
					...
					r_PeventLogger.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPlog
		{
			get
			{
				if(r_Plog == null)
				{
					...
					r_Plog.SetBelong(this.GetValue());
				}
				return r_Plog;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPpooled
		{
			get
			{
				if(r_Ppooled == null)
				{
					...
					r_Ppooled.SetBelong(this.GetValue());
				}
				return r_Ppooled;
			}
		}
		...
		public virtual RMethod RMLocalInit
		{
			get
			{
				if(r_MLocalInit == null)
				{
					...
					r_MLocalInit.SetBelong(this.GetValue());
				}
				return r_MLocalInit;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.Event)
		/// </summary>
		...
		public static RMethod RMGetPooled_Event
		{
			get
			{
				...
				{
					r_MGetPooled_Event = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.Event));
		...
		/// <summary>
		/// UnityEngine.UIElements.MouseDownEvent MakeFromPointerEvent(UnityEngine.UIElements.IPointerEvent)
		/// </summary>
		protected static RMethod r_MMakeFromPointerEvent_IPointerEvent;
		public static RMethod RMMakeFromPointerEvent_IPointerEvent
		{
			get
			{
				if(r_MMakeFromPointerEvent_IPointerEvent == null)
				{
					r_MMakeFromPointerEvent_IPointerEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "MakeFromPointerEvent", 0, typeof(UnityEngine.UIElements.IPointerEvent));
					r_MMakeFromPointerEvent_IPointerEvent.SetBelong(null);
				}
		...
		/// <summary>
		/// UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.UIElements.PointerDownEvent)
		/// </summary>
		protected static RMethod r_MGetPooled_PointerDownEvent;
		public static RMethod RMGetPooled_PointerDownEvent
		{
			get
			{
				if(r_MGetPooled_PointerDownEvent == null)
				{
					r_MGetPooled_PointerDownEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerDownEvent));
					r_MGetPooled_PointerDownEvent.SetBelong(null);
				}
				return r_MGetPooled_PointerDownEvent;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.UIElements.PointerMoveEvent)
		/// </summary>
		protected static RMethod r_MGetPooled_PointerMoveEvent;
		public static RMethod RMGetPooled_PointerMoveEvent
		{
			get
			{
				if(r_MGetPooled_PointerMoveEvent == null)
				{
					r_MGetPooled_PointerMoveEvent = new(typeof(UnityEngine.UIElements.MouseDownEvent), "GetPooled", 0, typeof(UnityEngine.UIElements.PointerMoveEvent));
					r_MGetPooled_PointerMoveEvent.SetBelong(null);
				}
		...
		public virtual RMethod RMPreDispatch_IPanel
		{
			get
			{
				if(r_MPreDispatch_IPanel == null)
				{
					...
					r_MPreDispatch_IPanel.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMPostDispatch_IPanel
		{
			get
			{
				if(r_MPostDispatch_IPanel == null)
				{
					...
					r_MPostDispatch_IPanel.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSetTriggerEventId_UInt64
		{
			get
			{
				if(r_MSetTriggerEventId_UInt64 == null)
				{
					...
					r_MSetTriggerEventId_UInt64.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMPreDispatch
		{
			get
			{
				if(r_MPreDispatch == null)
				{
					...
					r_MPreDispatch.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMPostDispatch
		{
			get
			{
				if(r_MPostDispatch == null)
				{
					...
					r_MPostDispatch.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSkip_IEventHandler
		{
			get
			{
				if(r_MSkip_IEventHandler == null)
				{
					...
					r_MSkip_IEventHandler.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMStopPropagation
		{
			get
			{
				if(r_MStopPropagation == null)
				{
					...
					r_MStopPropagation.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMStopImmediatePropagation
		{
			get
			{
				if(r_MStopImmediatePropagation == null)
				{
					...
					r_MStopImmediatePropagation.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMPreventDefault
		{
			get
			{
				if(r_MPreventDefault == null)
				{
					...
					r_MPreventDefault.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMMarkReceivedByDispatcher
		{
			get
			{
				if(r_MMarkReceivedByDispatcher == null)
				{
					...
					r_MMarkReceivedByDispatcher.SetBelong(this.GetValue());
				}
        ...
        public RMouseDownEvent() : base("UnityEngine.UIElements.MouseDownEvent")
        {
        }

        public RMouseDownEvent(System.Object instance) : base("UnityEngine.UIElements.MouseDownEvent")
		{
            SetInstance(instance);
		}

        public RMouseDownEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RMouseDownEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
        ...
        public static UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.Event @systemEvent)
        {
            ...
            return (UnityEngine.UIElements.MouseDownEvent)___result;
        }


        public static UnityEngine.UIElements.MouseDownEvent MakeFromPointerEvent(UnityEngine.UIElements.IPointerEvent @pointerEvent)
        {
        ...
        public static UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.UIElements.PointerDownEvent @pointerEvent)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@pointerEvent};
            var ___result = RMGetPooled_PointerDownEvent.Invoke(___genericsType, ___parameters);

            return (UnityEngine.UIElements.MouseDownEvent)___result;
        }


        public static UnityEngine.UIElements.MouseDownEvent GetPooled(UnityEngine.UIElements.PointerMoveEvent @pointerEvent)
        {
