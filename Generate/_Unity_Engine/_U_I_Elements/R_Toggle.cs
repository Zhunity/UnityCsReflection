    ...
    public partial class RToggle : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEngine.UIElements.Toggle), "ussClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFlabelUssClassName
		{
			get
			{
				...
				{
					r_FlabelUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "labelUssClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFinputUssClassName
		{
			get
			{
				...
				{
					r_FinputUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "inputUssClassName");
		...
		/// <summary>
		/// System.String noTextVariantUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FnoTextVariantUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFnoTextVariantUssClassName
		{
			get
			{
				if(r_FnoTextVariantUssClassName == null)
				{
					r_FnoTextVariantUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "noTextVariantUssClassName");
					r_FnoTextVariantUssClassName.SetBelong(null);
				}
				return r_FnoTextVariantUssClassName;
			}
		}

		/// <summary>
		/// System.String checkmarkUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FcheckmarkUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFcheckmarkUssClassName
		{
			get
			{
				if(r_FcheckmarkUssClassName == null)
				{
					r_FcheckmarkUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "checkmarkUssClassName");
					r_FcheckmarkUssClassName.SetBelong(null);
				}
				return r_FcheckmarkUssClassName;
			}
		}
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FtextUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFtextUssClassName
		{
			get
			{
				if(r_FtextUssClassName == null)
				{
					r_FtextUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "textUssClassName");
					r_FtextUssClassName.SetBelong(null);
				}
				return r_FtextUssClassName;
			}
		}

		/// <summary>
		/// System.String mixedValuesUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FmixedValuesUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFmixedValuesUssClassName
		{
			get
			{
				if(r_FmixedValuesUssClassName == null)
				{
					r_FmixedValuesUssClassName = new(typeof(UnityEngine.UIElements.Toggle), "mixedValuesUssClassName");
					r_FmixedValuesUssClassName.SetBelong(null);
				}
				return r_FmixedValuesUssClassName;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel r_Fm_Label;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLabel RFm_Label
		{
			get
			{
				if(r_Fm_Label == null)
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_CheckMark;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_CheckMark
		{
			get
			{
				if(r_Fm_CheckMark == null)
				{
					r_Fm_CheckMark = new(this, "m_CheckMark");
					r_Fm_CheckMark.SetBelong(this.GetValue());
				}
				return r_Fm_CheckMark;
			}
		}
		...
		/// Boolean rawValue
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_PrawValue;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPrawValue
		{
			get
			{
				if(r_PrawValue == null)
		...
		/// Void InitLabel()
		/// </summary>
		protected RMethod r_MInitLabel;
		public virtual RMethod RMInitLabel
		{
			get
			{
				if(r_MInitLabel == null)
				{
					r_MInitLabel = new(this, "InitLabel", 0);
					r_MInitLabel.SetBelong(this.GetValue());
				}
				return r_MInitLabel;
			}
		}
		...
		/// </summary>
		protected RMethod r_MSetValueWithoutNotify_Boolean;
		public virtual RMethod RMSetValueWithoutNotify_Boolean
		{
			get
			{
				if(r_MSetValueWithoutNotify_Boolean == null)
				{
					r_MSetValueWithoutNotify_Boolean = new(this, "SetValueWithoutNotify", 0, typeof(System.Boolean));
					r_MSetValueWithoutNotify_Boolean.SetBelong(this.GetValue());
				}
				return r_MSetValueWithoutNotify_Boolean;
			}
		}
		...
		/// Void ToggleValue()
		/// </summary>
		protected RMethod r_MToggleValue;
		public virtual RMethod RMToggleValue
		{
			get
			{
				if(r_MToggleValue == null)
				{
					r_MToggleValue = new(this, "ToggleValue", 0);
					r_MToggleValue.SetBelong(this.GetValue());
				}
				return r_MToggleValue;
			}
		}

		/// <summary>
		/// Boolean ValidatedValue(Boolean)
		/// </summary>
		protected RMethod r_MValidatedValue_Boolean;
		public virtual RMethod RMValidatedValue_Boolean
		{
			get
			{
				if(r_MValidatedValue_Boolean == null)
				{
					r_MValidatedValue_Boolean = new(this, "ValidatedValue", 0, typeof(System.Boolean));
					r_MValidatedValue_Boolean.SetBelong(this.GetValue());
				}
				return r_MValidatedValue_Boolean;
			}
		}

		/// <summary>
		/// Void SetValueWithoutValidation(Boolean)
		/// </summary>
		protected RMethod r_MSetValueWithoutValidation_Boolean;
		public virtual RMethod RMSetValueWithoutValidation_Boolean
		{
			get
			{
				if(r_MSetValueWithoutValidation_Boolean == null)
				{
					r_MSetValueWithoutValidation_Boolean = new(this, "SetValueWithoutValidation", 0, typeof(System.Boolean));
					r_MSetValueWithoutValidation_Boolean.SetBelong(this.GetValue());
				}
				return r_MSetValueWithoutValidation_Boolean;
			}
		}
        ...
        public virtual void InitLabel()
        {
            ...
            var ___result = RMInitLabel.Invoke(___genericsType, ___parameters);
        ...
        public virtual void SetValueWithoutNotify(System.Boolean @newValue)
        {
            ...
            var ___result = RMSetValueWithoutNotify_Boolean.Invoke(___genericsType, ___parameters);
        ...
        public virtual void ToggleValue()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMToggleValue.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.Boolean ValidatedValue(System.Boolean @value)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@value};
            var ___result = RMValidatedValue_Boolean.Invoke(___genericsType, ___parameters);

            return (System.Boolean)___result;
        }


        public virtual void SetValueWithoutValidation(System.Boolean @newValue)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@newValue};
            var ___result = RMSetValueWithoutValidation_Boolean.Invoke(___genericsType, ___parameters);
