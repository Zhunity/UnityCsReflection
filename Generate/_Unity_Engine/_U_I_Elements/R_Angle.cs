    ...
    public partial class RAngle : RMember //
    {
		...
		public static RMethod RMDegrees_Single
		{
			get
			{
				...
				{
					r_MDegrees_Single = new(Type, "Degrees", 0, typeof(System.Single));
				}
		...
		public static RMethod RMop_Equality_Angle_Angle
		{
			get
			{
				...
				{
					r_Mop_Equality_Angle_Angle = new(Type, "op_Equality", 0, typeof(UnityEngine.UIElements.Angle), typeof(UnityEngine.UIElements.Angle));
				}
		...
		public static RMethod RMop_Inequality_Angle_Angle
		{
			get
			{
				...
				{
					r_Mop_Inequality_Angle_Angle = new(Type, "op_Inequality", 0, typeof(UnityEngine.UIElements.Angle), typeof(UnityEngine.UIElements.Angle));
				}
