    ...
    public partial class RTextureId : RMember //
    {
		...
		public static RMethod RMop_Equality_TextureId_TextureId
		{
			get
			{
				...
				{
					r_Mop_Equality_TextureId_TextureId = new(Type, "op_Equality", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.TextureId"),  ReflectionUtils.GetType("UnityEngine.UIElements.TextureId"));
				}
		...
		public static RMethod RMop_Inequality_TextureId_TextureId
		{
			get
			{
				...
				{
					r_Mop_Inequality_TextureId_TextureId = new(Type, "op_Inequality", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.TextureId"),  ReflectionUtils.GetType("UnityEngine.UIElements.TextureId"));
				}
