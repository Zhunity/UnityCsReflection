...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleBackgroundPosition : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundPosition r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundPosition RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundPosition r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundPosition RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public static RMethod RMop_Equality_StyleBackgroundPosition_StyleBackgroundPosition
		{
			get
			{
				...
				{
					r_Mop_Equality_StyleBackgroundPosition_StyleBackgroundPosition = new(typeof(UnityEngine.UIElements.StyleBackgroundPosition), "op_Equality", 0, typeof(UnityEngine.UIElements.StyleBackgroundPosition), typeof(UnityEngine.UIElements.StyleBackgroundPosition));
					r_Mop_Equality_StyleBackgroundPosition_StyleBackgroundPosition.SetBelong(null);
				}
		...
		public static RMethod RMop_Inequality_StyleBackgroundPosition_StyleBackgroundPosition
		{
			get
			{
				...
				{
					r_Mop_Inequality_StyleBackgroundPosition_StyleBackgroundPosition = new(typeof(UnityEngine.UIElements.StyleBackgroundPosition), "op_Inequality", 0, typeof(UnityEngine.UIElements.StyleBackgroundPosition), typeof(UnityEngine.UIElements.StyleBackgroundPosition));
					r_Mop_Inequality_StyleBackgroundPosition_StyleBackgroundPosition.SetBelong(null);
				}
		...
		public static RMethod RMop_Implicit_StyleKeyword
		{
			get
			{
				...
				{
					r_Mop_Implicit_StyleKeyword = new(typeof(UnityEngine.UIElements.StyleBackgroundPosition), "op_Implicit", 0, typeof(UnityEngine.UIElements.StyleKeyword));
		...
		public static RMethod RMop_Implicit_BackgroundPosition
		{
			get
			{
				...
				{
					r_Mop_Implicit_BackgroundPosition = new(typeof(UnityEngine.UIElements.StyleBackgroundPosition), "op_Implicit", 0, typeof(UnityEngine.UIElements.BackgroundPosition));
					r_Mop_Implicit_BackgroundPosition.SetBelong(null);
				}
		...
		public virtual RMethod RMEquals_StyleBackgroundPosition
		{
			get
			{
				if(r_MEquals_StyleBackgroundPosition == null)
				{
					...
					r_MEquals_StyleBackgroundPosition.SetBelong(this.instance);
				}
