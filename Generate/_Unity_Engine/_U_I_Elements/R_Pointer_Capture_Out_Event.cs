...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RPointerCaptureOutEvent : RMember //
    {

		/// <summary>
		/// UnityEngine.UIElements.IEventHandler relatedTarget
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIEventHandler r_PrelatedTarget;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIEventHandler RPrelatedTarget
		{
			get
			{
        ...
        public RPointerCaptureOutEvent() : base("UnityEngine.UIElements.PointerCaptureOutEvent")
        {
        }

        public RPointerCaptureOutEvent(System.Object instance) : base("UnityEngine.UIElements.PointerCaptureOutEvent")
		{
            SetInstance(instance);
		}

        public RPointerCaptureOutEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RPointerCaptureOutEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
