    ...
    public partial class RTextField : RMember //
    {
		...
		public virtual REvent REonIsReadOnlyChanged
		{
			get
			{
				if(r_EonIsReadOnlyChanged == null)
				{
					...
					r_EonIsReadOnlyChanged.SetBelong(this.GetValue());
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEngine.UIElements.TextField), "ussClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFlabelUssClassName
		{
			get
			{
				...
				{
					r_FlabelUssClassName = new(typeof(UnityEngine.UIElements.TextField), "labelUssClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFinputUssClassName
		{
			get
			{
				...
				{
					r_FinputUssClassName = new(typeof(UnityEngine.UIElements.TextField), "inputUssClassName");
		...
		/// TextInput textInput
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField.RTextInput r_PtextInput;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField.RTextInput RPtextInput
		{
			get
			{
				if(r_PtextInput == null)
				{
					r_PtextInput = new(this, "textInput", -1);
					r_PtextInput.SetBelong(this.GetValue());
				}
				return r_PtextInput;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextInputBaseField<Hvak.Editor.Refleaction.RProperty>.RTextInputBase RPtextInputBase
		{
			get
			{
				if(r_PtextInputBase == null)
				{
					...
					r_PtextInputBase.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RVector2 RPcursorPosition
		{
			get
			{
				if(r_PcursorPosition == null)
				{
					...
					r_PcursorPosition.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPselectAllOnFocus
		{
			get
			{
				if(r_PselectAllOnFocus == null)
				{
					...
					r_PselectAllOnFocus.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPselectAllOnMouseUp
		{
			get
			{
				if(r_PselectAllOnMouseUp == null)
				{
					...
					r_PselectAllOnMouseUp.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMValueToString_String
		{
			get
			{
				if(r_MValueToString_String == null)
				{
					...
					r_MValueToString_String.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMValidatedValue_String
		{
			get
			{
				if(r_MValidatedValue_String == null)
				{
					...
					r_MValidatedValue_String.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMSetValueWithoutValidation_String
		{
			get
			{
				if(r_MSetValueWithoutValidation_String == null)
				{
					...
					r_MSetValueWithoutValidation_String.SetBelong(this.GetValue());
				}
