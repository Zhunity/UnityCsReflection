    ...
    public partial class RDragState : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RDragEventsProcessor.RDragState RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragEventsProcessor+DragState"), "None");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RDragEventsProcessor.RDragState RFCanStartDrag
		{
			get
			{
				...
				{
					r_FCanStartDrag = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragEventsProcessor+DragState"), "CanStartDrag");
					r_FCanStartDrag.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RDragEventsProcessor.RDragState RFDragging
		{
			get
			{
				if(r_FDragging == null)
				{
					r_FDragging = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragEventsProcessor+DragState"), "Dragging");
					r_FDragging.SetBelong(null);
				}
				return r_FDragging;
			}
		}
