    ...
    public partial class RButton : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEngine.UIElements.Button), "ussClassName");
		...
		/// <summary>
		/// System.String NonEmptyString
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FNonEmptyString;
		public static Hvak.Editor.Refleaction.RSystem.RString RFNonEmptyString
		{
			get
			{
				if(r_FNonEmptyString == null)
				{
					r_FNonEmptyString = new(typeof(UnityEngine.UIElements.Button), "NonEmptyString");
					r_FNonEmptyString.SetBelong(null);
				}
				return r_FNonEmptyString;
			}
		}
		...
		public virtual RMethod RMOnNavigationSubmit_NavigationSubmitEvent
		{
			get
			{
				if(r_MOnNavigationSubmit_NavigationSubmitEvent == null)
				{
					...
					r_MOnNavigationSubmit_NavigationSubmitEvent.SetBelong(this.GetValue());
				}
