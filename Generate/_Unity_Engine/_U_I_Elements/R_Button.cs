...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RButton : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RString r_FNonEmptyString;
		public static SMFrame.Editor.Refleaction.RSystem.RString RFNonEmptyString
		{
			get
			{
		...
		public virtual RMethod RMOnNavigationSubmit_NavigationSubmitEvent
		{
			get
			{
				if(r_MOnNavigationSubmit_NavigationSubmitEvent == null)
				{
					...
					r_MOnNavigationSubmit_NavigationSubmitEvent.SetBelong(this.instance);
				}
