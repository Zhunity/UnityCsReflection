...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RScroller : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(UnityEngine.UIElements.Scroller);
            }
        }
		...
		public virtual RMethod RMOnSliderValueChange_ChangeEvent_d_Single_p_
		{
			get
			{
				...
				{
					r_MOnSliderValueChange_ChangeEvent_d_Single_p_ = new(this, "OnSliderValueChange", 0,  ReflectionUtils.GetType("UnityEngine.UIElements.ChangeEvent`1").MakeGenericType(typeof(System.Single)));
				}
