    ...
    public partial class RScroller : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFsliderUssClassName
		{
			get
			{
				...
				{
					r_FsliderUssClassName = new(Type, "sliderUssClassName");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFlowButtonUssClassName
		{
			get
			{
				...
				{
					r_FlowButtonUssClassName = new(Type, "lowButtonUssClassName");
				}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFhighButtonUssClassName
		{
			get
			{
				...
				{
					r_FhighButtonUssClassName = new(Type, "highButtonUssClassName");
				}
