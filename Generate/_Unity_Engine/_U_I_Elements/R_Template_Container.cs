...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RTemplateContainer : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_F__0__templateId__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RF__0__templateId__1__k__BackingField
		{
			get
			{
				if(r_F__0__templateId__1__k__BackingField == null)
				{
					r_F__0__templateId__1__k__BackingField = new(this, "<templateId>k__BackingField");
					r_F__0__templateId__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__templateId__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualTreeAsset r_Fm_TemplateSource;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualTreeAsset RFm_TemplateSource
		{
			get
			{
				if(r_Fm_TemplateSource == null)
				{
					r_Fm_TemplateSource = new(this, "m_TemplateSource");
					r_Fm_TemplateSource.SetBelong(this.GetValue());
				}
				return r_Fm_TemplateSource;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_PtemplateId;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RPtemplateId
		{
			get
			{
				if(r_PtemplateId == null)
				{
					r_PtemplateId = new(this, "templateId", -1);
					r_PtemplateId.SetBelong(this.GetValue());
				}
				return r_PtemplateId;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.VisualTreeAsset templateSource
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualTreeAsset r_PtemplateSource;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualTreeAsset RPtemplateSource
		{
			get
			{
				if(r_PtemplateSource == null)
				{
					r_PtemplateSource = new(this, "templateSource", -1);
					r_PtemplateSource.SetBelong(this.GetValue());
				}
				return r_PtemplateSource;
			}
		}
		...
		/// <summary>
		/// Void SetContentContainer(UnityEngine.UIElements.VisualElement)
		/// </summary>
		protected RMethod r_MSetContentContainer_VisualElement;
		public virtual RMethod RMSetContentContainer_VisualElement
		{
			get
			{
				if(r_MSetContentContainer_VisualElement == null)
				{
					r_MSetContentContainer_VisualElement = new(this, "SetContentContainer", 0, typeof(UnityEngine.UIElements.VisualElement));
					r_MSetContentContainer_VisualElement.SetBelong(this.GetValue());
				}
				return r_MSetContentContainer_VisualElement;
			}
		}
        ...
        public virtual void SetContentContainer(UnityEngine.UIElements.VisualElement @content)
        {
            ...
            var ___result = RMSetContentContainer_VisualElement.Invoke(___genericsType, ___parameters);
