...
{public partial class RTextField
{
    ...
    public partial class RTextInput : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_PparentTextField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RPparentTextField
		{
			get
			{
				if(r_PparentTextField == null)
				{
					r_PparentTextField = new(this, "parentTextField", -1);
					r_PparentTextField.SetBelong(this.GetValue());
				}
				return r_PparentTextField;
			}
		}
		...
		public virtual RMethod RMget_isPasswordField
		{
			get
			{
				if(r_Mget_isPasswordField == null)
				{
					r_Mget_isPasswordField = new(this, "get_isPasswordField", 0);
					r_Mget_isPasswordField.SetBelong(this.GetValue());
				}
        ...
        public virtual System.Boolean get_isPasswordField()
        {
            ...
            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{};
            var ___result = RMget_isPasswordField.Invoke(___genericsType, ___parameters);
