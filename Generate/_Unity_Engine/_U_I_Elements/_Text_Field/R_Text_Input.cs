...
{public partial class RTextField
{
    ...
    public partial class RTextInput : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextField r_PparentTextField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextField RPparentTextField
		{
			get
			{
				if(r_PparentTextField == null)
				{
					...
					r_PparentTextField.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMget_isPasswordField
		{
			get
			{
				if(r_Mget_isPasswordField == null)
				{
					...
					r_Mget_isPasswordField.SetBelong(this.instance);
				}
