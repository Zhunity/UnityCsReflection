...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RDragVisualMode : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEngine.UIElements.DragVisualMode");
            }
        }

        public RDragVisualMode() : base("UnityEngine.UIElements.DragVisualMode")
        {
        }

        public RDragVisualMode(System.Object instance) : base("UnityEngine.UIElements.DragVisualMode")
		{
            SetInstance(instance);
		}

        public RDragVisualMode(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RDragVisualMode(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDragVisualMode RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragVisualMode"), "None");
				}
				return r_FNone;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDragVisualMode RFCopy
		{
			get
			{
				if(r_FCopy == null)
				{
					r_FCopy = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragVisualMode"), "Copy");
				}
				return r_FCopy;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDragVisualMode RFMove
		{
			get
			{
				if(r_FMove == null)
				{
					r_FMove = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragVisualMode"), "Move");
				}
				return r_FMove;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RDragVisualMode RFRejected
		{
			get
			{
				if(r_FRejected == null)
				{
					r_FRejected = new( ReflectionUtils.GetType("UnityEngine.UIElements.DragVisualMode"), "Rejected");
				}
				return r_FRejected;
			}
		}
