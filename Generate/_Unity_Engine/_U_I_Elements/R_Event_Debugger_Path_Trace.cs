...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class REventDebuggerPathTrace : RMember //
    {

		/// <summary>
		/// UnityEngine.UIElements.PropagationPaths <paths>k__BackingField
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RPropagationPaths r_F__0__paths__1__k__BackingField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RPropagationPaths RF__0__paths__1__k__BackingField
		{
			get
			{
				if(r_F__0__paths__1__k__BackingField == null)
				{
					r_F__0__paths__1__k__BackingField = new(this, "<paths>k__BackingField");
					r_F__0__paths__1__k__BackingField.SetBelong(this.instance);
				}
				return r_F__0__paths__1__k__BackingField;
			}
		}

		/// <summary>
		/// UnityEngine.UIElements.PropagationPaths paths
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RPropagationPaths r_Ppaths;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RPropagationPaths RPpaths
		{
			get
			{
				if(r_Ppaths == null)
				{
					r_Ppaths = new(this, "paths", -1);
					r_Ppaths.SetBelong(this.instance);
				}
				return r_Ppaths;
			}
		}
        ...
        public REventDebuggerPathTrace() : base("UnityEngine.UIElements.EventDebuggerPathTrace")
        {
        }

        public REventDebuggerPathTrace(System.Object instance) : base("UnityEngine.UIElements.EventDebuggerPathTrace")
		{
            SetInstance(instance);
		}

        public REventDebuggerPathTrace(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public REventDebuggerPathTrace(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
