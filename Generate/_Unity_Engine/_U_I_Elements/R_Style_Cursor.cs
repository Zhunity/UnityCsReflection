    ...
    public partial class RStyleCursor : RMember //
    {
		...
		public static RMethod RMop_Equality_StyleCursor_StyleCursor
		{
			get
			{
				...
				{
					r_Mop_Equality_StyleCursor_StyleCursor = new(Type, "op_Equality", 0, typeof(UnityEngine.UIElements.StyleCursor), typeof(UnityEngine.UIElements.StyleCursor));
				}
		...
		public static RMethod RMop_Inequality_StyleCursor_StyleCursor
		{
			get
			{
				...
				{
					r_Mop_Inequality_StyleCursor_StyleCursor = new(Type, "op_Inequality", 0, typeof(UnityEngine.UIElements.StyleCursor), typeof(UnityEngine.UIElements.StyleCursor));
				}
		...
		public static RMethod RMop_Implicit_Cursor
		{
			get
			{
				...
				{
					r_Mop_Implicit_Cursor = new(Type, "op_Implicit", 0, typeof(UnityEngine.UIElements.Cursor));
				}
        ...
        public static UnityEngine.UIElements.StyleCursor op_Implicit(UnityEngine.UIElements.StyleKeyword @keyword)
        {
            ...
            return ReflectionUtils.Convert<UnityEngine.UIElements.StyleCursor>(___result);
        }
