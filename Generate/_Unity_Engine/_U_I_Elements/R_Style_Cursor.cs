...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleCursor : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RCursor r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RCursor RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RCursor r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RCursor RPvalue
		{
			get
			{
				if(r_Pvalue == null)
