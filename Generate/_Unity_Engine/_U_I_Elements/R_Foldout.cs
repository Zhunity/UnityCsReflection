    ...
    public partial class RFoldout : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEngine.UIElements.Foldout), "ussClassName");
		...
		/// <summary>
		/// System.String toggleUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FtoggleUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFtoggleUssClassName
		{
			get
			{
				if(r_FtoggleUssClassName == null)
				{
					r_FtoggleUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "toggleUssClassName");
					r_FtoggleUssClassName.SetBelong(null);
				}
				return r_FtoggleUssClassName;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFcontentUssClassName
		{
			get
			{
				...
				{
					r_FcontentUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "contentUssClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFinputUssClassName
		{
			get
			{
				...
				{
					r_FinputUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "inputUssClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFcheckmarkUssClassName
		{
			get
			{
				...
				{
					r_FcheckmarkUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "checkmarkUssClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFtextUssClassName
		{
			get
			{
				...
				{
					r_FtextUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "textUssClassName");
		...
		/// <summary>
		/// System.String toggleInspectorUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FtoggleInspectorUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFtoggleInspectorUssClassName
		{
			get
			{
				if(r_FtoggleInspectorUssClassName == null)
				{
					r_FtoggleInspectorUssClassName = new(typeof(UnityEngine.UIElements.Foldout), "toggleInspectorUssClassName");
					r_FtoggleInspectorUssClassName.SetBelong(null);
				}
				return r_FtoggleInspectorUssClassName;
			}
		}

		/// <summary>
		/// System.String ussFoldoutDepthClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FussFoldoutDepthClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFussFoldoutDepthClassName
		{
			get
			{
				if(r_FussFoldoutDepthClassName == null)
				{
					r_FussFoldoutDepthClassName = new(typeof(UnityEngine.UIElements.Foldout), "ussFoldoutDepthClassName");
					r_FussFoldoutDepthClassName.SetBelong(null);
				}
				return r_FussFoldoutDepthClassName;
			}
		}

		/// <summary>
		/// System.Int32 ussFoldoutMaxDepth
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RInt32 r_FussFoldoutMaxDepth;
		public static Hvak.Editor.Refleaction.RSystem.RInt32 RFussFoldoutMaxDepth
		{
			get
			{
				if(r_FussFoldoutMaxDepth == null)
				{
					r_FussFoldoutMaxDepth = new(typeof(UnityEngine.UIElements.Foldout), "ussFoldoutMaxDepth");
					r_FussFoldoutMaxDepth.SetBelong(null);
				}
				return r_FussFoldoutMaxDepth;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle r_Ptoggle;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RToggle RPtoggle
		{
			get
			{
				if(r_Ptoggle == null)
				{
					r_Ptoggle = new(this, "toggle", -1);
					r_Ptoggle.SetBelong(this.GetValue());
				}
				return r_Ptoggle;
			}
		}
		...
		/// <summary>
		/// Void <.ctor>b__26_0(UnityEngine.UIElements.ChangeEvent`1[System.Boolean])
		/// </summary>
		protected RMethod r_M__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_;
		public virtual RMethod RM__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_
		{
			get
			{
				if(r_M__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_ == null)
				{
					r_M__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_ = new(this, "<.ctor>b__26_0", 0, typeof(UnityEngine.UIElements.ChangeEvent<>).MakeGenericType(typeof(System.Boolean)));
					r_M__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_.SetBelong(this.GetValue());
				}
				return r_M__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_;
			}
		}
        ...
        public virtual void __0____2__ctor__1__b__26_0(UnityEngine.UIElements.ChangeEvent<System.Boolean> @evt)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@evt};
            var ___result = RM__0____2__ctor__1__b__26_0_ChangeEvent_d_Boolean_p_.Invoke(___genericsType, ___parameters);
