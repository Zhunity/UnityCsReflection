...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RPointerMoveEvent : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_F__0__isHandledByDraggable__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RF__0__isHandledByDraggable__1__k__BackingField
		{
			get
			{
				if(r_F__0__isHandledByDraggable__1__k__BackingField == null)
				{
					r_F__0__isHandledByDraggable__1__k__BackingField = new(this, "<isHandledByDraggable>k__BackingField");
					r_F__0__isHandledByDraggable__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__isHandledByDraggable__1__k__BackingField;
			}
		}

		/// <summary>
		/// Boolean isHandledByDraggable
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_PisHandledByDraggable;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPisHandledByDraggable
		{
			get
			{
				if(r_PisHandledByDraggable == null)
				{
					r_PisHandledByDraggable = new(this, "isHandledByDraggable", -1);
					r_PisHandledByDraggable.SetBelong(this.GetValue());
				}
				return r_PisHandledByDraggable;
			}
		}
