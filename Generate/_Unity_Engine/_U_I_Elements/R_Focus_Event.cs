...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RFocusEvent : RMember //
    {

		/// <summary>
		/// UnityEngine.UIElements.Focusable relatedTarget
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RFocusable r_PrelatedTarget;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RFocusable RPrelatedTarget
		{
			get
			{
				if(r_PrelatedTarget == null)
				{
					r_PrelatedTarget = new(this, "relatedTarget", -1);
					r_PrelatedTarget.SetBelong(this.GetValue());
				}
				return r_PrelatedTarget;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RFocusChangeDirection r_Pdirection;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RFocusChangeDirection RPdirection
		{
			get
			{
		...
		/// <summary>
		/// Boolean IsFocusDelegated
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RBoolean r_PIsFocusDelegated;
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPIsFocusDelegated
		{
			get
			{
				if(r_PIsFocusDelegated == null)
				{
					r_PIsFocusDelegated = new(this, "IsFocusDelegated", -1);
					r_PIsFocusDelegated.SetBelong(this.GetValue());
				}
				return r_PIsFocusDelegated;
			}
		}
        ...
        public RFocusEvent() : base("UnityEngine.UIElements.FocusEvent")
        {
        }

        public RFocusEvent(System.Object instance) : base("UnityEngine.UIElements.FocusEvent")
		{
            SetInstance(instance);
		}

        public RFocusEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RFocusEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
