...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class REventCallback<TEventType, TCallbackArgs> : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEngine.UIElements.EventCallback`2").MakeGenericType(ReflectionUtils.GetType(typeof(TEventType)), ReflectionUtils.GetType(typeof(TCallbackArgs)));
            }
        }
