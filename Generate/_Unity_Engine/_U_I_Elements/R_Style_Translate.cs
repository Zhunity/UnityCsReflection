...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleTranslate : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTranslate r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTranslate RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTranslate r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTranslate RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public virtual RMethod RMEquals_StyleTranslate
		{
			get
			{
				if(r_MEquals_StyleTranslate == null)
				{
					...
					r_MEquals_StyleTranslate.SetBelong(this.instance);
				}
