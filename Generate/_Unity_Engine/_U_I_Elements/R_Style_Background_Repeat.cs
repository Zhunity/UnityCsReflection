...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleBackgroundRepeat : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundRepeat r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundRepeat RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundRepeat r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RBackgroundRepeat RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public static RMethod RMop_Equality_StyleBackgroundRepeat_StyleBackgroundRepeat
		{
			get
			{
				if(r_Mop_Equality_StyleBackgroundRepeat_StyleBackgroundRepeat == null)
				{
					...
					r_Mop_Equality_StyleBackgroundRepeat_StyleBackgroundRepeat.SetBelong(null);
				}
		...
		public static RMethod RMop_Inequality_StyleBackgroundRepeat_StyleBackgroundRepeat
		{
			get
			{
				if(r_Mop_Inequality_StyleBackgroundRepeat_StyleBackgroundRepeat == null)
				{
					...
					r_Mop_Inequality_StyleBackgroundRepeat_StyleBackgroundRepeat.SetBelong(null);
				}
		...
		public static RMethod RMop_Implicit_BackgroundRepeat
		{
			get
			{
				if(r_Mop_Implicit_BackgroundRepeat == null)
				{
					...
					r_Mop_Implicit_BackgroundRepeat.SetBelong(null);
				}
		...
		public virtual RMethod RMEquals_StyleBackgroundRepeat
		{
			get
			{
				if(r_MEquals_StyleBackgroundRepeat == null)
				{
					...
					r_MEquals_StyleBackgroundRepeat.SetBelong(this.instance);
				}
