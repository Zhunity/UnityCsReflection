...
{public partial class RMeshGenerationContextUtils
{
    ...
    public partial class RBorderParams : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RColor RFleftColor
		{
			get
			{
				if(r_FleftColor == null)
				{
					...
					r_FleftColor.SetBelong(this.GetValue());
				}
				return r_FleftColor;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RColor RFtopColor
		{
			get
			{
				if(r_FtopColor == null)
				{
					...
					r_FtopColor.SetBelong(this.GetValue());
				}
				return r_FtopColor;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RColor RFrightColor
		{
			get
			{
				if(r_FrightColor == null)
				{
					...
					r_FrightColor.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RColor RFbottomColor
		{
			get
			{
				if(r_FbottomColor == null)
				{
					...
					r_FbottomColor.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFleftWidth
		{
			get
			{
				if(r_FleftWidth == null)
				{
					...
					r_FleftWidth.SetBelong(this.GetValue());
				}
				return r_FleftWidth;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFtopWidth
		{
			get
			{
				if(r_FtopWidth == null)
				{
					...
					r_FtopWidth.SetBelong(this.GetValue());
				}
				return r_FtopWidth;
			}
		}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFrightWidth
		{
			get
			{
				if(r_FrightWidth == null)
				{
					...
					r_FrightWidth.SetBelong(this.GetValue());
				}
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RSingle RFbottomWidth
		{
			get
			{
				if(r_FbottomWidth == null)
				{
					...
					r_FbottomWidth.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage r_FleftColorPage;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage RFleftColorPage
		{
			get
			{
				if(r_FleftColorPage == null)
				{
					...
					r_FleftColorPage.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage r_FtopColorPage;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage RFtopColorPage
		{
			get
			{
				if(r_FtopColorPage == null)
				{
					...
					r_FtopColorPage.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage r_FrightColorPage;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage RFrightColorPage
		{
			get
			{
				if(r_FrightColorPage == null)
				{
					...
					r_FrightColorPage.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage r_FbottomColorPage;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RColorPage RFbottomColorPage
		{
			get
			{
				if(r_FbottomColorPage == null)
				{
					...
					r_FbottomColorPage.SetBelong(this.GetValue());
				}
		...
		public virtual RMethod RMToNativeParams
		{
			get
			{
				if(r_MToNativeParams == null)
				{
					...
					r_MToNativeParams.SetBelong(this.GetValue());
				}
        ...
        public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RMeshBuilderNative.RNativeBorderParams ToNativeParams()
        {
            ...
            return new Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RMeshBuilderNative.RNativeBorderParams(___result);
        }
