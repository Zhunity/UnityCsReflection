    ...
    public partial class RCustomStyleAccess : RMember //
    {
		...
		public virtual RMethod RMSetContext_Dictionary_d_String_StylePropertyValue_p__Single
		{
			get
			{
				...
				{
					r_MSetContext_Dictionary_d_String_StylePropertyValue_p__Single = new(this, "SetContext", 0,  ReflectionUtils.GetType("System.Collections.Generic.Dictionary`2").MakeGenericType(typeof(System.String),  ReflectionUtils.GetType("UnityEngine.UIElements.StyleSheets.StylePropertyValue")), typeof(System.Single));
				}
		...
		public static RMethod RMLogCustomPropertyWarning_String_StyleValueType_StylePropertyValue
		{
			get
			{
				...
				{
					r_MLogCustomPropertyWarning_String_StyleValueType_StylePropertyValue = new(Type, "LogCustomPropertyWarning", 0, typeof(System.String),  ReflectionUtils.GetType("UnityEngine.UIElements.StyleValueType"),  ReflectionUtils.GetType("UnityEngine.UIElements.StyleSheets.StylePropertyValue"));
				}
