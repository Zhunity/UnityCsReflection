...
{public partial class RStylePropertyReader
{
	
	/// <summary>
	/// UnityEngine.UIElements.StyleSheets.StylePropertyReader+GetCursorIdFunction
	/// </summary>
    public partial class RGetCursorIdFunction : RMember //
    {
		...
		/// <summary>
		/// Int32 Invoke(UnityEngine.UIElements.StyleSheet, UnityEngine.UIElements.StyleValueHandle)
		/// </summary>
		protected RMethod r_MInvoke_StyleSheet_StyleValueHandle;
		public virtual RMethod RMInvoke_StyleSheet_StyleValueHandle
		{
			get
			{
				if(r_MInvoke_StyleSheet_StyleValueHandle == null)
				{
					r_MInvoke_StyleSheet_StyleValueHandle = new(this, "Invoke", 0, typeof(UnityEngine.UIElements.StyleSheet),  ReflectionUtils.GetType("UnityEngine.UIElements.StyleValueHandle"));
					r_MInvoke_StyleSheet_StyleValueHandle.SetBelong(this.GetValue());
				}
				return r_MInvoke_StyleSheet_StyleValueHandle;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.UIElements.StyleSheet, UnityEngine.UIElements.StyleValueHandle, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.UIElements.StyleSheet),  ReflectionUtils.GetType("UnityEngine.UIElements.StyleValueHandle"), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object;
			}
		}
        ...
        public RGetCursorIdFunction() : base("UnityEngine.UIElements.StyleSheets.StylePropertyReader+GetCursorIdFunction")
        {
        }

        public RGetCursorIdFunction(System.Object instance) : base("UnityEngine.UIElements.StyleSheets.StylePropertyReader+GetCursorIdFunction")
		{
            SetInstance(instance);
		}

        public RGetCursorIdFunction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RGetCursorIdFunction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Int32 Invoke(UnityEngine.UIElements.StyleSheet @sheet, Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleValueHandle @handle)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sheet, @handle.Value};
            var ___result = RMInvoke_StyleSheet_StyleValueHandle.Invoke(___genericsType, ___parameters);

            return (System.Int32)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.UIElements.StyleSheet @sheet, Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RStyleValueHandle @handle, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@sheet, @handle.Value, @callback, @object};
            var ___result = RMBeginInvoke_StyleSheet_StyleValueHandle_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
