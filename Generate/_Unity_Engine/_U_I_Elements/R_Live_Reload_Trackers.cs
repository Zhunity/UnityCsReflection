...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RLiveReloadTrackers : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLiveReloadTrackers r_FDocument;
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLiveReloadTrackers RFDocument
		{
			get
			{
				if(r_FDocument == null)
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLiveReloadTrackers r_FText;
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RLiveReloadTrackers RFText
		{
			get
			{
				if(r_FText == null)
