...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RKeyDownEvent : RMember //
    {
		...
		public virtual Hvak.Editor.Refleaction.RSystem.RBoolean RPfunctionKey
		{
			get
			{
				if(r_PfunctionKey == null)
				{
					...
					r_PfunctionKey.SetBelong(this.GetValue());
				}
		...
		/// </summary>
		protected RMethod r_MGetEquivalentImguiEvent_Event;
		public virtual RMethod RMGetEquivalentImguiEvent_Event
		{
			get
			{
				if(r_MGetEquivalentImguiEvent_Event == null)
				{
					r_MGetEquivalentImguiEvent_Event = new(this, "GetEquivalentImguiEvent", 0, typeof(UnityEngine.Event));
					r_MGetEquivalentImguiEvent_Event.SetBelong(this.GetValue());
				}
				return r_MGetEquivalentImguiEvent_Event;
			}
		}
		...
		public virtual RMethod RMSendEquivalentNavigationEventIfAny_IPanel
		{
			get
			{
				if(r_MSendEquivalentNavigationEventIfAny_IPanel == null)
				{
					...
					r_MSendEquivalentNavigationEventIfAny_IPanel.SetBelong(this.GetValue());
				}
        ...
        public virtual void GetEquivalentImguiEvent(UnityEngine.Event @outImguiEvent)
        {
            ...
            var ___result = RMGetEquivalentImguiEvent_Event.Invoke(___genericsType, ___parameters);
