...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class ROpacityIdAccelerator : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_Fk_VerticesPerBatch;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RFk_VerticesPerBatch
		{
			get
			{
				if(r_Fk_VerticesPerBatch == null)
				{
					r_Fk_VerticesPerBatch = new( ReflectionUtils.GetType("UnityEngine.UIElements.UIR.OpacityIdAccelerator"), "k_VerticesPerBatch");
					r_Fk_VerticesPerBatch.SetBelong(null);
				}
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_Fk_JobLimit;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RFk_JobLimit
		{
			get
			{
				if(r_Fk_JobLimit == null)
				{
					r_Fk_JobLimit = new( ReflectionUtils.GetType("UnityEngine.UIElements.UIR.OpacityIdAccelerator"), "k_JobLimit");
					r_Fk_JobLimit.SetBelong(null);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeArray<SMFrame.Editor.Refleaction.RUnity.RJobs.RJobHandle> r_Fm_Jobs;
		public virtual SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeArray<SMFrame.Editor.Refleaction.RUnity.RJobs.RJobHandle> RFm_Jobs
		{
			get
			{
				if(r_Fm_Jobs == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RInt32 r_Fm_NextJobIndex;
		public virtual SMFrame.Editor.Refleaction.RSystem.RInt32 RFm_NextJobIndex
		{
			get
			{
				if(r_Fm_NextJobIndex == null)
				{
					...
					r_Fm_NextJobIndex.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMCreateJob_NativeSlice_d_Vertex_p__NativeSlice_d_Vertex_p__Color32_Int32
		{
			get
			{
				if(r_MCreateJob_NativeSlice_d_Vertex_p__NativeSlice_d_Vertex_p__Color32_Int32 == null)
				{
					...
					r_MCreateJob_NativeSlice_d_Vertex_p__NativeSlice_d_Vertex_p__Color32_Int32.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMCompleteJobs
		{
			get
			{
				if(r_MCompleteJobs == null)
				{
					...
					r_MCompleteJobs.SetBelong(this.instance);
				}
        ...
        public virtual void CreateJob(SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeSlice<SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVertex> @oldVerts, SMFrame.Editor.Refleaction.RUnity.RCollections.RNativeSlice<SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVertex> @newVerts, UnityEngine.Color32 @opacityData, System.Int32 @vertexCount)
        {
