...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RUIR
{
    ...
    public partial class RNativePagedList<T> : RMember // where T : struct
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEngine.UIElements.UIR.NativePagedList`1").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }
        ...
        public virtual Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnity.RCollections.RNativeSlice<Hvak.Editor.Refleaction.RType>> GetPages()
        {
            ...
            return ReflectionUtils.Convert<Hvak.Editor.Refleaction.RSystem.RCollections.RGeneric.RList<Hvak.Editor.Refleaction.RUnity.RCollections.RNativeSlice<Hvak.Editor.Refleaction.RType>>>(___result);
        }
