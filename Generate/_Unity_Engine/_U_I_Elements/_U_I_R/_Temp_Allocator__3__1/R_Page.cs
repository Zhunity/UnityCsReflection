...
{public partial class RTempAllocator<T>
{
    ...
    public partial class RPage : RMember //
    {
        public static Type Type
        {
            get
            {
                return  ReflectionUtils.GetType("UnityEngine.UIElements.UIR.TempAllocator`1+Page").MakeGenericType(ReflectionUtils.GetType(typeof(T)));
            }
        }

        public RPage() : base("UnityEngine.UIElements.UIR.TempAllocator`1+Page")
        {
        }

        public RPage(System.Object instance) : base("UnityEngine.UIElements.UIR.TempAllocator`1+Page")
		{
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnity.RCollections.RNativeArray<Hvak.Editor.Refleaction.RField> r_Farray;
		public virtual Hvak.Editor.Refleaction.RUnity.RCollections.RNativeArray<Hvak.Editor.Refleaction.RField> RFarray
		{
			get
			{
				if(r_Farray == null)
				{
					r_Farray = new(this, "array");
				}
				return r_Farray;
			}
		}
