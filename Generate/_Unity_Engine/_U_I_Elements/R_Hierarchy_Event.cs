...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RHierarchyEvent : RMember //
    {
		...
		/// <summary>
		/// Void Invoke(UnityEngine.UIElements.VisualElement, UnityEngine.UIElements.HierarchyChangeType)
		/// </summary>
		protected RMethod r_MInvoke_VisualElement_HierarchyChangeType;
		public virtual RMethod RMInvoke_VisualElement_HierarchyChangeType
		{
			get
			{
				if(r_MInvoke_VisualElement_HierarchyChangeType == null)
				{
					r_MInvoke_VisualElement_HierarchyChangeType = new(this, "Invoke", 0, typeof(UnityEngine.UIElements.VisualElement),  ReflectionUtils.GetType("UnityEngine.UIElements.HierarchyChangeType"));
					r_MInvoke_VisualElement_HierarchyChangeType.SetBelong(this.GetValue());
				}
				return r_MInvoke_VisualElement_HierarchyChangeType;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.UIElements.VisualElement, UnityEngine.UIElements.HierarchyChangeType, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object = new(this, "BeginInvoke", 0, typeof(UnityEngine.UIElements.VisualElement),  ReflectionUtils.GetType("UnityEngine.UIElements.HierarchyChangeType"), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object;
			}
		}
        ...
        public RHierarchyEvent() : base("UnityEngine.UIElements.HierarchyEvent")
        {
        }

        public RHierarchyEvent(System.Object instance) : base("UnityEngine.UIElements.HierarchyEvent")
		{
            SetInstance(instance);
		}

        public RHierarchyEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHierarchyEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual void Invoke(UnityEngine.UIElements.VisualElement @ve, Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHierarchyChangeType @changeType)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ve, @changeType.Value};
            var ___result = RMInvoke_VisualElement_HierarchyChangeType.Invoke(___genericsType, ___parameters);

            
        }


        public virtual System.IAsyncResult BeginInvoke(UnityEngine.UIElements.VisualElement @ve, Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHierarchyChangeType @changeType, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@ve, @changeType.Value, @callback, @object};
            var ___result = RMBeginInvoke_VisualElement_HierarchyChangeType_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
