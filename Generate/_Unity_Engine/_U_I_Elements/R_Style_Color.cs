...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleColor : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RColor r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RColor RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RColor r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RColor RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public virtual RMethod RMEquals_StyleColor
		{
			get
			{
				if(r_MEquals_StyleColor == null)
				{
					...
					r_MEquals_StyleColor.SetBelong(this.instance);
				}
