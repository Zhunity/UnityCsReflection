...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RAttachToPanelEvent : RMember //
    {

		/// <summary>
		/// UnityEngine.UIElements.IPanel originPanel
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel r_PoriginPanel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel RPoriginPanel
		{
			get
			{
				if(r_PoriginPanel == null)
				{
					r_PoriginPanel = new(this, "originPanel", -1);
					r_PoriginPanel.SetBelong(this.GetValue());
				}
				return r_PoriginPanel;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel r_PdestinationPanel;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel RPdestinationPanel
		{
			get
			{
				if(r_PdestinationPanel == null)
				{
					r_PdestinationPanel = new(this, "destinationPanel", -1);
					r_PdestinationPanel.SetBelong(this.GetValue());
				}
				return r_PdestinationPanel;
			}
		}
        ...
        public RAttachToPanelEvent() : base("UnityEngine.UIElements.AttachToPanelEvent")
        {
        }

        public RAttachToPanelEvent(System.Object instance) : base("UnityEngine.UIElements.AttachToPanelEvent")
		{
            SetInstance(instance);
		}

        public RAttachToPanelEvent(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RAttachToPanelEvent(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
