...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RAttachToPanelEvent : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel r_PoriginPanel;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel RPoriginPanel
		{
			get
			{
				if(r_PoriginPanel == null)
				{
					...
					r_PoriginPanel.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel r_PdestinationPanel;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RIPanel RPdestinationPanel
		{
			get
			{
				if(r_PdestinationPanel == null)
				{
					...
					r_PdestinationPanel.SetBelong(this.instance);
				}
