...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RReusableListViewItem : RMember //
    {
		...
		public virtual REvent REonGeometryChanged
		{
			get
			{
				if(r_EonGeometryChanged == null)
				{
					...
					r_EonGeometryChanged.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_DragHandle;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_DragHandle
		{
			get
			{
				if(r_Fm_DragHandle == null)
				{
					...
					r_Fm_DragHandle.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_ItemContainer;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_ItemContainer
		{
			get
			{
				if(r_Fm_ItemContainer == null)
				{
					...
					r_Fm_ItemContainer.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventCallback<SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RGeometryChangedEvent> RFm_GeometryChangedEventCallback
		{
			get
			{
				if(r_Fm_GeometryChangedEventCallback == null)
				{
					...
					r_Fm_GeometryChangedEventCallback.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RProotElement
		{
			get
			{
				if(r_ProotElement == null)
				{
					...
					r_ProotElement.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RPbindableElement
		{
			get
			{
				if(r_PbindableElement == null)
				{
					...
					r_PbindableElement.SetBelong(this.instance);
				}
		...
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RExperimental.RValueAnimation<SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RExperimental.RStyleValues> RPanimator
		{
			get
			{
				if(r_Panimator == null)
				{
					...
					r_Panimator.SetBelong(this.instance);
				}
				return r_Panimator;
			}
		}
		...
		public virtual SMFrame.Editor.Refleaction.RSystem.RBoolean RPisDragGhost
		{
			get
			{
				if(r_PisDragGhost == null)
				{
					...
					r_PisDragGhost.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMInit_VisualElement_Boolean
		{
			get
			{
				if(r_MInit_VisualElement_Boolean == null)
				{
					...
					r_MInit_VisualElement_Boolean.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMUpdateHierarchy_VisualElement_VisualElement_Boolean
		{
			get
			{
				if(r_MUpdateHierarchy_VisualElement_VisualElement_Boolean == null)
				{
					...
					r_MUpdateHierarchy_VisualElement_VisualElement_Boolean.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMUpdateDragHandle_Boolean
		{
			get
			{
				if(r_MUpdateDragHandle_Boolean == null)
				{
					...
					r_MUpdateDragHandle_Boolean.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMPreAttachElement
		{
			get
			{
				if(r_MPreAttachElement == null)
				{
					...
					r_MPreAttachElement.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMDetachElement
		{
			get
			{
				if(r_MDetachElement == null)
				{
					...
					r_MDetachElement.SetBelong(this.instance);
				}
		...
		public virtual RMethod RMInit_VisualElement
		{
			get
			{
				if(r_MInit_VisualElement == null)
				{
					...
					r_MInit_VisualElement.SetBelong(this.instance);
				}
