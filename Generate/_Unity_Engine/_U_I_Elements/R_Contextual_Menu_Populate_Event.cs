...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RContextualMenuPopulateEvent : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventBase r_F__0__triggerEvent__1__k__BackingField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventBase RF__0__triggerEvent__1__k__BackingField
		{
			get
			{
				if(r_F__0__triggerEvent__1__k__BackingField == null)
				{
					...
					r_F__0__triggerEvent__1__k__BackingField.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RContextualMenuManager r_Fm_ContextualMenuManager;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RContextualMenuManager RFm_ContextualMenuManager
		{
			get
			{
				if(r_Fm_ContextualMenuManager == null)
				{
					...
					r_Fm_ContextualMenuManager.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventBase r_PtriggerEvent;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.REventBase RPtriggerEvent
		{
			get
			{
				if(r_PtriggerEvent == null)
				{
					...
					r_PtriggerEvent.SetBelong(this.instance);
				}
