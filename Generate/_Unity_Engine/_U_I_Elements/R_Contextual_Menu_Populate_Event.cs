...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RContextualMenuPopulateEvent : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.UIElements.EventBase <triggerEvent>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventBase r_F__0__triggerEvent__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventBase RF__0__triggerEvent__1__k__BackingField
		{
			get
			{
				if(r_F__0__triggerEvent__1__k__BackingField == null)
				{
					r_F__0__triggerEvent__1__k__BackingField = new(this, "<triggerEvent>k__BackingField");
					r_F__0__triggerEvent__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__triggerEvent__1__k__BackingField;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RContextualMenuManager r_Fm_ContextualMenuManager;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RContextualMenuManager RFm_ContextualMenuManager
		{
			get
			{
				if(r_Fm_ContextualMenuManager == null)
				{
					r_Fm_ContextualMenuManager = new(this, "m_ContextualMenuManager");
					r_Fm_ContextualMenuManager.SetBelong(this.GetValue());
				}
				return r_Fm_ContextualMenuManager;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventBase r_PtriggerEvent;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.REventBase RPtriggerEvent
		{
			get
			{
				if(r_PtriggerEvent == null)
				{
					r_PtriggerEvent = new(this, "triggerEvent", -1);
					r_PtriggerEvent.SetBelong(this.GetValue());
				}
				return r_PtriggerEvent;
			}
		}
		...
		/// <summary>
		/// UnityEngine.UIElements.ContextualMenuPopulateEvent GetPooled(UnityEngine.UIElements.EventBase, UnityEngine.UIElements.DropdownMenu, UnityEngine.UIElements.IEventHandler, UnityEngine.UIElements.ContextualMenuManager)
		/// </summary>
		protected static RMethod r_MGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager;
		public static RMethod RMGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager
		{
			get
			{
				if(r_MGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager == null)
				{
					...
					r_MGetPooled_EventBase_DropdownMenu_IEventHandler_ContextualMenuManager.SetBelong(null);
				}
