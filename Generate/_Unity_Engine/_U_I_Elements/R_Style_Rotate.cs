...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleRotate : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RRotate r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RRotate RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RRotate r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RRotate RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public static RMethod RMop_Equality_StyleRotate_StyleRotate
		{
			get
			{
				if(r_Mop_Equality_StyleRotate_StyleRotate == null)
				{
					...
					r_Mop_Equality_StyleRotate_StyleRotate.SetBelong(null);
				}
		...
		public static RMethod RMop_Inequality_StyleRotate_StyleRotate
		{
			get
			{
				if(r_Mop_Inequality_StyleRotate_StyleRotate == null)
				{
					...
					r_Mop_Inequality_StyleRotate_StyleRotate.SetBelong(null);
				}
		...
		public static RMethod RMop_Implicit_Rotate
		{
			get
			{
				if(r_Mop_Implicit_Rotate == null)
				{
					...
					r_Mop_Implicit_Rotate.SetBelong(null);
				}
		...
		public virtual RMethod RMEquals_StyleRotate
		{
			get
			{
				if(r_MEquals_StyleRotate == null)
				{
					...
					r_MEquals_StyleRotate.SetBelong(this.instance);
				}
