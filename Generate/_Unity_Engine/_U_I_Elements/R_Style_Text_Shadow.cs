...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RStyleTextShadow : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextShadow r_Fm_Value;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextShadow RFm_Value
		{
			get
			{
				if(r_Fm_Value == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextShadow r_Pvalue;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RTextShadow RPvalue
		{
			get
			{
				if(r_Pvalue == null)
		...
		public static RMethod RMop_Equality_StyleTextShadow_StyleTextShadow
		{
			get
			{
				if(r_Mop_Equality_StyleTextShadow_StyleTextShadow == null)
				{
					...
					r_Mop_Equality_StyleTextShadow_StyleTextShadow.SetBelong(null);
				}
		...
		public static RMethod RMop_Inequality_StyleTextShadow_StyleTextShadow
		{
			get
			{
				if(r_Mop_Inequality_StyleTextShadow_StyleTextShadow == null)
				{
					...
					r_Mop_Inequality_StyleTextShadow_StyleTextShadow.SetBelong(null);
				}
		...
		public static RMethod RMop_Implicit_TextShadow
		{
			get
			{
				if(r_Mop_Implicit_TextShadow == null)
				{
					...
					r_Mop_Implicit_TextShadow.SetBelong(null);
				}
		...
		public virtual RMethod RMEquals_StyleTextShadow
		{
			get
			{
				if(r_MEquals_StyleTextShadow == null)
				{
					...
					r_MEquals_StyleTextShadow.SetBelong(this.instance);
				}
