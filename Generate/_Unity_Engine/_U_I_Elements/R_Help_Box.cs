...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RHelpBox : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFussClassName
		{
			get
			{
				...
				{
					r_FussClassName = new(typeof(UnityEngine.UIElements.HelpBox), "ussClassName");
		...
		public static Hvak.Editor.Refleaction.RSystem.RString RFlabelUssClassName
		{
			get
			{
				...
				{
					r_FlabelUssClassName = new(typeof(UnityEngine.UIElements.HelpBox), "labelUssClassName");
		...
		/// <summary>
		/// System.String iconUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FiconUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFiconUssClassName
		{
			get
			{
				if(r_FiconUssClassName == null)
				{
					r_FiconUssClassName = new(typeof(UnityEngine.UIElements.HelpBox), "iconUssClassName");
					r_FiconUssClassName.SetBelong(null);
				}
				return r_FiconUssClassName;
			}
		}

		/// <summary>
		/// System.String iconInfoUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FiconInfoUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFiconInfoUssClassName
		{
			get
			{
				if(r_FiconInfoUssClassName == null)
				{
					r_FiconInfoUssClassName = new(typeof(UnityEngine.UIElements.HelpBox), "iconInfoUssClassName");
					r_FiconInfoUssClassName.SetBelong(null);
				}
				return r_FiconInfoUssClassName;
			}
		}

		/// <summary>
		/// System.String iconwarningUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FiconwarningUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFiconwarningUssClassName
		{
			get
			{
				if(r_FiconwarningUssClassName == null)
				{
					r_FiconwarningUssClassName = new(typeof(UnityEngine.UIElements.HelpBox), "iconwarningUssClassName");
					r_FiconwarningUssClassName.SetBelong(null);
				}
				return r_FiconwarningUssClassName;
			}
		}

		/// <summary>
		/// System.String iconErrorUssClassName
		/// </summary>
		protected static Hvak.Editor.Refleaction.RSystem.RString r_FiconErrorUssClassName;
		public static Hvak.Editor.Refleaction.RSystem.RString RFiconErrorUssClassName
		{
			get
			{
				if(r_FiconErrorUssClassName == null)
				{
					r_FiconErrorUssClassName = new(typeof(UnityEngine.UIElements.HelpBox), "iconErrorUssClassName");
					r_FiconErrorUssClassName.SetBelong(null);
				}
				return r_FiconErrorUssClassName;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType r_Fm_HelpBoxMessageType;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RFm_HelpBoxMessageType
		{
			get
			{
				if(r_Fm_HelpBoxMessageType == null)
				{
					r_Fm_HelpBoxMessageType = new(this, "m_HelpBoxMessageType");
					r_Fm_HelpBoxMessageType.SetBelong(this.GetValue());
				}
				return r_Fm_HelpBoxMessageType;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement r_Fm_Icon;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RVisualElement RFm_Icon
		{
			get
			{
				if(r_Fm_Icon == null)
				{
					r_Fm_Icon = new(this, "m_Icon");
					r_Fm_Icon.SetBelong(this.GetValue());
				}
				return r_Fm_Icon;
			}
		}
		...
		/// <summary>
		/// System.String m_IconClass
		/// </summary>
		protected Hvak.Editor.Refleaction.RSystem.RString r_Fm_IconClass;
		public virtual Hvak.Editor.Refleaction.RSystem.RString RFm_IconClass
		{
			get
			{
				if(r_Fm_IconClass == null)
				{
					r_Fm_IconClass = new(this, "m_IconClass");
					r_Fm_IconClass.SetBelong(this.GetValue());
				}
				return r_Fm_IconClass;
			}
		}
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType r_PmessageType;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RPmessageType
		{
			get
			{
				if(r_PmessageType == null)
				{
					r_PmessageType = new(this, "messageType", -1);
					r_PmessageType.SetBelong(this.GetValue());
				}
				return r_PmessageType;
			}
		}
		...
		/// <summary>
		/// System.String GetIconClass(UnityEngine.UIElements.HelpBoxMessageType)
		/// </summary>
		protected RMethod r_MGetIconClass_HelpBoxMessageType;
		public virtual RMethod RMGetIconClass_HelpBoxMessageType
		{
			get
			{
				if(r_MGetIconClass_HelpBoxMessageType == null)
				{
					r_MGetIconClass_HelpBoxMessageType = new(this, "GetIconClass", 0, typeof(UnityEngine.UIElements.HelpBoxMessageType));
					r_MGetIconClass_HelpBoxMessageType.SetBelong(this.GetValue());
				}
				return r_MGetIconClass_HelpBoxMessageType;
			}
		}

		/// <summary>
		/// Void UpdateIcon(UnityEngine.UIElements.HelpBoxMessageType)
		/// </summary>
		protected RMethod r_MUpdateIcon_HelpBoxMessageType;
		public virtual RMethod RMUpdateIcon_HelpBoxMessageType
		{
			get
			{
				if(r_MUpdateIcon_HelpBoxMessageType == null)
				{
					r_MUpdateIcon_HelpBoxMessageType = new(this, "UpdateIcon", 0, typeof(UnityEngine.UIElements.HelpBoxMessageType));
					r_MUpdateIcon_HelpBoxMessageType.SetBelong(this.GetValue());
				}
				return r_MUpdateIcon_HelpBoxMessageType;
			}
		}
        ...
        public RHelpBox() : base("UnityEngine.UIElements.HelpBox")
        {
        }

        public RHelpBox(System.Object instance) : base("UnityEngine.UIElements.HelpBox")
		{
            SetInstance(instance);
		}

        public RHelpBox(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHelpBox(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.String GetIconClass(UnityEngine.UIElements.HelpBoxMessageType @messageType)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@messageType};
            var ___result = RMGetIconClass_HelpBoxMessageType.Invoke(___genericsType, ___parameters);

            return (System.String)___result;
        }


        public virtual void UpdateIcon(UnityEngine.UIElements.HelpBoxMessageType @messageType)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@messageType};
            var ___result = RMUpdateIcon_HelpBoxMessageType.Invoke(___genericsType, ___parameters);
