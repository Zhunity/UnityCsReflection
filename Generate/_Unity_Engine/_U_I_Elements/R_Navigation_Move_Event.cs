...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RNavigationMoveEvent : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_F__0__direction__1__k__BackingField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RF__0__direction__1__k__BackingField
		{
			get
			{
				if(r_F__0__direction__1__k__BackingField == null)
				{
					...
					r_F__0__direction__1__k__BackingField.SetBelong(this.instance);
				}
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector2 r_F__0__move__1__k__BackingField;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector2 RF__0__move__1__k__BackingField
		{
			get
			{
				if(r_F__0__move__1__k__BackingField == null)
				{
					...
					r_F__0__move__1__k__BackingField.SetBelong(this.instance);
				}
		...
		/// Direction direction
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_Pdirection;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RPdirection
		{
			get
			{
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector2 r_Pmove;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector2 RPmove
		{
			get
			{
				if(r_Pmove == null)
				{
					...
					r_Pmove.SetBelong(this.instance);
				}
				return r_Pmove;
			}
		}
        ...
        public static SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection DetermineMoveDirection(System.Single @x, System.Single @y, System.Single @deadZone)
        {
            ...
            return new SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection(___result);
        }
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(UnityEngine.Vector2 @moveVector, SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationDeviceType @deviceType, UnityEngine.EventModifiers @modifiers)
        {
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection @direction, UnityEngine.EventModifiers @modifiers)
        {
        ...
        public static UnityEngine.UIElements.NavigationMoveEvent GetPooled(SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection @direction, SMFrame.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationDeviceType @deviceType, UnityEngine.EventModifiers @modifiers)
        {
