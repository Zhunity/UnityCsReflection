...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
    ...
    public partial class RNavigationMoveEvent : RMember //
    {
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_F__0__direction__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RF__0__direction__1__k__BackingField
		{
			get
			{
				if(r_F__0__direction__1__k__BackingField == null)
				{
					r_F__0__direction__1__k__BackingField = new(this, "<direction>k__BackingField");
					r_F__0__direction__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__direction__1__k__BackingField;
			}
		}

		/// <summary>
		/// UnityEngine.Vector2 <move>k__BackingField
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RVector2 r_F__0__move__1__k__BackingField;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RVector2 RF__0__move__1__k__BackingField
		{
			get
			{
				if(r_F__0__move__1__k__BackingField == null)
				{
					r_F__0__move__1__k__BackingField = new(this, "<move>k__BackingField");
					r_F__0__move__1__k__BackingField.SetBelong(this.GetValue());
				}
				return r_F__0__move__1__k__BackingField;
			}
		}
		...
		/// Direction direction
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection r_Pdirection;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RNavigationMoveEvent.RDirection RPdirection
		{
			get
			{
		...
		/// </summary>
		protected Hvak.Editor.Refleaction.RUnityEngine.RVector2 r_Pmove;
		public virtual Hvak.Editor.Refleaction.RUnityEngine.RVector2 RPmove
		{
			get
			{
				if(r_Pmove == null)
				{
					r_Pmove = new(this, "move", -1);
					r_Pmove.SetBelong(this.GetValue());
				}
				return r_Pmove;
			}
		}
		...
		/// <summary>
		/// Direction DetermineMoveDirection(Single, Single, Single)
		/// </summary>
		protected static RMethod r_MDetermineMoveDirection_Single_Single_Single;
		public static RMethod RMDetermineMoveDirection_Single_Single_Single
		{
			get
			{
				if(r_MDetermineMoveDirection_Single_Single_Single == null)
				{
					...
					r_MDetermineMoveDirection_Single_Single_Single.SetBelong(null);
				}
		...
		public static RMethod RMGetPooled_Vector2_EventModifiers
		{
			get
			{
				if(r_MGetPooled_Vector2_EventModifiers == null)
				{
					...
					r_MGetPooled_Vector2_EventModifiers.SetBelong(null);
				}
		...
		public static RMethod RMGetPooled_Vector2_NavigationDeviceType_EventModifiers
		{
			get
			{
				if(r_MGetPooled_Vector2_NavigationDeviceType_EventModifiers == null)
				{
					...
					r_MGetPooled_Vector2_NavigationDeviceType_EventModifiers.SetBelong(null);
				}
		...
		public static RMethod RMGetPooled_Direction_EventModifiers
		{
			get
			{
				if(r_MGetPooled_Direction_EventModifiers == null)
				{
					...
					r_MGetPooled_Direction_EventModifiers.SetBelong(null);
				}
		...
		public static RMethod RMGetPooled_Direction_NavigationDeviceType_EventModifiers
		{
			get
			{
				if(r_MGetPooled_Direction_NavigationDeviceType_EventModifiers == null)
				{
					...
					r_MGetPooled_Direction_NavigationDeviceType_EventModifiers.SetBelong(null);
				}
