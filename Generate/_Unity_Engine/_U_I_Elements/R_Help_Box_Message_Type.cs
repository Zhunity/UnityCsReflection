...
namespace Hvak.Editor.Refleaction.RUnityEngine.RUIElements
{
	...
	/// </summary>
    public partial class RHelpBoxMessageType : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(UnityEngine.UIElements.HelpBoxMessageType);
            }
        }

        public RHelpBoxMessageType() : base("UnityEngine.UIElements.HelpBoxMessageType")
        {
        }

        public RHelpBoxMessageType(System.Object instance) : base("UnityEngine.UIElements.HelpBoxMessageType")
		{
            SetInstance(instance);
		}

        public RHelpBoxMessageType(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RHelpBoxMessageType(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RFNone
		{
			get
			{
				if(r_FNone == null)
				{
					r_FNone = new(typeof(UnityEngine.UIElements.HelpBoxMessageType), "None");
				}
				return r_FNone;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RFInfo
		{
			get
			{
				if(r_FInfo == null)
				{
					r_FInfo = new(typeof(UnityEngine.UIElements.HelpBoxMessageType), "Info");
				}
				return r_FInfo;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RFWarning
		{
			get
			{
				if(r_FWarning == null)
				{
					r_FWarning = new(typeof(UnityEngine.UIElements.HelpBoxMessageType), "Warning");
				}
				return r_FWarning;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RUIElements.RHelpBoxMessageType RFError
		{
			get
			{
				if(r_FError == null)
				{
					r_FError = new(typeof(UnityEngine.UIElements.HelpBoxMessageType), "Error");
				}
				return r_FError;
			}
		}
