...
{public partial class RBoundsInt
{
    ...
    public partial class RPositionEnumerator : RMember //
    {
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int r_F_min;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int RF_min
		{
			get
			{
				if(r_F_min == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int r_F_max;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int RF_max
		{
			get
			{
				if(r_F_max == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int r_F_current;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int RF_current
		{
			get
			{
				if(r_F_current == null)
		...
		/// </summary>
		protected SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int r_PCurrent;
		public virtual SMFrame.Editor.Refleaction.RUnityEngine.RVector3Int RPCurrent
		{
			get
			{
				if(r_PCurrent == null)
        ...
        public virtual SMFrame.Editor.Refleaction.RUnityEngine.RBoundsInt.RPositionEnumerator GetEnumerator()
        {
            ...
            return new SMFrame.Editor.Refleaction.RUnityEngine.RBoundsInt.RPositionEnumerator(___result);
        }
