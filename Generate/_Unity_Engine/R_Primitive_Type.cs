...
namespace Hvak.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RPrimitiveType : RMember //
    {
        public static Type Type
        {
            get
            {
                return typeof(UnityEngine.PrimitiveType);
            }
        }
