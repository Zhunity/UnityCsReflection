...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RSpriteMeshType : RMember //
    {
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RSpriteMeshType r_FFullRect;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RSpriteMeshType RFFullRect
		{
			get
			{
				if(r_FFullRect == null)
				{
					r_FFullRect = new(typeof(UnityEngine.SpriteMeshType), "FullRect");
					r_FFullRect.SetBelong(null);
				}
				return r_FFullRect;
			}
		}
		...
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RSpriteMeshType r_FTight;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RSpriteMeshType RFTight
		{
			get
			{
				if(r_FTight == null)
				{
					r_FTight = new(typeof(UnityEngine.SpriteMeshType), "Tight");
