...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
	...
	/// </summary>
    public partial class RUnityException : RMember //
    {
		...
		/// System.Int32 Result
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RSystem.RInt32 r_FResult;
		public static SMFrame.Editor.Refleaction.RSystem.RInt32 RFResult
		{
			get
			{
				if(r_FResult == null)
				{
					r_FResult = new(typeof(UnityEngine.UnityException), "Result");
					r_FResult.SetBelong(null);
				}
				return r_FResult;
			}
		}
		...
		/// <summary>
		/// System.String unityStackTrace
		/// </summary>
		protected SMFrame.Editor.Refleaction.RSystem.RString r_FunityStackTrace;
		public virtual SMFrame.Editor.Refleaction.RSystem.RString RFunityStackTrace
		{
			get
			{
				if(r_FunityStackTrace == null)
				{
					r_FunityStackTrace = new(this, "unityStackTrace");
					r_FunityStackTrace.SetBelong(this.instance);
				}
				return r_FunityStackTrace;
			}
		}
        ...
        public RUnityException() : base("UnityEngine.UnityException")
        {
        }

        public RUnityException(System.Object instance) : base("UnityEngine.UnityException")
		{
            SetInstance(instance);
		}

        public RUnityException(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RUnityException(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }
