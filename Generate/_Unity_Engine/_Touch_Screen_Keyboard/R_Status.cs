    ...
    public partial class RStatus : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboard.RStatus RFVisible
		{
			get
			{
				if(r_FVisible == null)
				{
					r_FVisible = new( ReflectionUtils.GetType("UnityEngine.TouchScreenKeyboard+Status"), "Visible");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboard.RStatus RFDone
		{
			get
			{
				if(r_FDone == null)
				{
					r_FDone = new( ReflectionUtils.GetType("UnityEngine.TouchScreenKeyboard+Status"), "Done");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboard.RStatus RFCanceled
		{
			get
			{
				if(r_FCanceled == null)
				{
					r_FCanceled = new( ReflectionUtils.GetType("UnityEngine.TouchScreenKeyboard+Status"), "Canceled");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboard.RStatus RFLostFocus
		{
			get
			{
				...
				{
					r_FLostFocus = new( ReflectionUtils.GetType("UnityEngine.TouchScreenKeyboard+Status"), "LostFocus");
					r_FLostFocus.SetBelong(null);
				}
				return r_FLostFocus;
			}
		}
