...
namespace Hvak.Editor.Refleaction.RUnityEngine.RYoga
{
	...
	/// </summary>
    public partial class RBaselineFunction : RMember //
    {
		...
		/// <summary>
		/// Single Invoke(UnityEngine.Yoga.YogaNode, Single, Single)
		/// </summary>
		protected RMethod r_MInvoke_YogaNode_Single_Single;
		public virtual RMethod RMInvoke_YogaNode_Single_Single
		{
			get
			{
				if(r_MInvoke_YogaNode_Single_Single == null)
				{
					r_MInvoke_YogaNode_Single_Single = new(this, "Invoke", 0,  ReflectionUtils.GetType("UnityEngine.Yoga.YogaNode"), typeof(System.Single), typeof(System.Single));
					r_MInvoke_YogaNode_Single_Single.SetBelong(this.GetValue());
				}
				return r_MInvoke_YogaNode_Single_Single;
			}
		}

		/// <summary>
		/// System.IAsyncResult BeginInvoke(UnityEngine.Yoga.YogaNode, Single, Single, System.AsyncCallback, System.Object)
		/// </summary>
		protected RMethod r_MBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object;
		public virtual RMethod RMBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object
		{
			get
			{
				if(r_MBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object == null)
				{
					r_MBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object = new(this, "BeginInvoke", 0,  ReflectionUtils.GetType("UnityEngine.Yoga.YogaNode"), typeof(System.Single), typeof(System.Single), typeof(System.AsyncCallback), typeof(System.Object));
					r_MBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object.SetBelong(this.GetValue());
				}
				return r_MBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object;
			}
		}

		/// <summary>
		/// Single EndInvoke(System.IAsyncResult)
		/// </summary>
        ...
        public RBaselineFunction() : base("UnityEngine.Yoga.BaselineFunction")
        {
        }

        public RBaselineFunction(System.Object instance) : base("UnityEngine.Yoga.BaselineFunction")
		{
            SetInstance(instance);
		}

        public RBaselineFunction(RMember belongMember, string name, int genericCount = -1, params Type[] types) : base(belongMember, name, genericCount, types)
	    {
	    }

		 public RBaselineFunction(Type belongType, string name, int genericCount = -1, params Type[] types) : base(belongType, name, genericCount, types)
	    {
	    }

        public virtual System.Single Invoke(Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaNode @node, System.Single @width, System.Single @height)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@node.Value, @width, @height};
            var ___result = RMInvoke_YogaNode_Single_Single.Invoke(___genericsType, ___parameters);

            return (System.Single)___result;
        }


        public virtual System.IAsyncResult BeginInvoke(Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaNode @node, System.Single @width, System.Single @height, System.AsyncCallback @callback, System.Object @object)
        {

            var ___genericsType = new Type[] {};
            var ___parameters = new object[]{@node.Value, @width, @height, @callback, @object};
            var ___result = RMBeginInvoke_YogaNode_Single_Single_AsyncCallback_Object.Invoke(___genericsType, ___parameters);
