...
namespace Hvak.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RYogaExperimentalFeature : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaExperimentalFeature r_FWebFlexBasis;
		public static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaExperimentalFeature RFWebFlexBasis
		{
			get
			{
