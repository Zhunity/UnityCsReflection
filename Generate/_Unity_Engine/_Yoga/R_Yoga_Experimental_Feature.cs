...
namespace SMFrame.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RYogaExperimentalFeature : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.Yoga.YogaExperimentalFeature WebFlexBasis
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RYoga.RYogaExperimentalFeature r_FWebFlexBasis;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RYoga.RYogaExperimentalFeature RFWebFlexBasis
		{
			get
			{
				if(r_FWebFlexBasis == null)
				{
					r_FWebFlexBasis = new( ReflectionUtils.GetType("UnityEngine.Yoga.YogaExperimentalFeature"), "WebFlexBasis");
					r_FWebFlexBasis.SetBelong(null);
				}
				return r_FWebFlexBasis;
			}
		}
