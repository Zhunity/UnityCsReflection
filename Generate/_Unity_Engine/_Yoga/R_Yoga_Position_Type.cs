...
namespace Hvak.Editor.Refleaction.RUnityEngine.RYoga
{
    ...
    public partial class RYogaPositionType : RMember //
    {
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaPositionType r_FRelative;
		public static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaPositionType RFRelative
		{
			get
			{
				if(r_FRelative == null)
		...
		/// </summary>
		protected static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaPositionType r_FAbsolute;
		public static Hvak.Editor.Refleaction.RUnityEngine.RYoga.RYogaPositionType RFAbsolute
		{
			get
			{
				if(r_FAbsolute == null)
