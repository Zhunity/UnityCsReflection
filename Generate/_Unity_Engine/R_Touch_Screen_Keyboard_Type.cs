    ...
    public partial class RTouchScreenKeyboardType : RMember //
    {
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFDefault
		{
			get
			{
				if(r_FDefault == null)
				{
					r_FDefault = new(typeof(UnityEngine.TouchScreenKeyboardType), "Default");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFASCIICapable
		{
			get
			{
				...
				{
					r_FASCIICapable = new(typeof(UnityEngine.TouchScreenKeyboardType), "ASCIICapable");
					r_FASCIICapable.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFNumbersAndPunctuation
		{
			get
			{
				...
				{
					r_FNumbersAndPunctuation = new(typeof(UnityEngine.TouchScreenKeyboardType), "NumbersAndPunctuation");
					r_FNumbersAndPunctuation.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFURL
		{
			get
			{
				if(r_FURL == null)
				{
					r_FURL = new(typeof(UnityEngine.TouchScreenKeyboardType), "URL");
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFNumberPad
		{
			get
			{
				...
				{
					r_FNumberPad = new(typeof(UnityEngine.TouchScreenKeyboardType), "NumberPad");
					r_FNumberPad.SetBelong(null);
				}
				return r_FNumberPad;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFPhonePad
		{
			get
			{
				if(r_FPhonePad == null)
				{
					r_FPhonePad = new(typeof(UnityEngine.TouchScreenKeyboardType), "PhonePad");
					r_FPhonePad.SetBelong(null);
				}
				return r_FPhonePad;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFNamePhonePad
		{
			get
			{
				...
				{
					r_FNamePhonePad = new(typeof(UnityEngine.TouchScreenKeyboardType), "NamePhonePad");
					r_FNamePhonePad.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFEmailAddress
		{
			get
			{
				...
				{
					r_FEmailAddress = new(typeof(UnityEngine.TouchScreenKeyboardType), "EmailAddress");
					r_FEmailAddress.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFNintendoNetworkAccount
		{
			get
			{
				...
				{
					r_FNintendoNetworkAccount = new(typeof(UnityEngine.TouchScreenKeyboardType), "NintendoNetworkAccount");
					r_FNintendoNetworkAccount.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFSocial
		{
			get
			{
				if(r_FSocial == null)
				{
					r_FSocial = new(typeof(UnityEngine.TouchScreenKeyboardType), "Social");
					r_FSocial.SetBelong(null);
				}
				return r_FSocial;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFSearch
		{
			get
			{
				if(r_FSearch == null)
				{
					r_FSearch = new(typeof(UnityEngine.TouchScreenKeyboardType), "Search");
					r_FSearch.SetBelong(null);
				}
				return r_FSearch;
			}
		}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFDecimalPad
		{
			get
			{
				...
				{
					r_FDecimalPad = new(typeof(UnityEngine.TouchScreenKeyboardType), "DecimalPad");
					r_FDecimalPad.SetBelong(null);
				}
		...
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTouchScreenKeyboardType RFOneTimeCode
		{
			get
			{
				...
				{
					r_FOneTimeCode = new(typeof(UnityEngine.TouchScreenKeyboardType), "OneTimeCode");
					r_FOneTimeCode.SetBelong(null);
				}
