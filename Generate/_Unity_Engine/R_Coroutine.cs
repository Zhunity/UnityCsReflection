...
namespace Hvak.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RCoroutine : RMember //
    {
		...
		/// <summary>
		/// Void ReleaseCoroutine(IntPtr)
		/// </summary>
		protected static RMethod r_MReleaseCoroutine_IntPtr;
		public static RMethod RMReleaseCoroutine_IntPtr
		{
			get
			{
				if(r_MReleaseCoroutine_IntPtr == null)
				{
					r_MReleaseCoroutine_IntPtr = new(typeof(UnityEngine.Coroutine), "ReleaseCoroutine", 0, typeof(System.IntPtr));
					r_MReleaseCoroutine_IntPtr.SetBelong(null);
				}
				return r_MReleaseCoroutine_IntPtr;
			}
		}
        ...
        public static void ReleaseCoroutine(System.IntPtr @ptr)
        {
            ...
            var ___result = RMReleaseCoroutine_IntPtr.Invoke(___genericsType, ___parameters);
