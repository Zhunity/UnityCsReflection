    ...
    public partial class RShadowCastingMode : RMember //
    {
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RRendering.RShadowCastingMode RFOff
		{
			get
			{
				if(r_FOff == null)
				{
					r_FOff = new(typeof(UnityEngine.Rendering.ShadowCastingMode), "Off");
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RRendering.RShadowCastingMode RFOn
		{
			get
			{
				if(r_FOn == null)
				{
					r_FOn = new(typeof(UnityEngine.Rendering.ShadowCastingMode), "On");
					r_FOn.SetBelong(null);
				}
				return r_FOn;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RRendering.RShadowCastingMode RFTwoSided
		{
			get
			{
				if(r_FTwoSided == null)
				{
					r_FTwoSided = new(typeof(UnityEngine.Rendering.ShadowCastingMode), "TwoSided");
					r_FTwoSided.SetBelong(null);
				}
				return r_FTwoSided;
			}
		}
		...
		public static Hvak.Editor.Refleaction.RUnityEngine.RRendering.RShadowCastingMode RFShadowsOnly
		{
			get
			{
				if(r_FShadowsOnly == null)
				{
					r_FShadowsOnly = new(typeof(UnityEngine.Rendering.ShadowCastingMode), "ShadowsOnly");
					r_FShadowsOnly.SetBelong(null);
				}
				return r_FShadowsOnly;
			}
		}
