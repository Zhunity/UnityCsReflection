...
namespace SMFrame.Editor.Refleaction.RUnityEngine
{
    ...
    public partial class RTextureColorSpace : RMember //
    {
		...
		/// <summary>
		/// UnityEngine.TextureColorSpace Linear
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RTextureColorSpace r_FLinear;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTextureColorSpace RFLinear
		{
			get
			{
				if(r_FLinear == null)
				{
					r_FLinear = new( ReflectionUtils.GetType("UnityEngine.TextureColorSpace"), "Linear");
		...
		/// <summary>
		/// UnityEngine.TextureColorSpace sRGB
		/// </summary>
		protected static SMFrame.Editor.Refleaction.RUnityEngine.RTextureColorSpace r_FsRGB;
		public static SMFrame.Editor.Refleaction.RUnityEngine.RTextureColorSpace RFsRGB
		{
			get
			{
				if(r_FsRGB == null)
				{
					r_FsRGB = new( ReflectionUtils.GetType("UnityEngine.TextureColorSpace"), "sRGB");
